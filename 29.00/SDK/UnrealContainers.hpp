...
namespace UC
{
	...
	{
	public:
		static inline void* Realloc(void* _a1, __int64 _a2, unsigned int _a3) {
			static auto ret = reinterpret_cast<void* (*)(void*, __int64, unsigned int)>(__int64(GetModuleHandleA(0)) + 0x574DB84);
