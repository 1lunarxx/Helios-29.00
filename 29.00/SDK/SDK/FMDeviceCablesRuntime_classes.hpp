...
{
public:
	FMulticastInlineDelegateProperty_             OnControllerCableConnected;                        // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnControllerCableDisconnected;                     // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	void DropCable();
	void OnControllerCableConnected__DelegateSignature(const TArray<class UFMDeviceCablePortComponent*>& ConnectedPorts);
	void OnControllerCableDisconnected__DelegateSignature();
...
static_assert(sizeof(UFMDeviceCableManagerComponent) == 0x000298, "Wrong size on UFMDeviceCableManagerComponent");
...
static_assert(offsetof(UFMDeviceCableManagerComponent, PlayerEnteredHandle) == 0x000100, "Member 'UFMDeviceCableManagerComponent::PlayerEnteredHandle' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableManagerComponent, FreeDeviceCables) == 0x000148, "Member 'UFMDeviceCableManagerComponent::FreeDeviceCables' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableManagerComponent, CableConnectionsByType) == 0x000158, "Member 'UFMDeviceCableManagerComponent::CableConnectionsByType' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableManagerComponent, PortsInVolume) == 0x0001A8, "Member 'UFMDeviceCableManagerComponent::PortsInVolume' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableManagerComponent, OriginalGuidToDuplicatedGuidThisFrame) == 0x0001F8, "Member 'UFMDeviceCableManagerComponent::OriginalGuidToDuplicatedGuidThisFrame' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableManagerComponent, SourceObjectToDuplicatedObjectThisFrame) == 0x000248, "Member 'UFMDeviceCableManagerComponent::SourceObjectToDuplicatedObjectThisFrame' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnCablePortSizeUpdated;                            // 0x05F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnimatorCreated;                                 // 0x0608(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnConnected;                                       // 0x0618(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_628[0x20];                                     // 0x0628(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnDisconnected;                                    // 0x0648(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnConnectionStarted;                               // 0x0658(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnConnectionEnded;                                 // 0x0668(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPortArtifactUpdated;                             // 0x0678(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnReceiveFloatProviders;                           // 0x0688(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDisconnectFloatProvider;                         // 0x0698(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	EFMDeviceCablePortComponentAllowMultipleConnections OverrideAllowMultipleConnections;                  // 0x07C6(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EFMDeviceCablePortComponentAllowMultipleConnections OverrideAllowSiblingConnections;                   // 0x07C7(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHideWhenNotRelevant;                              // 0x07C8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsPlayerPort;                                     // 0x07C9(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsOnPreviewBuildingActor;                         // 0x07CA(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7CB[0x1];                                      // 0x07CB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EnterVolumeTag;                                    // 0x07CC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ExitVolumeTag;                                     // 0x07D0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7D4[0x4];                                      // 0x07D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UFMDeviceCablePortComponent*>    ConnectedPorts;                                    // 0x07D8(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UFMDeviceCablePortComponent*>    ServerConnectedPorts;                              // 0x07E8(0x0010)(ExportObject, Net, ZeroConstructor, RepNotify, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UFMDeviceCableConnectionBase*>   CurrentConnections;                                // 0x07F8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	class AFMDeviceCable*                         ConstantCable;                                     // 0x0808(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFMDeviceCableManagerComponent*         DeviceCableManager;                                // 0x0810(0x0008)(ExportObject, Net, ZeroConstructor, Transient, InstancedReference, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UFMDeviceCablePortComponent*>    OtherPortsOnActor;                                 // 0x0818(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	EDeviceCableActivatedState                    PortActivatedState;                                // 0x0828(0x0001)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EDeviceCableActivatedState                    ServerPortActivatedState;                          // 0x0829(0x0001)(Net, ZeroConstructor, SaveGame, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EDeviceCablePortSelectableState               PortSelectableState;                               // 0x082A(0x0001)(Net, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_82B[0x5];                                      // 0x082B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UFMDeviceCableAnimatorBase*             DeviceCableAnimator;                               // 0x0830(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGuid                                  ConnectionGuid;                                    // 0x0838(0x0010)(ZeroConstructor, Transient, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FGuid>                          ConnectedGuids;                                    // 0x0848(0x0010)(ZeroConstructor, Transient, SaveGame, Protected, NativeAccessSpecifierProtected)
	struct FFMDeviceCableArtifact                 CachedArtifact;                                    // 0x0858(0x0020)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_878[0x10];                                     // 0x0878(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UFMDeviceCablePortComponent*>    PendingConnectionBroadcasts;                       // 0x0888(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FGuid                                  SaveGuid;                                          // 0x0898(0x0010)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	void FabricCablePortSizeUpdated__DelegateSignature(float Size);
	class AFMDeviceCable* GetConstantCable();
	class UFMDeviceCableAnimatorBase* GetDeviceCableAnimator();
	struct FGuid GetGuid();
	void OnAnimatorCreated__DelegateSignature(class UFMDeviceCableAnimatorBase* Animator);
	void OnConnected__DelegateSignature(class UFMDeviceCablePortComponent* ConnectedPort);
	void OnConnectedWithSourcePort__DelegateSignature(class UFMDeviceCablePortComponent* SourcePort, class UFMDeviceCablePortComponent* OtherPort);
	void OnConnectionEnded__DelegateSignature(class UFMDeviceCableConnectionBase* EndedConnection);
	void OnConnectionStarted__DelegateSignature(class UFMDeviceCableConnectionBase* NewConnection);
	void OnDisconnected__DelegateSignature(class UFMDeviceCablePortComponent* DisconnectedPort);
	void OnDisconnectFloatProvider__DelegateSignature(class UFabricFloatProviderBase* FloatProvider);
	...
	void OnPortArtifactUpdated__DelegateSignature();
	void OnReceiveFloatProviders__DelegateSignature(const TArray<class UFabricFloatProviderBase*>& FloatProviders);
...
static_assert(sizeof(UFMDeviceCablePortComponent) == 0x0008B0, "Wrong size on UFMDeviceCablePortComponent");
...
static_assert(offsetof(UFMDeviceCablePortComponent, OverrideAllowMultipleConnections) == 0x0007C6, "Member 'UFMDeviceCablePortComponent::OverrideAllowMultipleConnections' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, OverrideAllowSiblingConnections) == 0x0007C7, "Member 'UFMDeviceCablePortComponent::OverrideAllowSiblingConnections' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, bHideWhenNotRelevant) == 0x0007C8, "Member 'UFMDeviceCablePortComponent::bHideWhenNotRelevant' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, bIsPlayerPort) == 0x0007C9, "Member 'UFMDeviceCablePortComponent::bIsPlayerPort' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, bIsOnPreviewBuildingActor) == 0x0007CA, "Member 'UFMDeviceCablePortComponent::bIsOnPreviewBuildingActor' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, EnterVolumeTag) == 0x0007CC, "Member 'UFMDeviceCablePortComponent::EnterVolumeTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ExitVolumeTag) == 0x0007D0, "Member 'UFMDeviceCablePortComponent::ExitVolumeTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ConnectedPorts) == 0x0007D8, "Member 'UFMDeviceCablePortComponent::ConnectedPorts' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ServerConnectedPorts) == 0x0007E8, "Member 'UFMDeviceCablePortComponent::ServerConnectedPorts' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, CurrentConnections) == 0x0007F8, "Member 'UFMDeviceCablePortComponent::CurrentConnections' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ConstantCable) == 0x000808, "Member 'UFMDeviceCablePortComponent::ConstantCable' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, DeviceCableManager) == 0x000810, "Member 'UFMDeviceCablePortComponent::DeviceCableManager' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, OtherPortsOnActor) == 0x000818, "Member 'UFMDeviceCablePortComponent::OtherPortsOnActor' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, PortActivatedState) == 0x000828, "Member 'UFMDeviceCablePortComponent::PortActivatedState' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ServerPortActivatedState) == 0x000829, "Member 'UFMDeviceCablePortComponent::ServerPortActivatedState' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, PortSelectableState) == 0x00082A, "Member 'UFMDeviceCablePortComponent::PortSelectableState' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, DeviceCableAnimator) == 0x000830, "Member 'UFMDeviceCablePortComponent::DeviceCableAnimator' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ConnectionGuid) == 0x000838, "Member 'UFMDeviceCablePortComponent::ConnectionGuid' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, ConnectedGuids) == 0x000848, "Member 'UFMDeviceCablePortComponent::ConnectedGuids' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, CachedArtifact) == 0x000858, "Member 'UFMDeviceCablePortComponent::CachedArtifact' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, PendingConnectionBroadcasts) == 0x000888, "Member 'UFMDeviceCablePortComponent::PendingConnectionBroadcasts' has a wrong offset!");
static_assert(offsetof(UFMDeviceCablePortComponent, SaveGuid) == 0x000898, "Member 'UFMDeviceCablePortComponent::SaveGuid' has a wrong offset!");
...
public:
	...
	class FString                                 AssociatedProperty;                                // 0x08B8(0x0010)(Net, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UObject>                 AssociatedObject;                                  // 0x08C8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UFMDeviceCableModulatorPortComponent, AssociatedProperty) == 0x0008B8, "Member 'UFMDeviceCableModulatorPortComponent::AssociatedProperty' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableModulatorPortComponent, AssociatedObject) == 0x0008C8, "Member 'UFMDeviceCableModulatorPortComponent::AssociatedObject' has a wrong offset!");
...
{
public:
	struct FFMDeviceCableOrderingMovementInfo     InputsShowHideMovementInfo;                        // 0x00A0(0x0030)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_D0[0xB8];                                      // 0x00D0(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFMDeviceCableOrderingMovementInfo     InOutMovementInfo;                                 // 0x0188(0x0030)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FFMDeviceCableOrderingMovementInfo     TransitionMovementInfo;                            // 0x01B8(0x0030)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E8[0xB8];                                     // 0x01E8(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFMDeviceCableOrderingMovementInfo     CollapseExpandMovementInfo;                        // 0x02A0(0x0030)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0xB8];                                     // 0x02D0(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VisualChangeTimeoutTime;                           // 0x0388(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_38C[0x4];                                      // 0x038C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   ClosedMeshTag;                                     // 0x0390(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   TopMeshTag;                                        // 0x0394(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   MiddleMeshTag;                                     // 0x0398(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   BottomMeshTag;                                     // 0x039C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UStaticMeshComponent*                   ClosedMesh;                                        // 0x03A0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UStaticMeshComponent*                   TopMesh;                                           // 0x03A8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UStaticMeshComponent*>           MiddleMeshes;                                      // 0x03B0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UStaticMeshComponent*                   BottomMesh;                                        // 0x03C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3C8[0x8];                                      // 0x03C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UFMDeviceCableWildcardPortComponent*> InputWildcardPorts;                                // 0x03D0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UFMDeviceCableWildcardPortComponent*> OutputWildcardPorts;                               // 0x03E0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_3F0[0x30];                                     // 0x03F0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UFMDeviceCableWildcardPortComponent*> PortsWithPendingDisconnects;                       // 0x0420(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_430[0x50];                                     // 0x0430(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFMDeviceCableOrderingPortState> ServerPortStates;                                  // 0x0480(0x0010)(Net, ZeroConstructor, Transient, RepNotify, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFMDeviceCableWildcardOrderingComponent) == 0x000498, "Wrong size on UFMDeviceCableWildcardOrderingComponent");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, InputsShowHideMovementInfo) == 0x0000A0, "Member 'UFMDeviceCableWildcardOrderingComponent::InputsShowHideMovementInfo' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, InOutMovementInfo) == 0x000188, "Member 'UFMDeviceCableWildcardOrderingComponent::InOutMovementInfo' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, TransitionMovementInfo) == 0x0001B8, "Member 'UFMDeviceCableWildcardOrderingComponent::TransitionMovementInfo' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, CollapseExpandMovementInfo) == 0x0002A0, "Member 'UFMDeviceCableWildcardOrderingComponent::CollapseExpandMovementInfo' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, VisualChangeTimeoutTime) == 0x000388, "Member 'UFMDeviceCableWildcardOrderingComponent::VisualChangeTimeoutTime' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, ClosedMeshTag) == 0x000390, "Member 'UFMDeviceCableWildcardOrderingComponent::ClosedMeshTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, TopMeshTag) == 0x000394, "Member 'UFMDeviceCableWildcardOrderingComponent::TopMeshTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, MiddleMeshTag) == 0x000398, "Member 'UFMDeviceCableWildcardOrderingComponent::MiddleMeshTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, BottomMeshTag) == 0x00039C, "Member 'UFMDeviceCableWildcardOrderingComponent::BottomMeshTag' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, ClosedMesh) == 0x0003A0, "Member 'UFMDeviceCableWildcardOrderingComponent::ClosedMesh' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, TopMesh) == 0x0003A8, "Member 'UFMDeviceCableWildcardOrderingComponent::TopMesh' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, MiddleMeshes) == 0x0003B0, "Member 'UFMDeviceCableWildcardOrderingComponent::MiddleMeshes' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, BottomMesh) == 0x0003C0, "Member 'UFMDeviceCableWildcardOrderingComponent::BottomMesh' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, InputWildcardPorts) == 0x0003D0, "Member 'UFMDeviceCableWildcardOrderingComponent::InputWildcardPorts' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, OutputWildcardPorts) == 0x0003E0, "Member 'UFMDeviceCableWildcardOrderingComponent::OutputWildcardPorts' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, PortsWithPendingDisconnects) == 0x000420, "Member 'UFMDeviceCableWildcardOrderingComponent::PortsWithPendingDisconnects' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardOrderingComponent, ServerPortStates) == 0x000480, "Member 'UFMDeviceCableWildcardOrderingComponent::ServerPortStates' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnWildcardDataTypeChanged;                         // 0x08B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWildcardPortSlotSetFromSave;                     // 0x08C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	int32                                         SlotIndex;                                         // 0x08D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SavedSlotIndex;                                    // 0x08D4(0x0004)(Net, ZeroConstructor, SaveGame, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void OnWildcardDataTypeChanged__DelegateSignature(class UFMDeviceCableWildcardPortComponent* WildcardPort, EDeviceCablePortDataType DataType);
	void OnWildcardPortSlotSetFromSave__DelegateSignature(class UFMDeviceCableWildcardPortComponent* WildcardPort, bool bHasConnections);
...
static_assert(sizeof(UFMDeviceCableWildcardPortComponent) == 0x0008E0, "Wrong size on UFMDeviceCableWildcardPortComponent");
static_assert(offsetof(UFMDeviceCableWildcardPortComponent, OnWildcardDataTypeChanged) == 0x0008B0, "Member 'UFMDeviceCableWildcardPortComponent::OnWildcardDataTypeChanged' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardPortComponent, OnWildcardPortSlotSetFromSave) == 0x0008C0, "Member 'UFMDeviceCableWildcardPortComponent::OnWildcardPortSlotSetFromSave' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardPortComponent, SlotIndex) == 0x0008D0, "Member 'UFMDeviceCableWildcardPortComponent::SlotIndex' has a wrong offset!");
static_assert(offsetof(UFMDeviceCableWildcardPortComponent, SavedSlotIndex) == 0x0008D4, "Member 'UFMDeviceCableWildcardPortComponent::SavedSlotIndex' has a wrong offset!");
