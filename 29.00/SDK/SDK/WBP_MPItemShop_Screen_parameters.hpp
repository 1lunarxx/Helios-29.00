...
static_assert(offsetof(WBP_MPItemShop_Screen_C_BndEvt__WBP_MPItemShop_Screen_Button_BackToGame_NoOffers_K2Node_ComponentBoundEvent_7_CommonButtonBaseClicked__DelegateSignature, Button) == 0x000000, "Member 'WBP_MPItemShop_Screen_C_BndEvt__WBP_MPItemShop_Screen_Button_BackToGame_NoOffers_K2Node_ComponentBoundEvent_7_CommonButtonBaseClicked__DelegateSignature::Button' has a wrong offset!");
...
public:
	...
	class FString                                 K2Node_ComponentBoundEvent_OfferId;                // 0x0008(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	struct FFortItemShopCMSBackground             CallFunc_GetPreferredBackgroundForLayout_ReturnValue; // 0x0030(0x0020)()
	...
	class FString                                 K2Node_Event_OfferTrackingId;                      // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bShowOfferDetails;                    // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUserWidget*                            CallFunc_GetDesiredFocusTile_TileWidget;           // 0x0070(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	const class UFortItemShopOfferVM*             CallFunc_FindOfferByTrackingId_ReturnValue;        // 0x0080(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bUsingGamepad;                        // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8A[0x2];                                       // 0x008A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Event_ScrollAmount;                         // 0x008C(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsItemPreviewEnabled_ReturnValue;         // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 K2Node_CustomEvent_FeaturedOfferId;                // 0x00C0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UDialogVM_ShopInfo_C*                   CallFunc_SpawnObject_ReturnValue;                  // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UUIKitDialogViewModel*                  CallFunc_OverrideDialogInfoText_Out_ModalVM;       // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	const class UFortItemShopOfferGroupVM*        CallFunc_GetOfferGroupWithOffer_ReturnValue;       // 0x00F0(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_SupportACreator_Dialog_C*          CallFunc_Create_ReturnValue;                       // 0x0100(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UObject*                                K2Node_CustomEvent_LoadedBackground;               // 0x0108(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UObject* LoadedBackground)> K2Node_CreateDelegate_OutputDelegate;              // 0x0110(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LoadBackground_ReturnValue;               // 0x011C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	const class UFortItemShopOfferVM*             CallFunc_GetOfferFromId_ReturnValue_1;             // 0x0148(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsUsingTouch_ReturnValue_1;               // 0x0161(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_162[0x6];                                      // 0x0162(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonButtonBase*                      K2Node_ComponentBoundEvent_Button;                 // 0x0168(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen) == 0x000178, "Wrong size on WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_OfferId) == 0x000008, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_OfferId' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_Button_5) == 0x000018, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_Button_5' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_Button_3) == 0x000028, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_Button_3' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetPreferredBackgroundForLayout_ReturnValue) == 0x000030, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetPreferredBackgroundForLayout_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetCurrentRowWidget_RowWidget) == 0x000050, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetCurrentRowWidget_RowWidget' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_Event_OfferTrackingId) == 0x000058, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_Event_OfferTrackingId' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_Event_bShowOfferDetails) == 0x000068, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_Event_bShowOfferDetails' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetDesiredFocusTile_TileWidget) == 0x000070, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetDesiredFocusTile_TileWidget' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_Not_PreBool_ReturnValue) == 0x000078, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_FindOfferByTrackingId_ReturnValue) == 0x000080, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_FindOfferByTrackingId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_IsValid_ReturnValue) == 0x000088, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_Event_bUsingGamepad) == 0x000089, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_Event_bUsingGamepad' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_Event_ScrollAmount) == 0x00008C, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_Event_ScrollAmount' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_Button_1) == 0x000098, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_Button_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_SpawnSound2D_ReturnValue) == 0x0000A0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_IsItemPreviewEnabled_ReturnValue) == 0x0000A8, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_IsItemPreviewEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_SpawnSound2D_ReturnValue_1) == 0x0000B0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_SpawnSound2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_Button_6) == 0x0000B8, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_Button_6' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_CustomEvent_FeaturedOfferId) == 0x0000C0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_CustomEvent_FeaturedOfferId' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_IsEmpty_ReturnValue) == 0x0000D0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_Not_PreBool_ReturnValue_1) == 0x0000D1, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_SpawnObject_ReturnValue) == 0x0000D8, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_BooleanAND_ReturnValue) == 0x0000E0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_OverrideDialogInfoText_Out_ModalVM) == 0x0000E8, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_OverrideDialogInfoText_Out_ModalVM' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetOfferGroupWithOffer_ReturnValue) == 0x0000F0, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetOfferGroupWithOffer_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_Create_ReturnValue) == 0x000100, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_CustomEvent_LoadedBackground) == 0x000108, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_CustomEvent_LoadedBackground' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_CreateDelegate_OutputDelegate) == 0x000110, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_LoadBackground_ReturnValue) == 0x00011C, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_LoadBackground_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_Not_PreBool_ReturnValue_2) == 0x00011D, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_BooleanAND_ReturnValue_1) == 0x00011E, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetOfferFromId_ReturnValue_1) == 0x000148, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetOfferFromId_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetOwningPlayer_ReturnValue) == 0x000150, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_GetOwningPlayer_ReturnValue_1) == 0x000158, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_GetOwningPlayer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_IsUsingTouch_ReturnValue) == 0x000160, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_IsUsingTouch_ReturnValue_1) == 0x000161, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_IsUsingTouch_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, K2Node_ComponentBoundEvent_Button) == 0x000168, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen, CallFunc_HandleScroll_OffsetAmount_ImplicitCast) == 0x000170, "Member 'WBP_MPItemShop_Screen_C_ExecuteUbergraph_WBP_MPItemShop_Screen::CallFunc_HandleScroll_OffsetAmount_ImplicitCast' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_ShouldShowNavPromptBelowNav_ReturnValue;  // 0x0013(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue_2;                // 0x0014(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsItemPreviewEnabled_ReturnValue_1;       // 0x0015(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus) == 0x000008, "Wrong alignment on WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus");
static_assert(sizeof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus) == 0x000018, "Wrong size on WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_Not_PreBool_ReturnValue_1) == 0x000005, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_IsUsingTouch_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_IsItemPreviewEnabled_ReturnValue) == 0x000011, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_IsItemPreviewEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_BooleanAND_ReturnValue) == 0x000012, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_ShouldShowNavPromptBelowNav_ReturnValue) == 0x000013, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_ShouldShowNavPromptBelowNav_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_Not_PreBool_ReturnValue_2) == 0x000014, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_IsItemPreviewEnabled_ReturnValue_1) == 0x000015, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_IsItemPreviewEnabled_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, CallFunc_BooleanAND_ReturnValue_1) == 0x000016, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus, K2Node_Select_Default) == 0x000017, "Member 'WBP_MPItemShop_Screen_C_Handle_Quicknav_or_Content_Focus::K2Node_Select_Default' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_Set_Length_ReturnValue;                   // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	const class UFortLockerCategoryConfig*        CallFunc_GetItemCategory_ReturnValue;              // 0x0028(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsValidClass_ReturnValue_1;               // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, OfferVM) == 0x000000, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::OfferVM' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CustomBanner) == 0x000008, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CustomBanner' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, Temp_int_Array_Index_Variable) == 0x000010, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Set_Length_ReturnValue) == 0x000014, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Set_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000018, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Array_Get_Item) == 0x000020, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_GetItemCategory_ReturnValue) == 0x000028, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_GetItemCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Array_Length_ReturnValue) == 0x000030, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, Temp_int_Loop_Counter_Variable) == 0x000034, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Less_IntInt_ReturnValue) == 0x000038, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Add_IntInt_ReturnValue) == 0x00003C, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_IsValidClass_ReturnValue) == 0x000040, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, Temp_bool_True_if_break_was_hit_Variable) == 0x000041, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::Temp_bool_True_if_break_was_hit_Variable' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Not_PreBool_ReturnValue) == 0x000042, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_BooleanAND_ReturnValue) == 0x000043, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_IsValidClass_ReturnValue_1) == 0x000044, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_IsValidClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_GetOwningPlayer_ReturnValue) == 0x000048, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_Create_ReturnValue) == 0x000050, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, K2Node_DynamicCast_AsWBP_MPItem_Shop_Custom_Banner) == 0x000058, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::K2Node_DynamicCast_AsWBP_MPItem_Shop_Custom_Banner' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, K2Node_DynamicCast_bSuccess) == 0x000060, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_HandleBanner, CallFunc_AddChild_ReturnValue) == 0x000068, "Member 'WBP_MPItemShop_Screen_C_HandleBanner::CallFunc_AddChild_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Screen_C_UpdateBannerVisibility, ShouldShow) == 0x000000, "Member 'WBP_MPItemShop_Screen_C_UpdateBannerVisibility::ShouldShow' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_UpdateBannerVisibility, Temp_bool_Variable) == 0x000001, "Member 'WBP_MPItemShop_Screen_C_UpdateBannerVisibility::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_UpdateBannerVisibility, Temp_byte_Variable) == 0x000002, "Member 'WBP_MPItemShop_Screen_C_UpdateBannerVisibility::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_UpdateBannerVisibility, Temp_byte_Variable_1) == 0x000003, "Member 'WBP_MPItemShop_Screen_C_UpdateBannerVisibility::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Screen_C_UpdateBannerVisibility, K2Node_Select_Default) == 0x000004, "Member 'WBP_MPItemShop_Screen_C_UpdateBannerVisibility::K2Node_Select_Default' has a wrong offset!");
