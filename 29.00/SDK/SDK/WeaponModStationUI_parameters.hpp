...
struct AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature final
{
public:
	class UFortWeaponModItemDefinition*           CurrentlySelectedMod;                              // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature) == 0x000008, "Wrong alignment on AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature");
static_assert(sizeof(AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature) == 0x000008, "Wrong size on AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature");
static_assert(offsetof(AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature, CurrentlySelectedMod) == 0x000000, "Member 'AthenaWeaponModsWorkbenchContext_OnWeaponModsWorkbenchSelectedModChanged__DelegateSignature::CurrentlySelectedMod' has a wrong offset!");
