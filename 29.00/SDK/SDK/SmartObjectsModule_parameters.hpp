...
// Function SmartObjectsModule.SmartObjectComponent.SetDefinitionAsset
// 0x0008 (0x0008 - 0x0000)
struct SmartObjectComponent_SetDefinitionAsset final
{
public:
	class USmartObjectDefinition*                 Definition;                                        // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SmartObjectComponent_SetDefinitionAsset) == 0x000008, "Wrong alignment on SmartObjectComponent_SetDefinitionAsset");
static_assert(sizeof(SmartObjectComponent_SetDefinitionAsset) == 0x000008, "Wrong size on SmartObjectComponent_SetDefinitionAsset");
static_assert(offsetof(SmartObjectComponent_SetDefinitionAsset, Definition) == 0x000000, "Member 'SmartObjectComponent_SetDefinitionAsset::Definition' has a wrong offset!");
...
// Function SmartObjectsModule.SmartObjectComponent.GetDefinitionAsset
// 0x0008 (0x0008 - 0x0000)
struct SmartObjectComponent_GetDefinitionAsset final
{
public:
	const class USmartObjectDefinition*           ReturnValue;                                       // 0x0000(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SmartObjectComponent_GetDefinitionAsset) == 0x000008, "Wrong alignment on SmartObjectComponent_GetDefinitionAsset");
static_assert(sizeof(SmartObjectComponent_GetDefinitionAsset) == 0x000008, "Wrong size on SmartObjectComponent_GetDefinitionAsset");
static_assert(offsetof(SmartObjectComponent_GetDefinitionAsset, ReturnValue) == 0x000000, "Member 'SmartObjectComponent_GetDefinitionAsset::ReturnValue' has a wrong offset!");
