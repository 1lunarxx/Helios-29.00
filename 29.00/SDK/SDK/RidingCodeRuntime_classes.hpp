...
public:
	...
	FMulticastInlineDelegateProperty_             OnRiderStartedRiding;                              // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRiderStoppedRiding;                              // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URidableComponent) == 0x000410, "Wrong size on URidableComponent");
...
static_assert(offsetof(URidableComponent, WeaponTargetingSourceOffsetModifier) == 0x000228, "Member 'URidableComponent::WeaponTargetingSourceOffsetModifier' has a wrong offset!");
static_assert(offsetof(URidableComponent, RidableTag) == 0x000240, "Member 'URidableComponent::RidableTag' has a wrong offset!");
static_assert(offsetof(URidableComponent, EnergyDepletedTag) == 0x000244, "Member 'URidableComponent::EnergyDepletedTag' has a wrong offset!");
static_assert(offsetof(URidableComponent, PlaylistTagBlacklistRowHandle) == 0x000248, "Member 'URidableComponent::PlaylistTagBlacklistRowHandle' has a wrong offset!");
static_assert(offsetof(URidableComponent, ActiveRider) == 0x000258, "Member 'URidableComponent::ActiveRider' has a wrong offset!");
static_assert(offsetof(URidableComponent, LastRider) == 0x000260, "Member 'URidableComponent::LastRider' has a wrong offset!");
static_assert(offsetof(URidableComponent, RidableProp) == 0x000268, "Member 'URidableComponent::RidableProp' has a wrong offset!");
static_assert(offsetof(URidableComponent, OriginalCapsuleRadius) == 0x000270, "Member 'URidableComponent::OriginalCapsuleRadius' has a wrong offset!");
static_assert(offsetof(URidableComponent, OriginalCapsuleHalfHeight) == 0x000274, "Member 'URidableComponent::OriginalCapsuleHalfHeight' has a wrong offset!");
static_assert(offsetof(URidableComponent, RidingCapsuleRadius) == 0x000278, "Member 'URidableComponent::RidingCapsuleRadius' has a wrong offset!");
static_assert(offsetof(URidableComponent, RidingCapsuleHalfHeight) == 0x00027C, "Member 'URidableComponent::RidingCapsuleHalfHeight' has a wrong offset!");
static_assert(offsetof(URidableComponent, bOriginalClientPositionSmoothingThrottlingSetting) == 0x000280, "Member 'URidableComponent::bOriginalClientPositionSmoothingThrottlingSetting' has a wrong offset!");
static_assert(offsetof(URidableComponent, LockRotationToRidableActor) == 0x000281, "Member 'URidableComponent::LockRotationToRidableActor' has a wrong offset!");
static_assert(offsetof(URidableComponent, MaxHalfAimingAngle) == 0x000288, "Member 'URidableComponent::MaxHalfAimingAngle' has a wrong offset!");
static_assert(offsetof(URidableComponent, PrimaryFireMontageAnimCoreTypeOverrides) == 0x0002B0, "Member 'URidableComponent::PrimaryFireMontageAnimCoreTypeOverrides' has a wrong offset!");
static_assert(offsetof(URidableComponent, PrimaryFireMontageTagOverrides) == 0x0002C0, "Member 'URidableComponent::PrimaryFireMontageTagOverrides' has a wrong offset!");
static_assert(offsetof(URidableComponent, PettingData) == 0x0002D0, "Member 'URidableComponent::PettingData' has a wrong offset!");
static_assert(offsetof(URidableComponent, RestoreCollisionHandle) == 0x0003E0, "Member 'URidableComponent::RestoreCollisionHandle' has a wrong offset!");
static_assert(offsetof(URidableComponent, bIsSprinting) == 0x0003F8, "Member 'URidableComponent::bIsSprinting' has a wrong offset!");
...
public:
	...
	class FText                                   AbilityDisplayText;                                // 0x0468(0x0018)(Edit, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	bool                                          bCanJump;                                          // 0x0480(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAlwaysMoveForward;                                // 0x0481(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_482[0x2];                                      // 0x0482(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ForwardMoveSpeedMultiplier;                        // 0x0484(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BackwardMoveSpeedMultiplier;                       // 0x0488(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SidewaysMoveRotationOffset;                        // 0x048C(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EFortMovementUrgency                          MovementUrgency;                                   // 0x0490(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsBeingControlled;                                // 0x0491(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_492[0x1E];                                     // 0x0492(0x001E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRidableControlParams                  RidableControlParams;                              // 0x04B0(0x0208)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_6B8[0x28];                                     // 0x06B8(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         JumpUpwardGravityScale;                            // 0x06E0(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         JumpDownwardGravityScale;                          // 0x0708(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UControllableRidableComponent) == 0x000730, "Wrong size on UControllableRidableComponent");
static_assert(offsetof(UControllableRidableComponent, bUseGravityJump) == 0x000410, "Member 'UControllableRidableComponent::bUseGravityJump' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, IgnoreGravityJumpTagQuery) == 0x000418, "Member 'UControllableRidableComponent::IgnoreGravityJumpTagQuery' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, bIsControllable) == 0x000460, "Member 'UControllableRidableComponent::bIsControllable' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, bHasAbility) == 0x000461, "Member 'UControllableRidableComponent::bHasAbility' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, AbilityDisplayText) == 0x000468, "Member 'UControllableRidableComponent::AbilityDisplayText' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, bCanJump) == 0x000480, "Member 'UControllableRidableComponent::bCanJump' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, bAlwaysMoveForward) == 0x000481, "Member 'UControllableRidableComponent::bAlwaysMoveForward' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, ForwardMoveSpeedMultiplier) == 0x000484, "Member 'UControllableRidableComponent::ForwardMoveSpeedMultiplier' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, BackwardMoveSpeedMultiplier) == 0x000488, "Member 'UControllableRidableComponent::BackwardMoveSpeedMultiplier' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, SidewaysMoveRotationOffset) == 0x00048C, "Member 'UControllableRidableComponent::SidewaysMoveRotationOffset' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, MovementUrgency) == 0x000490, "Member 'UControllableRidableComponent::MovementUrgency' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, bIsBeingControlled) == 0x000491, "Member 'UControllableRidableComponent::bIsBeingControlled' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, RidableControlParams) == 0x0004B0, "Member 'UControllableRidableComponent::RidableControlParams' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, JumpUpwardGravityScale) == 0x0006E0, "Member 'UControllableRidableComponent::JumpUpwardGravityScale' has a wrong offset!");
static_assert(offsetof(UControllableRidableComponent, JumpDownwardGravityScale) == 0x000708, "Member 'UControllableRidableComponent::JumpDownwardGravityScale' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnStartedRiding;                                   // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStoppedRiding;                                   // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URiderComponent) == 0x000698, "Wrong size on URiderComponent");
...
static_assert(offsetof(URiderComponent, RiderPropClass) == 0x000120, "Member 'URiderComponent::RiderPropClass' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidablePropClass) == 0x000128, "Member 'URiderComponent::RidablePropClass' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachLocationOffset) == 0x000130, "Member 'URiderComponent::RiderPropAttachLocationOffset' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachRotationOffset) == 0x000148, "Member 'URiderComponent::RiderPropAttachRotationOffset' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachScale) == 0x000160, "Member 'URiderComponent::RiderPropAttachScale' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachSocket) == 0x000164, "Member 'URiderComponent::RiderPropAttachSocket' has a wrong offset!");
static_assert(offsetof(URiderComponent, bUseClientAttachGuideSocket) == 0x000168, "Member 'URiderComponent::bUseClientAttachGuideSocket' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachSoftBounds) == 0x000170, "Member 'URiderComponent::RiderPropAttachSoftBounds' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachSoftBoundsScalar) == 0x000188, "Member 'URiderComponent::RiderPropAttachSoftBoundsScalar' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachHardBounds) == 0x000190, "Member 'URiderComponent::RiderPropAttachHardBounds' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachSoftBoundsTargetingScalar) == 0x0001A8, "Member 'URiderComponent::RiderPropAttachSoftBoundsTargetingScalar' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachHardBoundsTargetingScalar) == 0x0001AC, "Member 'URiderComponent::RiderPropAttachHardBoundsTargetingScalar' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderPropAttachVerticalBufferTargetingScalar) == 0x0001B0, "Member 'URiderComponent::RiderPropAttachVerticalBufferTargetingScalar' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingExitHoldTime) == 0x0001B4, "Member 'URiderComponent::RidingExitHoldTime' has a wrong offset!");
static_assert(offsetof(URiderComponent, TimeBeforeReenteringRiding) == 0x0001B8, "Member 'URiderComponent::TimeBeforeReenteringRiding' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingExitStartedEventTag) == 0x0001E0, "Member 'URiderComponent::RidingExitStartedEventTag' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingExitStoppedEventTag) == 0x0001E4, "Member 'URiderComponent::RidingExitStoppedEventTag' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingInputContext) == 0x0001E8, "Member 'URiderComponent::RidingInputContext' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingExit) == 0x0001F0, "Member 'URiderComponent::RidingExit' has a wrong offset!");
static_assert(offsetof(URiderComponent, GamepadRidingExit) == 0x0001F8, "Member 'URiderComponent::GamepadRidingExit' has a wrong offset!");
static_assert(offsetof(URiderComponent, ConnectorFXAsset) == 0x000200, "Member 'URiderComponent::ConnectorFXAsset' has a wrong offset!");
static_assert(offsetof(URiderComponent, ConnectorPropSourceMeshParameterName) == 0x000208, "Member 'URiderComponent::ConnectorPropSourceMeshParameterName' has a wrong offset!");
static_assert(offsetof(URiderComponent, ConnectorPropTargetMeshParameterName) == 0x00020C, "Member 'URiderComponent::ConnectorPropTargetMeshParameterName' has a wrong offset!");
static_assert(offsetof(URiderComponent, SimulatedSmoothedRotationSpeed) == 0x000210, "Member 'URiderComponent::SimulatedSmoothedRotationSpeed' has a wrong offset!");
static_assert(offsetof(URiderComponent, ExcludedEmoteTags) == 0x000218, "Member 'URiderComponent::ExcludedEmoteTags' has a wrong offset!");
static_assert(offsetof(URiderComponent, ActiveRidable) == 0x000240, "Member 'URiderComponent::ActiveRidable' has a wrong offset!");
static_assert(offsetof(URiderComponent, LastRidable) == 0x000248, "Member 'URiderComponent::LastRidable' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderProp) == 0x000250, "Member 'URiderComponent::RiderProp' has a wrong offset!");
static_assert(offsetof(URiderComponent, ConnectorProp) == 0x000258, "Member 'URiderComponent::ConnectorProp' has a wrong offset!");
static_assert(offsetof(URiderComponent, PropAttachSeparation) == 0x000260, "Member 'URiderComponent::PropAttachSeparation' has a wrong offset!");
static_assert(offsetof(URiderComponent, AdditionalAttachOffset) == 0x000278, "Member 'URiderComponent::AdditionalAttachOffset' has a wrong offset!");
static_assert(offsetof(URiderComponent, SoftBoundsAttachmentOffset) == 0x000290, "Member 'URiderComponent::SoftBoundsAttachmentOffset' has a wrong offset!");
static_assert(offsetof(URiderComponent, HardBoundsAttachmentOffset) == 0x0002A8, "Member 'URiderComponent::HardBoundsAttachmentOffset' has a wrong offset!");
static_assert(offsetof(URiderComponent, PlaylistTagDenylistRowHandle) == 0x0002C0, "Member 'URiderComponent::PlaylistTagDenylistRowHandle' has a wrong offset!");
static_assert(offsetof(URiderComponent, RiderInputComponent) == 0x0002D0, "Member 'URiderComponent::RiderInputComponent' has a wrong offset!");
static_assert(offsetof(URiderComponent, PendingFailedEmoteErrorTags) == 0x0002D8, "Member 'URiderComponent::PendingFailedEmoteErrorTags' has a wrong offset!");
static_assert(offsetof(URiderComponent, ExitLaunchVelocity) == 0x0002F8, "Member 'URiderComponent::ExitLaunchVelocity' has a wrong offset!");
static_assert(offsetof(URiderComponent, JumpExitLaunchVelocity) == 0x0003A0, "Member 'URiderComponent::JumpExitLaunchVelocity' has a wrong offset!");
static_assert(offsetof(URiderComponent, ActiveAnaltyicsData) == 0x000450, "Member 'URiderComponent::ActiveAnaltyicsData' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidableLocationLastFrame) == 0x0004D0, "Member 'URiderComponent::RidableLocationLastFrame' has a wrong offset!");
static_assert(offsetof(URiderComponent, RestoreCollisionHandle) == 0x0004F0, "Member 'URiderComponent::RestoreCollisionHandle' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidableControlRuntimeData) == 0x0004F8, "Member 'URiderComponent::RidableControlRuntimeData' has a wrong offset!");
static_assert(offsetof(URiderComponent, ClampedController) == 0x00053C, "Member 'URiderComponent::ClampedController' has a wrong offset!");
static_assert(offsetof(URiderComponent, bIsPetting) == 0x000544, "Member 'URiderComponent::bIsPetting' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingCapsuleHalfHeight) == 0x000548, "Member 'URiderComponent::RidingCapsuleHalfHeight' has a wrong offset!");
static_assert(offsetof(URiderComponent, RidingCapsuleRadius) == 0x000570, "Member 'URiderComponent::RidingCapsuleRadius' has a wrong offset!");
static_assert(offsetof(URiderComponent, CollisionProfileName) == 0x0005A8, "Member 'URiderComponent::CollisionProfileName' has a wrong offset!");
static_assert(offsetof(URiderComponent, TraceRadius) == 0x0005B0, "Member 'URiderComponent::TraceRadius' has a wrong offset!");
static_assert(offsetof(URiderComponent, TraceLength) == 0x0005D8, "Member 'URiderComponent::TraceLength' has a wrong offset!");
static_assert(offsetof(URiderComponent, bPreventExitRidingFromInput) == 0x000600, "Member 'URiderComponent::bPreventExitRidingFromInput' has a wrong offset!");
...
static_assert(sizeof(UControllingRiderComponent) == 0x0006F0, "Wrong size on UControllingRiderComponent");
static_assert(offsetof(UControllingRiderComponent, ControllingRidingInputContext) == 0x000698, "Member 'UControllingRiderComponent::ControllingRidingInputContext' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, RidingAbility) == 0x0006A0, "Member 'UControllingRiderComponent::RidingAbility' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, GamepadRidingAbility) == 0x0006A8, "Member 'UControllingRiderComponent::GamepadRidingAbility' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, bCanControlRidable) == 0x0006B0, "Member 'UControllingRiderComponent::bCanControlRidable' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, bIsControllingRidable) == 0x0006B1, "Member 'UControllingRiderComponent::bIsControllingRidable' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, ControlInputStyle) == 0x0006B2, "Member 'UControllingRiderComponent::ControlInputStyle' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, ReplicatedControlInputState) == 0x0006C0, "Member 'UControllingRiderComponent::ReplicatedControlInputState' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, ReplicatedControlInputStateReliable) == 0x0006CC, "Member 'UControllingRiderComponent::ReplicatedControlInputStateReliable' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, ReplicatedControlInputStateUnreliable) == 0x0006CD, "Member 'UControllingRiderComponent::ReplicatedControlInputStateUnreliable' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, ControllingRiderInputComponent) == 0x0006D0, "Member 'UControllingRiderComponent::ControllingRiderInputComponent' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, AutoRunDoubleTapTimestamp) == 0x0006E8, "Member 'UControllingRiderComponent::AutoRunDoubleTapTimestamp' has a wrong offset!");
static_assert(offsetof(UControllingRiderComponent, bCanBePet) == 0x0006EC, "Member 'UControllingRiderComponent::bCanBePet' has a wrong offset!");
...
{
public:
	struct FVector                                OriginOffset;                                      // 0x1CA0(0x0018)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFortCameraMode_Riding) == 0x001CC0, "Wrong size on UFortCameraMode_Riding");
static_assert(offsetof(UFortCameraMode_Riding, OriginOffset) == 0x001CA0, "Member 'UFortCameraMode_Riding::OriginOffset' has a wrong offset!");
