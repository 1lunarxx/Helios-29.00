...
static_assert(sizeof(FPilgrimGuitarFretPressedState) == 0x000002, "Wrong size on FPilgrimGuitarFretPressedState");
...
static_assert(sizeof(FPilgrimEvaluatorGuitarState) == 0x000020, "Wrong size on FPilgrimEvaluatorGuitarState");
...
// ScriptStruct PilgrimCoreRuntime.PilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged
// 0x0001 (0x0001 - 0x0000)
struct FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged final
{
public:
	bool                                          bOverdriveClearsGems;                              // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged) == 0x000001, "Wrong alignment on FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged");
static_assert(sizeof(FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged) == 0x000001, "Wrong size on FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged");
static_assert(offsetof(FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged, bOverdriveClearsGems) == 0x000000, "Member 'FPilgrimEvent_PilgrimSettings_OverdriveClearsGemsChanged::bOverdriveClearsGems' has a wrong offset!");
...
public:
	...
	int32                                         NumSongs;                                          // 0x0140(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
