...
// Parameters:
// bool                                    bCanceled                                              (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAsyncAction_ListenForMidiEventBase::OnFinished__DelegateSignature(const bool bCanceled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncAction_ListenForMidiEventBase", "OnFinished__DelegateSignature");

	Params::AsyncAction_ListenForMidiEventBase_OnFinished__DelegateSignature Parms{};
...
// Parameters:
// uint8                                   MidiEventNote                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FParsedMidiNoteEvent             MidiEventData                                          (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UAsyncAction_ListenForMidiNoteEvent::OnMidiNoteEventDelegate__DelegateSignature(const uint8 MidiEventNote, const struct FParsedMidiNoteEvent& MidiEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncAction_ListenForMidiNoteEvent", "OnMidiNoteEventDelegate__DelegateSignature");

	Params::AsyncAction_ListenForMidiNoteEvent_OnMidiNoteEventDelegate__DelegateSignature Parms{};
...
// (MulticastDelegate, Public, Delegate, HasOutParams)
// Parameters:
// class FString                           MidiEventText                                          (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FParsedMidiTextEvent             MidiEventData                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UAsyncAction_ListenForMidiTextEvent::OnMidiTextEventDelegate__DelegateSignature(const class FString& MidiEventText, const struct FParsedMidiTextEvent& MidiEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncAction_ListenForMidiTextEvent", "OnMidiTextEventDelegate__DelegateSignature");

	Params::AsyncAction_ListenForMidiTextEvent_OnMidiTextEventDelegate__DelegateSignature Parms{};
...
// struct FParsedMidiNoteEvent             MidiNoteData                                           (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class FName                             WaitPoolID                                             (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ActualDelay                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   MaxDelayShortenedBy                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAsyncAction_ListenForMidiNoteEventPools::OnMidiNotePoolEventDelegate__DelegateSignature(const uint8 MidiNote, const struct FParsedMidiNoteEvent& MidiNoteData, const class FName WaitPoolID, const float ActualDelay, const float MaxDelayShortenedBy)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncAction_ListenForMidiNoteEventPools", "OnMidiNotePoolEventDelegate__DelegateSignature");

	Params::AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature Parms{};
