...
{
public:
	TArray<struct FActorEntityInteropRules>       ActorEntityRules;                                  // 0x0098(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortActorEntitySubsystem) == 0x0000A8, "Wrong size on UFortActorEntitySubsystem");
static_assert(offsetof(UFortActorEntitySubsystem, ActorEntityRules) == 0x000098, "Member 'UFortActorEntitySubsystem::ActorEntityRules' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnLoaded;                                          // 0x0070(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnCharacterModifierModified;                       // 0x0138(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnCharacterTypeModified;                           // 0x0148(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
