...
static_assert(sizeof(CommonTabListWidgetBase_OnTabSelected__DelegateSignature) == 0x000004, "Wrong size on CommonTabListWidgetBase_OnTabSelected__DelegateSignature");
