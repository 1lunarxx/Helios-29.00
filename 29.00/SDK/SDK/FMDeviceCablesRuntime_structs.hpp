...
public:
	...
	uint8                                         Pad_1C[0x22C];                                     // 0x001C(0x022C)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UFMDeviceCableWildcardOrderingComponent> Owner;                                             // 0x0248(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FFMDeviceCableOrderingPortState) == 0x000258, "Wrong size on FFMDeviceCableOrderingPortState");
...
static_assert(offsetof(FFMDeviceCableOrderingPortState, Owner) == 0x000248, "Member 'FFMDeviceCableOrderingPortState::Owner' has a wrong offset!");
