...
// 0x0200 (0x1960 - 0x1760)
class AJunoAIBotController final : public AFortAthenaAIBotController
{
public:
	class UJunoAIInventoryComponent*              JunoAIInventoryComponent;                          // 0x1760(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FItemAndCount>                  DefaultItemsToAdd;                                 // 0x1768(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1778[0x89];                                    // 0x1778(0x0089)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bRequiresPersistentInventory;                      // 0x1801(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1802[0x6];                                     // 0x1802(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         EnableDurabilityOnInventory;                       // 0x1808(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         UseRoleCheckForDurability;                         // 0x1830(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FGameplayTagQuery                      RequiredRoleForDurability;                         // 0x1858(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	bool                                          bUseFocusedActorEyeLocationForFocalPoint;          // 0x18A0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bUseValidItemsPerType;                             // 0x18A1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18A2[0x6];                                     // 0x18A2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem; // 0x18A8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FValidItemSlotConfiguration> ValidItemsTablePerType;                            // 0x18D0(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	class UFortItemDefinition*                    AutomaticallyEquippedWeaponOnDurabilityBreak;      // 0x1920(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         DurabilityMultiplier;                              // 0x1928(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           TagToApplyWhenAddingFallbackItemForDurabilityBreak; // 0x1950(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1954[0xC];                                     // 0x1954(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoAIBotController) == 0x001960, "Wrong size on AJunoAIBotController");
static_assert(offsetof(AJunoAIBotController, JunoAIInventoryComponent) == 0x001760, "Member 'AJunoAIBotController::JunoAIInventoryComponent' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, DefaultItemsToAdd) == 0x001768, "Member 'AJunoAIBotController::DefaultItemsToAdd' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, bRequiresPersistentInventory) == 0x001801, "Member 'AJunoAIBotController::bRequiresPersistentInventory' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, EnableDurabilityOnInventory) == 0x001808, "Member 'AJunoAIBotController::EnableDurabilityOnInventory' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, UseRoleCheckForDurability) == 0x001830, "Member 'AJunoAIBotController::UseRoleCheckForDurability' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, RequiredRoleForDurability) == 0x001858, "Member 'AJunoAIBotController::RequiredRoleForDurability' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, bUseFocusedActorEyeLocationForFocalPoint) == 0x0018A0, "Member 'AJunoAIBotController::bUseFocusedActorEyeLocationForFocalPoint' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, bUseValidItemsPerType) == 0x0018A1, "Member 'AJunoAIBotController::bUseValidItemsPerType' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem) == 0x0018A8, "Member 'AJunoAIBotController::EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, ValidItemsTablePerType) == 0x0018D0, "Member 'AJunoAIBotController::ValidItemsTablePerType' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, AutomaticallyEquippedWeaponOnDurabilityBreak) == 0x001920, "Member 'AJunoAIBotController::AutomaticallyEquippedWeaponOnDurabilityBreak' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, DurabilityMultiplier) == 0x001928, "Member 'AJunoAIBotController::DurabilityMultiplier' has a wrong offset!");
static_assert(offsetof(AJunoAIBotController, TagToApplyWhenAddingFallbackItemForDurabilityBreak) == 0x001950, "Member 'AJunoAIBotController::TagToApplyWhenAddingFallbackItemForDurabilityBreak' has a wrong offset!");
...
public:
	...
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x01C8(0x0048)(Edit, NativeAccessSpecifierPrivate)
	TSubclassOf<class UNavigationQueryFilter>     NavigationQueryFilterClass;                        // 0x0210(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bFallbackToPointWithNoCustomNavigationQueryFilter; // 0x0218(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_219[0x3];                                      // 0x0219(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   BestTargetActorName;                               // 0x021C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_220[0x4];                                      // 0x0220(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EnableKeyName;                                     // 0x0224(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoAIBotEvaluator_FallbackBehavior) == 0x000230, "Wrong size on UJunoAIBotEvaluator_FallbackBehavior");
static_assert(offsetof(UJunoAIBotEvaluator_FallbackBehavior, EQSRequest) == 0x0001C8, "Member 'UJunoAIBotEvaluator_FallbackBehavior::EQSRequest' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_FallbackBehavior, NavigationQueryFilterClass) == 0x000210, "Member 'UJunoAIBotEvaluator_FallbackBehavior::NavigationQueryFilterClass' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_FallbackBehavior, bFallbackToPointWithNoCustomNavigationQueryFilter) == 0x000218, "Member 'UJunoAIBotEvaluator_FallbackBehavior::bFallbackToPointWithNoCustomNavigationQueryFilter' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_FallbackBehavior, BestTargetActorName) == 0x00021C, "Member 'UJunoAIBotEvaluator_FallbackBehavior::BestTargetActorName' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_FallbackBehavior, EnableKeyName) == 0x000224, "Member 'UJunoAIBotEvaluator_FallbackBehavior::EnableKeyName' has a wrong offset!");
...
public:
	uint8                                         Pad_1B0[0x18];                                     // 0x01B0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x01C8(0x0048)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         RequestHardRemovalOnSuccess;                       // 0x0210(0x0028)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoAIBotEvaluator_HardRemovalStart) == 0x000238, "Wrong size on UJunoAIBotEvaluator_HardRemovalStart");
static_assert(offsetof(UJunoAIBotEvaluator_HardRemovalStart, EQSRequest) == 0x0001C8, "Member 'UJunoAIBotEvaluator_HardRemovalStart::EQSRequest' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_HardRemovalStart, RequestHardRemovalOnSuccess) == 0x000210, "Member 'UJunoAIBotEvaluator_HardRemovalStart::RequestHardRemovalOnSuccess' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         IsEnabled;                                         // 0x01E0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         UseTagForShelterCheck;                             // 0x0208(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTag                           TagToCheckForSheltered;                            // 0x0230(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_234[0x4];                                      // 0x0234(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      ShelterQueryTypes;                                 // 0x0238(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         MaxShelterDistance;                                // 0x0248(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         MinDistanceFromShelterLocationToKeepItValid;       // 0x0270(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  ShelterCollidingActorRequiresAnyTag;               // 0x0298(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTag                           TagToApplyForShelteredNPC;                         // 0x02B8(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           TagToApplyForNonShelteredNPC;                      // 0x02BC(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoAIBotEvaluator_UnderThunderBehavior) == 0x0002C0, "Wrong size on UJunoAIBotEvaluator_UnderThunderBehavior");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, IsEnabled) == 0x0001E0, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::IsEnabled' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, UseTagForShelterCheck) == 0x000208, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::UseTagForShelterCheck' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, TagToCheckForSheltered) == 0x000230, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::TagToCheckForSheltered' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, ShelterQueryTypes) == 0x000238, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::ShelterQueryTypes' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, MaxShelterDistance) == 0x000248, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::MaxShelterDistance' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, MinDistanceFromShelterLocationToKeepItValid) == 0x000270, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::MinDistanceFromShelterLocationToKeepItValid' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, ShelterCollidingActorRequiresAnyTag) == 0x000298, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::ShelterCollidingActorRequiresAnyTag' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, TagToApplyForShelteredNPC) == 0x0002B8, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::TagToApplyForShelteredNPC' has a wrong offset!");
static_assert(offsetof(UJunoAIBotEvaluator_UnderThunderBehavior, TagToApplyForNonShelteredNPC) == 0x0002BC, "Member 'UJunoAIBotEvaluator_UnderThunderBehavior::TagToApplyForNonShelteredNPC' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoAICampPawnComponentChangedSoftRemovedReason; // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
