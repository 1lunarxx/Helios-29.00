...
static_assert(offsetof(HurdleLibrary_PerformHurdleTargeting, OutTargetingData) == 0x0000B0, "Member 'HurdleLibrary_PerformHurdleTargeting::OutTargetingData' has a wrong offset!");
static_assert(offsetof(HurdleLibrary_PerformHurdleTargeting, bIsAutoHurdle) == 0x0001E0, "Member 'HurdleLibrary_PerformHurdleTargeting::bIsAutoHurdle' has a wrong offset!");
static_assert(offsetof(HurdleLibrary_PerformHurdleTargeting, OverrideAimDirection) == 0x0001E8, "Member 'HurdleLibrary_PerformHurdleTargeting::OverrideAimDirection' has a wrong offset!");
static_assert(offsetof(HurdleLibrary_PerformHurdleTargeting, ReturnValue) == 0x000200, "Member 'HurdleLibrary_PerformHurdleTargeting::ReturnValue' has a wrong offset!");
