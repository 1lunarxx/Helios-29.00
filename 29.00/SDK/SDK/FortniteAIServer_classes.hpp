...
public:
	...
	struct FScalableFloat                         MaxApproaches;                                     // 0x01D0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortNearbyActorsPerceptionConfiguration PerceptionConfiguration;                           // 0x0200(0x00D0)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FName                                   EnableKeyName;                                     // 0x02D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_ApproachNearbyPawns) == 0x0002E0, "Wrong size on UFortAthenaAIBotEvaluator_ApproachNearbyPawns");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ApproachNearbyPawns, MaxApproaches) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_ApproachNearbyPawns::MaxApproaches' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ApproachNearbyPawns, PerceptionConfiguration) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_ApproachNearbyPawns::PerceptionConfiguration' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ApproachNearbyPawns, EnableKeyName) == 0x0002D0, "Member 'UFortAthenaAIBotEvaluator_ApproachNearbyPawns::EnableKeyName' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UNavigationQueryFilter>     ProjectionNavigationQueryFilterClass;              // 0x01F8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UNavigationQueryFilter>     ValidNavigationQueryFilterClassOverride;           // 0x0200(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaximumTimeToHelpFromLastPlayerDamage;             // 0x0208(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         KeepTargetTimeOnWeaponTrigger;                     // 0x0230(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged; // 0x0258(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         TimeToTrackDamagedActors;                          // 0x0280(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxDistanceFromActorForFallbackNoHarvestBehaviour; // 0x02A8(0x0028)(Edit, NativeAccessSpecifierPrivate)
	TArray<TSubclassOf<class UGameplayEffect>>    GEsToApplyOnFallbackBehaviorTrigger;               // 0x02D0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<TSubclassOf<class UGameplayEffect>>    GEsToApplyOnCannotDamageBehaviorTrigger;           // 0x02E0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	class FName                                   HarvestTargetKeyName;                              // 0x02F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2F4[0x4];                                      // 0x02F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   HarvestTargetHitPointKeyName;                      // 0x02F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2FC[0x4];                                      // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   HarvestDestinationKeyName;                         // 0x0300(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_304[0x4];                                      // 0x0304(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   FallbackBehaviorKeyName;                           // 0x0308(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_30C[0x4];                                      // 0x030C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CannotDamageKeyName;                               // 0x0310(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_314[0x4];                                      // 0x0314(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   WeaponTriggerMeleeKeyName;                         // 0x0318(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Harvest) == 0x000320, "Wrong size on UFortAthenaAIBotEvaluator_Harvest");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, ProjectionNavigationQueryFilterClass) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_Harvest::ProjectionNavigationQueryFilterClass' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, ValidNavigationQueryFilterClassOverride) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_Harvest::ValidNavigationQueryFilterClassOverride' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, MaximumTimeToHelpFromLastPlayerDamage) == 0x000208, "Member 'UFortAthenaAIBotEvaluator_Harvest::MaximumTimeToHelpFromLastPlayerDamage' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, KeepTargetTimeOnWeaponTrigger) == 0x000230, "Member 'UFortAthenaAIBotEvaluator_Harvest::KeepTargetTimeOnWeaponTrigger' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged) == 0x000258, "Member 'UFortAthenaAIBotEvaluator_Harvest::AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, TimeToTrackDamagedActors) == 0x000280, "Member 'UFortAthenaAIBotEvaluator_Harvest::TimeToTrackDamagedActors' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, MaxDistanceFromActorForFallbackNoHarvestBehaviour) == 0x0002A8, "Member 'UFortAthenaAIBotEvaluator_Harvest::MaxDistanceFromActorForFallbackNoHarvestBehaviour' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, GEsToApplyOnFallbackBehaviorTrigger) == 0x0002D0, "Member 'UFortAthenaAIBotEvaluator_Harvest::GEsToApplyOnFallbackBehaviorTrigger' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, GEsToApplyOnCannotDamageBehaviorTrigger) == 0x0002E0, "Member 'UFortAthenaAIBotEvaluator_Harvest::GEsToApplyOnCannotDamageBehaviorTrigger' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, HarvestTargetKeyName) == 0x0002F0, "Member 'UFortAthenaAIBotEvaluator_Harvest::HarvestTargetKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, HarvestTargetHitPointKeyName) == 0x0002F8, "Member 'UFortAthenaAIBotEvaluator_Harvest::HarvestTargetHitPointKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, HarvestDestinationKeyName) == 0x000300, "Member 'UFortAthenaAIBotEvaluator_Harvest::HarvestDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, FallbackBehaviorKeyName) == 0x000308, "Member 'UFortAthenaAIBotEvaluator_Harvest::FallbackBehaviorKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, CannotDamageKeyName) == 0x000310, "Member 'UFortAthenaAIBotEvaluator_Harvest::CannotDamageKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Harvest, WeaponTriggerMeleeKeyName) == 0x000318, "Member 'UFortAthenaAIBotEvaluator_Harvest::WeaponTriggerMeleeKeyName' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         MaxSecondsToReactToBump;                           // 0x0220(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxSecondsToReactToBox;                            // 0x0248(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MinSecondsBetweenInstantReactions;                 // 0x0270(0x0028)(Edit, NativeAccessSpecifierPrivate)
	class UEnvQuery*                              FindAwayLocationFromPawnQueryTemplate;             // 0x0298(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EEnvQueryRunMode                              FindAwayLocationFromPawnRunMode;                   // 0x02A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A1[0x7];                                      // 0x02A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UEnvQuery*                              FindAwayLocationFromBoxQueryTemplate;              // 0x02A8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EEnvQueryRunMode                              FindAwayLocationFromBoxRunMode;                    // 0x02B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_MoveAway) == 0x0002B8, "Wrong size on UFortAthenaAIBotEvaluator_MoveAway");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, MaxSecondsToReactToBump) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_MoveAway::MaxSecondsToReactToBump' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, MaxSecondsToReactToBox) == 0x000248, "Member 'UFortAthenaAIBotEvaluator_MoveAway::MaxSecondsToReactToBox' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, MinSecondsBetweenInstantReactions) == 0x000270, "Member 'UFortAthenaAIBotEvaluator_MoveAway::MinSecondsBetweenInstantReactions' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, FindAwayLocationFromPawnQueryTemplate) == 0x000298, "Member 'UFortAthenaAIBotEvaluator_MoveAway::FindAwayLocationFromPawnQueryTemplate' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, FindAwayLocationFromPawnRunMode) == 0x0002A0, "Member 'UFortAthenaAIBotEvaluator_MoveAway::FindAwayLocationFromPawnRunMode' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, FindAwayLocationFromBoxQueryTemplate) == 0x0002A8, "Member 'UFortAthenaAIBotEvaluator_MoveAway::FindAwayLocationFromBoxQueryTemplate' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MoveAway, FindAwayLocationFromBoxRunMode) == 0x0002B0, "Member 'UFortAthenaAIBotEvaluator_MoveAway::FindAwayLocationFromBoxRunMode' has a wrong offset!");
...
{
public:
	class UFortAthenaAIRuntimeParameters_SmartObjectBase* SmartObjectRuntimeParameters;                      // 0x01B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USmartObjectSubsystem*                  SmartObjectSubsystem;                              // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortAIActiveCommandSOUsageData        RunningCommandData;                                // 0x01C8(0x0010)(Transient, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FBotEvaluatorCommandCooldown           CommandOnCooldown;                                 // 0x01D8(0x0018)(Transient, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           EvaluationTag;                                     // 0x01F0(0x0004)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEvaluateSOValidityAfterChosen;                    // 0x01F4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableEntryLocationsSupport;                      // 0x01F5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F6[0x2];                                      // 0x01F6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         SingleCommandCooldown;                             // 0x01F8(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class USmartObjectSlotValidationFilter> OverridenFilterClassForEntryPoints;                // 0x0220(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectExecutionStatusKeyName;                 // 0x0228(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectMovementStateKeyName;                   // 0x022C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectDestinationKeyName;                     // 0x0230(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectDestinationRotationKeyName;             // 0x0234(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectShouldMoveKeyName;                      // 0x0238(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectUrgencyKeyName;                         // 0x023C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SmartObjectCommand) == 0x000250, "Wrong size on UFortAthenaAIBotEvaluator_SmartObjectCommand");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectRuntimeParameters) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectRuntimeParameters' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectSubsystem) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectSubsystem' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, RunningCommandData) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::RunningCommandData' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, CommandOnCooldown) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::CommandOnCooldown' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, EvaluationTag) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::EvaluationTag' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, bEvaluateSOValidityAfterChosen) == 0x0001F4, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::bEvaluateSOValidityAfterChosen' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, bEnableEntryLocationsSupport) == 0x0001F5, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::bEnableEntryLocationsSupport' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SingleCommandCooldown) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SingleCommandCooldown' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, OverridenFilterClassForEntryPoints) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::OverridenFilterClassForEntryPoints' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectExecutionStatusKeyName) == 0x000228, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectMovementStateKeyName) == 0x00022C, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectDestinationKeyName) == 0x000230, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectDestinationRotationKeyName) == 0x000234, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectDestinationRotationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectShouldMoveKeyName) == 0x000238, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectShouldMoveKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectCommand, SmartObjectUrgencyKeyName) == 0x00023C, "Member 'UFortAthenaAIBotEvaluator_SmartObjectCommand::SmartObjectUrgencyKeyName' has a wrong offset!");
...
public:
	...
	class USmartObjectSubsystem*                  SmartObjectSubsystem;                              // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBotEvaluatorSmartObjectConvertedData  RunningData;                                       // 0x01C8(0x0008)(Transient, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           EvaluationTag;                                     // 0x01D0(0x0004)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEvaluateSOValidityAfterChosen;                    // 0x01D4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableEntryLocationsSupport;                      // 0x01D5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIgnoreCooldowns;                                  // 0x01D6(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1D7[0x1];                                      // 0x01D7(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class USmartObjectSlotValidationFilter> OverridenFilterClassForEntryPoints;                // 0x01D8(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectExecutionStatusKeyName;                 // 0x01E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectMovementStateKeyName;                   // 0x01E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectDestinationKeyName;                     // 0x01E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectDestinationRotationKeyName;             // 0x01EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectShouldMoveKeyName;                      // 0x01F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   SmartObjectUrgencyKeyName;                         // 0x01F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SmartObjectConverted) == 0x000208, "Wrong size on UFortAthenaAIBotEvaluator_SmartObjectConverted");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectRuntimeParameters) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectRuntimeParameters' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectSubsystem) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectSubsystem' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, RunningData) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::RunningData' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, EvaluationTag) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::EvaluationTag' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, bEvaluateSOValidityAfterChosen) == 0x0001D4, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::bEvaluateSOValidityAfterChosen' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, bEnableEntryLocationsSupport) == 0x0001D5, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::bEnableEntryLocationsSupport' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, bIgnoreCooldowns) == 0x0001D6, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::bIgnoreCooldowns' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, OverridenFilterClassForEntryPoints) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::OverridenFilterClassForEntryPoints' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectExecutionStatusKeyName) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectMovementStateKeyName) == 0x0001E4, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectDestinationKeyName) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectDestinationRotationKeyName) == 0x0001EC, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectDestinationRotationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectShouldMoveKeyName) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectShouldMoveKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjectConverted, SmartObjectUrgencyKeyName) == 0x0001F4, "Member 'UFortAthenaAIBotEvaluator_SmartObjectConverted::SmartObjectUrgencyKeyName' has a wrong offset!");
...
public:
	...
	class FName                                   WeaponKeyName;                                     // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   MoveToDestinationKeyName;                          // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TargetActorName;                                   // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Attack) == 0x0001C8, "Wrong size on UFortAthenaAIBotEvaluator_Attack");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Attack, WeaponKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Attack::WeaponKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Attack, MoveToDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Attack::MoveToDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Attack, TargetActorName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Attack::TargetActorName' has a wrong offset!");
...
public:
	...
	TArray<struct FPositioningEQS>                EQSs;                                              // 0x01D8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	float                                         TokenPositionCooldown;                             // 0x01E8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TokenPositionCooldownVariation;                    // 0x01EC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F0[0x30];                                     // 0x01F0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAICombatTokenConsumerComponent*    CachedTokenConsumerComponent;                      // 0x0220(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UFortAICombatTokenProviderComponent> CachedTokenProviderComponent;                      // 0x0228(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         RunningEQSRequestID;                               // 0x0230(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_234[0x1C];                                     // 0x0234(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bPositionRequested;                                // 0x0250(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_TokenPosition) == 0x000258, "Wrong size on UFortAthenaAIBotEvaluator_TokenPosition");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, EQSs) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::EQSs' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, TokenPositionCooldown) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::TokenPositionCooldown' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, TokenPositionCooldownVariation) == 0x0001EC, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::TokenPositionCooldownVariation' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, CachedTokenConsumerComponent) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::CachedTokenConsumerComponent' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, CachedTokenProviderComponent) == 0x000228, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::CachedTokenProviderComponent' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, RunningEQSRequestID) == 0x000230, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::RunningEQSRequestID' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TokenPosition, bPositionRequested) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_TokenPosition::bPositionRequested' has a wrong offset!");
...
static_assert(offsetof(UFortBTService_AIEvaluatorsInjector, InjectionTagsKeys) == 0x000070, "Member 'UFortBTService_AIEvaluatorsInjector::InjectionTagsKeys' has a wrong offset!");
static_assert(offsetof(UFortBTService_AIEvaluatorsInjector, InjectionItemKeyName) == 0x000080, "Member 'UFortBTService_AIEvaluatorsInjector::InjectionItemKeyName' has a wrong offset!");
...
{
public:
	class FName                                   AvoidThreatKeyName;                                // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AvoidThreatMovementStateKeyName;                   // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AvoidThreatDestinationKeyName;                     // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1BC[0xC];                                      // 0x01BC(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CurrentThreatActorAvoiding;                        // 0x01C8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotEvasiveManeuversDigestedSkillSet* CacheEMDigestedSkillSet;                           // 0x01D0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_AvoidThreat) == 0x0001D8, "Wrong size on UFortAthenaAIBotEvaluator_AvoidThreat");
static_assert(offsetof(UFortAthenaAIBotEvaluator_AvoidThreat, AvoidThreatKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_AvoidThreat::AvoidThreatKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_AvoidThreat, AvoidThreatMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_AvoidThreat::AvoidThreatMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_AvoidThreat, AvoidThreatDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_AvoidThreat::AvoidThreatDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_AvoidThreat, CurrentThreatActorAvoiding) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_AvoidThreat::CurrentThreatActorAvoiding' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_AvoidThreat, CacheEMDigestedSkillSet) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_AvoidThreat::CacheEMDigestedSkillSet' has a wrong offset!");
...
{
public:
	class FName                                   LastKnownPositionName;                             // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   DestinationKeyName;                                // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   MoveToDestinationKeyName;                          // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AggressivenessName;                                // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Ambush) == 0x000218, "Wrong size on UFortAthenaAIBotEvaluator_Ambush");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Ambush, LastKnownPositionName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Ambush::LastKnownPositionName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Ambush, DestinationKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Ambush::DestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Ambush, MoveToDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Ambush::MoveToDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Ambush, AggressivenessName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Ambush::AggressivenessName' has a wrong offset!");
...
{
public:
	class FName                                   BuildExecutionStatusKeyName;                       // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   HealingStatusKeyName;                              // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  DangerTags;                                        // 0x01B8(0x0020)(Edit, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Bunker) == 0x000268, "Wrong size on UFortAthenaAIBotEvaluator_Bunker");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Bunker, BuildExecutionStatusKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Bunker::BuildExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Bunker, HealingStatusKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Bunker::HealingStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Bunker, DangerTags) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Bunker::DangerTags' has a wrong offset!");
...
// 0x01D8 (0x0388 - 0x01B0)
class UFortAthenaAIBotEvaluator_Converted final : public UFortAthenaAIBotEvaluator_Movement
{
public:
	class FName                                   ShouldMoveTowardsConverterName;                    // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ShouldTeleportTowardsConverterName;                // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ConvertedAllowPatrolAroundName;                    // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ConvertedAllowScanAroundWhenWaitingName;           // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ConvertedDestinationName;                          // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   CrouchExecutionStatusName;                         // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                TeleportLocationProjectionExtent;                  // 0x01C8(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                MovingFromLosLocationProjectionExtent;             // 0x01E0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         AmountOfTimesNonHostilePawnNeedsToBeDamagedForTargeting; // 0x01F8(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         TimeToTrackDamagedActors;                          // 0x0220(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         NearbyPlayerDistanceForTeleportTowardsConverter;   // 0x0248(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         PlayerFOVForNearbyPlayersVisibility;               // 0x0270(0x0028)(Edit, NativeAccessSpecifierPrivate)
	class UEnvQuery*                              TeleportToConverterQueryTemplate;                  // 0x0298(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EEnvQueryRunMode                              TeleportToConverterRunMode;                        // 0x02A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A1[0x7];                                      // 0x02A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FMimicConverterAbilityData>     AbilitiesToMimic;                                  // 0x02A8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FGameplayTagQuery                      RequiredTagQueryToTargetConverterDamagedPawn;      // 0x02B8(0x0048)(Edit, NativeAccessSpecifierPrivate)
	uint8                                         Pad_300[0x68];                                     // 0x0300(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPawn*                              ConverterPawn;                                     // 0x0368(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIRuntimeParameters_AIBotConvert* CachedAIBotConvertParameters;                      // 0x0370(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Converted) == 0x000388, "Wrong size on UFortAthenaAIBotEvaluator_Converted");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ShouldMoveTowardsConverterName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Converted::ShouldMoveTowardsConverterName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ShouldTeleportTowardsConverterName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Converted::ShouldTeleportTowardsConverterName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ConvertedAllowPatrolAroundName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Converted::ConvertedAllowPatrolAroundName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ConvertedAllowScanAroundWhenWaitingName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Converted::ConvertedAllowScanAroundWhenWaitingName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ConvertedDestinationName) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Converted::ConvertedDestinationName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, CrouchExecutionStatusName) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_Converted::CrouchExecutionStatusName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, TeleportLocationProjectionExtent) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Converted::TeleportLocationProjectionExtent' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, MovingFromLosLocationProjectionExtent) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_Converted::MovingFromLosLocationProjectionExtent' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, AmountOfTimesNonHostilePawnNeedsToBeDamagedForTargeting) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_Converted::AmountOfTimesNonHostilePawnNeedsToBeDamagedForTargeting' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, TimeToTrackDamagedActors) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_Converted::TimeToTrackDamagedActors' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, NearbyPlayerDistanceForTeleportTowardsConverter) == 0x000248, "Member 'UFortAthenaAIBotEvaluator_Converted::NearbyPlayerDistanceForTeleportTowardsConverter' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, PlayerFOVForNearbyPlayersVisibility) == 0x000270, "Member 'UFortAthenaAIBotEvaluator_Converted::PlayerFOVForNearbyPlayersVisibility' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, TeleportToConverterQueryTemplate) == 0x000298, "Member 'UFortAthenaAIBotEvaluator_Converted::TeleportToConverterQueryTemplate' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, TeleportToConverterRunMode) == 0x0002A0, "Member 'UFortAthenaAIBotEvaluator_Converted::TeleportToConverterRunMode' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, AbilitiesToMimic) == 0x0002A8, "Member 'UFortAthenaAIBotEvaluator_Converted::AbilitiesToMimic' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, RequiredTagQueryToTargetConverterDamagedPawn) == 0x0002B8, "Member 'UFortAthenaAIBotEvaluator_Converted::RequiredTagQueryToTargetConverterDamagedPawn' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, ConverterPawn) == 0x000368, "Member 'UFortAthenaAIBotEvaluator_Converted::ConverterPawn' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Converted, CachedAIBotConvertParameters) == 0x000370, "Member 'UFortAthenaAIBotEvaluator_Converted::CachedAIBotConvertParameters' has a wrong offset!");
...
{
public:
	class FName                                   DBNODestinationKeyName;                            // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B4[0x2];                                      // 0x01B4(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAllowReachSquadmates : 1;                         // 0x01B6(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAllowReachSameFactionNPCs : 1;                    // 0x01B6(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_1B7[0x1];                                      // 0x01B7(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AFortPlayerPawnAthena*>          AllyPawns;                                         // 0x01B8(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FVector                                CachedCurrentDestination;                          // 0x01C8(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotDBNODigestedSkillSet*   DBNOSkillSet;                                      // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAICoverComponent*            CachedCoverComponent;                              // 0x01E8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIRuntimeParameters_DBNOBehavior* DBNOBehaviorRuntimeParameters;                     // 0x01F0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F8[0x10];                                     // 0x01F8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_DBNO) == 0x000208, "Wrong size on UFortAthenaAIBotEvaluator_DBNO");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, DBNODestinationKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_DBNO::DBNODestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, AllyPawns) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_DBNO::AllyPawns' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, CachedCurrentDestination) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_DBNO::CachedCurrentDestination' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, DBNOSkillSet) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_DBNO::DBNOSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, CachedCoverComponent) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_DBNO::CachedCoverComponent' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_DBNO, DBNOBehaviorRuntimeParameters) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_DBNO::DBNOBehaviorRuntimeParameters' has a wrong offset!");
...
{
public:
	struct FGameplayTagContainer                  EscapeTags;                                        // 0x01B0(0x0020)(Edit, NativeAccessSpecifierPrivate)
	float                                         CooldownBetweenAggressivenessChanges;              // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AggressivenessName;                                // 0x01D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Escape) == 0x0001E0, "Wrong size on UFortAthenaAIBotEvaluator_Escape");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Escape, EscapeTags) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Escape::EscapeTags' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Escape, CooldownBetweenAggressivenessChanges) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_Escape::CooldownBetweenAggressivenessChanges' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Escape, AggressivenessName) == 0x0001D4, "Member 'UFortAthenaAIBotEvaluator_Escape::AggressivenessName' has a wrong offset!");
...
{
public:
	class AFortAIDirector*                        CachedAIDirector;                                  // 0x01B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CachedRangeAttackDigestedSkillSet;                 // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FlankingExecutionStatusKeyName;                    // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FlankingMovementStateKeyName;                      // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FlankingDestinationKeyName;                        // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1CC[0xC];                                      // 0x01CC(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFlankingLocationInfo>          LocationsToEvaluate;                               // 0x01D8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TArray<struct FFlankingLocationInfo>          BestLocations;                                     // 0x01E8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TArray<TWeakObjectPtr<class AActor>>          ActorsInArea;                                      // 0x01F8(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Flanking) == 0x000228, "Wrong size on UFortAthenaAIBotEvaluator_Flanking");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, CachedAIDirector) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Flanking::CachedAIDirector' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, CachedRangeAttackDigestedSkillSet) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Flanking::CachedRangeAttackDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, FlankingExecutionStatusKeyName) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Flanking::FlankingExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, FlankingMovementStateKeyName) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_Flanking::FlankingMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, FlankingDestinationKeyName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Flanking::FlankingDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, LocationsToEvaluate) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_Flanking::LocationsToEvaluate' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, BestLocations) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_Flanking::BestLocations' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flanking, ActorsInArea) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_Flanking::ActorsInArea' has a wrong offset!");
...
{
public:
	float                                         MinDistanceFromTarget;                             // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MinValidDistanceForFleeLocation;                   // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         FleeDistance;                                      // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxDistanceFromTargetWhenFleeing;                  // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MinDistanceHysteresisWhenChangingTarget;           // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FleeKeyName;                                       // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FleeMovementStateKeyName;                          // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FleeDestinationKeyName;                            // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FleeActorKeyName;                                  // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D4[0xC];                                      // 0x01D4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CurrentActorFleeingFrom;                           // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Flee) == 0x0001E8, "Wrong size on UFortAthenaAIBotEvaluator_Flee");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, MinDistanceFromTarget) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Flee::MinDistanceFromTarget' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, MinValidDistanceForFleeLocation) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Flee::MinValidDistanceForFleeLocation' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, FleeDistance) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Flee::FleeDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, MaxDistanceFromTargetWhenFleeing) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Flee::MaxDistanceFromTargetWhenFleeing' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, MinDistanceHysteresisWhenChangingTarget) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Flee::MinDistanceHysteresisWhenChangingTarget' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, FleeKeyName) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_Flee::FleeKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, FleeMovementStateKeyName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Flee::FleeMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, FleeDestinationKeyName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_Flee::FleeDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, FleeActorKeyName) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_Flee::FleeActorKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Flee, CurrentActorFleeingFrom) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_Flee::CurrentActorFleeingFrom' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         AttackDurationBeforeEvade;                         // 0x01B0(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MeleeAttackMaxDistToEvade;                         // 0x01D8(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ClampEvadeDistanceEnable;                          // 0x0200(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MinDistanceToEvade;                                // 0x0228(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxDistanceToEvade;                                // 0x0250(0x0028)(Edit, NativeAccessSpecifierPrivate)
	class FName                                   EvadeKeyName;                                      // 0x0278(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   EvadeMovementStateKeyName;                         // 0x027C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   EvadeDestinationKeyName;                           // 0x0280(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   WeaponTriggerMeleeName;                            // 0x0284(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_288[0x10];                                     // 0x0288(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MeleeAttackMaxDistToEvadeSqr;                      // 0x0298(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxDistanceToEvadeSqr;                             // 0x029C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_HitAndRun) == 0x0002A8, "Wrong size on UFortAthenaAIBotEvaluator_HitAndRun");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, AttackDurationBeforeEvade) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::AttackDurationBeforeEvade' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, MeleeAttackMaxDistToEvade) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::MeleeAttackMaxDistToEvade' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, ClampEvadeDistanceEnable) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::ClampEvadeDistanceEnable' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, MinDistanceToEvade) == 0x000228, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::MinDistanceToEvade' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, MaxDistanceToEvade) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::MaxDistanceToEvade' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, EvadeKeyName) == 0x000278, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::EvadeKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, EvadeMovementStateKeyName) == 0x00027C, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::EvadeMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, EvadeDestinationKeyName) == 0x000280, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::EvadeDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, WeaponTriggerMeleeName) == 0x000284, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::WeaponTriggerMeleeName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, MeleeAttackMaxDistToEvadeSqr) == 0x000298, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::MeleeAttackMaxDistToEvadeSqr' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_HitAndRun, MaxDistanceToEvadeSqr) == 0x00029C, "Member 'UFortAthenaAIBotEvaluator_HitAndRun::MaxDistanceToEvadeSqr' has a wrong offset!");
...
public:
	...
	class FName                                   MoveToDestinationKeyName;                          // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AggressivenessName;                                // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   CautiousKeyName;                                   // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AlertLevelName;                                    // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UNavigationQueryFilter>     SearchQueryFilterClass;                            // 0x01C8(0x0008)(Edit, ZeroConstructor, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D0[0x10];                                     // 0x01D0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaAIBotAimingDigestedSkillSet* CacheAimingDigestedSkillSet;                       // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotAttackingDigestedSkillSet* CacheAttackingDigestedSkillSet;                    // 0x01E8(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotUnstuckDigestedSkillSet* CachedUnstuckSkillSet;                             // 0x01F0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F8[0x48];                                     // 0x01F8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 InvestigatingSupportingActor;                      // 0x0240(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ABuildingSMActor*                       UnderminingBuildingActor;                          // 0x0248(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AActor*                                 ExcludeReachingTarget;                             // 0x0250(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Investigate) == 0x000270, "Wrong size on UFortAthenaAIBotEvaluator_Investigate");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, LastKnownPositionName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Investigate::LastKnownPositionName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, DestinationKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Investigate::DestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, MoveToDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Investigate::MoveToDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, AggressivenessName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Investigate::AggressivenessName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, CautiousKeyName) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Investigate::CautiousKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, AlertLevelName) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_Investigate::AlertLevelName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, SearchQueryFilterClass) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Investigate::SearchQueryFilterClass' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, CacheAimingDigestedSkillSet) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_Investigate::CacheAimingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, CacheAttackingDigestedSkillSet) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_Investigate::CacheAttackingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, CachedUnstuckSkillSet) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_Investigate::CachedUnstuckSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, InvestigatingSupportingActor) == 0x000240, "Member 'UFortAthenaAIBotEvaluator_Investigate::InvestigatingSupportingActor' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, UnderminingBuildingActor) == 0x000248, "Member 'UFortAthenaAIBotEvaluator_Investigate::UnderminingBuildingActor' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Investigate, ExcludeReachingTarget) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_Investigate::ExcludeReachingTarget' has a wrong offset!");
...
public:
	...
	class FName                                   WeaponTriggerMeleeName;                            // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ThrowableAttacksAllowedName;                       // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TraversalBlockMeleeAttackName;                     // 0x01D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TargetContextReachableKeyName;                     // 0x01D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TargetContextInsideLeashKeyName;                   // 0x01DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E0[0x18];                                     // 0x01E0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaAIBotAttackingDigestedSkillSet* AttackingSkillSet;                                 // 0x01F8(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_MeleeAttack) == 0x000208, "Wrong size on UFortAthenaAIBotEvaluator_MeleeAttack");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, WeaponTriggerMeleeName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::WeaponTriggerMeleeName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, ThrowableAttacksAllowedName) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::ThrowableAttacksAllowedName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, TraversalBlockMeleeAttackName) == 0x0001D4, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::TraversalBlockMeleeAttackName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, TargetContextReachableKeyName) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::TargetContextReachableKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, TargetContextInsideLeashKeyName) == 0x0001DC, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::TargetContextInsideLeashKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_MeleeAttack, AttackingSkillSet) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_MeleeAttack::AttackingSkillSet' has a wrong offset!");
...
{
public:
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x01B0(0x0048)(Edit, NativeAccessSpecifierPrivate)
	TSubclassOf<class UNavigationQueryFilter>     NavigationQueryFilterClass;                        // 0x01F8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bFallbackToPointWithNoCustomNavigationQueryFilter; // 0x0200(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_201[0x3];                                      // 0x0201(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   PatrolDestinationName;                             // 0x0204(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   PatrolExecutionStatusName;                         // 0x0208(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   PatrolMovementStateName;                           // 0x020C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   BestTargetActorName;                               // 0x0210(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class AFortGameModeAthena*                    CacheAthenaGameMode;                               // 0x0220(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_PatrolAround) == 0x000248, "Wrong size on UFortAthenaAIBotEvaluator_PatrolAround");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, EQSRequest) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::EQSRequest' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, NavigationQueryFilterClass) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::NavigationQueryFilterClass' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, bFallbackToPointWithNoCustomNavigationQueryFilter) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::bFallbackToPointWithNoCustomNavigationQueryFilter' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, PatrolDestinationName) == 0x000204, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::PatrolDestinationName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, PatrolExecutionStatusName) == 0x000208, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::PatrolExecutionStatusName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, PatrolMovementStateName) == 0x00020C, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::PatrolMovementStateName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, BestTargetActorName) == 0x000210, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::BestTargetActorName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PatrolAround, EnableKeyName) == 0x000214, "Member 'UFortAthenaAIBotEvaluator_PatrolAround::EnableKeyName' has a wrong offset!");
...
{
public:
	class FName                                   PlayEmoteExecutionStatusKeyName;                   // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   PlayEmoteDestinationKeyName;                       // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 ExcludeReachingTarget;                             // 0x01C0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_PlayEmote) == 0x0001D0, "Wrong size on UFortAthenaAIBotEvaluator_PlayEmote");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PlayEmote, PlayEmoteExecutionStatusKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_PlayEmote::PlayEmoteExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PlayEmote, PlayEmoteDestinationKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_PlayEmote::PlayEmoteDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_PlayEmote, ExcludeReachingTarget) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_PlayEmote::ExcludeReachingTarget' has a wrong offset!");
...
public:
	...
	class FName                                   WeaponReloadName;                                  // 0x0200(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   WeaponFireName;                                    // 0x0204(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   RangeAttackIsReadyToFireName;                      // 0x0208(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   WeaponTargetingName;                               // 0x020C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   AggressivenessName;                                // 0x0210(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   HasLoSOnThreatName;                                // 0x0214(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   UrgentMovementKeyName;                             // 0x0218(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21C[0xE];                                      // 0x021C(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bAlwaysAllowTargetingEvaluation;                   // 0x022A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSkipADSEvaluation;                                // 0x022B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bConsiderLoF;                                      // 0x022C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bShouldValidateRangedWeapon;                       // 0x022D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_22E[0x2];                                      // 0x022E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RangeReachHysteresisRatio;                         // 0x0230(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_234[0x1C];                                     // 0x0234(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, WeaponReloadName) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::WeaponReloadName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, WeaponFireName) == 0x000204, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::WeaponFireName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, RangeAttackIsReadyToFireName) == 0x000208, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::RangeAttackIsReadyToFireName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, WeaponTargetingName) == 0x00020C, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::WeaponTargetingName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, AggressivenessName) == 0x000210, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::AggressivenessName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, HasLoSOnThreatName) == 0x000214, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::HasLoSOnThreatName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, UrgentMovementKeyName) == 0x000218, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::UrgentMovementKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, bAlwaysAllowTargetingEvaluation) == 0x00022A, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::bAlwaysAllowTargetingEvaluation' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, bSkipADSEvaluation) == 0x00022B, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::bSkipADSEvaluation' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, bConsiderLoF) == 0x00022C, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::bConsiderLoF' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, bShouldValidateRangedWeapon) == 0x00022D, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::bShouldValidateRangedWeapon' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, RangeReachHysteresisRatio) == 0x000230, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::RangeReachHysteresisRatio' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CacheRangeAttackDigestedSkillSet) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CacheRangeAttackDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CacheAimingDigestedSkillSet) == 0x000258, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CacheAimingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CachePerceptionDigestedSkillSet) == 0x000260, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CachePerceptionDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CacheAttackingDigestedSkillSet) == 0x000268, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CacheAttackingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CacheZoneManager) == 0x000270, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CacheZoneManager' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, CachedAIServiceCover) == 0x000278, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::CachedAIServiceCover' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RangeAttack, ExcludeReachingTarget) == 0x000280, "Member 'UFortAthenaAIBotEvaluator_RangeAttack::ExcludeReachingTarget' has a wrong offset!");
...
{
public:
	class FName                                   ReachBeaconStatusKeyName;                          // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ReachBeaconMovementStateKeyName;                   // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ReachBeaconTargetKeyName;                          // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1BC[0x8];                                      // 0x01BC(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UFortAthenaBeaconComponent> CurrentBeacon;                                     // 0x01C4(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_ReachBeacon) == 0x0001D0, "Wrong size on UFortAthenaAIBotEvaluator_ReachBeacon");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReachBeacon, ReachBeaconStatusKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_ReachBeacon::ReachBeaconStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReachBeacon, ReachBeaconMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_ReachBeacon::ReachBeaconMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReachBeacon, ReachBeaconTargetKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_ReachBeacon::ReachBeaconTargetKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReachBeacon, CurrentBeacon) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_ReachBeacon::CurrentBeacon' has a wrong offset!");

// Class FortniteAIServer.FortAthenaAIBotEvaluator_ReactToVerb
// 0x0240 (0x03F0 - 0x01B0)
...
public:
	...
	class UFortAthenaAIBotReactToVerbDigestedSkillSet* CacheReactToVerbDigestedSkillSet;                  // 0x0218(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDataTable*                             VerbReactions;                                     // 0x0220(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                         MinDistanceFromPlayerToReact;                      // 0x0228(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         MaxReactionEmoteDuration;                          // 0x0250(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         MaxReactionWaitTime;                               // 0x0278(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReactToVerb, CacheReactToVerbDigestedSkillSet) == 0x000218, "Member 'UFortAthenaAIBotEvaluator_ReactToVerb::CacheReactToVerbDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReactToVerb, VerbReactions) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_ReactToVerb::VerbReactions' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReactToVerb, MinDistanceFromPlayerToReact) == 0x000228, "Member 'UFortAthenaAIBotEvaluator_ReactToVerb::MinDistanceFromPlayerToReact' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReactToVerb, MaxReactionEmoteDuration) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_ReactToVerb::MaxReactionEmoteDuration' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ReactToVerb, MaxReactionWaitTime) == 0x000278, "Member 'UFortAthenaAIBotEvaluator_ReactToVerb::MaxReactionWaitTime' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         RecoveringLineOfSightMaxDuration;                  // 0x01B0(0x0028)(Edit, NativeAccessSpecifierPrivate)
	TArray<class FName>                           ExecutionStatusToListenKeyNames;                   // 0x01D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	class FName                                   RecoverLineOfSightExecutionStatusKeyName;          // 0x01E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   RecoverLineOfSightMovementStateKeyName;            // 0x01EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   RecoverLineOfSightDestinationKeyName;              // 0x01F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F4[0x24];                                     // 0x01F4(0x0024)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_RecoverLineOfSight) == 0x000218, "Wrong size on UFortAthenaAIBotEvaluator_RecoverLineOfSight");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RecoverLineOfSight, RecoveringLineOfSightMaxDuration) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_RecoverLineOfSight::RecoveringLineOfSightMaxDuration' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RecoverLineOfSight, ExecutionStatusToListenKeyNames) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_RecoverLineOfSight::ExecutionStatusToListenKeyNames' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RecoverLineOfSight, RecoverLineOfSightExecutionStatusKeyName) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_RecoverLineOfSight::RecoverLineOfSightExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RecoverLineOfSight, RecoverLineOfSightMovementStateKeyName) == 0x0001EC, "Member 'UFortAthenaAIBotEvaluator_RecoverLineOfSight::RecoverLineOfSightMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_RecoverLineOfSight, RecoverLineOfSightDestinationKeyName) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_RecoverLineOfSight::RecoverLineOfSightDestinationKeyName' has a wrong offset!");
...
{
public:
	class FName                                   RetreatDestinationName;                            // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaAIBotAttackingDigestedSkillSet* CacheAttackingDigestedSkillSet;                    // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAICoverComponent*            CachedCoverComponent;                              // 0x01C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Retreat) == 0x0001E0, "Wrong size on UFortAthenaAIBotEvaluator_Retreat");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Retreat, RetreatDestinationName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Retreat::RetreatDestinationName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Retreat, CacheAttackingDigestedSkillSet) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Retreat::CacheAttackingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Retreat, CachedCoverComponent) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Retreat::CachedCoverComponent' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         LastReviveTargetExpiration;                        // 0x01B0(0x0028)(Edit, NativeAccessSpecifierPrivate)
	class FName                                   ReviveTargetKeyName;                               // 0x01D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ReviveLastTargetKeyName;                           // 0x01DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIRuntimeParameters_ReviveBehavior* ReviveBehaviorRuntimeParameters;                   // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AFortPlayerPawnAthena*                  CurrentReviveTarget;                               // 0x01E8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class AFortPlayerPawnAthena*>          DBNOAllyPawns;                                     // 0x01F0(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotReviveDigestedSkillSet* ReviveSkillSet;                                    // 0x0200(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Revive) == 0x000218, "Wrong size on UFortAthenaAIBotEvaluator_Revive");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, LastReviveTargetExpiration) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Revive::LastReviveTargetExpiration' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, ReviveTargetKeyName) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_Revive::ReviveTargetKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, ReviveLastTargetKeyName) == 0x0001DC, "Member 'UFortAthenaAIBotEvaluator_Revive::ReviveLastTargetKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, ReviveBehaviorRuntimeParameters) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_Revive::ReviveBehaviorRuntimeParameters' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, CurrentReviveTarget) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_Revive::CurrentReviveTarget' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, DBNOAllyPawns) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_Revive::DBNOAllyPawns' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Revive, ReviveSkillSet) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_Revive::ReviveSkillSet' has a wrong offset!");
...
{
public:
	class FName                                   DynamicPOIExecutionStatusKeyName;                  // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   DynamicPOILocationKeyName;                         // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortTeamInfoAthena*                    CachedTeamInfo;                                    // 0x01C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FTimerHandle                           NextSearchTimerHandle;                             // 0x0208(0x0008)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FFailedToReachPOI>              FailedBotPOIList;                                  // 0x0210(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	int32                                         CachedSelectedBotPOIID;                            // 0x0220(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI) == 0x000228, "Wrong size on UFortAthenaAIBotEvaluator_SelectNextDynamicPOI");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, DynamicPOIExecutionStatusKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::DynamicPOIExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, DynamicPOILocationKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::DynamicPOILocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, CachedTeamInfo) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::CachedTeamInfo' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, CachedGamePhaseLogic) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::CachedGamePhaseLogic' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, NextSearchTimerHandle) == 0x000208, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::NextSearchTimerHandle' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, FailedBotPOIList) == 0x000210, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::FailedBotPOIList' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextDynamicPOI, CachedSelectedBotPOIID) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::CachedSelectedBotPOIID' has a wrong offset!");
...
{
public:
	class FName                                   NextPOIKeyName;                                    // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   MarkerLocationKeyName;                             // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPoiVolume*                         StartingGroundPOI;                                 // 0x01C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCheckForStartingGroundPOI;                        // 0x01C8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C9[0x3];                                      // 0x01C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CurrentPOICompletionTime;                          // 0x01CC(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         DurationInsideCurrentPOI;                          // 0x01D0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D4[0x4];                                      // 0x01D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortTeamInfoAthena*                    CachedTeamInfo;                                    // 0x01D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotLootingDigestedSkillSet* CachedLootingSkillSet;                             // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SelectNextPOI) == 0x0001E8, "Wrong size on UFortAthenaAIBotEvaluator_SelectNextPOI");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, NextPOIKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::NextPOIKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, MarkerLocationKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::MarkerLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, StartingGroundPOI) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::StartingGroundPOI' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, bCheckForStartingGroundPOI) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::bCheckForStartingGroundPOI' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, CurrentPOICompletionTime) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::CurrentPOICompletionTime' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, DurationInsideCurrentPOI) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::DurationInsideCurrentPOI' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, CachedTeamInfo) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::CachedTeamInfo' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectNextPOI, CachedLootingSkillSet) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_SelectNextPOI::CachedLootingSkillSet' has a wrong offset!");
...
{
public:
	class FName                                   VehicleDestinationKeyName;                         // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SelectVehicleMovementStateKeyName;                 // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SelectVehicleStatusKeyName;                        // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SelectedVehicleKeyName;                            // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         Enabled;                                           // 0x01C8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	float                                         VehicleSearchRadius;                               // 0x01F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterOnlyWithHisConverter;                     // 0x01F4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterAsDriver;                                 // 0x01F5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterVehiclesInWater;                          // 0x01F6(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterOutOfFuelVehicles;                        // 0x01F7(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterWithPlayerDriver;                         // 0x01F8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEnterOnlyMatchingPatrols;                      // 0x01F9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1FA[0x6];                                      // 0x01FA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      VehiclesFilterTagQuery;                            // 0x0200(0x0048)(Edit, NativeAccessSpecifierPrivate)
	struct FGameplayTagQuery                      SeatsFilterTagQuery;                               // 0x0248(0x0048)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SelectVehicle) == 0x000290, "Wrong size on UFortAthenaAIBotEvaluator_SelectVehicle");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, VehicleDestinationKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::VehicleDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, SelectVehicleMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::SelectVehicleMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, SelectVehicleStatusKeyName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::SelectVehicleStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, SelectedVehicleKeyName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::SelectedVehicleKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, Enabled) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::Enabled' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, VehicleSearchRadius) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::VehicleSearchRadius' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterOnlyWithHisConverter) == 0x0001F4, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterOnlyWithHisConverter' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterAsDriver) == 0x0001F5, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterAsDriver' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterVehiclesInWater) == 0x0001F6, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterVehiclesInWater' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterOutOfFuelVehicles) == 0x0001F7, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterOutOfFuelVehicles' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterWithPlayerDriver) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterWithPlayerDriver' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, bCanEnterOnlyMatchingPatrols) == 0x0001F9, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::bCanEnterOnlyMatchingPatrols' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, VehiclesFilterTagQuery) == 0x000200, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::VehiclesFilterTagQuery' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SelectVehicle, SeatsFilterTagQuery) == 0x000248, "Member 'UFortAthenaAIBotEvaluator_SelectVehicle::SeatsFilterTagQuery' has a wrong offset!");
...
public:
	...
	class USmartObjectSubsystem*                  SmartObjectSubsystem;                              // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           EvaluationTag;                                     // 0x01C8(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEvaluateSOValidityAfterChosen;                    // 0x01CC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnableEntryLocationsSupport;                      // 0x01CD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1CE[0x2];                                      // 0x01CE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         MaximumEntryLocationsChecksPerEvaluation;          // 0x01D0(0x0028)(Edit, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         EntryLocationFailuresBlacklistedTime;              // 0x01F8(0x0028)(Edit, NativeAccessSpecifierPrivate)
	class UCurveFloat*                            DistanceToWeightCurveForSlotPicking;               // 0x0220(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class USmartObjectSlotValidationFilter> OverridenFilterClassForEntryPoints;                // 0x0228(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames; // 0x0230(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, NativeAccessSpecifierPrivate)
	uint8                                         Pad_240[0x10];                                     // 0x0240(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SmartObjectExecutionStatusKeyName;                 // 0x0250(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SmartObjectMovementStateKeyName;                   // 0x0254(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SmartObjectDestinationKeyName;                     // 0x0258(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SmartObjectDestinationRotationKeyName;             // 0x025C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SmartObjectShouldMoveKeyName;                      // 0x0260(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   SmartObjectUrgencyKeyName;                         // 0x0264(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_SmartObjects) == 0x000278, "Wrong size on UFortAthenaAIBotEvaluator_SmartObjects");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectRuntimeParameters) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectRuntimeParameters' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectSubsystem) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectSubsystem' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, EvaluationTag) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::EvaluationTag' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, bEvaluateSOValidityAfterChosen) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::bEvaluateSOValidityAfterChosen' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, bEnableEntryLocationsSupport) == 0x0001CD, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::bEnableEntryLocationsSupport' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, MaximumEntryLocationsChecksPerEvaluation) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::MaximumEntryLocationsChecksPerEvaluation' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, EntryLocationFailuresBlacklistedTime) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::EntryLocationFailuresBlacklistedTime' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, DistanceToWeightCurveForSlotPicking) == 0x000220, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::DistanceToWeightCurveForSlotPicking' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, OverridenFilterClassForEntryPoints) == 0x000228, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::OverridenFilterClassForEntryPoints' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames) == 0x000230, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectExecutionStatusKeyName) == 0x000250, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectMovementStateKeyName) == 0x000254, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectDestinationKeyName) == 0x000258, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectDestinationRotationKeyName) == 0x00025C, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectDestinationRotationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectShouldMoveKeyName) == 0x000260, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectShouldMoveKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_SmartObjects, SmartObjectUrgencyKeyName) == 0x000264, "Member 'UFortAthenaAIBotEvaluator_SmartObjects::SmartObjectUrgencyKeyName' has a wrong offset!");
...
{
public:
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CachedRangeAttackDigestedSkillSet;                 // 0x01B0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   StepBackExecutionStatusKeyName;                    // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   StepBackMovementStateKeyName;                      // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   StepBackDestinationKeyName;                        // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_StepBack) == 0x0001E0, "Wrong size on UFortAthenaAIBotEvaluator_StepBack");
static_assert(offsetof(UFortAthenaAIBotEvaluator_StepBack, CachedRangeAttackDigestedSkillSet) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_StepBack::CachedRangeAttackDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_StepBack, CachedAIServiceCover) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_StepBack::CachedAIServiceCover' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_StepBack, StepBackExecutionStatusKeyName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_StepBack::StepBackExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_StepBack, StepBackMovementStateKeyName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_StepBack::StepBackMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_StepBack, StepBackDestinationKeyName) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_StepBack::StepBackDestinationKeyName' has a wrong offset!");
...
{
public:
	class FName                                   StormDestinationName;                              // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B4[0xC];                                      // 0x01B4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortGameModeAthena*                    CacheAthenaGameMode;                               // 0x01C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UBehaviorTreeComponent*                 CachedBTComp;                                      // 0x01C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortGameStateComponent_BattleRoyaleGamePhaseLogic* CachedGamePhaseLogic;                              // 0x01D0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_Storm) == 0x000210, "Wrong size on UFortAthenaAIBotEvaluator_Storm");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Storm, StormDestinationName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Storm::StormDestinationName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Storm, CacheAthenaGameMode) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Storm::CacheAthenaGameMode' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Storm, CachedBTComp) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Storm::CachedBTComp' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Storm, CachedGamePhaseLogic) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_Storm::CachedGamePhaseLogic' has a wrong offset!");
...
{
public:
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackDigestedSkillSet;                  // 0x01B0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotAimingDigestedSkillSet* CacheAimingDigestedSkillSet;                       // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAthenaAIServiceCover*                  CachedAIServiceCover;                              // 0x01C0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   DestinationKeyName;                                // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   MoveToDestinationKeyName;                          // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   HealingStatusKeyName;                              // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   WeaponFireName;                                    // 0x01D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TargetActorName;                                   // 0x01D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   BunkerStatusKeyName;                               // 0x01DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E0[0x10];                                     // 0x01E0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class ABuildingActor*                         CachedCoverBuildingActor;                          // 0x01F0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class ABuildingActor*>                 ExcludedBuildingActors;                            // 0x01F8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_TakeCover) == 0x000240, "Wrong size on UFortAthenaAIBotEvaluator_TakeCover");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, CacheRangeAttackDigestedSkillSet) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_TakeCover::CacheRangeAttackDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, CacheAimingDigestedSkillSet) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_TakeCover::CacheAimingDigestedSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, CachedAIServiceCover) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_TakeCover::CachedAIServiceCover' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, DestinationKeyName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_TakeCover::DestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, MoveToDestinationKeyName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_TakeCover::MoveToDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, HealingStatusKeyName) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_TakeCover::HealingStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, WeaponFireName) == 0x0001D4, "Member 'UFortAthenaAIBotEvaluator_TakeCover::WeaponFireName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, TargetActorName) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_TakeCover::TargetActorName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, BunkerStatusKeyName) == 0x0001DC, "Member 'UFortAthenaAIBotEvaluator_TakeCover::BunkerStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, CachedCoverBuildingActor) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_TakeCover::CachedCoverBuildingActor' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_TakeCover, ExcludedBuildingActors) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_TakeCover::ExcludedBuildingActors' has a wrong offset!");
...
{
public:
	class FName                                   WeaponTriggerThrowableName;                        // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ThrowableAttackIsReadyToThrowName;                 // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D0[0x8];                                      // 0x01D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaAIBotAttackingDigestedSkillSet* AttackingSkillSet;                                 // 0x01D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* RangeAttackSkillSet;                               // 0x01E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaAIBotAimingDigestedSkillSet* AimingSkillSet;                                    // 0x01E8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortWorldItem*                         ChosenWeapon;                                      // 0x01F0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AFortPawn*                              CachedFortPawn;                                    // 0x01F8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIBotEvaluator_ThrowableAttack) == 0x000218, "Wrong size on UFortAthenaAIBotEvaluator_ThrowableAttack");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, WeaponTriggerThrowableName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::WeaponTriggerThrowableName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, ThrowableAttackIsReadyToThrowName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::ThrowableAttackIsReadyToThrowName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, AttackingSkillSet) == 0x0001D8, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::AttackingSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, RangeAttackSkillSet) == 0x0001E0, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::RangeAttackSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, AimingSkillSet) == 0x0001E8, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::AimingSkillSet' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, ChosenWeapon) == 0x0001F0, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::ChosenWeapon' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_ThrowableAttack, CachedFortPawn) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_ThrowableAttack::CachedFortPawn' has a wrong offset!");
...
{
public:
	class FName                                   CurrentDestinationKeyName;                         // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineTargetKeyName;                              // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   LastZiplineUsedName;                               // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineMoveExecutionStatusKeyName;                 // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineEntryLocationKeyName;                       // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineExitLocationKeyName;                        // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineLastUsageTimeName;                          // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZiplineUsageExecutionStatusName;                   // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                         WaitTimeBetweenZiplineRandomChoices;               // 0x01D0(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ProbabilityToUseZipline;                           // 0x01F8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, CurrentDestinationKeyName) == 0x0001B0, "Member 'UFortAthenaAIBotEvaluator_Zipline::CurrentDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineTargetKeyName) == 0x0001B4, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineTargetKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, LastZiplineUsedName) == 0x0001B8, "Member 'UFortAthenaAIBotEvaluator_Zipline::LastZiplineUsedName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineMoveExecutionStatusKeyName) == 0x0001BC, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineMoveExecutionStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineEntryLocationKeyName) == 0x0001C0, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineEntryLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineExitLocationKeyName) == 0x0001C4, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineExitLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineLastUsageTimeName) == 0x0001C8, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineLastUsageTimeName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ZiplineUsageExecutionStatusName) == 0x0001CC, "Member 'UFortAthenaAIBotEvaluator_Zipline::ZiplineUsageExecutionStatusName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, WaitTimeBetweenZiplineRandomChoices) == 0x0001D0, "Member 'UFortAthenaAIBotEvaluator_Zipline::WaitTimeBetweenZiplineRandomChoices' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIBotEvaluator_Zipline, ProbabilityToUseZipline) == 0x0001F8, "Member 'UFortAthenaAIBotEvaluator_Zipline::ProbabilityToUseZipline' has a wrong offset!");
...
public:
	...
	bool                                          bEvaluateOnBlackboardKeyChange;                    // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           ListeningBlackboardKeyNames;                       // 0x00E0(0x0010)(Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaAIEvaluator_BlueprintBase) == 0x000100, "Wrong size on UFortAthenaAIEvaluator_BlueprintBase");
...
static_assert(offsetof(UFortAthenaAIEvaluator_BlueprintBase, bEvaluateOnBlackboardKeyChange) == 0x0000D8, "Member 'UFortAthenaAIEvaluator_BlueprintBase::bEvaluateOnBlackboardKeyChange' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIEvaluator_BlueprintBase, ListeningBlackboardKeyNames) == 0x0000E0, "Member 'UFortAthenaAIEvaluator_BlueprintBase::ListeningBlackboardKeyNames' has a wrong offset!");
...
{
public:
	class FName                                   FollowGroupLeaderStatusKeyName;                    // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FollowGroupLeaderMovementStateKeyName;             // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FollowGroupLeaderDestinationKeyName;               // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TooFarFromLeaderKeyName;                           // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C0[0x8];                                      // 0x01C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortPawnComponent_AIGroup*             CachedAIGroupComponent;                            // 0x01C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaAIEvaluator_FollowGroupLeader) == 0x0001D0, "Wrong size on UFortAthenaAIEvaluator_FollowGroupLeader");
static_assert(offsetof(UFortAthenaAIEvaluator_FollowGroupLeader, FollowGroupLeaderStatusKeyName) == 0x0001B0, "Member 'UFortAthenaAIEvaluator_FollowGroupLeader::FollowGroupLeaderStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIEvaluator_FollowGroupLeader, FollowGroupLeaderMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaAIEvaluator_FollowGroupLeader::FollowGroupLeaderMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIEvaluator_FollowGroupLeader, FollowGroupLeaderDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaAIEvaluator_FollowGroupLeader::FollowGroupLeaderDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIEvaluator_FollowGroupLeader, TooFarFromLeaderKeyName) == 0x0001BC, "Member 'UFortAthenaAIEvaluator_FollowGroupLeader::TooFarFromLeaderKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaAIEvaluator_FollowGroupLeader, CachedAIGroupComponent) == 0x0001C8, "Member 'UFortAthenaAIEvaluator_FollowGroupLeader::CachedAIGroupComponent' has a wrong offset!");
...
static_assert(offsetof(UFortAthenaBTService_AgentOffNavMesh, AgentIsOffNavMeshKeyName) == 0x000070, "Member 'UFortAthenaBTService_AgentOffNavMesh::AgentIsOffNavMeshKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaBTService_AgentOffNavMesh, bEvaluateOnTick) == 0x000074, "Member 'UFortAthenaBTService_AgentOffNavMesh::bEvaluateOnTick' has a wrong offset!");
static_assert(offsetof(UFortAthenaBTService_AgentOffNavMesh, TickInterval) == 0x000078, "Member 'UFortAthenaBTService_AgentOffNavMesh::TickInterval' has a wrong offset!");
static_assert(offsetof(UFortAthenaBTService_AgentOffNavMesh, bEvaluateOnMoveRequestFinished) == 0x0000A0, "Member 'UFortAthenaBTService_AgentOffNavMesh::bEvaluateOnMoveRequestFinished' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         EncampmentEnable;                                  // 0x01B0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         EncampmentTentativeDelayMin;                       // 0x01D8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         EncampmentTentativeDelayMax;                       // 0x0200(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         EncampmentDurationMin;                             // 0x0228(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         EncampmentDurationMax;                             // 0x0250(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         BuilderPercentage;                                 // 0x0278(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         BuilderMinDistance;                                // 0x02A0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         BuilderMaxDistance;                                // 0x02C8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         GuardMinDistance;                                  // 0x02F0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         GuardMaxDistance;                                  // 0x0318(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         AllowInSwimming;                                   // 0x0340(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         AllowInFalling;                                    // 0x0368(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MinSquadMembersCountToBuild;                       // 0x0390(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	class FName                                   EncampmentStatusKeyName;                           // 0x03B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3BC[0x4];                                      // 0x03BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EncampmentMovementStateKeyName;                    // 0x03C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3C4[0x4];                                      // 0x03C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EncampmentCenterLocationKeyName;                   // 0x03C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3CC[0x4];                                      // 0x03CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EncampmentDestinationKeyName;                      // 0x03D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3D4[0x4];                                      // 0x03D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EncampmentAroundCampFireLocationKeyName;           // 0x03D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3DC[0x4];                                      // 0x03DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EncampmentRoleKeyName;                             // 0x03E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E4[0x4];                                      // 0x03E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DefensiveBuildName;                                // 0x03E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3EC[0x6C];                                     // 0x03EC(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortAthenaNpcEvaluator_Encampment) == 0x000458, "Wrong size on UFortAthenaNpcEvaluator_Encampment");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentEnable) == 0x0001B0, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentEnable' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentTentativeDelayMin) == 0x0001D8, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentTentativeDelayMin' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentTentativeDelayMax) == 0x000200, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentTentativeDelayMax' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentDurationMin) == 0x000228, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentDurationMin' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentDurationMax) == 0x000250, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentDurationMax' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, BuilderPercentage) == 0x000278, "Member 'UFortAthenaNpcEvaluator_Encampment::BuilderPercentage' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, BuilderMinDistance) == 0x0002A0, "Member 'UFortAthenaNpcEvaluator_Encampment::BuilderMinDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, BuilderMaxDistance) == 0x0002C8, "Member 'UFortAthenaNpcEvaluator_Encampment::BuilderMaxDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, GuardMinDistance) == 0x0002F0, "Member 'UFortAthenaNpcEvaluator_Encampment::GuardMinDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, GuardMaxDistance) == 0x000318, "Member 'UFortAthenaNpcEvaluator_Encampment::GuardMaxDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, AllowInSwimming) == 0x000340, "Member 'UFortAthenaNpcEvaluator_Encampment::AllowInSwimming' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, AllowInFalling) == 0x000368, "Member 'UFortAthenaNpcEvaluator_Encampment::AllowInFalling' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, MinSquadMembersCountToBuild) == 0x000390, "Member 'UFortAthenaNpcEvaluator_Encampment::MinSquadMembersCountToBuild' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentStatusKeyName) == 0x0003B8, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentMovementStateKeyName) == 0x0003C0, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentCenterLocationKeyName) == 0x0003C8, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentCenterLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentDestinationKeyName) == 0x0003D0, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentAroundCampFireLocationKeyName) == 0x0003D8, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentAroundCampFireLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, EncampmentRoleKeyName) == 0x0003E0, "Member 'UFortAthenaNpcEvaluator_Encampment::EncampmentRoleKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Encampment, DefensiveBuildName) == 0x0003E8, "Member 'UFortAthenaNpcEvaluator_Encampment::DefensiveBuildName' has a wrong offset!");
...
{
public:
	class FName                                   FollowPatrolPathKeyName;                           // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FollowPatrolPathMovementStateKeyName;              // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   FollowPatrolPathDestinationKeyName;                // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1BC[0x8];                                      // 0x01BC(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ChanceToTakeABreak;                                // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         BreakDurationMin;                                  // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         BreakDurationMax;                                  // 0x01CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaNpcEvaluator_FollowPatrolPath) == 0x0001E8, "Wrong size on UFortAthenaNpcEvaluator_FollowPatrolPath");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, FollowPatrolPathKeyName) == 0x0001B0, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::FollowPatrolPathKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, FollowPatrolPathMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::FollowPatrolPathMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, FollowPatrolPathDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::FollowPatrolPathDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, ChanceToTakeABreak) == 0x0001C4, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::ChanceToTakeABreak' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, BreakDurationMin) == 0x0001C8, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::BreakDurationMin' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowPatrolPath, BreakDurationMax) == 0x0001CC, "Member 'UFortAthenaNpcEvaluator_FollowPatrolPath::BreakDurationMax' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         FormationOffsetRadiusMin;                          // 0x01B0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         FormationOffsetRadiusMax;                          // 0x01D8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         TooFarFromSquadLeaderDistance;                     // 0x0200(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxNoiseRadius;                                    // 0x0228(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MinDurationNoiseEvaluate;                          // 0x0250(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxDurationNoiseEvaluate;                          // 0x0278(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	class FName                                   FollowSquadLeaderStatusKeyName;                    // 0x02A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   FollowSquadLeaderMovementStateKeyName;             // 0x02A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2AC[0x4];                                      // 0x02AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   FollowSquadLeaderDestinationKeyName;               // 0x02B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   TooFarFromLeaderKeyName;                           // 0x02B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2BC[0x4];                                      // 0x02BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CachedSquadFormationOffset;                        // 0x02C0(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                CachedNoiseOffset;                                 // 0x02D8(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CachedTooFarFromSquadLeaderDistanceSqr;            // 0x02F0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         LastNoiseOffsetUpdateTime;                         // 0x02F4(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         DurationNoiseEvaluate;                             // 0x02F8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaNpcEvaluator_FollowSquadLeader) == 0x000300, "Wrong size on UFortAthenaNpcEvaluator_FollowSquadLeader");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, FormationOffsetRadiusMin) == 0x0001B0, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::FormationOffsetRadiusMin' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, FormationOffsetRadiusMax) == 0x0001D8, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::FormationOffsetRadiusMax' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, TooFarFromSquadLeaderDistance) == 0x000200, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::TooFarFromSquadLeaderDistance' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, MaxNoiseRadius) == 0x000228, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::MaxNoiseRadius' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, MinDurationNoiseEvaluate) == 0x000250, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::MinDurationNoiseEvaluate' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, MaxDurationNoiseEvaluate) == 0x000278, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::MaxDurationNoiseEvaluate' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, FollowSquadLeaderStatusKeyName) == 0x0002A0, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::FollowSquadLeaderStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, FollowSquadLeaderMovementStateKeyName) == 0x0002A8, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::FollowSquadLeaderMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, FollowSquadLeaderDestinationKeyName) == 0x0002B0, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::FollowSquadLeaderDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, TooFarFromLeaderKeyName) == 0x0002B8, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::TooFarFromLeaderKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, CachedSquadFormationOffset) == 0x0002C0, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::CachedSquadFormationOffset' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, CachedNoiseOffset) == 0x0002D8, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::CachedNoiseOffset' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, CachedTooFarFromSquadLeaderDistanceSqr) == 0x0002F0, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::CachedTooFarFromSquadLeaderDistanceSqr' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, LastNoiseOffsetUpdateTime) == 0x0002F4, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::LastNoiseOffsetUpdateTime' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_FollowSquadLeader, DurationNoiseEvaluate) == 0x0002F8, "Member 'UFortAthenaNpcEvaluator_FollowSquadLeader::DurationNoiseEvaluate' has a wrong offset!");
...
{
public:
	class FName                                   LeashKeyName;                                      // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   LeashMovementStateKeyName;                         // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   LeashDestinationKeyName;                           // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   LeashLocationKeyName;                              // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   LeashOuterRadiusKeyName;                           // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ShouldTeleportInLeashKeyName;                      // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   TriggerLeashBehaviorKeyName;                       // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAlwaysForceMoveToLeashCenter;                     // 0x01CC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bForcePositionOnLeash;                             // 0x01CD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1CE[0x2];                                      // 0x01CE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UNavigationQueryFilter>     AvoidObstaclesFilterClass;                         // 0x01D0(0x0008)(Edit, ZeroConstructor, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D8[0x10];                                     // 0x01D8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaAIRuntimeParameters_Leash*   LeashRuntimeParameters;                            // 0x01E8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaNpcEvaluator_Leash) == 0x0001F0, "Wrong size on UFortAthenaNpcEvaluator_Leash");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashKeyName) == 0x0001B0, "Member 'UFortAthenaNpcEvaluator_Leash::LeashKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaNpcEvaluator_Leash::LeashMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaNpcEvaluator_Leash::LeashDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashLocationKeyName) == 0x0001BC, "Member 'UFortAthenaNpcEvaluator_Leash::LeashLocationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashOuterRadiusKeyName) == 0x0001C0, "Member 'UFortAthenaNpcEvaluator_Leash::LeashOuterRadiusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, ShouldTeleportInLeashKeyName) == 0x0001C4, "Member 'UFortAthenaNpcEvaluator_Leash::ShouldTeleportInLeashKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, TriggerLeashBehaviorKeyName) == 0x0001C8, "Member 'UFortAthenaNpcEvaluator_Leash::TriggerLeashBehaviorKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, bAlwaysForceMoveToLeashCenter) == 0x0001CC, "Member 'UFortAthenaNpcEvaluator_Leash::bAlwaysForceMoveToLeashCenter' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, bForcePositionOnLeash) == 0x0001CD, "Member 'UFortAthenaNpcEvaluator_Leash::bForcePositionOnLeash' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, AvoidObstaclesFilterClass) == 0x0001D0, "Member 'UFortAthenaNpcEvaluator_Leash::AvoidObstaclesFilterClass' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Leash, LeashRuntimeParameters) == 0x0001E8, "Member 'UFortAthenaNpcEvaluator_Leash::LeashRuntimeParameters' has a wrong offset!");
...
{
public:
	class FName                                   PatrollingKeyName;                                 // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PatrollingMovementStateKeyName;                    // 0x01B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PatrollingDestinationKeyName;                      // 0x01B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   DynamicBlueprintStatusKeyName;                     // 0x01BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   DynamicBlueprintActorKeyName;                      // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PatrollingShouldMoveKeyName;                       // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PatrollingAppendDestinationKeyName;                // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1CC[0x10];                                     // 0x01CC(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DistanceToTestPoint;                               // 0x01DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCanDisablePatrolling;                             // 0x01E0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCanReenablePatrolling;                            // 0x01E1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E2[0x2];                                      // 0x01E2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ReenableTimer;                                     // 0x01E4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCanSelectNearestPatrolPointAtStart;               // 0x01E8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E9[0x7];                                      // 0x01E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAthenaNpcPatrollingComponent*      CachedNpcPatrollingComponent;                      // 0x01F0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortAthenaNpcEvaluator_Patrolling) == 0x000200, "Wrong size on UFortAthenaNpcEvaluator_Patrolling");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, PatrollingKeyName) == 0x0001B0, "Member 'UFortAthenaNpcEvaluator_Patrolling::PatrollingKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, PatrollingMovementStateKeyName) == 0x0001B4, "Member 'UFortAthenaNpcEvaluator_Patrolling::PatrollingMovementStateKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, PatrollingDestinationKeyName) == 0x0001B8, "Member 'UFortAthenaNpcEvaluator_Patrolling::PatrollingDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, DynamicBlueprintStatusKeyName) == 0x0001BC, "Member 'UFortAthenaNpcEvaluator_Patrolling::DynamicBlueprintStatusKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, DynamicBlueprintActorKeyName) == 0x0001C0, "Member 'UFortAthenaNpcEvaluator_Patrolling::DynamicBlueprintActorKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, PatrollingShouldMoveKeyName) == 0x0001C4, "Member 'UFortAthenaNpcEvaluator_Patrolling::PatrollingShouldMoveKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, PatrollingAppendDestinationKeyName) == 0x0001C8, "Member 'UFortAthenaNpcEvaluator_Patrolling::PatrollingAppendDestinationKeyName' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, DistanceToTestPoint) == 0x0001DC, "Member 'UFortAthenaNpcEvaluator_Patrolling::DistanceToTestPoint' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, bCanDisablePatrolling) == 0x0001E0, "Member 'UFortAthenaNpcEvaluator_Patrolling::bCanDisablePatrolling' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, bCanReenablePatrolling) == 0x0001E1, "Member 'UFortAthenaNpcEvaluator_Patrolling::bCanReenablePatrolling' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, ReenableTimer) == 0x0001E4, "Member 'UFortAthenaNpcEvaluator_Patrolling::ReenableTimer' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, bCanSelectNearestPatrolPointAtStart) == 0x0001E8, "Member 'UFortAthenaNpcEvaluator_Patrolling::bCanSelectNearestPatrolPointAtStart' has a wrong offset!");
static_assert(offsetof(UFortAthenaNpcEvaluator_Patrolling, CachedNpcPatrollingComponent) == 0x0001F0, "Member 'UFortAthenaNpcEvaluator_Patrolling::CachedNpcPatrollingComponent' has a wrong offset!");
