...
static_assert(offsetof(FOptimusFunctionNodeGraphHeader, FunctionName) == 0x000020, "Member 'FOptimusFunctionNodeGraphHeader::FunctionName' has a wrong offset!");
static_assert(offsetof(FOptimusFunctionNodeGraphHeader, Category) == 0x000024, "Member 'FOptimusFunctionNodeGraphHeader::Category' has a wrong offset!");
