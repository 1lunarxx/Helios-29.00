...
public:
	...
	TMap<class FName, class FString>              LatestImportedStyleRevisions;                      // 0x0190(0x0050)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FConnectionFieldContainer              ConnectionFields;                                  // 0x01E0(0x0030)(Edit, EditConst, NativeAccessSpecifierPrivate)
	struct FConnectionFieldContainer              ConnectionFieldsOverride;                          // 0x0210(0x0030)(Edit, NativeAccessSpecifierPrivate)

public:
	static class FName GetMainGroupName(int32 MainGroupId);
	static class FName GetSubMainGroupName(int32 SubMainGroupId);

	class UAtomPrimitiveGeometryContainer* GetGeometryContainerForBestExportStyle(const TArray<class FString>& GeometryStylePriorityList) const;
...
static_assert(sizeof(UAtomPrimitive) == 0x000240, "Wrong size on UAtomPrimitive");
...
static_assert(offsetof(UAtomPrimitive, LatestImportedStyleRevisions) == 0x000190, "Member 'UAtomPrimitive::LatestImportedStyleRevisions' has a wrong offset!");
static_assert(offsetof(UAtomPrimitive, ConnectionFields) == 0x0001E0, "Member 'UAtomPrimitive::ConnectionFields' has a wrong offset!");
static_assert(offsetof(UAtomPrimitive, ConnectionFieldsOverride) == 0x000210, "Member 'UAtomPrimitive::ConnectionFieldsOverride' has a wrong offset!");
