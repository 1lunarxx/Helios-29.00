...
static_assert(offsetof(FortWeaponModManagementComponent_WeaponModSlotsChangedDelegate__DelegateSignature, Weapon) == 0x000000, "Member 'FortWeaponModManagementComponent_WeaponModSlotsChangedDelegate__DelegateSignature::Weapon' has a wrong offset!");
...
static_assert(offsetof(FortWeaponModStationComponent_OnLocalModPurchaseStarted__DelegateSignature, EventParams) == 0x000000, "Member 'FortWeaponModStationComponent_OnLocalModPurchaseStarted__DelegateSignature::EventParams' has a wrong offset!");
...
static_assert(offsetof(FortWeaponModStationComponent_OnStartInteractWithWorkbenchActorDelegate__DelegateSignature, NewInteractingWeaponModStation) == 0x000000, "Member 'FortWeaponModStationComponent_OnStartInteractWithWorkbenchActorDelegate__DelegateSignature::NewInteractingWeaponModStation' has a wrong offset!");
...
static_assert(offsetof(FortWeaponModStationComponent_OnStopInteractWithWorkbenchActorDelegate__DelegateSignature, WeaponModStation) == 0x000000, "Member 'FortWeaponModStationComponent_OnStopInteractWithWorkbenchActorDelegate__DelegateSignature::WeaponModStation' has a wrong offset!");
