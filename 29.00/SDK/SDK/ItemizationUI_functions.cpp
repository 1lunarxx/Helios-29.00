...
// DelegateFunction ItemizationUI.GenericInventoryPanel.OnInputDelegate__DelegateSignature
// (MulticastDelegate, Public, Delegate)

void UGenericInventoryPanel::OnInputDelegate__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GenericInventoryPanel", "OnInputDelegate__DelegateSignature");
