...
static_assert(offsetof(DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature, PlayerState) == 0x000000, "Member 'DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature::PlayerState' has a wrong offset!");
static_assert(offsetof(DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature, EventTag) == 0x000008, "Member 'DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature::EventTag' has a wrong offset!");
static_assert(offsetof(DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature, Context) == 0x000010, "Member 'DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature::Context' has a wrong offset!");
...
static_assert(offsetof(WidgetTransitioner_WidgetTransitionerStatusChange__DelegateSignature, Transitioner) == 0x000000, "Member 'WidgetTransitioner_WidgetTransitionerStatusChange__DelegateSignature::Transitioner' has a wrong offset!");
static_assert(offsetof(WidgetTransitioner_WidgetTransitionerStatusChange__DelegateSignature, Status) == 0x000008, "Member 'WidgetTransitioner_WidgetTransitionerStatusChange__DelegateSignature::Status' has a wrong offset!");
...
static_assert(offsetof(DelMarActionWidget_OnInputMethodChanged__DelegateSignature, bUsingGamepad) == 0x000000, "Member 'DelMarActionWidget_OnInputMethodChanged__DelegateSignature::bUsingGamepad' has a wrong offset!");
