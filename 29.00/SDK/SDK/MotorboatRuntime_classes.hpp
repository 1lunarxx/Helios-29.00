...
// 0x02F0 (0x2290 - 0x1FA0)
class AFortMeatballVehicle final : public AFortAthenaSKVehicle
{
public:
	struct FFortRechargingActionTimer             BoostAction;                                       // 0x1FA0(0x00D8)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	float                                         FxNormalizationMaxSpeedKmh;                        // 0x2078(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_207C[0x4];                                     // 0x207C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortVehicleAudioVoice*                 CacheAudioEngineUp;                                // 0x2080(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVehicleAudioVoice*                 CacheAudioEngineDown;                              // 0x2088(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVehicleAudioVoice*                 CacheAudioWakeTurn;                                // 0x2090(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVehicleAudioVoice*                 CacheAudioWakeSpeed;                               // 0x2098(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVehicleAudioVoice*                 CacheAudioScrape;                                  // 0x20A0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVehicleAudioVoice*                 CacheAudioEngineOutOfFuel;                         // 0x20A8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInstanceDynamic*               BoostMID;                                          // 0x20B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraComponent*                      CachedGroundFXComponent;                           // 0x20B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class APlayerController*                      DrivingPlayerController;                           // 0x20C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULegacyCameraShake*                     LandCameraShake;                                   // 0x20C8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ULegacyCameraShake>         LandCameraShakeClass;                              // 0x20D0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULegacyCameraShake*                     DriverCameraShake;                                 // 0x20D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ULegacyCameraShake>         DriverCameraShakeClass;                            // 0x20E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LandRumbleIntensity;                               // 0x20E8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_20EC[0x4];                                     // 0x20EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	uint64                                        LandForceFeedbackHandle;                           // 0x20F0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnRumbleIntensity;                               // 0x20F8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_20FC[0x4];                                     // 0x20FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	uint64                                        TurnForceFeedbackHandle;                           // 0x2100(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentSnowAltitude;                               // 0x2108(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasSnow;                                          // 0x210C(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLargeRumble;                                      // 0x210D(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTurnRumbleActive;                                 // 0x210E(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWaterDropsOnScreen;                               // 0x210F(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           GCVehicleScreenDrips;                              // 0x2110(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2114[0x4];                                     // 0x2114(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayCueParameters                 GCParamsEmpty;                                     // 0x2118(0x00D0)(Edit, BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortCameraMode>            BoostingCamera;                                    // 0x21E8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UFortCameraMode>            VehicleCameraNoWeaponOverride;                     // 0x21F0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21F8[0x10];                                    // 0x21F8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortMeatballVehicleConfigs*            FortMeatballVehicleConfigs;                        // 0x2208(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WaterLineStartPontoonIndex;                        // 0x2210(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WaterLineEndPontoonIndex;                          // 0x2214(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2218[0x38];                                    // 0x2218(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bBoostFailed;                                      // 0x2250(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2251[0x3F];                                    // 0x2251(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFortMeatballVehicle) == 0x002290, "Wrong size on AFortMeatballVehicle");
static_assert(offsetof(AFortMeatballVehicle, BoostAction) == 0x001FA0, "Member 'AFortMeatballVehicle::BoostAction' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, FxNormalizationMaxSpeedKmh) == 0x002078, "Member 'AFortMeatballVehicle::FxNormalizationMaxSpeedKmh' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioEngineUp) == 0x002080, "Member 'AFortMeatballVehicle::CacheAudioEngineUp' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioEngineDown) == 0x002088, "Member 'AFortMeatballVehicle::CacheAudioEngineDown' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioWakeTurn) == 0x002090, "Member 'AFortMeatballVehicle::CacheAudioWakeTurn' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioWakeSpeed) == 0x002098, "Member 'AFortMeatballVehicle::CacheAudioWakeSpeed' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioScrape) == 0x0020A0, "Member 'AFortMeatballVehicle::CacheAudioScrape' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CacheAudioEngineOutOfFuel) == 0x0020A8, "Member 'AFortMeatballVehicle::CacheAudioEngineOutOfFuel' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, BoostMID) == 0x0020B0, "Member 'AFortMeatballVehicle::BoostMID' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CachedGroundFXComponent) == 0x0020B8, "Member 'AFortMeatballVehicle::CachedGroundFXComponent' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, DrivingPlayerController) == 0x0020C0, "Member 'AFortMeatballVehicle::DrivingPlayerController' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, LandCameraShake) == 0x0020C8, "Member 'AFortMeatballVehicle::LandCameraShake' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, LandCameraShakeClass) == 0x0020D0, "Member 'AFortMeatballVehicle::LandCameraShakeClass' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, DriverCameraShake) == 0x0020D8, "Member 'AFortMeatballVehicle::DriverCameraShake' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, DriverCameraShakeClass) == 0x0020E0, "Member 'AFortMeatballVehicle::DriverCameraShakeClass' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, LandRumbleIntensity) == 0x0020E8, "Member 'AFortMeatballVehicle::LandRumbleIntensity' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, LandForceFeedbackHandle) == 0x0020F0, "Member 'AFortMeatballVehicle::LandForceFeedbackHandle' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, TurnRumbleIntensity) == 0x0020F8, "Member 'AFortMeatballVehicle::TurnRumbleIntensity' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, TurnForceFeedbackHandle) == 0x002100, "Member 'AFortMeatballVehicle::TurnForceFeedbackHandle' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, CurrentSnowAltitude) == 0x002108, "Member 'AFortMeatballVehicle::CurrentSnowAltitude' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, bHasSnow) == 0x00210C, "Member 'AFortMeatballVehicle::bHasSnow' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, bLargeRumble) == 0x00210D, "Member 'AFortMeatballVehicle::bLargeRumble' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, bTurnRumbleActive) == 0x00210E, "Member 'AFortMeatballVehicle::bTurnRumbleActive' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, bWaterDropsOnScreen) == 0x00210F, "Member 'AFortMeatballVehicle::bWaterDropsOnScreen' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, GCVehicleScreenDrips) == 0x002110, "Member 'AFortMeatballVehicle::GCVehicleScreenDrips' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, GCParamsEmpty) == 0x002118, "Member 'AFortMeatballVehicle::GCParamsEmpty' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, BoostingCamera) == 0x0021E8, "Member 'AFortMeatballVehicle::BoostingCamera' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, VehicleCameraNoWeaponOverride) == 0x0021F0, "Member 'AFortMeatballVehicle::VehicleCameraNoWeaponOverride' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, FortMeatballVehicleConfigs) == 0x002208, "Member 'AFortMeatballVehicle::FortMeatballVehicleConfigs' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, WaterLineStartPontoonIndex) == 0x002210, "Member 'AFortMeatballVehicle::WaterLineStartPontoonIndex' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, WaterLineEndPontoonIndex) == 0x002214, "Member 'AFortMeatballVehicle::WaterLineEndPontoonIndex' has a wrong offset!");
static_assert(offsetof(AFortMeatballVehicle, bBoostFailed) == 0x002250, "Member 'AFortMeatballVehicle::bBoostFailed' has a wrong offset!");
