...
static_assert(sizeof(UFortPawnComponent_AscenderMontageProvider) == 0x0000C0, "Wrong size on UFortPawnComponent_AscenderMontageProvider");
static_assert(offsetof(UFortPawnComponent_AscenderMontageProvider, M_Ascending) == 0x0000A0, "Member 'UFortPawnComponent_AscenderMontageProvider::M_Ascending' has a wrong offset!");
static_assert(offsetof(UFortPawnComponent_AscenderMontageProvider, M_Descending) == 0x0000A8, "Member 'UFortPawnComponent_AscenderMontageProvider::M_Descending' has a wrong offset!");
static_assert(offsetof(UFortPawnComponent_AscenderMontageProvider, F_Ascending) == 0x0000B0, "Member 'UFortPawnComponent_AscenderMontageProvider::F_Ascending' has a wrong offset!");
static_assert(offsetof(UFortPawnComponent_AscenderMontageProvider, F_Descending) == 0x0000B8, "Member 'UFortPawnComponent_AscenderMontageProvider::F_Descending' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAscenderSetupComplete;                           // 0x0C98(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
