...
static_assert(offsetof(ADelMarRaceManager, MatchEventSystemComponent) == 0x000400, "Member 'ADelMarRaceManager::MatchEventSystemComponent' has a wrong offset!");
static_assert(offsetof(ADelMarRaceManager, ManagedPlayerStates) == 0x000408, "Member 'ADelMarRaceManager::ManagedPlayerStates' has a wrong offset!");
static_assert(offsetof(ADelMarRaceManager, InactivePlayerStates) == 0x000458, "Member 'ADelMarRaceManager::InactivePlayerStates' has a wrong offset!");
...
static_assert(offsetof(ADelMarChallengeRaceManager, bIsOvertime) == 0x0004A8, "Member 'ADelMarChallengeRaceManager::bIsOvertime' has a wrong offset!");
static_assert(offsetof(ADelMarChallengeRaceManager, OvertimeTimer) == 0x0004B0, "Member 'ADelMarChallengeRaceManager::OvertimeTimer' has a wrong offset!");
...
// 0x0DE0 (0x2D80 - 0x1FA0)
class ADelMarVehicle final : public AFortAthenaSKVehicle
{
public:
	uint8                                         Pad_1FA0[0x50];                                    // 0x1FA0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UFortCameraMode>>    DelMarCameraModes;                                 // 0x1FF0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          bLocalDriverHasReplicatedVehicle;                  // 0x2000(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2001[0xF];                                     // 0x2001(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortAthenaVehicleInputState           PendingDriverInputState;                           // 0x2010(0x0040)(Transient, NoDestructor, NativeAccessSpecifierPublic)
	float                                         DistanceToPack;                                    // 0x2050(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceFromTrackFinish;                           // 0x2054(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ATTR_bVehicleThrottleDisabled;                     // 0x2058(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2059[0x7];                                     // 0x2059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarInputAction                     ThrottleAction;                                    // 0x2060(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     BrakeAction;                                       // 0x2070(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     SteerAction;                                       // 0x2080(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     SteerLeftAction;                                   // 0x2090(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     SteerRightAction;                                  // 0x20A0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     PitchAction;                                       // 0x20B0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     PitchUpAction;                                     // 0x20C0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     PitchDownAction;                                   // 0x20D0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     RollAction;                                        // 0x20E0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     YawAction;                                         // 0x20F0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     DriftAction;                                       // 0x2100(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     JumpAction;                                        // 0x2110(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     KickFlipAction;                                    // 0x2120(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     UnderthrustAction;                                 // 0x2130(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     TurboAction;                                       // 0x2140(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     DelMarExitAction;                                  // 0x2150(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     ResetRunAction;                                    // 0x2160(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     AirFreestyleAction;                                // 0x2170(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     StrafeAction;                                      // 0x2180(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     AerialPitchAction;                                 // 0x2190(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarInputAction                     DemolishAction;                                    // 0x21A0(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class UDelMarPlayerInputManagerComponent> InputManagerClass;                                 // 0x21B0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21B8[0x18];                                    // 0x21B8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IdleVelocityLengthThreshold;                       // 0x21D0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class ADelMarRaceManager>      RaceManager;                                       // 0x21D4(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_21DC[0x4];                                     // 0x21DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UDelMarVehicleNetworkPhysicsComponent*  NetworkPhysicsComponent;                           // 0x21E0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarVehicleCosmeticComponent*        CosmeticComponent;                                 // 0x21E8(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_21F0[0x8];                                     // 0x21F0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UDelMarVehicleMovementSet*              DelMarVehicleMovementSet;                          // 0x21F8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortClientSettingsRecord*              FortSettings;                                      // 0x2200(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UDelMarTrackPositionComponent> TrackPositionComponentClass;                       // 0x2208(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarTrackPositionComponent*          TrackPositionComponent;                            // 0x2210(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FDelMarVehicleCachedContact>    CachedContacts;                                    // 0x2218(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	float                                         NearbyTrackDistanceThreshold;                      // 0x2228(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_222C[0x6C];                                    // 0x222C(0x006C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarVehicleConfigOverrides          ConfigOverrides;                                   // 0x2298(0x0084)(Net, Transient, RepNotify, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_231C[0x48];                                    // 0x231C(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VisualSteerAngleInterpRate;                        // 0x2364(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         DriftVisualSteerAngleInterpRate;                   // 0x2368(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bOverrideVisualSteeringAngle;                      // 0x236C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_236D[0x3];                                     // 0x236D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DrivingVisualSteeringDegrees;                      // 0x2370(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2374[0x4];                                     // 0x2374(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarScaledCurve                     DriftSteeringDegreesCurve;                         // 0x2378(0x0090)(Edit, Protected, NativeAccessSpecifierProtected)
	bool                                          bShowVisualSteerAngleInAir;                        // 0x2408(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2409[0x7];                                     // 0x2409(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UDelMarVehicleBodySetup*                BodySetup;                                         // 0x2410(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UDelMarRaceConfigComponent> ActiveRaceConfig;                                  // 0x2418(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UDelMarTimeManagerComponent> RaceTimeManager;                                   // 0x2420(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UDelMarGlobalInputDisabler> GlobalInputDisabler;                               // 0x2428(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2430[0x10];                                    // 0x2430(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnVehicleWheelsLeftGround;                         // 0x2440(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSpeedometerSpeedChanged;                         // 0x2450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	float                                         MinNoThrottleSpeed;                                // 0x2460(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpeedSlowdownSpeedometerSeconds;                   // 0x2464(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTag>                   SpeedSlowdownTags;                                 // 0x2468(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EDelMarInvertSteerMethod                      InvertSteerMethod;                                 // 0x2478(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPitchInverted;                                    // 0x2479(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVerticalKickflipInverted;                         // 0x247A(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAerialPitchActivationEnabled;                     // 0x247B(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_247C[0x34];                                    // 0x247C(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnBonusSpeedActivated;                             // 0x24B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBonusSpeedDeactivated;                           // 0x24C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBonusSpeedChanged;                               // 0x24D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnyWheelsOnGroundChanged;                        // 0x24E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWheelsOnGroundChanged;                           // 0x24F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleForwardStateChanged;                      // 0x2500(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2510[0xC0];                                    // 0x2510(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitWall;                            // 0x25D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitVehicle;                         // 0x25E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitByVehicle;                       // 0x25F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleLanded;                                   // 0x2600(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2610[0x10];                                    // 0x2610(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnWorldBonusSpeedStackGained;                      // 0x2620(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWorldBonusSpeedStackLost;                        // 0x2630(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bEnforceSpeedAdjustmentChecks;                     // 0x2640(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnforceTargetSpeedAdjustmentChecks;               // 0x2641(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2642[0x6E];                                    // 0x2642(0x006E)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnVehicleStartedSkydiving;                         // 0x26B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleStoppedSkydiving;                         // 0x26C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_26D0[0x8];                                     // 0x26D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnDriftActivated;                                  // 0x26D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftDeactivated;                                // 0x26E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftSlipAngleRatioChanged;                      // 0x26F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftKickActivated;                              // 0x2708(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftKickDeactivated;                            // 0x2718(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftControlChanged;                             // 0x2728(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftDurationChanged;                            // 0x2738(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2748[0x40];                                    // 0x2748(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnEnteredDriftBoostRange;                          // 0x2788(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnExitedDriftBoostRange;                           // 0x2798(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartedLosingAppliedDriftBoost;                  // 0x27A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftBoostActivated;                             // 0x27B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDriftBoostDeactivated;                           // 0x27C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMaxPotentialReached;                             // 0x27D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMaxPotentialLost;                                // 0x27E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAllPotentialLost;                                // 0x27F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEarnedDriftBoost;                                // 0x2808(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPotentialDriftBoostChanged;                      // 0x2818(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2828[0x38];                                    // 0x2828(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnDraftActivated;                                  // 0x2860(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDraftDeactivated;                                // 0x2870(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDraftStateChanged;                               // 0x2880(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnReachedMaxBonusSpeed;                            // 0x2890(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_28A0[0x2C];                                    // 0x28A0(0x002C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarRubberbandingConfig             RubberbandingConfig;                               // 0x28CC(0x0028)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_28F4[0x34];                                    // 0x28F4(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnStartlineBoostActivated;                         // 0x2928(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartlineBoostDeactivated;                       // 0x2938(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartlineBoostFailed;                            // 0x2948(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FDelMarStartlineBoostData              StartlineBoostData;                                // 0x2958(0x0010)(Net, Transient, RepNotify, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2968[0x20];                                    // 0x2968(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnStrafeActivated;                                 // 0x2988(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStrafeDeactivated;                               // 0x2998(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStrafeCooldownChanged;                           // 0x29A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStrafeUsabilityChanged;                          // 0x29B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStrafeDisabledChanged;                           // 0x29C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_29D8[0x20];                                    // 0x29D8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnTurboActivated;                                  // 0x29F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTurboDeactivated;                                // 0x2A08(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTurboChargesUpdated;                             // 0x2A18(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTurboBonusZoneStateChanged;                      // 0x2A28(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTurboChargeUsed;                                 // 0x2A38(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	float                                         TurboCharges;                                      // 0x2A48(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A4C[0x44];                                    // 0x2A4C(0x0044)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnKickflipActivated;                               // 0x2A90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipDeactivated;                             // 0x2AA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipSuctionActivated;                        // 0x2AB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipSuctionDeactivated;                      // 0x2AC0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipDistanceToSuctionSurfaceChanged;         // 0x2AD0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipDurationChanged;                         // 0x2AE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKickflipActivationChargesChanged;                // 0x2AF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B00[0x88];                                    // 0x2B00(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnReattachmentActivated;                           // 0x2B88(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnReattachmentDeactivated;                         // 0x2B98(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FVector                                ForcedReattachmentDirection;                       // 0x2BA8(0x0018)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2BC0[0x28];                                    // 0x2BC0(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnUnderthrustActivated;                            // 0x2BE8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnderthrustDeactivated;                          // 0x2BF8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnderthrustPercentChanged;                       // 0x2C08(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C18[0x10];                                    // 0x2C18(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnJumpActivated;                                   // 0x2C28(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJumpDeactivated;                                 // 0x2C38(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C48[0x8];                                     // 0x2C48(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DemolitionRespawnSeconds;                          // 0x2C50(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C54[0x4];                                     // 0x2C54(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnVehicleDemolished;                               // 0x2C58(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDemolishPressDurationUpdated;                    // 0x2C68(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C78[0x18];                                    // 0x2C78(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnHazardHit;                                       // 0x2C90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInvulnerabilityActivated;                        // 0x2CA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInvulnerabilityDeactivated;                      // 0x2CB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CC0[0x4];                                     // 0x2CC0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxSpawnBroadcastSeconds;                          // 0x2CC4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDelMarVehicleSpawnInfo                SpawnInfo;                                         // 0x2CC8(0x0010)(Net, Transient, RepNotify, NoDestructor, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDelMarVehicleSpawned;                            // 0x2CD8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bAllowExitingVehicle;                              // 0x2CE8(0x0001)(Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CE9[0x7];                                     // 0x2CE9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnVehicleTeleportEntered;                          // 0x2CF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleTeleportExit;                             // 0x2D00(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleAppliedTeleportRotation;                  // 0x2D10(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAirFreestyleActivated;                           // 0x2D20(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAirFreestyleDeactivated;                         // 0x2D30(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D40[0x8];                                     // 0x2D40(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarAudioController*                 CachedVehicleAudioController;                      // 0x2D48(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVehicleCollisionsEnabled;                         // 0x2D50(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPawnCollisionsEnabled;                            // 0x2D51(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D52[0xE];                                     // 0x2D52(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUsePredictiveInterpolation;                       // 0x2D60(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D61[0x7];                                     // 0x2D61(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPostProcessComponent*                  PostProcessComp;                                   // 0x2D68(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D70[0x10];                                    // 0x2D70(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ADelMarVehicle) == 0x002D80, "Wrong size on ADelMarVehicle");
static_assert(offsetof(ADelMarVehicle, DelMarCameraModes) == 0x001FF0, "Member 'ADelMarVehicle::DelMarCameraModes' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bLocalDriverHasReplicatedVehicle) == 0x002000, "Member 'ADelMarVehicle::bLocalDriverHasReplicatedVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, PendingDriverInputState) == 0x002010, "Member 'ADelMarVehicle::PendingDriverInputState' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DistanceToPack) == 0x002050, "Member 'ADelMarVehicle::DistanceToPack' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DistanceFromTrackFinish) == 0x002054, "Member 'ADelMarVehicle::DistanceFromTrackFinish' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ATTR_bVehicleThrottleDisabled) == 0x002058, "Member 'ADelMarVehicle::ATTR_bVehicleThrottleDisabled' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ThrottleAction) == 0x002060, "Member 'ADelMarVehicle::ThrottleAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, BrakeAction) == 0x002070, "Member 'ADelMarVehicle::BrakeAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SteerAction) == 0x002080, "Member 'ADelMarVehicle::SteerAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SteerLeftAction) == 0x002090, "Member 'ADelMarVehicle::SteerLeftAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SteerRightAction) == 0x0020A0, "Member 'ADelMarVehicle::SteerRightAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, PitchAction) == 0x0020B0, "Member 'ADelMarVehicle::PitchAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, PitchUpAction) == 0x0020C0, "Member 'ADelMarVehicle::PitchUpAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, PitchDownAction) == 0x0020D0, "Member 'ADelMarVehicle::PitchDownAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, RollAction) == 0x0020E0, "Member 'ADelMarVehicle::RollAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, YawAction) == 0x0020F0, "Member 'ADelMarVehicle::YawAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DriftAction) == 0x002100, "Member 'ADelMarVehicle::DriftAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, JumpAction) == 0x002110, "Member 'ADelMarVehicle::JumpAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, KickFlipAction) == 0x002120, "Member 'ADelMarVehicle::KickFlipAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, UnderthrustAction) == 0x002130, "Member 'ADelMarVehicle::UnderthrustAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, TurboAction) == 0x002140, "Member 'ADelMarVehicle::TurboAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DelMarExitAction) == 0x002150, "Member 'ADelMarVehicle::DelMarExitAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ResetRunAction) == 0x002160, "Member 'ADelMarVehicle::ResetRunAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, AirFreestyleAction) == 0x002170, "Member 'ADelMarVehicle::AirFreestyleAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, StrafeAction) == 0x002180, "Member 'ADelMarVehicle::StrafeAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, AerialPitchAction) == 0x002190, "Member 'ADelMarVehicle::AerialPitchAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DemolishAction) == 0x0021A0, "Member 'ADelMarVehicle::DemolishAction' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, InputManagerClass) == 0x0021B0, "Member 'ADelMarVehicle::InputManagerClass' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, IdleVelocityLengthThreshold) == 0x0021D0, "Member 'ADelMarVehicle::IdleVelocityLengthThreshold' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, RaceManager) == 0x0021D4, "Member 'ADelMarVehicle::RaceManager' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, NetworkPhysicsComponent) == 0x0021E0, "Member 'ADelMarVehicle::NetworkPhysicsComponent' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, CosmeticComponent) == 0x0021E8, "Member 'ADelMarVehicle::CosmeticComponent' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DelMarVehicleMovementSet) == 0x0021F8, "Member 'ADelMarVehicle::DelMarVehicleMovementSet' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, FortSettings) == 0x002200, "Member 'ADelMarVehicle::FortSettings' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, TrackPositionComponentClass) == 0x002208, "Member 'ADelMarVehicle::TrackPositionComponentClass' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, TrackPositionComponent) == 0x002210, "Member 'ADelMarVehicle::TrackPositionComponent' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, CachedContacts) == 0x002218, "Member 'ADelMarVehicle::CachedContacts' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, NearbyTrackDistanceThreshold) == 0x002228, "Member 'ADelMarVehicle::NearbyTrackDistanceThreshold' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ConfigOverrides) == 0x002298, "Member 'ADelMarVehicle::ConfigOverrides' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, VisualSteerAngleInterpRate) == 0x002364, "Member 'ADelMarVehicle::VisualSteerAngleInterpRate' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DriftVisualSteerAngleInterpRate) == 0x002368, "Member 'ADelMarVehicle::DriftVisualSteerAngleInterpRate' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bOverrideVisualSteeringAngle) == 0x00236C, "Member 'ADelMarVehicle::bOverrideVisualSteeringAngle' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DrivingVisualSteeringDegrees) == 0x002370, "Member 'ADelMarVehicle::DrivingVisualSteeringDegrees' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DriftSteeringDegreesCurve) == 0x002378, "Member 'ADelMarVehicle::DriftSteeringDegreesCurve' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bShowVisualSteerAngleInAir) == 0x002408, "Member 'ADelMarVehicle::bShowVisualSteerAngleInAir' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, BodySetup) == 0x002410, "Member 'ADelMarVehicle::BodySetup' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ActiveRaceConfig) == 0x002418, "Member 'ADelMarVehicle::ActiveRaceConfig' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, RaceTimeManager) == 0x002420, "Member 'ADelMarVehicle::RaceTimeManager' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, GlobalInputDisabler) == 0x002428, "Member 'ADelMarVehicle::GlobalInputDisabler' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleWheelsLeftGround) == 0x002440, "Member 'ADelMarVehicle::OnVehicleWheelsLeftGround' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnSpeedometerSpeedChanged) == 0x002450, "Member 'ADelMarVehicle::OnSpeedometerSpeedChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, MinNoThrottleSpeed) == 0x002460, "Member 'ADelMarVehicle::MinNoThrottleSpeed' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SpeedSlowdownSpeedometerSeconds) == 0x002464, "Member 'ADelMarVehicle::SpeedSlowdownSpeedometerSeconds' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SpeedSlowdownTags) == 0x002468, "Member 'ADelMarVehicle::SpeedSlowdownTags' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, InvertSteerMethod) == 0x002478, "Member 'ADelMarVehicle::InvertSteerMethod' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bPitchInverted) == 0x002479, "Member 'ADelMarVehicle::bPitchInverted' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bVerticalKickflipInverted) == 0x00247A, "Member 'ADelMarVehicle::bVerticalKickflipInverted' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bAerialPitchActivationEnabled) == 0x00247B, "Member 'ADelMarVehicle::bAerialPitchActivationEnabled' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnBonusSpeedActivated) == 0x0024B0, "Member 'ADelMarVehicle::OnBonusSpeedActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnBonusSpeedDeactivated) == 0x0024C0, "Member 'ADelMarVehicle::OnBonusSpeedDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnBonusSpeedChanged) == 0x0024D0, "Member 'ADelMarVehicle::OnBonusSpeedChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnAnyWheelsOnGroundChanged) == 0x0024E0, "Member 'ADelMarVehicle::OnAnyWheelsOnGroundChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnWheelsOnGroundChanged) == 0x0024F0, "Member 'ADelMarVehicle::OnWheelsOnGroundChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleForwardStateChanged) == 0x002500, "Member 'ADelMarVehicle::OnVehicleForwardStateChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDelMarVehicleHitWall) == 0x0025D0, "Member 'ADelMarVehicle::OnDelMarVehicleHitWall' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDelMarVehicleHitVehicle) == 0x0025E0, "Member 'ADelMarVehicle::OnDelMarVehicleHitVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDelMarVehicleHitByVehicle) == 0x0025F0, "Member 'ADelMarVehicle::OnDelMarVehicleHitByVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleLanded) == 0x002600, "Member 'ADelMarVehicle::OnVehicleLanded' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnWorldBonusSpeedStackGained) == 0x002620, "Member 'ADelMarVehicle::OnWorldBonusSpeedStackGained' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnWorldBonusSpeedStackLost) == 0x002630, "Member 'ADelMarVehicle::OnWorldBonusSpeedStackLost' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bEnforceSpeedAdjustmentChecks) == 0x002640, "Member 'ADelMarVehicle::bEnforceSpeedAdjustmentChecks' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bEnforceTargetSpeedAdjustmentChecks) == 0x002641, "Member 'ADelMarVehicle::bEnforceTargetSpeedAdjustmentChecks' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleStartedSkydiving) == 0x0026B0, "Member 'ADelMarVehicle::OnVehicleStartedSkydiving' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleStoppedSkydiving) == 0x0026C0, "Member 'ADelMarVehicle::OnVehicleStoppedSkydiving' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftActivated) == 0x0026D8, "Member 'ADelMarVehicle::OnDriftActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftDeactivated) == 0x0026E8, "Member 'ADelMarVehicle::OnDriftDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftSlipAngleRatioChanged) == 0x0026F8, "Member 'ADelMarVehicle::OnDriftSlipAngleRatioChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftKickActivated) == 0x002708, "Member 'ADelMarVehicle::OnDriftKickActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftKickDeactivated) == 0x002718, "Member 'ADelMarVehicle::OnDriftKickDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftControlChanged) == 0x002728, "Member 'ADelMarVehicle::OnDriftControlChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftDurationChanged) == 0x002738, "Member 'ADelMarVehicle::OnDriftDurationChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnEnteredDriftBoostRange) == 0x002788, "Member 'ADelMarVehicle::OnEnteredDriftBoostRange' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnExitedDriftBoostRange) == 0x002798, "Member 'ADelMarVehicle::OnExitedDriftBoostRange' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStartedLosingAppliedDriftBoost) == 0x0027A8, "Member 'ADelMarVehicle::OnStartedLosingAppliedDriftBoost' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftBoostActivated) == 0x0027B8, "Member 'ADelMarVehicle::OnDriftBoostActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDriftBoostDeactivated) == 0x0027C8, "Member 'ADelMarVehicle::OnDriftBoostDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnMaxPotentialReached) == 0x0027D8, "Member 'ADelMarVehicle::OnMaxPotentialReached' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnMaxPotentialLost) == 0x0027E8, "Member 'ADelMarVehicle::OnMaxPotentialLost' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnAllPotentialLost) == 0x0027F8, "Member 'ADelMarVehicle::OnAllPotentialLost' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnEarnedDriftBoost) == 0x002808, "Member 'ADelMarVehicle::OnEarnedDriftBoost' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnPotentialDriftBoostChanged) == 0x002818, "Member 'ADelMarVehicle::OnPotentialDriftBoostChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDraftActivated) == 0x002860, "Member 'ADelMarVehicle::OnDraftActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDraftDeactivated) == 0x002870, "Member 'ADelMarVehicle::OnDraftDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDraftStateChanged) == 0x002880, "Member 'ADelMarVehicle::OnDraftStateChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnReachedMaxBonusSpeed) == 0x002890, "Member 'ADelMarVehicle::OnReachedMaxBonusSpeed' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, RubberbandingConfig) == 0x0028CC, "Member 'ADelMarVehicle::RubberbandingConfig' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStartlineBoostActivated) == 0x002928, "Member 'ADelMarVehicle::OnStartlineBoostActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStartlineBoostDeactivated) == 0x002938, "Member 'ADelMarVehicle::OnStartlineBoostDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStartlineBoostFailed) == 0x002948, "Member 'ADelMarVehicle::OnStartlineBoostFailed' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, StartlineBoostData) == 0x002958, "Member 'ADelMarVehicle::StartlineBoostData' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStrafeActivated) == 0x002988, "Member 'ADelMarVehicle::OnStrafeActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStrafeDeactivated) == 0x002998, "Member 'ADelMarVehicle::OnStrafeDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStrafeCooldownChanged) == 0x0029A8, "Member 'ADelMarVehicle::OnStrafeCooldownChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStrafeUsabilityChanged) == 0x0029B8, "Member 'ADelMarVehicle::OnStrafeUsabilityChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnStrafeDisabledChanged) == 0x0029C8, "Member 'ADelMarVehicle::OnStrafeDisabledChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnTurboActivated) == 0x0029F8, "Member 'ADelMarVehicle::OnTurboActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnTurboDeactivated) == 0x002A08, "Member 'ADelMarVehicle::OnTurboDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnTurboChargesUpdated) == 0x002A18, "Member 'ADelMarVehicle::OnTurboChargesUpdated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnTurboBonusZoneStateChanged) == 0x002A28, "Member 'ADelMarVehicle::OnTurboBonusZoneStateChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnTurboChargeUsed) == 0x002A38, "Member 'ADelMarVehicle::OnTurboChargeUsed' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, TurboCharges) == 0x002A48, "Member 'ADelMarVehicle::TurboCharges' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipActivated) == 0x002A90, "Member 'ADelMarVehicle::OnKickflipActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipDeactivated) == 0x002AA0, "Member 'ADelMarVehicle::OnKickflipDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipSuctionActivated) == 0x002AB0, "Member 'ADelMarVehicle::OnKickflipSuctionActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipSuctionDeactivated) == 0x002AC0, "Member 'ADelMarVehicle::OnKickflipSuctionDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipDistanceToSuctionSurfaceChanged) == 0x002AD0, "Member 'ADelMarVehicle::OnKickflipDistanceToSuctionSurfaceChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipDurationChanged) == 0x002AE0, "Member 'ADelMarVehicle::OnKickflipDurationChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnKickflipActivationChargesChanged) == 0x002AF0, "Member 'ADelMarVehicle::OnKickflipActivationChargesChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnReattachmentActivated) == 0x002B88, "Member 'ADelMarVehicle::OnReattachmentActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnReattachmentDeactivated) == 0x002B98, "Member 'ADelMarVehicle::OnReattachmentDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, ForcedReattachmentDirection) == 0x002BA8, "Member 'ADelMarVehicle::ForcedReattachmentDirection' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnUnderthrustActivated) == 0x002BE8, "Member 'ADelMarVehicle::OnUnderthrustActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnUnderthrustDeactivated) == 0x002BF8, "Member 'ADelMarVehicle::OnUnderthrustDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnUnderthrustPercentChanged) == 0x002C08, "Member 'ADelMarVehicle::OnUnderthrustPercentChanged' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnJumpActivated) == 0x002C28, "Member 'ADelMarVehicle::OnJumpActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnJumpDeactivated) == 0x002C38, "Member 'ADelMarVehicle::OnJumpDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, DemolitionRespawnSeconds) == 0x002C50, "Member 'ADelMarVehicle::DemolitionRespawnSeconds' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleDemolished) == 0x002C58, "Member 'ADelMarVehicle::OnVehicleDemolished' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDemolishPressDurationUpdated) == 0x002C68, "Member 'ADelMarVehicle::OnDemolishPressDurationUpdated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnHazardHit) == 0x002C90, "Member 'ADelMarVehicle::OnHazardHit' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnInvulnerabilityActivated) == 0x002CA0, "Member 'ADelMarVehicle::OnInvulnerabilityActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnInvulnerabilityDeactivated) == 0x002CB0, "Member 'ADelMarVehicle::OnInvulnerabilityDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, MaxSpawnBroadcastSeconds) == 0x002CC4, "Member 'ADelMarVehicle::MaxSpawnBroadcastSeconds' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, SpawnInfo) == 0x002CC8, "Member 'ADelMarVehicle::SpawnInfo' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnDelMarVehicleSpawned) == 0x002CD8, "Member 'ADelMarVehicle::OnDelMarVehicleSpawned' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bAllowExitingVehicle) == 0x002CE8, "Member 'ADelMarVehicle::bAllowExitingVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleTeleportEntered) == 0x002CF0, "Member 'ADelMarVehicle::OnVehicleTeleportEntered' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleTeleportExit) == 0x002D00, "Member 'ADelMarVehicle::OnVehicleTeleportExit' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnVehicleAppliedTeleportRotation) == 0x002D10, "Member 'ADelMarVehicle::OnVehicleAppliedTeleportRotation' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnAirFreestyleActivated) == 0x002D20, "Member 'ADelMarVehicle::OnAirFreestyleActivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, OnAirFreestyleDeactivated) == 0x002D30, "Member 'ADelMarVehicle::OnAirFreestyleDeactivated' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, CachedVehicleAudioController) == 0x002D48, "Member 'ADelMarVehicle::CachedVehicleAudioController' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bVehicleCollisionsEnabled) == 0x002D50, "Member 'ADelMarVehicle::bVehicleCollisionsEnabled' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bPawnCollisionsEnabled) == 0x002D51, "Member 'ADelMarVehicle::bPawnCollisionsEnabled' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, bUsePredictiveInterpolation) == 0x002D60, "Member 'ADelMarVehicle::bUsePredictiveInterpolation' has a wrong offset!");
static_assert(offsetof(ADelMarVehicle, PostProcessComp) == 0x002D68, "Member 'ADelMarVehicle::PostProcessComp' has a wrong offset!");
...
static_assert(offsetof(ADelMarCompetitiveRaceManager, FinishRaceAfterFirstPlayerFinishedSeconds) == 0x0004A8, "Member 'ADelMarCompetitiveRaceManager::FinishRaceAfterFirstPlayerFinishedSeconds' has a wrong offset!");
static_assert(offsetof(ADelMarCompetitiveRaceManager, FirstPlayerFinishedTimestamp) == 0x0004B8, "Member 'ADelMarCompetitiveRaceManager::FirstPlayerFinishedTimestamp' has a wrong offset!");
...
static_assert(offsetof(UDelMarMatchEventSystemComponent, EnabledMatchEventTags) == 0x0000B8, "Member 'UDelMarMatchEventSystemComponent::EnabledMatchEventTags' has a wrong offset!");
...
{
public:
	class UDelMarTutorialConfigComponent*         TutorialConfigComponent;                           // 0x04A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ADelMarTutorialRaceManager) == 0x0004B0, "Wrong size on ADelMarTutorialRaceManager");
static_assert(offsetof(ADelMarTutorialRaceManager, TutorialConfigComponent) == 0x0004A8, "Member 'ADelMarTutorialRaceManager::TutorialConfigComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_27B0[0x930];                                   // 0x27B0(0x0930)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDelMarVehicleCameraMode_V2) == 0x0030E0, "Wrong size on UDelMarVehicleCameraMode_V2");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnBigAirStarted;                                   // 0x0350(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBigAirStopped;                                   // 0x0360(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x0198 (0x0D70 - 0x0BD8)
class alignas(0x10) ADelMarCheckpoint final : public AFortCreativeDeviceProp
{
public:
	FMulticastInlineDelegateProperty_             OnCheckpointTirggeredEvent;                        // 0x0BD8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         bIsFinishLine : 1;                                 // 0x0BE8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIsStartingLine : 1;                               // 0x0BE8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIsTimeTrialSectionEnd : 1;                        // 0x0BE8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIsTeleportEnabled : 1;                            // 0x0BE8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_BE9[0x7];                                      // 0x0BE9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class ADelMarCheckpoint*>                NextCheckpoints;                                   // 0x0BF0(0x0050)(Edit, DisableEditOnTemplate, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	float                                         DynamicSpawnOffset;                                // 0x0C40(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SpawnDistanceBeforeOrAfterSplineLocation;          // 0x0C44(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BaseRadius;                                        // 0x0C48(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CheckpointId;                                      // 0x0C4C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         SplinePointIndex;                                  // 0x0C50(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C54[0x4];                                      // 0x0C54(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarPlayerStart*                     SpawnPoint;                                        // 0x0C58(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarTrackSnapToComponent*            SnapToComponent;                                   // 0x0C60(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSet<class ADelMarCheckpoint*>                PreviousCheckpoints;                               // 0x0C68(0x0050)(Edit, EditConst, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FCheckpointTrackDistance               NearestTrack;                                      // 0x0CB8(0x0018)(BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FCheckpointTrackDistance>       AssociatedTracks;                                  // 0x0CD0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	int32                                         ComputedCheckpointIndex;                           // 0x0CE0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_CE4[0x4];                                      // 0x0CE4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMeshComponent*                   ColliderVolume;                                    // 0x0CE8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_CF0[0x70];                                     // 0x0CF0(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarCheckpoint*                      CheckpointToTeleportTo;                            // 0x0D60(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ADelMarCheckpoint) == 0x000D70, "Wrong size on ADelMarCheckpoint");
...
static_assert(offsetof(ADelMarCheckpoint, NextCheckpoints) == 0x000BF0, "Member 'ADelMarCheckpoint::NextCheckpoints' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, DynamicSpawnOffset) == 0x000C40, "Member 'ADelMarCheckpoint::DynamicSpawnOffset' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, SpawnDistanceBeforeOrAfterSplineLocation) == 0x000C44, "Member 'ADelMarCheckpoint::SpawnDistanceBeforeOrAfterSplineLocation' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, BaseRadius) == 0x000C48, "Member 'ADelMarCheckpoint::BaseRadius' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, CheckpointId) == 0x000C4C, "Member 'ADelMarCheckpoint::CheckpointId' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, SplinePointIndex) == 0x000C50, "Member 'ADelMarCheckpoint::SplinePointIndex' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, SpawnPoint) == 0x000C58, "Member 'ADelMarCheckpoint::SpawnPoint' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, SnapToComponent) == 0x000C60, "Member 'ADelMarCheckpoint::SnapToComponent' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, PreviousCheckpoints) == 0x000C68, "Member 'ADelMarCheckpoint::PreviousCheckpoints' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, NearestTrack) == 0x000CB8, "Member 'ADelMarCheckpoint::NearestTrack' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, AssociatedTracks) == 0x000CD0, "Member 'ADelMarCheckpoint::AssociatedTracks' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, ComputedCheckpointIndex) == 0x000CE0, "Member 'ADelMarCheckpoint::ComputedCheckpointIndex' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, ColliderVolume) == 0x000CE8, "Member 'ADelMarCheckpoint::ColliderVolume' has a wrong offset!");
static_assert(offsetof(ADelMarCheckpoint, CheckpointToTeleportTo) == 0x000D60, "Member 'ADelMarCheckpoint::CheckpointToTeleportTo' has a wrong offset!");
...
// 0x0620 (0x22E0 - 0x1CC0)
class UDelMarVehicleCameraMode final : public UFortCameraMode_AthenaVehicle
{
public:
	struct FDelMarVehicleCameraSettings           CameraSettings;                                    // 0x1CB8(0x001C)(Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1CD4[0x4];                                     // 0x1CD4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     VelocityViewDistance;                              // 0x1CD8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     VelocityFOV;                                       // 0x1D60(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AerialViewDistance;                                // 0x1DE8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AerialFocusOffset;                                 // 0x1E70(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AerialPitch;                                       // 0x1EF8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AccelViewDistance;                                 // 0x1F80(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AccelPitch;                                        // 0x2008(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     AirRotationInterpRate;                             // 0x2090(0x0088)(Edit, NativeAccessSpecifierPublic)
	float                                         DriftSwivelSpeed;                                  // 0x2118(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ViewDistanceInterpSpeed;                           // 0x211C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FOVInterpSpeed;                                    // 0x2120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AccelerationViewDistanceDecayRate;                 // 0x2124(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxAccumulatedAccelViewDistance;                   // 0x2128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinAccumulatedAccelViewDistance;                   // 0x212C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AerialOffsetInterpSpeed;                           // 0x2130(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumDownwardAerialPitch;                        // 0x2134(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumUpwardAerialPitch;                          // 0x2138(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AccelerationPitchDecayRate;                        // 0x213C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxAccumulatedAccelPitch;                          // 0x2140(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinAccumulatedAccelPitch;                          // 0x2144(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPreventSpeedIncreaseInAir;                        // 0x2148(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2149[0x3];                                     // 0x2149(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SpeedInputScalar;                                  // 0x214C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SwivelPitchMax;                                    // 0x2150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SwivelYawMax;                                      // 0x2154(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundPitchInterpRate;                             // 0x2158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundMaxPitchForNormalBlend;                      // 0x215C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundNormalInterpRate;                            // 0x2160(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundNormalAirInterpRate;                         // 0x2164(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundYawRateMin;                                  // 0x2168(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundYawRateMax;                                  // 0x216C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WallYawRateMin;                                    // 0x2170(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WallYawRateMax;                                    // 0x2174(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InterpToGroundTime;                                // 0x2178(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InterpToAirTime;                                   // 0x217C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AverageVelocityInterpRate;                         // 0x2180(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FocusOffsetInterpRate;                             // 0x2184(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceSpeedScale;                                // 0x2188(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceOffsetMin;                                 // 0x218C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceOffsetMax;                                 // 0x2190(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceInterpRate;                                // 0x2194(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxSpeedFOVOffset;                                 // 0x2198(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SupersonicFOVOffset;                               // 0x219C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FOVInterpRate;                                     // 0x21A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21A4[0x4];                                     // 0x21A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarVehicle*                         VehicleTarget;                                     // 0x21A8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21B0[0x130];                                   // 0x21B0(0x0130)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDelMarVehicleCameraMode) == 0x0022E0, "Wrong size on UDelMarVehicleCameraMode");
static_assert(offsetof(UDelMarVehicleCameraMode, CameraSettings) == 0x001CB8, "Member 'UDelMarVehicleCameraMode::CameraSettings' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, VelocityViewDistance) == 0x001CD8, "Member 'UDelMarVehicleCameraMode::VelocityViewDistance' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, VelocityFOV) == 0x001D60, "Member 'UDelMarVehicleCameraMode::VelocityFOV' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AerialViewDistance) == 0x001DE8, "Member 'UDelMarVehicleCameraMode::AerialViewDistance' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AerialFocusOffset) == 0x001E70, "Member 'UDelMarVehicleCameraMode::AerialFocusOffset' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AerialPitch) == 0x001EF8, "Member 'UDelMarVehicleCameraMode::AerialPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AccelViewDistance) == 0x001F80, "Member 'UDelMarVehicleCameraMode::AccelViewDistance' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AccelPitch) == 0x002008, "Member 'UDelMarVehicleCameraMode::AccelPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AirRotationInterpRate) == 0x002090, "Member 'UDelMarVehicleCameraMode::AirRotationInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, DriftSwivelSpeed) == 0x002118, "Member 'UDelMarVehicleCameraMode::DriftSwivelSpeed' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, ViewDistanceInterpSpeed) == 0x00211C, "Member 'UDelMarVehicleCameraMode::ViewDistanceInterpSpeed' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, FOVInterpSpeed) == 0x002120, "Member 'UDelMarVehicleCameraMode::FOVInterpSpeed' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AccelerationViewDistanceDecayRate) == 0x002124, "Member 'UDelMarVehicleCameraMode::AccelerationViewDistanceDecayRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MaxAccumulatedAccelViewDistance) == 0x002128, "Member 'UDelMarVehicleCameraMode::MaxAccumulatedAccelViewDistance' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MinAccumulatedAccelViewDistance) == 0x00212C, "Member 'UDelMarVehicleCameraMode::MinAccumulatedAccelViewDistance' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AerialOffsetInterpSpeed) == 0x002130, "Member 'UDelMarVehicleCameraMode::AerialOffsetInterpSpeed' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MaximumDownwardAerialPitch) == 0x002134, "Member 'UDelMarVehicleCameraMode::MaximumDownwardAerialPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MaximumUpwardAerialPitch) == 0x002138, "Member 'UDelMarVehicleCameraMode::MaximumUpwardAerialPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AccelerationPitchDecayRate) == 0x00213C, "Member 'UDelMarVehicleCameraMode::AccelerationPitchDecayRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MaxAccumulatedAccelPitch) == 0x002140, "Member 'UDelMarVehicleCameraMode::MaxAccumulatedAccelPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MinAccumulatedAccelPitch) == 0x002144, "Member 'UDelMarVehicleCameraMode::MinAccumulatedAccelPitch' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, bPreventSpeedIncreaseInAir) == 0x002148, "Member 'UDelMarVehicleCameraMode::bPreventSpeedIncreaseInAir' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, SpeedInputScalar) == 0x00214C, "Member 'UDelMarVehicleCameraMode::SpeedInputScalar' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, SwivelPitchMax) == 0x002150, "Member 'UDelMarVehicleCameraMode::SwivelPitchMax' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, SwivelYawMax) == 0x002154, "Member 'UDelMarVehicleCameraMode::SwivelYawMax' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundPitchInterpRate) == 0x002158, "Member 'UDelMarVehicleCameraMode::GroundPitchInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundMaxPitchForNormalBlend) == 0x00215C, "Member 'UDelMarVehicleCameraMode::GroundMaxPitchForNormalBlend' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundNormalInterpRate) == 0x002160, "Member 'UDelMarVehicleCameraMode::GroundNormalInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundNormalAirInterpRate) == 0x002164, "Member 'UDelMarVehicleCameraMode::GroundNormalAirInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundYawRateMin) == 0x002168, "Member 'UDelMarVehicleCameraMode::GroundYawRateMin' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, GroundYawRateMax) == 0x00216C, "Member 'UDelMarVehicleCameraMode::GroundYawRateMax' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, WallYawRateMin) == 0x002170, "Member 'UDelMarVehicleCameraMode::WallYawRateMin' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, WallYawRateMax) == 0x002174, "Member 'UDelMarVehicleCameraMode::WallYawRateMax' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, InterpToGroundTime) == 0x002178, "Member 'UDelMarVehicleCameraMode::InterpToGroundTime' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, InterpToAirTime) == 0x00217C, "Member 'UDelMarVehicleCameraMode::InterpToAirTime' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, AverageVelocityInterpRate) == 0x002180, "Member 'UDelMarVehicleCameraMode::AverageVelocityInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, FocusOffsetInterpRate) == 0x002184, "Member 'UDelMarVehicleCameraMode::FocusOffsetInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, DistanceSpeedScale) == 0x002188, "Member 'UDelMarVehicleCameraMode::DistanceSpeedScale' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, DistanceOffsetMin) == 0x00218C, "Member 'UDelMarVehicleCameraMode::DistanceOffsetMin' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, DistanceOffsetMax) == 0x002190, "Member 'UDelMarVehicleCameraMode::DistanceOffsetMax' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, DistanceInterpRate) == 0x002194, "Member 'UDelMarVehicleCameraMode::DistanceInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, MaxSpeedFOVOffset) == 0x002198, "Member 'UDelMarVehicleCameraMode::MaxSpeedFOVOffset' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, SupersonicFOVOffset) == 0x00219C, "Member 'UDelMarVehicleCameraMode::SupersonicFOVOffset' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, FOVInterpRate) == 0x0021A0, "Member 'UDelMarVehicleCameraMode::FOVInterpRate' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleCameraMode, VehicleTarget) == 0x0021A8, "Member 'UDelMarVehicleCameraMode::VehicleTarget' has a wrong offset!");
...
{
public:
	class UMaterial*                              GhostMaterial;                                     // 0x1F10(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ADelMarGhostVehicle) == 0x001F20, "Wrong size on ADelMarGhostVehicle");
static_assert(offsetof(ADelMarGhostVehicle, GhostMaterial) == 0x001F10, "Member 'ADelMarGhostVehicle::GhostMaterial' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           Slot;                                              // 0x0390(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_394[0x4];                                      // 0x0394(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSoftClassPtr<class UClass>>           CosmeticActorClasses;                              // 0x0398(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDelMarCosmeticItemDefinition) == 0x0003A8, "Wrong size on UDelMarCosmeticItemDefinition");
static_assert(offsetof(UDelMarCosmeticItemDefinition, Slot) == 0x000390, "Member 'UDelMarCosmeticItemDefinition::Slot' has a wrong offset!");
static_assert(offsetof(UDelMarCosmeticItemDefinition, CosmeticActorClasses) == 0x000398, "Member 'UDelMarCosmeticItemDefinition::CosmeticActorClasses' has a wrong offset!");
...
static_assert(sizeof(UDelMarVehicleBodyItemDefinition) == 0x0003A8, "Wrong size on UDelMarVehicleBodyItemDefinition");
...
public:
	...
	class FString                                 MRSLinkId;                                         // 0x0738(0x0010)(Net, ZeroConstructor, Transient, RepNotify, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_748[0x10];                                     // 0x0748(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UDelMarGameStateMachine*                PrimaryStateMachine;                               // 0x0758(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bShouldShowLoadingScreen;                          // 0x0760(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_761[0x3];                                      // 0x0761(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class ADelMarRaceManager>      ActiveRaceManager;                                 // 0x0764(0x0008)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UFortPlaylistAthena>     PlaylistData;                                      // 0x076C(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UDelMarLevelManagerComponent> LevelManager;                                      // 0x0774(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_77C[0x4];                                      // 0x077C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortLevelStreamComponent*              LevelStreamComponent;                              // 0x0780(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDelMarMapSet                          MapSet;                                            // 0x0788(0x0018)(Net, Transient, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  PlaylistDefinedMapTags;                            // 0x07A0(0x0020)(Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ADelMarPlayspace) == 0x0007E0, "Wrong size on ADelMarPlayspace");
...
static_assert(offsetof(ADelMarPlayspace, MRSLinkId) == 0x000738, "Member 'ADelMarPlayspace::MRSLinkId' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, PrimaryStateMachine) == 0x000758, "Member 'ADelMarPlayspace::PrimaryStateMachine' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, bShouldShowLoadingScreen) == 0x000760, "Member 'ADelMarPlayspace::bShouldShowLoadingScreen' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, ActiveRaceManager) == 0x000764, "Member 'ADelMarPlayspace::ActiveRaceManager' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, PlaylistData) == 0x00076C, "Member 'ADelMarPlayspace::PlaylistData' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, LevelManager) == 0x000774, "Member 'ADelMarPlayspace::LevelManager' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, LevelStreamComponent) == 0x000780, "Member 'ADelMarPlayspace::LevelStreamComponent' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, MapSet) == 0x000788, "Member 'ADelMarPlayspace::MapSet' has a wrong offset!");
static_assert(offsetof(ADelMarPlayspace, PlaylistDefinedMapTags) == 0x0007A0, "Member 'ADelMarPlayspace::PlaylistDefinedMapTags' has a wrong offset!");
...
static_assert(offsetof(ADelMarDeathRaceManager, NextRoundSeconds) == 0x0004A8, "Member 'ADelMarDeathRaceManager::NextRoundSeconds' has a wrong offset!");
static_assert(offsetof(ADelMarDeathRaceManager, DeathRaceConfigData) == 0x0004B0, "Member 'ADelMarDeathRaceManager::DeathRaceConfigData' has a wrong offset!");
static_assert(offsetof(ADelMarDeathRaceManager, NumPlayersFinished) == 0x0004D0, "Member 'ADelMarDeathRaceManager::NumPlayersFinished' has a wrong offset!");
...
public:
	...
	struct FDelMarVehicleConfig_Gravity           Gravity;                                           // 0x1AF0(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Jump              Jump;                                              // 0x1B10(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Kickflip          Kickflip;                                          // 0x1B28(0x0158)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleOversteerConfig          Oversteer;                                         // 0x1C80(0x0138)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Reattachment      Reattachment;                                      // 0x1DB8(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Rubberbanding     Rubberbanding;                                     // 0x1E58(0x01B8)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_StartlineBoost    StartlineBoost;                                    // 0x2010(0x00A8)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Strafe            Strafe;                                            // 0x20B8(0x001C)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_20D4[0x4];                                     // 0x20D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarVehicleTurboConfig              Turbo;                                             // 0x20D8(0x0070)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfig_Underthrust       Underthrust;                                       // 0x2148(0x00D8)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDelMarVehicleConfigs) == 0x002220, "Wrong size on UDelMarVehicleConfigs");
...
static_assert(offsetof(UDelMarVehicleConfigs, Jump) == 0x001B10, "Member 'UDelMarVehicleConfigs::Jump' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Kickflip) == 0x001B28, "Member 'UDelMarVehicleConfigs::Kickflip' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Oversteer) == 0x001C80, "Member 'UDelMarVehicleConfigs::Oversteer' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Reattachment) == 0x001DB8, "Member 'UDelMarVehicleConfigs::Reattachment' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Rubberbanding) == 0x001E58, "Member 'UDelMarVehicleConfigs::Rubberbanding' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, StartlineBoost) == 0x002010, "Member 'UDelMarVehicleConfigs::StartlineBoost' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Strafe) == 0x0020B8, "Member 'UDelMarVehicleConfigs::Strafe' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Turbo) == 0x0020D8, "Member 'UDelMarVehicleConfigs::Turbo' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleConfigs, Underthrust) == 0x002148, "Member 'UDelMarVehicleConfigs::Underthrust' has a wrong offset!");
...
static_assert(offsetof(UDelMarVehicleTurboManagerComponent, TurboCharges) == 0x0000A0, "Member 'UDelMarVehicleTurboManagerComponent::TurboCharges' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleTurboManagerComponent, RechargeRateSeconds) == 0x0000A4, "Member 'UDelMarVehicleTurboManagerComponent::RechargeRateSeconds' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleTurboManagerComponent, MaxCharges) == 0x0000A8, "Member 'UDelMarVehicleTurboManagerComponent::MaxCharges' has a wrong offset!");
static_assert(offsetof(UDelMarVehicleTurboManagerComponent, OwnerVehicle) == 0x0000B0, "Member 'UDelMarVehicleTurboManagerComponent::OwnerVehicle' has a wrong offset!");
