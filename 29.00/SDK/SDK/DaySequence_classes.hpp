...
public:
	...
	FMulticastInlineDelegateProperty_             OnPostReinitializeSubSequences;                    // 0x0318(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnPostEnableModifier;                              // 0x0328(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnVolumeBlendTargetOverlapBegin;                   // 0x0338(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnVolumeBlendTargetOverlapEnd;                     // 0x0348(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	TMap<class FName, struct FDaySequenceAssetData> DaySequences;                                      // 0x02A8(0x0050)(Edit, NativeAccessSpecifierPublic)
	TMap<class FName, struct FDaySequenceAssetData> TransientCollectionSequences;                      // 0x02F8(0x0050)(Transient, NativeAccessSpecifierPublic)
	class UDaySequenceCollectionAsset*            DaySequenceCollection;                             // 0x0348(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Bias;                                              // 0x0350(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_354[0x4];                                      // 0x0354(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieSceneBindingOverrides*            BindingOverrides;                                  // 0x0358(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bReplicatePlayback : 1;                            // 0x0360(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_361[0x7];                                      // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UDaySequencePlayer*                     SequencePlayer;                                    // 0x0368(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(ADaySequenceActor, DayInterpCurve) == 0x0002A0, "Member 'ADaySequenceActor::DayInterpCurve' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, DaySequences) == 0x0002A8, "Member 'ADaySequenceActor::DaySequences' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, TransientCollectionSequences) == 0x0002F8, "Member 'ADaySequenceActor::TransientCollectionSequences' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, DaySequenceCollection) == 0x000348, "Member 'ADaySequenceActor::DaySequenceCollection' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, Bias) == 0x000350, "Member 'ADaySequenceActor::Bias' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, BindingOverrides) == 0x000358, "Member 'ADaySequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ADaySequenceActor, SequencePlayer) == 0x000368, "Member 'ADaySequenceActor::SequencePlayer' has a wrong offset!");
