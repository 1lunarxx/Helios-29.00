...
public:
	...
	FMulticastInlineDelegateProperty_             OnCompletedEvaluationDelegate;                     // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)

public:
	void EvaluateAndEnablePointProviders();
	void OnCompletedEvaluation__DelegateSignature(const TArray<TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>>& EnabledPointProviders);
...
{
public:
	FMulticastInlineDelegateProperty_             OnActorSpawned;                                    // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFirstActorSpawned;                               // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnActorDestroyed;                                  // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLastActorDestroyed;                              // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnActorDied;                                       // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLastActorDied;                                   // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventSpawned;                                    // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnEventSpawned__DelegateSignature(const TArray<class AActor*>& SpawnedActors_0);
	void OnLastActorDied__DelegateSignature();
	void PauseEncounter();
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAllActorSpawnedDelegate;                         // 0x0850(0x0010)(ZeroConstructor, Transient, InstancedReference, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	void OnAllActorSpawnedDelegate__DelegateSignature(const TArray<class AActor*>& SpawnedActors_0);
	...
	void OnAllActorSpawned__DelegateSignature(const TArray<class AActor*>& SpawnedActors_0);
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorSpawnedDelegate;                            // 0x0390(0x0010)(ZeroConstructor, Transient, InstancedReference, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	void OnActorSpawnedDelegate__DelegateSignature(class AActor* SpawnedActor_0);
	void OnActorSpawned__DelegateSignature(class AActor* SpawnedActor_0);
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorSpawned;                                    // 0x0128(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorSpawned;                                    // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorSpawnedResult;                              // 0x0400(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnPointProviderRegistered;                         // 0x0410(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActorSpawnedResult;                              // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AFortAthenaPatrolPathPointProvider) == 0x000390, "Wrong size on AFortAthenaPatrolPathPointProvider");
