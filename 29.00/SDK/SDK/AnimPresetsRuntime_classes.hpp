...
static_assert(alignof(UAnimPresetComponent) == 0x000008, "Wrong alignment on UAnimPresetComponent");
static_assert(sizeof(UAnimPresetComponent) == 0x0000C0, "Wrong size on UAnimPresetComponent");
static_assert(offsetof(UAnimPresetComponent, AnimPreset) == 0x0000A0, "Member 'UAnimPresetComponent::AnimPreset' has a wrong offset!");
