...
// 0x0070 (0x2010 - 0x1FA0)
class AVehicleCosmeticsPreviewVehicle final : public AFortAthenaSKVehicle
{
public:
	uint8                                         Pad_1FA0[0x70];                                    // 0x1FA0(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AVehicleCosmeticsPreviewVehicle) == 0x002010, "Wrong size on AVehicleCosmeticsPreviewVehicle");
...
public:
	...
	TSoftObjectPtr<class UVehicleCosmeticsItemDefinition> VehicleCosmeticsItemDef;                           // 0x0750(0x0020)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           ItemTypeTag;                                       // 0x0770(0x0004)(Edit, DisableEditOnInstance, EditConst, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_774[0x4];                                      // 0x0774(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UVehicleCosmeticsPreviewConfigs> PreviewConfig;                                     // 0x0778(0x0020)(Config, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FVehicleCosmeticsRestrictionDefinition> RestrictionDefinitions;                            // 0x0798(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UFortVehicleCosmeticsItemDefinition> ItemPreviewVehicleBody;                            // 0x07A8(0x0020)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition");
static_assert(offsetof(UFortVehicleCosmeticsItemDefinition, VehicleCosmeticsItemDef) == 0x000750, "Member 'UFortVehicleCosmeticsItemDefinition::VehicleCosmeticsItemDef' has a wrong offset!");
static_assert(offsetof(UFortVehicleCosmeticsItemDefinition, ItemTypeTag) == 0x000770, "Member 'UFortVehicleCosmeticsItemDefinition::ItemTypeTag' has a wrong offset!");
static_assert(offsetof(UFortVehicleCosmeticsItemDefinition, PreviewConfig) == 0x000778, "Member 'UFortVehicleCosmeticsItemDefinition::PreviewConfig' has a wrong offset!");
static_assert(offsetof(UFortVehicleCosmeticsItemDefinition, RestrictionDefinitions) == 0x000798, "Member 'UFortVehicleCosmeticsItemDefinition::RestrictionDefinitions' has a wrong offset!");
static_assert(offsetof(UFortVehicleCosmeticsItemDefinition, ItemPreviewVehicleBody) == 0x0007A8, "Member 'UFortVehicleCosmeticsItemDefinition::ItemPreviewVehicleBody' has a wrong offset!");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_Body) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_Body");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_Booster) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_Booster");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_DriftTrail) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_DriftTrail");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_EngineAudio) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_EngineAudio");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_Skin) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_Skin");
...
static_assert(sizeof(UFortVehicleCosmeticsItemDefinition_Wheel) == 0x0007C8, "Wrong size on UFortVehicleCosmeticsItemDefinition_Wheel");
...
static_assert(sizeof(UFortVehicleCosmeticsVariantTokenType) == 0x0003C8, "Wrong size on UFortVehicleCosmeticsVariantTokenType");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnCosmeticActorSpawned;                            // 0x0580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	...
	FMulticastInlineDelegateProperty_             OnEngineAudioUpdated;                              // 0x05F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleCosmeticsFailed;                          // 0x0608(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_618[0x70];                                     // 0x0618(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVehicleCosmeticsAssembledMeshUserComponent) == 0x000688, "Wrong size on UVehicleCosmeticsAssembledMeshUserComponent");
...
static_assert(offsetof(UVehicleCosmeticsAssembledMeshUserComponent, OnVehicleCosmeticsFailed) == 0x000608, "Member 'UVehicleCosmeticsAssembledMeshUserComponent::OnVehicleCosmeticsFailed' has a wrong offset!");
