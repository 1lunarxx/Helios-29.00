...
public:
	...
	FMulticastInlineDelegateProperty_             OnCountdownTimeChanged;                            // 0x0370(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCountdownTimeSet;                                // 0x0380(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCountdownTimeEnded;                              // 0x0390(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class FText                                   DisplayName;                                       // 0x0030(0x0018)(Transient, NativeAccessSpecifierPublic)
	struct FKey                                   Key;                                               // 0x0048(0x0018)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDelMarInputActionRichTextBlockDecorator) == 0x000140, "Wrong size on UDelMarInputActionRichTextBlockDecorator");
...
static_assert(offsetof(UDelMarInputActionRichTextBlockDecorator, Key) == 0x000048, "Member 'UDelMarInputActionRichTextBlockDecorator::Key' has a wrong offset!");
...
static_assert(offsetof(UDelMarInputActionRichTextBlockDecorator, OwnerWidget) == 0x000120, "Member 'UDelMarInputActionRichTextBlockDecorator::OwnerWidget' has a wrong offset!");
static_assert(offsetof(UDelMarInputActionRichTextBlockDecorator, OwningLocalPlayer) == 0x000128, "Member 'UDelMarInputActionRichTextBlockDecorator::OwningLocalPlayer' has a wrong offset!");
static_assert(offsetof(UDelMarInputActionRichTextBlockDecorator, CommonInputSubsystem) == 0x000130, "Member 'UDelMarInputActionRichTextBlockDecorator::CommonInputSubsystem' has a wrong offset!");
static_assert(offsetof(UDelMarInputActionRichTextBlockDecorator, EnhancedInputSubsystem) == 0x000138, "Member 'UDelMarInputActionRichTextBlockDecorator::EnhancedInputSubsystem' has a wrong offset!");
...
public:
	...
	bool                                          bTreatNavigationAsScrolling;                       // 0x0BE0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDelMarListView) == 0x000BF0, "Wrong size on UDelMarListView");
static_assert(offsetof(UDelMarListView, bTreatNavigationAsScrolling) == 0x000BE0, "Member 'UDelMarListView::bTreatNavigationAsScrolling' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnMatchEventOccured;                               // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	void OnMatchEventOccured__DelegateSignature(class AFortPlayerState* PlayerState, const struct FGameplayTag& EventTag, const class FString& Context);
...
static_assert(sizeof(UDelMarMatchEventViewModel) == 0x000078, "Wrong size on UDelMarMatchEventViewModel");
static_assert(offsetof(UDelMarMatchEventViewModel, OnMatchEventOccured) == 0x000068, "Member 'UDelMarMatchEventViewModel::OnMatchEventOccured' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnExpandToggled;                                   // 0x03C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnNavigationEnabledChanged;                        // 0x03D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnExpandableChanged;                               // 0x03E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnHighlightChanged;                                // 0x03E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
{
public:
	FMulticastInlineDelegateProperty_             OnTransitionerStatusChanged;                       // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void WidgetTransitionerStatusChange__DelegateSignature(class UWidgetTransitioner* Transitioner, EWidgetTransitionerStatus Status);
...
{
public:
	FMulticastInlineDelegateProperty_             OnDisplayedPlayerSet;                              // 0x0360(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class UDelMarMatchEventViewModel*             MatchEventViewModel;                               // 0x0128(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarPlayerViewModel*                 LocalPlayer;                                       // 0x0130(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarPlayerViewModel*                 TargetPlayer;                                      // 0x0138(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TWeakObjectPtr<class ADelMarRaceManager>      RaceManager;                                       // 0x01E0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class AFortPlayerController>   LocalPlayerController;                             // 0x01E8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class AFortPlayerState>        ViewTargetPlayerState;                             // 0x01F0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UDelMarPositionalTrackerComponent> PositionalTrackerComponent;                        // 0x01F8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDelMarPlayerViewModel*                 EmptyPlayerViewModel;                              // 0x0200(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDelMarRaceViewModel) == 0x000208, "Wrong size on UDelMarRaceViewModel");
...
static_assert(offsetof(UDelMarRaceViewModel, MatchEventViewModel) == 0x000128, "Member 'UDelMarRaceViewModel::MatchEventViewModel' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, LocalPlayer) == 0x000130, "Member 'UDelMarRaceViewModel::LocalPlayer' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, TargetPlayer) == 0x000138, "Member 'UDelMarRaceViewModel::TargetPlayer' has a wrong offset!");
...
static_assert(offsetof(UDelMarRaceViewModel, RaceManager) == 0x0001E0, "Member 'UDelMarRaceViewModel::RaceManager' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, LocalPlayerController) == 0x0001E8, "Member 'UDelMarRaceViewModel::LocalPlayerController' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, ViewTargetPlayerState) == 0x0001F0, "Member 'UDelMarRaceViewModel::ViewTargetPlayerState' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, PositionalTrackerComponent) == 0x0001F8, "Member 'UDelMarRaceViewModel::PositionalTrackerComponent' has a wrong offset!");
static_assert(offsetof(UDelMarRaceViewModel, EmptyPlayerViewModel) == 0x000200, "Member 'UDelMarRaceViewModel::EmptyPlayerViewModel' has a wrong offset!");
