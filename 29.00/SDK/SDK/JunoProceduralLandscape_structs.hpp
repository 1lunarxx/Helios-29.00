...
public:
	...
	TArray<class FName>                           SerializedWeightmaps;                              // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_38[0x50];                                      // 0x0038(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FJunoLandscapeMaterialInstanceCacheKey, struct FJunoLandscapeComponentPrecachedDataLayers> PrecachedLayersMap;                                // 0x0088(0x0050)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FJunoLandscapeComponentPrecachedData) == 0x0000D8, "Wrong size on FJunoLandscapeComponentPrecachedData");
static_assert(offsetof(FJunoLandscapeComponentPrecachedData, SerializedWeightmaps) == 0x000028, "Member 'FJunoLandscapeComponentPrecachedData::SerializedWeightmaps' has a wrong offset!");
static_assert(offsetof(FJunoLandscapeComponentPrecachedData, PrecachedLayersMap) == 0x000088, "Member 'FJunoLandscapeComponentPrecachedData::PrecachedLayersMap' has a wrong offset!");
