...
{
public:
	class UCosmeticLoadoutSchema*                 VehicleLoadoutSchema;                              // 0x0180(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FPrimaryAssetType>              AllowedAssetTypes;                                 // 0x0188(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDelMarLockerCategoryConfig) == 0x000198, "Wrong size on UDelMarLockerCategoryConfig");
static_assert(offsetof(UDelMarLockerCategoryConfig, VehicleLoadoutSchema) == 0x000180, "Member 'UDelMarLockerCategoryConfig::VehicleLoadoutSchema' has a wrong offset!");
static_assert(offsetof(UDelMarLockerCategoryConfig, AllowedAssetTypes) == 0x000188, "Member 'UDelMarLockerCategoryConfig::AllowedAssetTypes' has a wrong offset!");
