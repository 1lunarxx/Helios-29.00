...
{
public:
	FMulticastInlineDelegateProperty_             OnWidgetCreated;                                   // 0x0220(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWidgetAdded;                                     // 0x0230(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnActiveOverridesChanged;                          // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnActiveOverridesChanged__DelegateSignature();
...
public:
	...
	FMulticastInlineDelegateProperty_             OnModulatedPropertyValueChanged;                   // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKnobRuntimeValueChanged;                         // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKnobSerializedValueChanged;                      // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFloatProviderConnectionChanged;                  // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	class FText                                   OverriddenTitle;                                   // 0x0300(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	bool                                          bCanBeModulated;                                   // 0x0318(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bKnobEnabled;                                      // 0x0319(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bKnobDisplayOnly;                                  // 0x031A(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_31B[0x5];                                      // 0x031B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class USceneComponent*                        ModulatorPortParent;                               // 0x0320(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFMDeviceCableModulatorPortComponent*   ModulatorPort;                                     // 0x0328(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0330(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	class UPlaylistUserOptionBase*                MyUserOption;                                      // 0x0350(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_358[0x8];                                      // 0x0358(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TWeakObjectPtr<class UFabricFloatProviderBase>> CurrentFloatProviders;                             // 0x0360(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	TWeakObjectPtr<class UFabricFloatProviderBase> ActiveFloatProvider;                               // 0x0370(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                        HitComponent;                                      // 0x0378(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TWeakObjectPtr<class APlayerController>       InteractingController;                             // 0x0380(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EFabricInteractableType                       InteractableType;                                  // 0x0388(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_389[0x3];                                      // 0x0389(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UFabricInteractableViewModel> WidgetViewModel;                                   // 0x038C(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_394[0x4];                                      // 0x0394(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FText>                           OverrideLabels;                                    // 0x0398(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<class FText>                           OptionLabels;                                      // 0x03A8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<class FString>                         OptionValues;                                      // 0x03B8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, AdvancedDisplay, NativeAccessSpecifierPrivate)
	int32                                         SerializedOptionIndex;                             // 0x03C8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         CurrentOptionIndex;                                // 0x03CC(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ClampedKnobValue;                                  // 0x03D0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bTrackingInput;                                    // 0x03D4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsVisibilityBound;                                // 0x03D5(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3D6[0x2];                                      // 0x03D6(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFMInWorldKnobActorBase) == 0x0003D8, "Wrong size on AFMInWorldKnobActorBase");
static_assert(offsetof(AFMInWorldKnobActorBase, OnModulatedPropertyValueChanged) == 0x0002B0, "Member 'AFMInWorldKnobActorBase::OnModulatedPropertyValueChanged' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OnKnobRuntimeValueChanged) == 0x0002C0, "Member 'AFMInWorldKnobActorBase::OnKnobRuntimeValueChanged' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OnKnobSerializedValueChanged) == 0x0002D0, "Member 'AFMInWorldKnobActorBase::OnKnobSerializedValueChanged' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OnFloatProviderConnectionChanged) == 0x0002E0, "Member 'AFMInWorldKnobActorBase::OnFloatProviderConnectionChanged' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OptionKey) == 0x0002F0, "Member 'AFMInWorldKnobActorBase::OptionKey' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OverriddenTitle) == 0x000300, "Member 'AFMInWorldKnobActorBase::OverriddenTitle' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, bCanBeModulated) == 0x000318, "Member 'AFMInWorldKnobActorBase::bCanBeModulated' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, bKnobEnabled) == 0x000319, "Member 'AFMInWorldKnobActorBase::bKnobEnabled' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, bKnobDisplayOnly) == 0x00031A, "Member 'AFMInWorldKnobActorBase::bKnobDisplayOnly' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, ModulatorPortParent) == 0x000320, "Member 'AFMInWorldKnobActorBase::ModulatorPortParent' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, ModulatorPort) == 0x000328, "Member 'AFMInWorldKnobActorBase::ModulatorPort' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, GameplayTags) == 0x000330, "Member 'AFMInWorldKnobActorBase::GameplayTags' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, MyUserOption) == 0x000350, "Member 'AFMInWorldKnobActorBase::MyUserOption' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, CurrentFloatProviders) == 0x000360, "Member 'AFMInWorldKnobActorBase::CurrentFloatProviders' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, ActiveFloatProvider) == 0x000370, "Member 'AFMInWorldKnobActorBase::ActiveFloatProvider' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, HitComponent) == 0x000378, "Member 'AFMInWorldKnobActorBase::HitComponent' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, InteractingController) == 0x000380, "Member 'AFMInWorldKnobActorBase::InteractingController' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, InteractableType) == 0x000388, "Member 'AFMInWorldKnobActorBase::InteractableType' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, WidgetViewModel) == 0x00038C, "Member 'AFMInWorldKnobActorBase::WidgetViewModel' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OverrideLabels) == 0x000398, "Member 'AFMInWorldKnobActorBase::OverrideLabels' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OptionLabels) == 0x0003A8, "Member 'AFMInWorldKnobActorBase::OptionLabels' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, OptionValues) == 0x0003B8, "Member 'AFMInWorldKnobActorBase::OptionValues' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, SerializedOptionIndex) == 0x0003C8, "Member 'AFMInWorldKnobActorBase::SerializedOptionIndex' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, CurrentOptionIndex) == 0x0003CC, "Member 'AFMInWorldKnobActorBase::CurrentOptionIndex' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, ClampedKnobValue) == 0x0003D0, "Member 'AFMInWorldKnobActorBase::ClampedKnobValue' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, bTrackingInput) == 0x0003D4, "Member 'AFMInWorldKnobActorBase::bTrackingInput' has a wrong offset!");
static_assert(offsetof(AFMInWorldKnobActorBase, bIsVisibilityBound) == 0x0003D5, "Member 'AFMInWorldKnobActorBase::bIsVisibilityBound' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnModulatedPropertyValueChanged;                   // 0x0300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKnobRuntimeValueChanged;                         // 0x0310(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKnobSerializedValueChanged;                      // 0x0320(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFloatProviderConnectionChanged;                  // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKnobActorSet;                                    // 0x0340(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_A0[0x8];                                       // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnInitialKnobValuesLoaded;                         // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAllKnobsLoaded;                                  // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnyKnobRuntimeValueChanged;                      // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnyKnobSerializedValueChanged;                   // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnAllKnobsLoaded__DelegateSignature();
	void OnAnyKnobRuntimeValueChanged__DelegateSignature();
	void OnAnyKnobSerializedValueChanged__DelegateSignature();
	void OnAnyOptionUpdated();
	void OnInitialKnobValuesLoaded__DelegateSignature();
