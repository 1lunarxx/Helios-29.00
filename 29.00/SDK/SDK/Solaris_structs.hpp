...
static_assert(offsetof(FVerseClassVarAccessors, bGetterIsInstanceMember) == 0x000000, "Member 'FVerseClassVarAccessors::bGetterIsInstanceMember' has a wrong offset!");
static_assert(offsetof(FVerseClassVarAccessors, Getter) == 0x000008, "Member 'FVerseClassVarAccessors::Getter' has a wrong offset!");
static_assert(offsetof(FVerseClassVarAccessors, bSetterIsInstanceMember) == 0x000010, "Member 'FVerseClassVarAccessors::bSetterIsInstanceMember' has a wrong offset!");
static_assert(offsetof(FVerseClassVarAccessors, Setter) == 0x000018, "Member 'FVerseClassVarAccessors::Setter' has a wrong offset!");
