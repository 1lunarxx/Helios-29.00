...
public:
	void BeginBridgeSelection(const struct FJunoBridgePOISelectorParams& Params_0);
	void DoSelection();
...
public:
	...
	class ULevel*                                 DynamicCellLevel;                                  // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           DynamicDataLayers;                                 // 0x00D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoDynamicRuntimeCell) == 0x000100, "Wrong size on UJunoDynamicRuntimeCell");
static_assert(offsetof(UJunoDynamicRuntimeCell, DynamicCellLevel) == 0x0000D0, "Member 'UJunoDynamicRuntimeCell::DynamicCellLevel' has a wrong offset!");
static_assert(offsetof(UJunoDynamicRuntimeCell, DynamicDataLayers) == 0x0000D8, "Member 'UJunoDynamicRuntimeCell::DynamicDataLayers' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnCellLoad;                                        // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCellUnload;                                      // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCellActivate;                                    // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCellDeactivate;                                  // 0x0118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnLifecyclePhaseChangedDelegate;                   // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLifecycleCompletedDelegate;                      // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnTexture2DPackageCreatedDelegate;                 // 0x0290(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	struct FDataRegistryType                      POIDataRegistry;                                   // 0x00E8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FDataTableRowHandle                    TuningParams;                                      // 0x00F8(0x0010)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoPOIPreselectorComponent) == 0x0001A0, "Wrong size on UJunoPOIPreselectorComponent");
...
static_assert(offsetof(UJunoPOIPreselectorComponent, TuningParams) == 0x0000F8, "Member 'UJunoPOIPreselectorComponent::TuningParams' has a wrong offset!");
...
public:
	...
	TSet<EJunoWorldTilePOIType>                   POITypes;                                          // 0x00D8(0x0050)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	bool                                          bRandomizeRotation;                                // 0x0128(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_129[0x7];                                      // 0x0129(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FJunoPOISelectorParams                 Params_0;                                          // 0x0130(0x0030)(Protected, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UJunoPOIPreselectorComponent> PreSelectorComponent;                              // 0x0160(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_168[0x8];                                      // 0x0168(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FJunoCaveSurfaceData                   CaveSurfaceData;                                   // 0x0170(0x0030)(Protected, NativeAccessSpecifierProtected)
...
public:
	...
	void BeginPOISelection(const struct FJunoPOISelectorParams& Params_0);
	void DoSelection();
...
static_assert(sizeof(UJunoPOISelectorComponent) == 0x0001B0, "Wrong size on UJunoPOISelectorComponent");
...
static_assert(offsetof(UJunoPOISelectorComponent, POITypes) == 0x0000D8, "Member 'UJunoPOISelectorComponent::POITypes' has a wrong offset!");
static_assert(offsetof(UJunoPOISelectorComponent, bRandomizeRotation) == 0x000128, "Member 'UJunoPOISelectorComponent::bRandomizeRotation' has a wrong offset!");
static_assert(offsetof(UJunoPOISelectorComponent, Params_0) == 0x000130, "Member 'UJunoPOISelectorComponent::Params_0' has a wrong offset!");
static_assert(offsetof(UJunoPOISelectorComponent, PreSelectorComponent) == 0x000160, "Member 'UJunoPOISelectorComponent::PreSelectorComponent' has a wrong offset!");
static_assert(offsetof(UJunoPOISelectorComponent, CaveSurfaceData) == 0x000170, "Member 'UJunoPOISelectorComponent::CaveSurfaceData' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnJunoEnvironmentChanged;                          // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_5F0[0x38];                                     // 0x05F0(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoWorldTile) == 0x000628, "Wrong size on AJunoWorldTile");
...
public:
	...
	FMulticastInlineDelegateProperty_             PathfinderSpawnWarpingActorDelegate;               // 0x01C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPCGJunoActorBoundsToPointSettings) == 0x0000A8, "Wrong size on UPCGJunoActorBoundsToPointSettings");
...
static_assert(sizeof(UPCGJunoFindFoundationSettings) == 0x0000B0, "Wrong size on UPCGJunoFindFoundationSettings");
static_assert(offsetof(UPCGJunoFindFoundationSettings, DistanceToSample) == 0x0000A8, "Member 'UPCGJunoFindFoundationSettings::DistanceToSample' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoCreateMaskDataNodeSettings) == 0x0000B0, "Wrong size on UPCGJunoCreateMaskDataNodeSettings");
static_assert(offsetof(UPCGJunoCreateMaskDataNodeSettings, bIs2D) == 0x0000A8, "Member 'UPCGJunoCreateMaskDataNodeSettings::bIs2D' has a wrong offset!");
static_assert(offsetof(UPCGJunoCreateMaskDataNodeSettings, Resolution) == 0x0000AC, "Member 'UPCGJunoCreateMaskDataNodeSettings::Resolution' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoApplyMaskNodeSettings) == 0x0000B0, "Wrong size on UPCGJunoApplyMaskNodeSettings");
static_assert(offsetof(UPCGJunoApplyMaskNodeSettings, Mode) == 0x0000A8, "Member 'UPCGJunoApplyMaskNodeSettings::Mode' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoUnionMasksNodeSettings) == 0x0000B0, "Wrong size on UPCGJunoUnionMasksNodeSettings");
static_assert(offsetof(UPCGJunoUnionMasksNodeSettings, bIs2D) == 0x0000A8, "Member 'UPCGJunoUnionMasksNodeSettings::bIs2D' has a wrong offset!");
static_assert(offsetof(UPCGJunoUnionMasksNodeSettings, Resolution) == 0x0000AC, "Member 'UPCGJunoUnionMasksNodeSettings::Resolution' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoProjectPositionSettings) == 0x0000B0, "Wrong size on UPCGJunoProjectPositionSettings");
static_assert(offsetof(UPCGJunoProjectPositionSettings, bProjectLandscapeMetadata) == 0x0000A8, "Member 'UPCGJunoProjectPositionSettings::bProjectLandscapeMetadata' has a wrong offset!");
static_assert(offsetof(UPCGJunoProjectPositionSettings, bProjectPositions) == 0x0000A9, "Member 'UPCGJunoProjectPositionSettings::bProjectPositions' has a wrong offset!");
static_assert(offsetof(UPCGJunoProjectPositionSettings, bProjectRotations) == 0x0000AA, "Member 'UPCGJunoProjectPositionSettings::bProjectRotations' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoStoreDataSettings) == 0x0000B8, "Wrong size on UPCGJunoStoreDataSettings");
static_assert(offsetof(UPCGJunoStoreDataSettings, ExpectedPins) == 0x0000A8, "Member 'UPCGJunoStoreDataSettings::ExpectedPins' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoLoadDataSettings) == 0x0000E0, "Wrong size on UPCGJunoLoadDataSettings");
static_assert(offsetof(UPCGJunoLoadDataSettings, Pins) == 0x0000A8, "Member 'UPCGJunoLoadDataSettings::Pins' has a wrong offset!");
static_assert(offsetof(UPCGJunoLoadDataSettings, Source) == 0x0000B8, "Member 'UPCGJunoLoadDataSettings::Source' has a wrong offset!");
static_assert(offsetof(UPCGJunoLoadDataSettings, AdditionalExtents) == 0x0000C0, "Member 'UPCGJunoLoadDataSettings::AdditionalExtents' has a wrong offset!");
static_assert(offsetof(UPCGJunoLoadDataSettings, Tag) == 0x0000D8, "Member 'UPCGJunoLoadDataSettings::Tag' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnLevelLoaded;                                     // 0x07A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FJunoRoadAINavigationClusterSharedPointsEntry> SharedPoints;                                      // 0x02A0(0x0010)(Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
	TArray<struct FRoadPatrolPathInfo>            PatrolInfos;                                       // 0x02B0(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<struct FRoadPatrolPointInfo>           PointInfos;                                        // 0x02C0(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         PartitionnerCellSize;                              // 0x02D0(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	float                                         SharedPointsTolerance;                             // 0x02F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2FC[0x4];                                      // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         NavInvokationRange;                                // 0x0300(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         NavMeshGenerationRadius;                           // 0x0328(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FNavAgentSelector                      NavInvokationSupportedAgents;                      // 0x0350(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_354[0x94];                                     // 0x0354(0x0094)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoRoadAINavigationCluster) == 0x0003E8, "Wrong size on AJunoRoadAINavigationCluster");
...
static_assert(offsetof(AJunoRoadAINavigationCluster, SharedPoints) == 0x0002A0, "Member 'AJunoRoadAINavigationCluster::SharedPoints' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, PatrolInfos) == 0x0002B0, "Member 'AJunoRoadAINavigationCluster::PatrolInfos' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, PointInfos) == 0x0002C0, "Member 'AJunoRoadAINavigationCluster::PointInfos' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, PartitionnerCellSize) == 0x0002D0, "Member 'AJunoRoadAINavigationCluster::PartitionnerCellSize' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, SharedPointsTolerance) == 0x0002F8, "Member 'AJunoRoadAINavigationCluster::SharedPointsTolerance' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, NavInvokationRange) == 0x000300, "Member 'AJunoRoadAINavigationCluster::NavInvokationRange' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, NavMeshGenerationRadius) == 0x000328, "Member 'AJunoRoadAINavigationCluster::NavMeshGenerationRadius' has a wrong offset!");
static_assert(offsetof(AJunoRoadAINavigationCluster, NavInvokationSupportedAgents) == 0x000350, "Member 'AJunoRoadAINavigationCluster::NavInvokationSupportedAgents' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnGenerationFinishedMulticastDelegate;             // 0x02E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGAddLandscapeLayerWeightsSettings) == 0x0000A8, "Wrong size on UPCGAddLandscapeLayerWeightsSettings");
...
static_assert(sizeof(UPCGJunoFractalNoise2DSettings) == 0x000158, "Wrong size on UPCGJunoFractalNoise2DSettings");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, TilingFactor) == 0x0000A8, "Member 'UPCGJunoFractalNoise2DSettings::TilingFactor' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, Brightness) == 0x0000B8, "Member 'UPCGJunoFractalNoise2DSettings::Brightness' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, Contrast) == 0x0000BC, "Member 'UPCGJunoFractalNoise2DSettings::Contrast' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, Iterations) == 0x0000C0, "Member 'UPCGJunoFractalNoise2DSettings::Iterations' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, Mode) == 0x0000C4, "Member 'UPCGJunoFractalNoise2DSettings::Mode' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, AttributeName) == 0x0000C8, "Member 'UPCGJunoFractalNoise2DSettings::AttributeName' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, VoronoiIDAttributeName) == 0x0000CC, "Member 'UPCGJunoFractalNoise2DSettings::VoronoiIDAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, bVoronoiOrientSamplesToCellEdge) == 0x0000D0, "Member 'UPCGJunoFractalNoise2DSettings::bVoronoiOrientSamplesToCellEdge' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, VoronoiDistortion) == 0x0000D8, "Member 'UPCGJunoFractalNoise2DSettings::VoronoiDistortion' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, VoronoiDistortionTiling) == 0x0000E0, "Member 'UPCGJunoFractalNoise2DSettings::VoronoiDistortionTiling' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, TiledVoronoiResolution) == 0x0000F0, "Member 'UPCGJunoFractalNoise2DSettings::TiledVoronoiResolution' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, DensityMode) == 0x0000F4, "Member 'UPCGJunoFractalNoise2DSettings::DensityMode' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, Offset) == 0x0000F8, "Member 'UPCGJunoFractalNoise2DSettings::Offset' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, RandomizedOffset) == 0x000108, "Member 'UPCGJunoFractalNoise2DSettings::RandomizedOffset' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendDistance) == 0x000118, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendDistance' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeNoiseBrightness) == 0x00011C, "Member 'UPCGJunoFractalNoise2DSettings::EdgeNoiseBrightness' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeNoiseContrast) == 0x000120, "Member 'UPCGJunoFractalNoise2DSettings::EdgeNoiseContrast' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendCurve) == 0x000124, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendCurve' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendCurveOffset) == 0x000128, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendCurveOffset' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendNoise) == 0x00012C, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendNoise' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendFadeOut) == 0x000130, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendFadeOut' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendNoiseTilingFactor) == 0x000138, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendNoiseTilingFactor' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeNoiseMode) == 0x000148, "Member 'UPCGJunoFractalNoise2DSettings::EdgeNoiseMode' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeNoiseIterations) == 0x00014C, "Member 'UPCGJunoFractalNoise2DSettings::EdgeNoiseIterations' has a wrong offset!");
static_assert(offsetof(UPCGJunoFractalNoise2DSettings, EdgeBlendCellCount) == 0x000150, "Member 'UPCGJunoFractalNoise2DSettings::EdgeBlendCellCount' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoPathfindSettings) == 0x0000D0, "Wrong size on UPCGJunoPathfindSettings");
static_assert(offsetof(UPCGJunoPathfindSettings, ProceduralRouteTag) == 0x0000A8, "Member 'UPCGJunoPathfindSettings::ProceduralRouteTag' has a wrong offset!");
static_assert(offsetof(UPCGJunoPathfindSettings, InputPins) == 0x0000B0, "Member 'UPCGJunoPathfindSettings::InputPins' has a wrong offset!");
static_assert(offsetof(UPCGJunoPathfindSettings, OutputPins) == 0x0000C0, "Member 'UPCGJunoPathfindSettings::OutputPins' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoReadProceduralSplinesSettings) == 0x0000C0, "Wrong size on UPCGJunoReadProceduralSplinesSettings");
static_assert(offsetof(UPCGJunoReadProceduralSplinesSettings, ProceduralRouteTag) == 0x0000A8, "Member 'UPCGJunoReadProceduralSplinesSettings::ProceduralRouteTag' has a wrong offset!");
static_assert(offsetof(UPCGJunoReadProceduralSplinesSettings, OutputPins) == 0x0000B0, "Member 'UPCGJunoReadProceduralSplinesSettings::OutputPins' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoReadLandscapeSplinesSettings) == 0x0000C8, "Wrong size on UPCGJunoReadLandscapeSplinesSettings");
static_assert(offsetof(UPCGJunoReadLandscapeSplinesSettings, ExtraSearchExtents) == 0x0000A8, "Member 'UPCGJunoReadLandscapeSplinesSettings::ExtraSearchExtents' has a wrong offset!");
static_assert(offsetof(UPCGJunoReadLandscapeSplinesSettings, bPerformBoundsCheck) == 0x0000C0, "Member 'UPCGJunoReadLandscapeSplinesSettings::bPerformBoundsCheck' has a wrong offset!");
...
public:
	...
	float                                         StepLength;                                        // 0x0108(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LineDeviationTolerance;                            // 0x010C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinRoadLength;                                     // 0x0110(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGJunoRoadAINavigationSettings) == 0x000118, "Wrong size on UPCGJunoRoadAINavigationSettings");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, RoadClusterClass) == 0x0000A8, "Member 'UPCGJunoRoadAINavigationSettings::RoadClusterClass' has a wrong offset!");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, PatrolPathClass) == 0x0000C8, "Member 'UPCGJunoRoadAINavigationSettings::PatrolPathClass' has a wrong offset!");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, PatrolPointClass) == 0x0000E8, "Member 'UPCGJunoRoadAINavigationSettings::PatrolPointClass' has a wrong offset!");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, StepLength) == 0x000108, "Member 'UPCGJunoRoadAINavigationSettings::StepLength' has a wrong offset!");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, LineDeviationTolerance) == 0x00010C, "Member 'UPCGJunoRoadAINavigationSettings::LineDeviationTolerance' has a wrong offset!");
static_assert(offsetof(UPCGJunoRoadAINavigationSettings, MinRoadLength) == 0x000110, "Member 'UPCGJunoRoadAINavigationSettings::MinRoadLength' has a wrong offset!");
...
static_assert(sizeof(UPCGJunoSpawnLivingWorldStaticPointSettings) == 0x000130, "Wrong size on UPCGJunoSpawnLivingWorldStaticPointSettings");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, FiltersTags) == 0x0000A8, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::FiltersTags' has a wrong offset!");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, ConditionalTags) == 0x0000C8, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::ConditionalTags' has a wrong offset!");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, ConditionalTagsSets) == 0x0000D8, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::ConditionalTagsSets' has a wrong offset!");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, bExclusiveConditionalTags) == 0x0000E8, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::bExclusiveConditionalTags' has a wrong offset!");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, StaticPointClass) == 0x0000F0, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::StaticPointClass' has a wrong offset!");
static_assert(offsetof(UPCGJunoSpawnLivingWorldStaticPointSettings, PointClusterClass) == 0x000110, "Member 'UPCGJunoSpawnLivingWorldStaticPointSettings::PointClusterClass' has a wrong offset!");
...
static_assert(sizeof(UPCGResolveAudioBankSettings) == 0x0000B8, "Wrong size on UPCGResolveAudioBankSettings");
static_assert(offsetof(UPCGResolveAudioBankSettings, AttributeNameForBiomeDataTable) == 0x0000A8, "Member 'UPCGResolveAudioBankSettings::AttributeNameForBiomeDataTable' has a wrong offset!");
static_assert(offsetof(UPCGResolveAudioBankSettings, AttributeNameForResolvedActorPath) == 0x0000AC, "Member 'UPCGResolveAudioBankSettings::AttributeNameForResolvedActorPath' has a wrong offset!");
static_assert(offsetof(UPCGResolveAudioBankSettings, AttributeNameForResolvedAudioBankPath) == 0x0000B0, "Member 'UPCGResolveAudioBankSettings::AttributeNameForResolvedAudioBankPath' has a wrong offset!");
...
static_assert(sizeof(UPCGResolveBiomeSettings) == 0x0000F0, "Wrong size on UPCGResolveBiomeSettings");
static_assert(offsetof(UPCGResolveBiomeSettings, DefaultBiome) == 0x0000A8, "Member 'UPCGResolveBiomeSettings::DefaultBiome' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeSettings, Biomes) == 0x0000D0, "Member 'UPCGResolveBiomeSettings::Biomes' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeSettings, AttributeNameForResolvedBiome) == 0x0000E0, "Member 'UPCGResolveBiomeSettings::AttributeNameForResolvedBiome' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeSettings, AttributeNameForResolvedBiomeEnum) == 0x0000E4, "Member 'UPCGResolveBiomeSettings::AttributeNameForResolvedBiomeEnum' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeSettings, AttributeNameForResolvedBiomeDataTable) == 0x0000E8, "Member 'UPCGResolveBiomeSettings::AttributeNameForResolvedBiomeDataTable' has a wrong offset!");
...
static_assert(sizeof(UPCGResolveBiomeIngredientsSettings) == 0x0000C8, "Wrong size on UPCGResolveBiomeIngredientsSettings");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForBiomeTypeFilter) == 0x0000A8, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForBiomeTypeFilter' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForBiomeDataTable) == 0x0000AC, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForBiomeDataTable' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForBiomeLayer) == 0x0000B0, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForBiomeLayer' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForResolvedActorPath) == 0x0000B4, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForResolvedActorPath' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForRepresentation) == 0x0000B8, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForRepresentation' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, AttributeNameForResolvedRowName) == 0x0000BC, "Member 'UPCGResolveBiomeIngredientsSettings::AttributeNameForResolvedRowName' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, bApplyBlendToVertical) == 0x0000C0, "Member 'UPCGResolveBiomeIngredientsSettings::bApplyBlendToVertical' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomeIngredientsSettings, bApplyRandomLeanAmount) == 0x0000C1, "Member 'UPCGResolveBiomeIngredientsSettings::bApplyRandomLeanAmount' has a wrong offset!");
...
static_assert(sizeof(UPCGResolveBiomePOISettings) == 0x0000C0, "Wrong size on UPCGResolveBiomePOISettings");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForBiomeDataTable) == 0x0000A8, "Member 'UPCGResolveBiomePOISettings::AttributeNameForBiomeDataTable' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForResolvedActorPath) == 0x0000AC, "Member 'UPCGResolveBiomePOISettings::AttributeNameForResolvedActorPath' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForResolvedPOIPath) == 0x0000B0, "Member 'UPCGResolveBiomePOISettings::AttributeNameForResolvedPOIPath' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForBoundsMultiplier) == 0x0000B4, "Member 'UPCGResolveBiomePOISettings::AttributeNameForBoundsMultiplier' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForRepresentation) == 0x0000B8, "Member 'UPCGResolveBiomePOISettings::AttributeNameForRepresentation' has a wrong offset!");
static_assert(offsetof(UPCGResolveBiomePOISettings, AttributeNameForResolvedRowName) == 0x0000BC, "Member 'UPCGResolveBiomePOISettings::AttributeNameForResolvedRowName' has a wrong offset!");
...
static_assert(sizeof(UPCGResolvePOISlotsSettings) == 0x0000C0, "Wrong size on UPCGResolvePOISlotsSettings");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForBiomeDataTable) == 0x0000A8, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForBiomeDataTable' has a wrong offset!");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForPotentialPIOsDataTable) == 0x0000AC, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForPotentialPIOsDataTable' has a wrong offset!");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForResolvedActorPath) == 0x0000B0, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForResolvedActorPath' has a wrong offset!");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForResolvedPOIPath) == 0x0000B4, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForResolvedPOIPath' has a wrong offset!");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForResolvedSlotSize) == 0x0000B8, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForResolvedSlotSize' has a wrong offset!");
static_assert(offsetof(UPCGResolvePOISlotsSettings, AttributeNameForResolvedTerrainHeightPatch) == 0x0000BC, "Member 'UPCGResolvePOISlotsSettings::AttributeNameForResolvedTerrainHeightPatch' has a wrong offset!");
...
static_assert(sizeof(UPCGSetAudioBankSettings) == 0x0000B0, "Wrong size on UPCGSetAudioBankSettings");
static_assert(offsetof(UPCGSetAudioBankSettings, AttributeNameForResolvedAudioBankPath) == 0x0000A8, "Member 'UPCGSetAudioBankSettings::AttributeNameForResolvedAudioBankPath' has a wrong offset!");
static_assert(offsetof(UPCGSetAudioBankSettings, AttributeNameForSpawnedActorPtr) == 0x0000AC, "Member 'UPCGSetAudioBankSettings::AttributeNameForSpawnedActorPtr' has a wrong offset!");
...
static_assert(sizeof(UPCGSetFoundationLevelSettings) == 0x0000B0, "Wrong size on UPCGSetFoundationLevelSettings");
static_assert(offsetof(UPCGSetFoundationLevelSettings, AttributeNameForResolvedPOIPath) == 0x0000A8, "Member 'UPCGSetFoundationLevelSettings::AttributeNameForResolvedPOIPath' has a wrong offset!");
static_assert(offsetof(UPCGSetFoundationLevelSettings, AttributeNameForSpawnedActorPtr) == 0x0000AC, "Member 'UPCGSetFoundationLevelSettings::AttributeNameForSpawnedActorPtr' has a wrong offset!");
...
static_assert(sizeof(UPCGSetLevelInstanceLevelSettings) == 0x0000B0, "Wrong size on UPCGSetLevelInstanceLevelSettings");
static_assert(offsetof(UPCGSetLevelInstanceLevelSettings, AttributeNameForResolvedPOIPath) == 0x0000A8, "Member 'UPCGSetLevelInstanceLevelSettings::AttributeNameForResolvedPOIPath' has a wrong offset!");
static_assert(offsetof(UPCGSetLevelInstanceLevelSettings, AttributeNameForSpawnedActorPtr) == 0x0000AC, "Member 'UPCGSetLevelInstanceLevelSettings::AttributeNameForSpawnedActorPtr' has a wrong offset!");
...
static_assert(sizeof(UPCGSetPOISlotPropertiesSettings) == 0x0000C0, "Wrong size on UPCGSetPOISlotPropertiesSettings");
static_assert(offsetof(UPCGSetPOISlotPropertiesSettings, AttributeNameForSpawnedActorPtr) == 0x0000A8, "Member 'UPCGSetPOISlotPropertiesSettings::AttributeNameForSpawnedActorPtr' has a wrong offset!");
static_assert(offsetof(UPCGSetPOISlotPropertiesSettings, AttributeNameForPotentialPIOsDataTable) == 0x0000AC, "Member 'UPCGSetPOISlotPropertiesSettings::AttributeNameForPotentialPIOsDataTable' has a wrong offset!");
static_assert(offsetof(UPCGSetPOISlotPropertiesSettings, AttributeNameForResolvedPOIPath) == 0x0000B0, "Member 'UPCGSetPOISlotPropertiesSettings::AttributeNameForResolvedPOIPath' has a wrong offset!");
static_assert(offsetof(UPCGSetPOISlotPropertiesSettings, AttributeNameForResolvedSlotSize) == 0x0000B4, "Member 'UPCGSetPOISlotPropertiesSettings::AttributeNameForResolvedSlotSize' has a wrong offset!");
static_assert(offsetof(UPCGSetPOISlotPropertiesSettings, AttributeNameForResolvedTerrainHeightPatch) == 0x0000B8, "Member 'UPCGSetPOISlotPropertiesSettings::AttributeNameForResolvedTerrainHeightPatch' has a wrong offset!");
...
static_assert(sizeof(UPCGSpawnActorForPathSettings) == 0x0000F0, "Wrong size on UPCGSpawnActorForPathSettings");
static_assert(offsetof(UPCGSpawnActorForPathSettings, bUseLightWeightInstances) == 0x0000A8, "Member 'UPCGSpawnActorForPathSettings::bUseLightWeightInstances' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, InstanceTags) == 0x0000B0, "Member 'UPCGSpawnActorForPathSettings::InstanceTags' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, TagsToAddOnActors) == 0x0000D0, "Member 'UPCGSpawnActorForPathSettings::TagsToAddOnActors' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, bAddSpawnedActorAttribute) == 0x0000E0, "Member 'UPCGSpawnActorForPathSettings::bAddSpawnedActorAttribute' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, AttributeNameForSpawnedActorPtr) == 0x0000E4, "Member 'UPCGSpawnActorForPathSettings::AttributeNameForSpawnedActorPtr' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, PathAttributeName) == 0x0000E8, "Member 'UPCGSpawnActorForPathSettings::PathAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorForPathSettings, AttributeNameForRepresentation) == 0x0000EC, "Member 'UPCGSpawnActorForPathSettings::AttributeNameForRepresentation' has a wrong offset!");
...
static_assert(sizeof(UPCGSpawnJunoBiomeSettings) == 0x0000E0, "Wrong size on UPCGSpawnJunoBiomeSettings");
static_assert(offsetof(UPCGSpawnJunoBiomeSettings, DefaultBiome) == 0x0000A8, "Member 'UPCGSpawnJunoBiomeSettings::DefaultBiome' has a wrong offset!");
static_assert(offsetof(UPCGSpawnJunoBiomeSettings, Biomes) == 0x0000D0, "Member 'UPCGSpawnJunoBiomeSettings::Biomes' has a wrong offset!");
...
public:
	...
	struct FJunoWorldTileSaveData_v1              SaveData;                                          // 0x00E8(0x00A0)(SaveGame, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoWorldTilePersistenceFeatureData) == 0x000188, "Wrong size on UJunoWorldTilePersistenceFeatureData");
static_assert(offsetof(UJunoWorldTilePersistenceFeatureData, Caves) == 0x000048, "Member 'UJunoWorldTilePersistenceFeatureData::Caves' has a wrong offset!");
static_assert(offsetof(UJunoWorldTilePersistenceFeatureData, POIs) == 0x000098, "Member 'UJunoWorldTilePersistenceFeatureData::POIs' has a wrong offset!");
static_assert(offsetof(UJunoWorldTilePersistenceFeatureData, SaveData) == 0x0000E8, "Member 'UJunoWorldTilePersistenceFeatureData::SaveData' has a wrong offset!");
