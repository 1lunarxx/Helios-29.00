...
public:
	...
	uint8                                         Pad_289[0x1E7];                                    // 0x0289(0x01E7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPhysicsControlComponent) == 0x000470, "Wrong size on UPhysicsControlComponent");
static_assert(offsetof(UPhysicsControlComponent, PhysicsControlProfileAsset) == 0x000220, "Member 'UPhysicsControlComponent::PhysicsControlProfileAsset' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, TeleportDistanceThreshold) == 0x000240, "Member 'UPhysicsControlComponent::TeleportDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, TeleportRotationThreshold) == 0x000244, "Member 'UPhysicsControlComponent::TeleportRotationThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugVisualization) == 0x000248, "Member 'UPhysicsControlComponent::bShowDebugVisualization' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VisualizationSizeScale) == 0x00024C, "Member 'UPhysicsControlComponent::VisualizationSizeScale' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugControlList) == 0x000250, "Member 'UPhysicsControlComponent::bShowDebugControlList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugControlDetailFilter) == 0x000258, "Member 'UPhysicsControlComponent::DebugControlDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugBodyModifierList) == 0x000268, "Member 'UPhysicsControlComponent::bShowDebugBodyModifierList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugBodyModifierDetailFilter) == 0x000270, "Member 'UPhysicsControlComponent::DebugBodyModifierDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VelocityPredictionTime) == 0x000280, "Member 'UPhysicsControlComponent::VelocityPredictionTime' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, MaxNumControlsOrModifiersPerName) == 0x000284, "Member 'UPhysicsControlComponent::MaxNumControlsOrModifiersPerName' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bWarnAboutInvalidNames) == 0x000288, "Member 'UPhysicsControlComponent::bWarnAboutInvalidNames' has a wrong offset!");
...
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialControls) == 0x0002F0, "Member 'UPhysicsControlInitializerComponent::InitialControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialBodyModifiers) == 0x000340, "Member 'UPhysicsControlInitializerComponent::InitialBodyModifiers' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, bCreateControlsAtBeginPlay) == 0x000390, "Member 'UPhysicsControlInitializerComponent::bCreateControlsAtBeginPlay' has a wrong offset!");
