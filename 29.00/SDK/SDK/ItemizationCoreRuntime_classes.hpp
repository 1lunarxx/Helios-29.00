...
{
public:
	TArray<struct FGuid>                          ActiveItems;                                       // 0x0598(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPrivate)
	TArray<struct FGuid>                          PreviouslyActiveItems;                             // 0x05A8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UEquippableInventory, ActiveItems) == 0x000598, "Member 'UEquippableInventory::ActiveItems' has a wrong offset!");
static_assert(offsetof(UEquippableInventory, PreviouslyActiveItems) == 0x0005A8, "Member 'UEquippableInventory::PreviouslyActiveItems' has a wrong offset!");
...
public:
	...
	TArray<struct FInventoryStartingItem>         StartingItems;                                     // 0x0050(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UItemDefinition) == 0x0000E0, "Wrong size on UItemDefinition");
...
static_assert(offsetof(UItemizationCoreSubsystem, ItemInstanceClassOverride) == 0x000030, "Member 'UItemizationCoreSubsystem::ItemInstanceClassOverride' has a wrong offset!");
...
static_assert(offsetof(UItemizationLootCountCalculator_Value, Value) == 0x000028, "Member 'UItemizationLootCountCalculator_Value::Value' has a wrong offset!");
...
static_assert(offsetof(UItemizationLootCountCalculator_Range, Min) == 0x000028, "Member 'UItemizationLootCountCalculator_Range::Min' has a wrong offset!");
static_assert(offsetof(UItemizationLootCountCalculator_Range, Max) == 0x000050, "Member 'UItemizationLootCountCalculator_Range::Max' has a wrong offset!");
...
{
public:
	class FText                                   LootTableName;                                     // 0x0030(0x0018)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FText                                   LootTableDescription;                              // 0x0048(0x0018)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<class UItemizationLootPoolProcessor*>  LootPoolPostProcessorList;                         // 0x0060(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FItemizationLootEntry_Guaranteed> GuaranteedLoot;                                    // 0x0070(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class UItemizationLootCountCalculator*        SelectionCount;                                    // 0x0080(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FItemizationLootEntry_Chance>   ChanceLoot;                                        // 0x0088(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UItemizationLootPoolAsset) == 0x000098, "Wrong size on UItemizationLootPoolAsset");
static_assert(offsetof(UItemizationLootPoolAsset, LootTableName) == 0x000030, "Member 'UItemizationLootPoolAsset::LootTableName' has a wrong offset!");
static_assert(offsetof(UItemizationLootPoolAsset, LootTableDescription) == 0x000048, "Member 'UItemizationLootPoolAsset::LootTableDescription' has a wrong offset!");
static_assert(offsetof(UItemizationLootPoolAsset, LootPoolPostProcessorList) == 0x000060, "Member 'UItemizationLootPoolAsset::LootPoolPostProcessorList' has a wrong offset!");
static_assert(offsetof(UItemizationLootPoolAsset, GuaranteedLoot) == 0x000070, "Member 'UItemizationLootPoolAsset::GuaranteedLoot' has a wrong offset!");
static_assert(offsetof(UItemizationLootPoolAsset, SelectionCount) == 0x000080, "Member 'UItemizationLootPoolAsset::SelectionCount' has a wrong offset!");
static_assert(offsetof(UItemizationLootPoolAsset, ChanceLoot) == 0x000088, "Member 'UItemizationLootPoolAsset::ChanceLoot' has a wrong offset!");
...
// Class ItemizationCoreRuntime.ItemizationLootCountCalculator_SetAttribute
// 0x0050 (0x0078 - 0x0028)
class UItemizationLootCountCalculator_SetAttribute final : public UItemizationLootPoolProcessor
{
public:
	TSubclassOf<class UItemAttribute>             Attribute;                                         // 0x0028(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EItemAttributeType                            AttributeType;                                     // 0x0030(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         NumberValue;                                       // 0x0038(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	bool                                          Value;                                             // 0x0060(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 StringValue;                                       // 0x0068(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	TArray<class UClass*> GetAllowedItemAttributeClasses() const;
	TArray<class UClass*> GetDisallowedItemAttributeClasses() const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ItemizationLootCountCalculator_SetAttribute">();
	}
	static class UItemizationLootCountCalculator_SetAttribute* GetDefaultObj()
	{
		return GetDefaultObjImpl<UItemizationLootCountCalculator_SetAttribute>();
	}
};
static_assert(alignof(UItemizationLootCountCalculator_SetAttribute) == 0x000008, "Wrong alignment on UItemizationLootCountCalculator_SetAttribute");
static_assert(sizeof(UItemizationLootCountCalculator_SetAttribute) == 0x000078, "Wrong size on UItemizationLootCountCalculator_SetAttribute");
static_assert(offsetof(UItemizationLootCountCalculator_SetAttribute, Attribute) == 0x000028, "Member 'UItemizationLootCountCalculator_SetAttribute::Attribute' has a wrong offset!");
static_assert(offsetof(UItemizationLootCountCalculator_SetAttribute, AttributeType) == 0x000030, "Member 'UItemizationLootCountCalculator_SetAttribute::AttributeType' has a wrong offset!");
static_assert(offsetof(UItemizationLootCountCalculator_SetAttribute, NumberValue) == 0x000038, "Member 'UItemizationLootCountCalculator_SetAttribute::NumberValue' has a wrong offset!");
static_assert(offsetof(UItemizationLootCountCalculator_SetAttribute, Value) == 0x000060, "Member 'UItemizationLootCountCalculator_SetAttribute::Value' has a wrong offset!");
static_assert(offsetof(UItemizationLootCountCalculator_SetAttribute, StringValue) == 0x000068, "Member 'UItemizationLootCountCalculator_SetAttribute::StringValue' has a wrong offset!");
...
static_assert(offsetof(UItemizationLootWeightCalculator_Value, Value) == 0x000028, "Member 'UItemizationLootWeightCalculator_Value::Value' has a wrong offset!");
...
static_assert(offsetof(UItemizationLootWeightCalculator_Range, Min) == 0x000028, "Member 'UItemizationLootWeightCalculator_Range::Min' has a wrong offset!");
static_assert(offsetof(UItemizationLootWeightCalculator_Range, Max) == 0x000050, "Member 'UItemizationLootWeightCalculator_Range::Max' has a wrong offset!");
...
{
public:
	class UItemDefinition*                        Original;                                          // 0x00E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UItemVariant) == 0x0000E8, "Wrong size on UItemVariant");
static_assert(offsetof(UItemVariant, Original) == 0x0000E0, "Member 'UItemVariant::Original' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class AInventoryCollection>    InventoryCollection;                               // 0x00D8(0x0008)(Net, ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                  PersistenceID;                                     // 0x00E0(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UInventoryComponent, InventoryCollectionClass) == 0x0000B0, "Member 'UInventoryComponent::InventoryCollectionClass' has a wrong offset!");
static_assert(offsetof(UInventoryComponent, InventorySetupData) == 0x0000B8, "Member 'UInventoryComponent::InventorySetupData' has a wrong offset!");
static_assert(offsetof(UInventoryComponent, InventoryCollection) == 0x0000D8, "Member 'UInventoryComponent::InventoryCollection' has a wrong offset!");
static_assert(offsetof(UInventoryComponent, PersistenceID) == 0x0000E0, "Member 'UInventoryComponent::PersistenceID' has a wrong offset!");
