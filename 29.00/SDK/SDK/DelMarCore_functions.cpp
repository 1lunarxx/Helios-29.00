...
// DelegateFunction DelMarCore.DelMarVehicleCosmeticComponent.DelMarOnAllCosmeticActorsSpawned__DelegateSignature
// (MulticastDelegate, Public, Delegate)

void UDelMarVehicleCosmeticComponent::DelMarOnAllCosmeticActorsSpawned__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarVehicleCosmeticComponent", "DelMarOnAllCosmeticActorsSpawned__DelegateSignature");
...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// class ADelMarCosmeticActor*             CosmeticActor                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UDelMarVehicleCosmeticComponent::DelMarOnCosmeticItemSpawned__DelegateSignature(class ADelMarCosmeticActor* CosmeticActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarVehicleCosmeticComponent", "DelMarOnCosmeticItemSpawned__DelegateSignature");

	Params::DelMarVehicleCosmeticComponent_DelMarOnCosmeticItemSpawned__DelegateSignature Parms{};

	Parms.CosmeticActor = CosmeticActor;
