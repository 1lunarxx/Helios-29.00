...
static_assert(offsetof(WBP_ActiveAugments_Timer_C_OnNumAugPendingUpdated__DelegateSignature, NumPendingToGrant) == 0x000000, "Member 'WBP_ActiveAugments_Timer_C_OnNumAugPendingUpdated__DelegateSignature::NumPendingToGrant' has a wrong offset!");
