...
// DelegateFunction FabricRuntime.FabricButtonBase.ToggleStateChanged__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct FabricButtonBase_ToggleStateChanged__DelegateSignature final
{
public:
	class APlayerController*                      InteractingController_0;                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsToggle;                                          // 0x0008(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FabricButtonBase_ToggleStateChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricButtonBase_ToggleStateChanged__DelegateSignature");
static_assert(sizeof(FabricButtonBase_ToggleStateChanged__DelegateSignature) == 0x000010, "Wrong size on FabricButtonBase_ToggleStateChanged__DelegateSignature");
static_assert(offsetof(FabricButtonBase_ToggleStateChanged__DelegateSignature, InteractingController_0) == 0x000000, "Member 'FabricButtonBase_ToggleStateChanged__DelegateSignature::InteractingController_0' has a wrong offset!");
static_assert(offsetof(FabricButtonBase_ToggleStateChanged__DelegateSignature, IsToggle) == 0x000008, "Member 'FabricButtonBase_ToggleStateChanged__DelegateSignature::IsToggle' has a wrong offset!");
...
// DelegateFunction FabricRuntime.FabricButtonComponentBase.ToggleStateChanged__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct FabricButtonComponentBase_ToggleStateChanged__DelegateSignature final
{
public:
	class APlayerController*                      InteractingController_0;                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsToggle;                                          // 0x0008(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FabricButtonComponentBase_ToggleStateChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricButtonComponentBase_ToggleStateChanged__DelegateSignature");
static_assert(sizeof(FabricButtonComponentBase_ToggleStateChanged__DelegateSignature) == 0x000010, "Wrong size on FabricButtonComponentBase_ToggleStateChanged__DelegateSignature");
static_assert(offsetof(FabricButtonComponentBase_ToggleStateChanged__DelegateSignature, InteractingController_0) == 0x000000, "Member 'FabricButtonComponentBase_ToggleStateChanged__DelegateSignature::InteractingController_0' has a wrong offset!");
static_assert(offsetof(FabricButtonComponentBase_ToggleStateChanged__DelegateSignature, IsToggle) == 0x000008, "Member 'FabricButtonComponentBase_ToggleStateChanged__DelegateSignature::IsToggle' has a wrong offset!");
...
// DelegateFunction FabricRuntime.FabricFloatProviderBase.OnFloatChanged__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct FabricFloatProviderBase_OnFloatChanged__DelegateSignature final
{
public:
...
static_assert(alignof(FabricFloatProviderBase_OnFloatChanged__DelegateSignature) == 0x000004, "Wrong alignment on FabricFloatProviderBase_OnFloatChanged__DelegateSignature");
static_assert(sizeof(FabricFloatProviderBase_OnFloatChanged__DelegateSignature) == 0x000004, "Wrong size on FabricFloatProviderBase_OnFloatChanged__DelegateSignature");
static_assert(offsetof(FabricFloatProviderBase_OnFloatChanged__DelegateSignature, Float) == 0x000000, "Member 'FabricFloatProviderBase_OnFloatChanged__DelegateSignature::Float' has a wrong offset!");
...
static_assert(alignof(FabricInteractable_GetInteractableDescription) == 0x000008, "Wrong alignment on FabricInteractable_GetInteractableDescription");
static_assert(sizeof(FabricInteractable_GetInteractableDescription) == 0x000018, "Wrong size on FabricInteractable_GetInteractableDescription");
static_assert(offsetof(FabricInteractable_GetInteractableDescription, OutDescription) == 0x000000, "Member 'FabricInteractable_GetInteractableDescription::OutDescription' has a wrong offset!");
...
static_assert(alignof(FabricInteractable_GetInteractableName) == 0x000008, "Wrong alignment on FabricInteractable_GetInteractableName");
static_assert(sizeof(FabricInteractable_GetInteractableName) == 0x000018, "Wrong size on FabricInteractable_GetInteractableName");
static_assert(offsetof(FabricInteractable_GetInteractableName, OutName) == 0x000000, "Member 'FabricInteractable_GetInteractableName::OutName' has a wrong offset!");
...
// DelegateFunction FabricRuntime.FabricInteractionTool.OnCableHeldStateChanged__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature final
{
public:
...
static_assert(alignof(FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature");
static_assert(sizeof(FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature) == 0x000008, "Wrong size on FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature");
static_assert(offsetof(FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature, Device) == 0x000000, "Member 'FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature::Device' has a wrong offset!");

// DelegateFunction FabricRuntime.FabricInteractionTool.OnInteractionStateChanged__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct FabricInteractionTool_OnInteractionStateChanged__DelegateSignature final
{
public:
	EFabricInteractionToolStates                  NewState;                                          // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortCreativeDeviceProp*                Device;                                            // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FabricInteractionTool_OnInteractionStateChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricInteractionTool_OnInteractionStateChanged__DelegateSignature");
static_assert(sizeof(FabricInteractionTool_OnInteractionStateChanged__DelegateSignature) == 0x000010, "Wrong size on FabricInteractionTool_OnInteractionStateChanged__DelegateSignature");
static_assert(offsetof(FabricInteractionTool_OnInteractionStateChanged__DelegateSignature, NewState) == 0x000000, "Member 'FabricInteractionTool_OnInteractionStateChanged__DelegateSignature::NewState' has a wrong offset!");
static_assert(offsetof(FabricInteractionTool_OnInteractionStateChanged__DelegateSignature, Device) == 0x000008, "Member 'FabricInteractionTool_OnInteractionStateChanged__DelegateSignature::Device' has a wrong offset!");

// DelegateFunction FabricRuntime.FabricInteractionTool.OnMetasoundGeneratorCrossfadeStarted__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature final
{
public:
	float                                         CrossfadeSeconds;                                  // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature) == 0x000004, "Wrong alignment on FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature");
static_assert(sizeof(FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature) == 0x000004, "Wrong size on FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature");
static_assert(offsetof(FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature, CrossfadeSeconds) == 0x000000, "Member 'FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature::CrossfadeSeconds' has a wrong offset!");
...
static_assert(alignof(FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed) == 0x000008, "Wrong alignment on FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed");
static_assert(sizeof(FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed) == 0x000018, "Wrong size on FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed");
static_assert(offsetof(FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed, OutputName) == 0x000000, "Member 'FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed::OutputName' has a wrong offset!");
static_assert(offsetof(FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed, Output) == 0x000008, "Member 'FabricNoteReceivedPatchWrapper_OnMetaSoundMidiEventPassed::Output' has a wrong offset!");
...
static_assert(alignof(FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged) == 0x000004, "Wrong alignment on FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged");
static_assert(sizeof(FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged) == 0x000008, "Wrong size on FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged");
static_assert(offsetof(FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged, NoteIndex) == 0x000000, "Member 'FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged::NoteIndex' has a wrong offset!");
static_assert(offsetof(FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged, bTriggerActive) == 0x000004, "Member 'FabricNoteReceivedPatchWrapper_OnTriggerNoteChanged::bTriggerActive' has a wrong offset!");
...
static_assert(alignof(FabricMIDIPlayerPatchWrapper_SetMidiFile) == 0x000008, "Wrong alignment on FabricMIDIPlayerPatchWrapper_SetMidiFile");
static_assert(sizeof(FabricMIDIPlayerPatchWrapper_SetMidiFile) == 0x000008, "Wrong size on FabricMIDIPlayerPatchWrapper_SetMidiFile");
static_assert(offsetof(FabricMIDIPlayerPatchWrapper_SetMidiFile, MidiFile) == 0x000000, "Member 'FabricMIDIPlayerPatchWrapper_SetMidiFile::MidiFile' has a wrong offset!");
...
// DelegateFunction FabricRuntime.FabricTextureModifierBase.OnSourceTextureChanged__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature final
{
public:
	TArray<struct FFabricTextureProviderTexture>  Textures;                                          // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature");
static_assert(sizeof(FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature) == 0x000010, "Wrong size on FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature");
static_assert(offsetof(FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature, Textures) == 0x000000, "Member 'FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature::Textures' has a wrong offset!");
...
// DelegateFunction FabricRuntime.FabricTextureProviderBase.OnTextureChanged__DelegateSignature
// 0x0018 (0x0018 - 0x0000)
struct FabricTextureProviderBase_OnTextureChanged__DelegateSignature final
{
public:
	struct FFabricTextureProviderTexture          Texture;                                           // 0x0000(0x0018)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FabricTextureProviderBase_OnTextureChanged__DelegateSignature) == 0x000008, "Wrong alignment on FabricTextureProviderBase_OnTextureChanged__DelegateSignature");
static_assert(sizeof(FabricTextureProviderBase_OnTextureChanged__DelegateSignature) == 0x000018, "Wrong size on FabricTextureProviderBase_OnTextureChanged__DelegateSignature");
static_assert(offsetof(FabricTextureProviderBase_OnTextureChanged__DelegateSignature, Texture) == 0x000000, "Member 'FabricTextureProviderBase_OnTextureChanged__DelegateSignature::Texture' has a wrong offset!");
