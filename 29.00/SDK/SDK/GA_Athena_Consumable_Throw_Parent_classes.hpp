...
public:
	...
	FMulticastInlineDelegateProperty_             OnProjectileSpawn;                                 // 0x0D10(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class UFortAbilityTask_PlayMontageWaitTarget* ThrowMontageAsyncTask;                             // 0x1008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_Athena_Consumable_Throw_Parent_C) == 0x001010, "Wrong size on UGA_Athena_Consumable_Throw_Parent_C");
...
static_assert(offsetof(UGA_Athena_Consumable_Throw_Parent_C, ThrowMontageAsyncTask) == 0x001008, "Member 'UGA_Athena_Consumable_Throw_Parent_C::ThrowMontageAsyncTask' has a wrong offset!");
