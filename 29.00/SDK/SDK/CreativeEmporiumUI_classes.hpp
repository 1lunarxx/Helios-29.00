...
{
public:
	FMulticastInlineDelegateProperty_             OnFilterEnabled;                                   // 0x1490(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFilterSelected;                                  // 0x14A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWidgetDestroyed;                                 // 0x14B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x02A0 (0x0588 - 0x02E8)
class UEmporiumBrowserFiltersPanel final : public UCommonUserWidget
{
public:
	FMulticastInlineDelegateProperty_             OnFilterChanged;                                   // 0x02E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSortChanged;                                     // 0x02F8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSubFilterToggled;                                // 0x0308(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFocusChanged;                                    // 0x0318(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCategoryActivated;                               // 0x0328(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCategoryFocused;                                 // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateCategoryCounts;                            // 0x0348(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_358[0x10];                                     // 0x0358(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UFortEmporiumFilterCategoryHeader> FilterSectionHeaderWidgetClass;                    // 0x0368(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UFortEmporiumFilterCategoryHeader> FilterCategoryHeaderWidgetClass;                   // 0x0370(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UFortEmporiumFilterCategoryHeader> FilterHomeHeaderWidgetClass;                       // 0x0378(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UEmporiumBrowserFilterEntry> FilterEntryWidgetClass;                            // 0x0380(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FFortEmporiumSortEntry>         SortEntries;                                       // 0x0388(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<struct FFortEmporiumFilterEntry>       FilterEntries;                                     // 0x0398(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<struct FFortEmporiumPriceFilterEntry>  PriceFilterEntries;                                // 0x03A8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<class FName>                           LicenseFilterEntries;                              // 0x03B8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FName                                   DefaultCategoryFilter;                             // 0x03C8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3CC[0x54];                                     // 0x03CC(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	class UScrollBox*                             ScrollBox_FilterScroll;                            // 0x0420(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UEmporiumBrowserFilterEntry*            Button_All;                                        // 0x0428(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonButtonBase*                      Button_SortAndFilter;                              // 0x0430(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FilterSectionHeaderWidgetClass) == 0x000368, "Member 'UEmporiumBrowserFiltersPanel::FilterSectionHeaderWidgetClass' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FilterCategoryHeaderWidgetClass) == 0x000370, "Member 'UEmporiumBrowserFiltersPanel::FilterCategoryHeaderWidgetClass' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FilterHomeHeaderWidgetClass) == 0x000378, "Member 'UEmporiumBrowserFiltersPanel::FilterHomeHeaderWidgetClass' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FilterEntryWidgetClass) == 0x000380, "Member 'UEmporiumBrowserFiltersPanel::FilterEntryWidgetClass' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, SortEntries) == 0x000388, "Member 'UEmporiumBrowserFiltersPanel::SortEntries' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FilterEntries) == 0x000398, "Member 'UEmporiumBrowserFiltersPanel::FilterEntries' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, PriceFilterEntries) == 0x0003A8, "Member 'UEmporiumBrowserFiltersPanel::PriceFilterEntries' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, LicenseFilterEntries) == 0x0003B8, "Member 'UEmporiumBrowserFiltersPanel::LicenseFilterEntries' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, DefaultCategoryFilter) == 0x0003C8, "Member 'UEmporiumBrowserFiltersPanel::DefaultCategoryFilter' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, ScrollBox_FilterScroll) == 0x000420, "Member 'UEmporiumBrowserFiltersPanel::ScrollBox_FilterScroll' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, Button_All) == 0x000428, "Member 'UEmporiumBrowserFiltersPanel::Button_All' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, Button_SortAndFilter) == 0x000430, "Member 'UEmporiumBrowserFiltersPanel::Button_SortAndFilter' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, FocusSearchInputActionRow) == 0x000548, "Member 'UEmporiumBrowserFiltersPanel::FocusSearchInputActionRow' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, ClearSearchInputActionRow) == 0x000558, "Member 'UEmporiumBrowserFiltersPanel::ClearSearchInputActionRow' has a wrong offset!");
static_assert(offsetof(UEmporiumBrowserFiltersPanel, CycleSectionsInputActionRow) == 0x000568, "Member 'UEmporiumBrowserFiltersPanel::CycleSectionsInputActionRow' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnCategoryActivated;                               // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWidgetDestroyed;                                 // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnExpandCategory;                                  // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnItemThumbnailDownloaded;                         // 0x0318(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_328[0xF0];                                     // 0x0328(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortEmporiumItemDefinition) == 0x000418, "Wrong size on UFortEmporiumItemDefinition");
static_assert(offsetof(UFortEmporiumItemDefinition, OnItemThumbnailDownloaded) == 0x000318, "Member 'UFortEmporiumItemDefinition::OnItemThumbnailDownloaded' has a wrong offset!");
...
public:
	...
	class UItemDefinitionBase*                    CachedItemDefinition;                              // 0x0330(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UFortEmporiumItemDetailsPanel*          SubTabItemDetailsPanel;                            // 0x0940(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAthenaCustomizationPickerSortAndFilterBlade* Blade_SortAndFilter;                               // 0x0948(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonVisibilitySwitcher*              Switcher_SidePanels;                               // 0x0950(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_Categories) == 0x000888, "Member 'UFortEmporiumItemListMenu::Switcher_Categories' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_ItemTabWarnings) == 0x000890, "Member 'UFortEmporiumItemListMenu::Switcher_ItemTabWarnings' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_ChestEmpty) == 0x000898, "Member 'UFortEmporiumItemListMenu::Overlay_ChestEmpty' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_TabEmpty) == 0x0008A0, "Member 'UFortEmporiumItemListMenu::Overlay_TabEmpty' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_DownloadingFabCategories) == 0x0008A8, "Member 'UFortEmporiumItemListMenu::Overlay_DownloadingFabCategories' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_FabCategoriesNotLoaded) == 0x0008B0, "Member 'UFortEmporiumItemListMenu::Overlay_FabCategoriesNotLoaded' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_CommandBar) == 0x0008B8, "Member 'UFortEmporiumItemListMenu::Switcher_CommandBar' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_ChestCommands) == 0x0008C0, "Member 'UFortEmporiumItemListMenu::Overlay_ChestCommands' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_VendCommands) == 0x0008C8, "Member 'UFortEmporiumItemListMenu::Overlay_VendCommands' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, MenuQuickbar_QuickBars) == 0x0008D0, "Member 'UFortEmporiumItemListMenu::MenuQuickbar_QuickBars' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_ResetChest) == 0x0008D8, "Member 'UFortEmporiumItemListMenu::Button_ResetChest' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_CreateChest) == 0x0008E0, "Member 'UFortEmporiumItemListMenu::Button_CreateChest' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_AddToQuickBar) == 0x0008E8, "Member 'UFortEmporiumItemListMenu::Button_AddToQuickBar' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_OpenItem) == 0x0008F0, "Member 'UFortEmporiumItemListMenu::Button_OpenItem' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_PlaceNow) == 0x0008F8, "Member 'UFortEmporiumItemListMenu::Button_PlaceNow' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_Equip) == 0x000900, "Member 'UFortEmporiumItemListMenu::Button_Equip' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_AddToChest) == 0x000908, "Member 'UFortEmporiumItemListMenu::Button_AddToChest' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_Drop) == 0x000910, "Member 'UFortEmporiumItemListMenu::Button_Drop' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_CreateLlama) == 0x000918, "Member 'UFortEmporiumItemListMenu::Button_CreateLlama' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Button_RemoveFromChest) == 0x000920, "Member 'UFortEmporiumItemListMenu::Button_RemoveFromChest' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_SearchFilters) == 0x000928, "Member 'UFortEmporiumItemListMenu::Overlay_SearchFilters' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_LeftPanel) == 0x000930, "Member 'UFortEmporiumItemListMenu::Switcher_LeftPanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, FiltersPanel) == 0x000938, "Member 'UFortEmporiumItemListMenu::FiltersPanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, SubTabItemDetailsPanel) == 0x000940, "Member 'UFortEmporiumItemListMenu::SubTabItemDetailsPanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Blade_SortAndFilter) == 0x000948, "Member 'UFortEmporiumItemListMenu::Blade_SortAndFilter' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_SidePanels) == 0x000950, "Member 'UFortEmporiumItemListMenu::Switcher_SidePanels' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, ItemDetailsSidePanel_DefaultSidePanel) == 0x000958, "Member 'UFortEmporiumItemListMenu::ItemDetailsSidePanel_DefaultSidePanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_ProductPage) == 0x000960, "Member 'UFortEmporiumItemListMenu::Switcher_ProductPage' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_ItemBrowser) == 0x000968, "Member 'UFortEmporiumItemListMenu::Overlay_ItemBrowser' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, ItemProductPagePanel) == 0x000970, "Member 'UFortEmporiumItemListMenu::ItemProductPagePanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Switcher_InventoryPermission) == 0x000978, "Member 'UFortEmporiumItemListMenu::Switcher_InventoryPermission' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_EmporiumPanel) == 0x000980, "Member 'UFortEmporiumItemListMenu::Overlay_EmporiumPanel' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_InventoryNotAllowed) == 0x000988, "Member 'UFortEmporiumItemListMenu::Overlay_InventoryNotAllowed' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_EditorDisconnected) == 0x000990, "Member 'UFortEmporiumItemListMenu::Overlay_EditorDisconnected' has a wrong offset!");
static_assert(offsetof(UFortEmporiumItemListMenu, Overlay_InitializingInventory) == 0x000998, "Member 'UFortEmporiumItemListMenu::Overlay_InitializingInventory' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnItemCountChanged;                                // 0x0660(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
