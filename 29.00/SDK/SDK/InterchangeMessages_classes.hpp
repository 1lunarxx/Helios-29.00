...
{
public:
	class FText                                   Text;                                              // 0x0080(0x0018)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResultMeshWarning_Generic) == 0x000098, "Wrong size on UInterchangeResultMeshWarning_Generic");
...
static_assert(sizeof(UInterchangeResultMeshError_Generic) == 0x000098, "Wrong size on UInterchangeResultMeshError_Generic");
...
static_assert(sizeof(UInterchangeResultTextureWarning_TextureFileDoNotExist) == 0x0000A8, "Wrong size on UInterchangeResultTextureWarning_TextureFileDoNotExist");
...
static_assert(offsetof(UInterchangeResultTextureWarning_TextureFileDoNotExist, MaterialName) == 0x000098, "Member 'UInterchangeResultTextureWarning_TextureFileDoNotExist::MaterialName' has a wrong offset!");
