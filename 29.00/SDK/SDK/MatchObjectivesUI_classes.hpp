...
static_assert(sizeof(UFortMobileHUDElement_ObjectiveSelectorWrapper) == 0x000368, "Wrong size on UFortMobileHUDElement_ObjectiveSelectorWrapper");
static_assert(offsetof(UFortMobileHUDElement_ObjectiveSelectorWrapper, MatchQuestsComponent) == 0x000350, "Member 'UFortMobileHUDElement_ObjectiveSelectorWrapper::MatchQuestsComponent' has a wrong offset!");
static_assert(offsetof(UFortMobileHUDElement_ObjectiveSelectorWrapper, Overlay_WrapperContents) == 0x000358, "Member 'UFortMobileHUDElement_ObjectiveSelectorWrapper::Overlay_WrapperContents' has a wrong offset!");
...
public:
	...
	EMatchQuestsSelectorState                     WidgetSelectorState;                               // 0x0330(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_331[0x7];                                      // 0x0331(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputComponent*                        MatchObjectivesInputComponent;                     // 0x0338(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonButtonBase*                      Button_HeaderToggle;                               // 0x0340(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMatchObjectivesSelectorWidget) == 0x000350, "Wrong size on UMatchObjectivesSelectorWidget");
...
static_assert(offsetof(UMatchObjectivesSelectorWidget, WidgetSelectorState) == 0x000330, "Member 'UMatchObjectivesSelectorWidget::WidgetSelectorState' has a wrong offset!");
static_assert(offsetof(UMatchObjectivesSelectorWidget, MatchObjectivesInputComponent) == 0x000338, "Member 'UMatchObjectivesSelectorWidget::MatchObjectivesInputComponent' has a wrong offset!");
static_assert(offsetof(UMatchObjectivesSelectorWidget, Button_HeaderToggle) == 0x000340, "Member 'UMatchObjectivesSelectorWidget::Button_HeaderToggle' has a wrong offset!");
