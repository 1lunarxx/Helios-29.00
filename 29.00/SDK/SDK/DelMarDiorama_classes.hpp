...
static_assert(sizeof(ADelMarDriverCameraActor) == 0x000A30, "Wrong size on ADelMarDriverCameraActor");
static_assert(offsetof(ADelMarDriverCameraActor, CaptureComponent) == 0x000A20, "Member 'ADelMarDriverCameraActor::CaptureComponent' has a wrong offset!");
