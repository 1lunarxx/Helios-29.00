...
static_assert(sizeof(UBPS29_BattlePassTile_C) == 0x0017E0, "Wrong size on UBPS29_BattlePassTile_C");
static_assert(offsetof(UBPS29_BattlePassTile_C, UberGraphFrame) == 0x001670, "Member 'UBPS29_BattlePassTile_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Select_Premium) == 0x001678, "Member 'UBPS29_BattlePassTile_C::Select_Premium' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, GrowTile) == 0x001680, "Member 'UBPS29_BattlePassTile_C::GrowTile' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Hold_Completed) == 0x001688, "Member 'UBPS29_BattlePassTile_C::Hold_Completed' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Secondary_Hold_Progress) == 0x001690, "Member 'UBPS29_BattlePassTile_C::Secondary_Hold_Progress' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Hold_Progress) == 0x001698, "Member 'UBPS29_BattlePassTile_C::Hold_Progress' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Hover_Burst) == 0x0016A0, "Member 'UBPS29_BattlePassTile_C::Hover_Burst' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Reveal_Hide) == 0x0016A8, "Member 'UBPS29_BattlePassTile_C::Reveal_Hide' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Reveal) == 0x0016B0, "Member 'UBPS29_BattlePassTile_C::Reveal' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Select) == 0x0016B8, "Member 'UBPS29_BattlePassTile_C::Select' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Item_Hover) == 0x0016C0, "Member 'UBPS29_BattlePassTile_C::Item_Hover' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Availability_Switcher) == 0x0016C8, "Member 'UBPS29_BattlePassTile_C::Availability_Switcher' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Available_State) == 0x0016D0, "Member 'UBPS29_BattlePassTile_C::Available_State' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Border_SelectTrim) == 0x0016D8, "Member 'UBPS29_BattlePassTile_C::Border_SelectTrim' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Border_SelectTrim_1) == 0x0016E0, "Member 'UBPS29_BattlePassTile_C::Border_SelectTrim_1' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, EmptyBackground) == 0x0016E8, "Member 'UBPS29_BattlePassTile_C::EmptyBackground' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Equipped_State) == 0x0016F0, "Member 'UBPS29_BattlePassTile_C::Equipped_State' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HB_PriceInfo) == 0x0016F8, "Member 'UBPS29_BattlePassTile_C::HB_PriceInfo' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_Lock) == 0x001700, "Member 'UBPS29_BattlePassTile_C::Image_Lock' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_Preview) == 0x001708, "Member 'UBPS29_BattlePassTile_C::Image_Preview' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_PriceBg) == 0x001710, "Member 'UBPS29_BattlePassTile_C::Image_PriceBg' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_PriceBg_Tint) == 0x001718, "Member 'UBPS29_BattlePassTile_C::Image_PriceBg_Tint' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_Progress) == 0x001720, "Member 'UBPS29_BattlePassTile_C::Image_Progress' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Image_RewardItem_BG) == 0x001728, "Member 'UBPS29_BattlePassTile_C::Image_RewardItem_BG' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, InProgressBacking) == 0x001730, "Member 'UBPS29_BattlePassTile_C::InProgressBacking' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, InProgressOverlay) == 0x001738, "Member 'UBPS29_BattlePassTile_C::InProgressOverlay' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, InProgressText) == 0x001740, "Member 'UBPS29_BattlePassTile_C::InProgressText' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Locked_Overlay_Item) == 0x001748, "Member 'UBPS29_BattlePassTile_C::Locked_Overlay_Item' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Overlay_Input) == 0x001750, "Member 'UBPS29_BattlePassTile_C::Overlay_Input' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Owned_State) == 0x001758, "Member 'UBPS29_BattlePassTile_C::Owned_State' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, RainbowCorner) == 0x001760, "Member 'UBPS29_BattlePassTile_C::RainbowCorner' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Text_Price) == 0x001768, "Member 'UBPS29_BattlePassTile_C::Text_Price' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, VisibilitySwitcher_Included) == 0x001770, "Member 'UBPS29_BattlePassTile_C::VisibilitySwitcher_Included' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Has_prerequisite) == 0x001778, "Member 'UBPS29_BattlePassTile_C::Has_prerequisite' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Selected) == 0x001779, "Member 'UBPS29_BattlePassTile_C::Selected' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Hovered) == 0x00177A, "Member 'UBPS29_BattlePassTile_C::Hovered' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, IsPremiumTile) == 0x00177B, "Member 'UBPS29_BattlePassTile_C::IsPremiumTile' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, Locked) == 0x00177C, "Member 'UBPS29_BattlePassTile_C::Locked' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, OverlayTintColor) == 0x001780, "Member 'UBPS29_BattlePassTile_C::OverlayTintColor' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, ProgressCompleted) == 0x001790, "Member 'UBPS29_BattlePassTile_C::ProgressCompleted' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HoldStartedSound) == 0x001798, "Member 'UBPS29_BattlePassTile_C::HoldStartedSound' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HoldSound) == 0x0017A0, "Member 'UBPS29_BattlePassTile_C::HoldSound' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HoldInterruptedSound) == 0x0017A8, "Member 'UBPS29_BattlePassTile_C::HoldInterruptedSound' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HoldCompletedSound) == 0x0017B0, "Member 'UBPS29_BattlePassTile_C::HoldCompletedSound' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HoldSoundAudioComponent) == 0x0017B8, "Member 'UBPS29_BattlePassTile_C::HoldSoundAudioComponent' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, PressedSoundAudioComponent) == 0x0017C0, "Member 'UBPS29_BattlePassTile_C::PressedSoundAudioComponent' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, AudioLoopFadeOutTime) == 0x0017C8, "Member 'UBPS29_BattlePassTile_C::AudioLoopFadeOutTime' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, AudioLoopFadeInTime) == 0x0017D0, "Member 'UBPS29_BattlePassTile_C::AudioLoopFadeInTime' has a wrong offset!");
static_assert(offsetof(UBPS29_BattlePassTile_C, HasTrasnference) == 0x0017D8, "Member 'UBPS29_BattlePassTile_C::HasTrasnference' has a wrong offset!");
