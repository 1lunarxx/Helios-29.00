...
// Function ActivityBrowserLobbyTileButton_MinimalStyle.ActivityBrowserLobbyTileButton_MinimalStyle_C.OnShowChildModeChangedNotification__DelegateSignature
// 0x0018 (0x0018 - 0x0000)
struct ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature final
{
public:
	class FText                                   DisplayName;                                       // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature) == 0x000008, "Wrong alignment on ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature");
static_assert(sizeof(ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature) == 0x000018, "Wrong size on ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature");
static_assert(offsetof(ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature, DisplayName) == 0x000000, "Member 'ActivityBrowserLobbyTileButton_MinimalStyle_C_OnShowChildModeChangedNotification__DelegateSignature::DisplayName' has a wrong offset!");
