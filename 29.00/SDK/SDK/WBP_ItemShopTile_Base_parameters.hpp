...
public:
	...
	bool                                          CallFunc_InEditorOrPIE_ReturnValue;                // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_82[0x2];                                       // 0x0082(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetConsoleVariableFloatValue_ReturnValue; // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base) == 0x000088, "Wrong size on WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base");
...
static_assert(offsetof(WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base, CallFunc_GetOwningPlayer_ReturnValue) == 0x000078, "Member 'WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base, CallFunc_IsUsingTouch_ReturnValue) == 0x000080, "Member 'WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base, CallFunc_InEditorOrPIE_ReturnValue) == 0x000081, "Member 'WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base::CallFunc_InEditorOrPIE_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base, CallFunc_GetConsoleVariableFloatValue_ReturnValue) == 0x000084, "Member 'WBP_ItemShopTile_Base_C_ExecuteUbergraph_WBP_ItemShopTile_Base::CallFunc_GetConsoleVariableFloatValue_ReturnValue' has a wrong offset!");
...
// Function WBP_ItemShopTile_Base.WBP_ItemShopTile_Base_C.OnTileFocused__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature final
{
public:
...
static_assert(alignof(WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature) == 0x000008, "Wrong alignment on WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature");
static_assert(sizeof(WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature) == 0x000008, "Wrong size on WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature");
static_assert(offsetof(WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature, FocusedTile) == 0x000000, "Member 'WBP_ItemShopTile_Base_C_OnTileFocused__DelegateSignature::FocusedTile' has a wrong offset!");
