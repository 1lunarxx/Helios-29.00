...
// Parameters:
// TSoftObjectPtr<class UAnimSequence>     LipSyncAnimSequence                                    (ConstParm, Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<class APlayerState*>             PlayerStates                                           (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UPlayspaceComponent_LipSyncAssetManager::LipSyncAnimDecidedDelegate__DelegateSignature(const TSoftObjectPtr<class UAnimSequence> LipSyncAnimSequence, const TArray<class APlayerState*>& PlayerStates)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayspaceComponent_LipSyncAssetManager", "LipSyncAnimDecidedDelegate__DelegateSignature");

	Params::PlayspaceComponent_LipSyncAssetManager_LipSyncAnimDecidedDelegate__DelegateSignature Parms{};

	Parms.LipSyncAnimSequence = LipSyncAnimSequence;
...
// Parameters:
// TScriptInterface<class IMidiEventDriverInterface>MidiEventDriver                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void ASparksMusicPlayspace::MidiEventDataParsedDelegate__DelegateSignature(TScriptInterface<class IMidiEventDriverInterface> MidiEventDriver, class UParsedMidiEventData* ParsedMidiEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SparksMusicPlayspace", "MidiEventDataParsedDelegate__DelegateSignature");

	Params::SparksMusicPlayspace_MidiEventDataParsedDelegate__DelegateSignature Parms{};
...
void ASparksMusicPlayspace::MidiEventDriverChangedDelegate__DelegateSignature(TScriptInterface<class IMidiEventDriverInterface> MidiEventDriver)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SparksMusicPlayspace", "MidiEventDriverChangedDelegate__DelegateSignature");

	Params::SparksMusicPlayspace_MidiEventDriverChangedDelegate__DelegateSignature Parms{};
