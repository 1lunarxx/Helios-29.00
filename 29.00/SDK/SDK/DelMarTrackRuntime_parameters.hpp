...
static_assert(offsetof(DelMarTrackBase_ForceValidTrack, SplineIndex) == 0x000000, "Member 'DelMarTrackBase_ForceValidTrack::SplineIndex' has a wrong offset!");
static_assert(offsetof(DelMarTrackBase_ForceValidTrack, ReturnValue) == 0x000004, "Member 'DelMarTrackBase_ForceValidTrack::ReturnValue' has a wrong offset!");
