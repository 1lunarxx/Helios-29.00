...
{
public:
	struct FScalableFloat                         AugmentsEnabledViaHotfix;                          // 0x0670(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<struct FGameplayTag, TSoftObjectPtr<class UObject>> TagToImageMap;                                     // 0x0698(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UCommonTextBlock*                       Text_CategoryTitle;                                // 0x06E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortPlayerAugmentCollectionScreen) == 0x0006F0, "Wrong size on UFortPlayerAugmentCollectionScreen");
static_assert(offsetof(UFortPlayerAugmentCollectionScreen, AugmentsEnabledViaHotfix) == 0x000670, "Member 'UFortPlayerAugmentCollectionScreen::AugmentsEnabledViaHotfix' has a wrong offset!");
static_assert(offsetof(UFortPlayerAugmentCollectionScreen, TagToImageMap) == 0x000698, "Member 'UFortPlayerAugmentCollectionScreen::TagToImageMap' has a wrong offset!");
static_assert(offsetof(UFortPlayerAugmentCollectionScreen, Text_CategoryTitle) == 0x0006E8, "Member 'UFortPlayerAugmentCollectionScreen::Text_CategoryTitle' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         UnblockInteractionWithChoicesTime;                 // 0x0330(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<class UFortPlayerAugmentItemDefinition*> AvailableAugmentItemDefinitions;                   // 0x0358(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UWidget*                                Overlay_Reroll;                                    // 0x0368(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortPlayerAugmentGranterWidget) == 0x000380, "Wrong size on UFortPlayerAugmentGranterWidget");
static_assert(offsetof(UFortPlayerAugmentGranterWidget, UnblockInteractionWithChoicesTime) == 0x000330, "Member 'UFortPlayerAugmentGranterWidget::UnblockInteractionWithChoicesTime' has a wrong offset!");
static_assert(offsetof(UFortPlayerAugmentGranterWidget, AvailableAugmentItemDefinitions) == 0x000358, "Member 'UFortPlayerAugmentGranterWidget::AvailableAugmentItemDefinitions' has a wrong offset!");
static_assert(offsetof(UFortPlayerAugmentGranterWidget, Overlay_Reroll) == 0x000368, "Member 'UFortPlayerAugmentGranterWidget::Overlay_Reroll' has a wrong offset!");
