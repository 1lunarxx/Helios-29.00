...
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, LODThreshold) == 0x00012C, "Member 'FAnimNode_RetargetPoseFromMesh::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, LODThresholdForIK) == 0x000130, "Member 'FAnimNode_RetargetPoseFromMesh::LODThresholdForIK' has a wrong offset!");
