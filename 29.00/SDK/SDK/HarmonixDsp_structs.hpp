...
static_assert(offsetof(FAdsrSettings, Target) == 0x000000, "Member 'FAdsrSettings::Target' has a wrong offset!");
static_assert(offsetof(FAdsrSettings, IsEnabled) == 0x000001, "Member 'FAdsrSettings::IsEnabled' has a wrong offset!");
...
static_assert(offsetof(FAdsrSettingsArray, Array) == 0x000000, "Member 'FAdsrSettingsArray::Array' has a wrong offset!");
...
static_assert(offsetof(FLfoSettings, Target) == 0x000000, "Member 'FLfoSettings::Target' has a wrong offset!");
static_assert(offsetof(FLfoSettings, IsEnabled) == 0x000001, "Member 'FLfoSettings::IsEnabled' has a wrong offset!");
static_assert(offsetof(FLfoSettings, Shape) == 0x000002, "Member 'FLfoSettings::Shape' has a wrong offset!");
...
static_assert(offsetof(FLfoSettingsArray, Array) == 0x000000, "Member 'FLfoSettingsArray::Array' has a wrong offset!");
...
static_assert(offsetof(FModulatorSettingsArray, Array) == 0x000000, "Member 'FModulatorSettingsArray::Array' has a wrong offset!");
...
static_assert(offsetof(FFusionPatchSettings, VolumeDb) == 0x000000, "Member 'FFusionPatchSettings::VolumeDb' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, PannerDetails) == 0x000004, "Member 'FFusionPatchSettings::PannerDetails' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, DownPitchBendCents) == 0x000010, "Member 'FFusionPatchSettings::DownPitchBendCents' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, UpPitchBendCents) == 0x000014, "Member 'FFusionPatchSettings::UpPitchBendCents' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, FineTuneCents) == 0x000018, "Member 'FFusionPatchSettings::FineTuneCents' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, StartPointOffsetMs) == 0x00001C, "Member 'FFusionPatchSettings::StartPointOffsetMs' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, MaxVoices) == 0x000020, "Member 'FFusionPatchSettings::MaxVoices' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, KeyzoneSelectMode) == 0x000024, "Member 'FFusionPatchSettings::KeyzoneSelectMode' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Portamento) == 0x000028, "Member 'FFusionPatchSettings::Portamento' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Filter) == 0x000030, "Member 'FFusionPatchSettings::Filter' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Adsr) == 0x000048, "Member 'FFusionPatchSettings::Adsr' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, LFO) == 0x000288, "Member 'FFusionPatchSettings::LFO' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Randomizer) == 0x0002B8, "Member 'FFusionPatchSettings::Randomizer' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, VelocityModulator) == 0x0002D0, "Member 'FFusionPatchSettings::VelocityModulator' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Adsrs) == 0x0002E8, "Member 'FFusionPatchSettings::Adsrs' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Lfos) == 0x000528, "Member 'FFusionPatchSettings::Lfos' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, Randomizers) == 0x000558, "Member 'FFusionPatchSettings::Randomizers' has a wrong offset!");
static_assert(offsetof(FFusionPatchSettings, VelocityModulators) == 0x000570, "Member 'FFusionPatchSettings::VelocityModulators' has a wrong offset!");
...
static_assert(offsetof(FFusionPatchData, Settings) == 0x000010, "Member 'FFusionPatchData::Settings' has a wrong offset!");
static_assert(offsetof(FFusionPatchData, Presets) == 0x000598, "Member 'FFusionPatchData::Presets' has a wrong offset!");
