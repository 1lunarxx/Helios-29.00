...
static_assert(offsetof(FDelMarVehicleConfigOverride_Kickflip, bResetChargesOnLanding) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Kickflip::bResetChargesOnLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Kickflip, NumActivationCharges) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Kickflip::NumActivationCharges' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Kickflip, CooldownSeconds) == 0x000008, "Member 'FDelMarVehicleConfigOverride_Kickflip::CooldownSeconds' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Collision, bCollisionDemosEnabled) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Collision::bCollisionDemosEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Collision, bWallRicochetEnabled) == 0x000001, "Member 'FDelMarVehicleConfigOverride_Collision::bWallRicochetEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Collision, DemoSpeedScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Collision::DemoSpeedScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Drift, SpeedCapScalar) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Drift::SpeedCapScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drift, AccelerationRateScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Drift::AccelerationRateScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drift, DecelerationRateScalar) == 0x000008, "Member 'FDelMarVehicleConfigOverride_Drift::DecelerationRateScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_DriftBoost, MaxBonusSpeedScalar) == 0x000000, "Member 'FDelMarVehicleConfigOverride_DriftBoost::MaxBonusSpeedScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_DriftBoost, DurationScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_DriftBoost::DurationScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_DriftBoost, PotentialRateScalar) == 0x000008, "Member 'FDelMarVehicleConfigOverride_DriftBoost::PotentialRateScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Drive, MaxBaseForwardSpeedScalar) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Drive::MaxBaseForwardSpeedScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drive, AccelerationScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Drive::AccelerationScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drive, DecelerationScalar) == 0x000008, "Member 'FDelMarVehicleConfigOverride_Drive::DecelerationScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drive, BrakeScalar) == 0x00000C, "Member 'FDelMarVehicleConfigOverride_Drive::BrakeScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Drive, MaxAerialSpeedScalar) == 0x000010, "Member 'FDelMarVehicleConfigOverride_Drive::MaxAerialSpeedScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Jump, JumpImpulseScalar) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Jump::JumpImpulseScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Oversteer, bEnabled) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Oversteer::bEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Oversteer, AccumulatedSteerThresholdScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Oversteer::AccumulatedSteerThresholdScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, StartingVehicleCharges) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Turbo::StartingVehicleCharges' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, ChargeRegenRateScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Turbo::ChargeRegenRateScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, DriftBoostTurboGenerationScalar) == 0x000008, "Member 'FDelMarVehicleConfigOverride_Turbo::DriftBoostTurboGenerationScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, TurboSpeedScalar) == 0x00000C, "Member 'FDelMarVehicleConfigOverride_Turbo::TurboSpeedScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, MaxActiveTimeSeconds) == 0x000010, "Member 'FDelMarVehicleConfigOverride_Turbo::MaxActiveTimeSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Turbo, SuccessfulBonusZoneHitSeconds) == 0x000014, "Member 'FDelMarVehicleConfigOverride_Turbo::SuccessfulBonusZoneHitSeconds' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, StartingTankPercentage) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Underthrust::StartingTankPercentage' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, ConsumptionRateMultiplier) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Underthrust::ConsumptionRateMultiplier' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, bReplenishTankOnLanding) == 0x000008, "Member 'FDelMarVehicleConfigOverride_Underthrust::bReplenishTankOnLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, bReplenishTankOverTime) == 0x000009, "Member 'FDelMarVehicleConfigOverride_Underthrust::bReplenishTankOverTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, TankReplenishDelaySeconds) == 0x00000C, "Member 'FDelMarVehicleConfigOverride_Underthrust::TankReplenishDelaySeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, TankReplenishRateMultiplier) == 0x000010, "Member 'FDelMarVehicleConfigOverride_Underthrust::TankReplenishRateMultiplier' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, AccelScalar) == 0x000014, "Member 'FDelMarVehicleConfigOverride_Underthrust::AccelScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Underthrust, MaxUpwardSpeedScalar) == 0x000018, "Member 'FDelMarVehicleConfigOverride_Underthrust::MaxUpwardSpeedScalar' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDelMarVehicleConfigOverride_Collision Collision;                                         // 0x0004(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Drift     Drift;                                             // 0x000C(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_DriftBoost DriftBoost;                                        // 0x0018(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Drive     Drive;                                             // 0x0024(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Jump      Jump;                                              // 0x0038(0x0004)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Kickflip  Kickflip;                                          // 0x003C(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Oversteer Oversteer;                                         // 0x0048(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Turbo     Turbo;                                             // 0x0050(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarVehicleConfigOverride_Underthrust Underthrust;                                       // 0x0068(0x001C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarVehicleConfigOverrides) == 0x000004, "Wrong alignment on FDelMarVehicleConfigOverrides");
static_assert(sizeof(FDelMarVehicleConfigOverrides) == 0x000084, "Wrong size on FDelMarVehicleConfigOverrides");
static_assert(offsetof(FDelMarVehicleConfigOverrides, bValid) == 0x000000, "Member 'FDelMarVehicleConfigOverrides::bValid' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Collision) == 0x000004, "Member 'FDelMarVehicleConfigOverrides::Collision' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Drift) == 0x00000C, "Member 'FDelMarVehicleConfigOverrides::Drift' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, DriftBoost) == 0x000018, "Member 'FDelMarVehicleConfigOverrides::DriftBoost' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Drive) == 0x000024, "Member 'FDelMarVehicleConfigOverrides::Drive' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Jump) == 0x000038, "Member 'FDelMarVehicleConfigOverrides::Jump' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Kickflip) == 0x00003C, "Member 'FDelMarVehicleConfigOverrides::Kickflip' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Oversteer) == 0x000048, "Member 'FDelMarVehicleConfigOverrides::Oversteer' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Turbo) == 0x000050, "Member 'FDelMarVehicleConfigOverrides::Turbo' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Underthrust) == 0x000068, "Member 'FDelMarVehicleConfigOverrides::Underthrust' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleRuntimeConfig, bApplyOverlapFilter) == 0x000011, "Member 'FDelMarVehicleRuntimeConfig::bApplyOverlapFilter' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, StartingTankPercentage) == 0x000014, "Member 'FDelMarVehicleConfig_Underthrust::StartingTankPercentage' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, MaxThrustSeconds) == 0x000018, "Member 'FDelMarVehicleConfig_Underthrust::MaxThrustSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, ForwardSpeedCap) == 0x00001C, "Member 'FDelMarVehicleConfig_Underthrust::ForwardSpeedCap' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, MaxSpeedReduction) == 0x000020, "Member 'FDelMarVehicleConfig_Underthrust::MaxSpeedReduction' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, SpeedCapSecondsBuffer) == 0x000024, "Member 'FDelMarVehicleConfig_Underthrust::SpeedCapSecondsBuffer' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, MinJumpActiveSecondsBeforeActivating) == 0x000028, "Member 'FDelMarVehicleConfig_Underthrust::MinJumpActiveSecondsBeforeActivating' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, FallingUpsideDownThrustDampeningPercentage) == 0x000030, "Member 'FDelMarVehicleConfig_Underthrust::FallingUpsideDownThrustDampeningPercentage' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bVehicleRelativeWithFreestyle) == 0x0000C0, "Member 'FDelMarVehicleConfig_Underthrust::bVehicleRelativeWithFreestyle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, MinUpwardAccel) == 0x0000C4, "Member 'FDelMarVehicleConfig_Underthrust::MinUpwardAccel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, LateralRelativeAccel) == 0x0000C8, "Member 'FDelMarVehicleConfig_Underthrust::LateralRelativeAccel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bReplenishTankOnLanding) == 0x0000CC, "Member 'FDelMarVehicleConfig_Underthrust::bReplenishTankOnLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bReplenishTankOverTime) == 0x0000CD, "Member 'FDelMarVehicleConfig_Underthrust::bReplenishTankOverTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, TankReplenishDelaySeconds) == 0x0000D0, "Member 'FDelMarVehicleConfig_Underthrust::TankReplenishDelaySeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, TankReplenishRatePerSecond) == 0x0000D4, "Member 'FDelMarVehicleConfig_Underthrust::TankReplenishRatePerSecond' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_Gravity, MinWheelsForCounterGravityMeasures) == 0x000014, "Member 'FDelMarVehicleConfig_Gravity::MinWheelsForCounterGravityMeasures' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Gravity, MaxCounterGravitySpringVarianceDegrees) == 0x000018, "Member 'FDelMarVehicleConfig_Gravity::MaxCounterGravitySpringVarianceDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Gravity, bCounterGravityInKickflipSuctionDirection) == 0x00001C, "Member 'FDelMarVehicleConfig_Gravity::bCounterGravityInKickflipSuctionDirection' has a wrong offset!");
...
// 0x0850 (0x09F0 - 0x01A0)
struct alignas(0x10) FDelMarVehicleInPersistent final : public FFortVehicleInPersistent
{
public:
	uint8                                         Pad_1A0[0x850];                                    // 0x01A0(0x0850)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDelMarVehicleInPersistent) == 0x000010, "Wrong alignment on FDelMarVehicleInPersistent");
static_assert(sizeof(FDelMarVehicleInPersistent) == 0x0009F0, "Wrong size on FDelMarVehicleInPersistent");
...
public:
	...
	float                                         MaxLandingSpeedSpringVarianceDegrees;              // 0x0350(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDownDegreesForForwardDirection;                 // 0x0354(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxNormalizedForwardSpeed;                         // 0x0358(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxNormalizedBonusSpeed;                           // 0x035C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxLandingSpeedSpringVarianceDegrees) == 0x000350, "Member 'FDelMarVehicleDriveSetup::MaxLandingSpeedSpringVarianceDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinDownDegreesForForwardDirection) == 0x000354, "Member 'FDelMarVehicleDriveSetup::MinDownDegreesForForwardDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxNormalizedForwardSpeed) == 0x000358, "Member 'FDelMarVehicleDriveSetup::MaxNormalizedForwardSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxNormalizedBonusSpeed) == 0x00035C, "Member 'FDelMarVehicleDriveSetup::MaxNormalizedBonusSpeed' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, bResetChargesOnLanding) == 0x000014, "Member 'FDelMarVehicleConfig_Kickflip::bResetChargesOnLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinActiveSecondsToReactivate) == 0x000018, "Member 'FDelMarVehicleConfig_Kickflip::MinActiveSecondsToReactivate' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinActiveTime) == 0x00001C, "Member 'FDelMarVehicleConfig_Kickflip::MinActiveTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxActiveLateralTime) == 0x000020, "Member 'FDelMarVehicleConfig_Kickflip::MaxActiveLateralTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxActiveUpwardTime) == 0x000024, "Member 'FDelMarVehicleConfig_Kickflip::MaxActiveUpwardTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxActiveDownwardTime) == 0x000028, "Member 'FDelMarVehicleConfig_Kickflip::MaxActiveDownwardTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, CooldownSeconds) == 0x00002C, "Member 'FDelMarVehicleConfig_Kickflip::CooldownSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, bAllowGroundedKickflips) == 0x000030, "Member 'FDelMarVehicleConfig_Kickflip::bAllowGroundedKickflips' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, GroundedKickflipForce) == 0x000034, "Member 'FDelMarVehicleConfig_Kickflip::GroundedKickflipForce' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, LateralVelocity) == 0x000038, "Member 'FDelMarVehicleConfig_Kickflip::LateralVelocity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, LateralVelocityScalarCurve) == 0x000040, "Member 'FDelMarVehicleConfig_Kickflip::LateralVelocityScalarCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinForwardSpeedForLateralScalar) == 0x0000D0, "Member 'FDelMarVehicleConfig_Kickflip::MinForwardSpeedForLateralScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxLateralVelocityCancelled) == 0x0000D4, "Member 'FDelMarVehicleConfig_Kickflip::MaxLateralVelocityCancelled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, UpwardVerticalVelocity) == 0x0000D8, "Member 'FDelMarVehicleConfig_Kickflip::UpwardVerticalVelocity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, DownwardVerticalVelocity) == 0x0000DC, "Member 'FDelMarVehicleConfig_Kickflip::DownwardVerticalVelocity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, LateralVerticalForce) == 0x0000E0, "Member 'FDelMarVehicleConfig_Kickflip::LateralVerticalForce' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, RotationDamping) == 0x0000E4, "Member 'FDelMarVehicleConfig_Kickflip::RotationDamping' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, RotationTorque) == 0x0000E8, "Member 'FDelMarVehicleConfig_Kickflip::RotationTorque' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, RotationTorqueIncomingCollision) == 0x0000EC, "Member 'FDelMarVehicleConfig_Kickflip::RotationTorqueIncomingCollision' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinSpeedToRotateYaw) == 0x0000F0, "Member 'FDelMarVehicleConfig_Kickflip::MinSpeedToRotateYaw' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxVerticalYawLandingDegrees) == 0x0000F4, "Member 'FDelMarVehicleConfig_Kickflip::MaxVerticalYawLandingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxLateralYawLandingDegrees) == 0x0000F8, "Member 'FDelMarVehicleConfig_Kickflip::MaxLateralYawLandingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxVerticalNormalLandingDegrees) == 0x0000FC, "Member 'FDelMarVehicleConfig_Kickflip::MaxVerticalNormalLandingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxLateralNormalLandingDegrees) == 0x000100, "Member 'FDelMarVehicleConfig_Kickflip::MaxLateralNormalLandingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinLongRollTimeCheck) == 0x000104, "Member 'FDelMarVehicleConfig_Kickflip::MinLongRollTimeCheck' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinLongRollTimeCheckDownwardKick) == 0x000108, "Member 'FDelMarVehicleConfig_Kickflip::MinLongRollTimeCheckDownwardKick' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxLongRollDegrees) == 0x00010C, "Member 'FDelMarVehicleConfig_Kickflip::MaxLongRollDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinDegreesToCompleteRoll) == 0x000110, "Member 'FDelMarVehicleConfig_Kickflip::MinDegreesToCompleteRoll' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, FastTorqueDistanceCheck) == 0x000114, "Member 'FDelMarVehicleConfig_Kickflip::FastTorqueDistanceCheck' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, bUseStartingDirectionWhenLanding) == 0x000118, "Member 'FDelMarVehicleConfig_Kickflip::bUseStartingDirectionWhenLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, PredictionTickInterval) == 0x00011C, "Member 'FDelMarVehicleConfig_Kickflip::PredictionTickInterval' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxSimulationRedirectSeconds) == 0x000120, "Member 'FDelMarVehicleConfig_Kickflip::MaxSimulationRedirectSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxSimulationDistanceLateral) == 0x000124, "Member 'FDelMarVehicleConfig_Kickflip::MaxSimulationDistanceLateral' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxSimulationDistanceUpward) == 0x000128, "Member 'FDelMarVehicleConfig_Kickflip::MaxSimulationDistanceUpward' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxSimulationDistanceDownward) == 0x00012C, "Member 'FDelMarVehicleConfig_Kickflip::MaxSimulationDistanceDownward' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, bApplySuctionToSurfaces) == 0x000130, "Member 'FDelMarVehicleConfig_Kickflip::bApplySuctionToSurfaces' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, SuctionVelocity) == 0x000134, "Member 'FDelMarVehicleConfig_Kickflip::SuctionVelocity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxSuctionPerSecond) == 0x000138, "Member 'FDelMarVehicleConfig_Kickflip::MaxSuctionPerSecond' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, SuctionDistanceCheck) == 0x00013C, "Member 'FDelMarVehicleConfig_Kickflip::SuctionDistanceCheck' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxAdditionalVelocitySuctionDistance) == 0x000140, "Member 'FDelMarVehicleConfig_Kickflip::MaxAdditionalVelocitySuctionDistance' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, SuctionChannel) == 0x000144, "Member 'FDelMarVehicleConfig_Kickflip::SuctionChannel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxForwardVelocityDegreeDifference) == 0x000148, "Member 'FDelMarVehicleConfig_Kickflip::MaxForwardVelocityDegreeDifference' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MinSpeedForPrimaryForwardRotation) == 0x00014C, "Member 'FDelMarVehicleConfig_Kickflip::MinSpeedForPrimaryForwardRotation' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Kickflip, MaxGroundedDirectionDegrees) == 0x000150, "Member 'FDelMarVehicleConfig_Kickflip::MaxGroundedDirectionDegrees' has a wrong offset!");
