...
static_assert(sizeof(FGameInputControllerAxisData) == 0x000010, "Wrong size on FGameInputControllerAxisData");
...
static_assert(offsetof(FGameInputControllerAxisData, DeadZone) == 0x000004, "Member 'FGameInputControllerAxisData::DeadZone' has a wrong offset!");
static_assert(offsetof(FGameInputControllerAxisData, Scalar) == 0x000008, "Member 'FGameInputControllerAxisData::Scalar' has a wrong offset!");
static_assert(offsetof(FGameInputControllerAxisData, bIsPackedPositveAndNegative) == 0x00000C, "Member 'FGameInputControllerAxisData::bIsPackedPositveAndNegative' has a wrong offset!");
...
public:
	class FName                                   KeyName;                                           // 0x0000(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERawDeviceReportTranslationBehavior           TranslationBehavior;                               // 0x0004(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         AnalogDeadzone;                                    // 0x0005(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameInputRawDeviceReportData, TranslationBehavior) == 0x000004, "Member 'FGameInputRawDeviceReportData::TranslationBehavior' has a wrong offset!");
static_assert(offsetof(FGameInputRawDeviceReportData, AnalogDeadzone) == 0x000005, "Member 'FGameInputRawDeviceReportData::AnalogDeadzone' has a wrong offset!");
static_assert(offsetof(FGameInputRawDeviceReportData, Scalar) == 0x000008, "Member 'FGameInputRawDeviceReportData::Scalar' has a wrong offset!");
