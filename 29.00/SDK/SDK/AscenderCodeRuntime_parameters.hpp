...
static_assert(offsetof(FortPawnComponent_AscenderMontageProvider_GetSuitableMontage, bAscending) == 0x000000, "Member 'FortPawnComponent_AscenderMontageProvider_GetSuitableMontage::bAscending' has a wrong offset!");
static_assert(offsetof(FortPawnComponent_AscenderMontageProvider_GetSuitableMontage, ReturnValue) == 0x000008, "Member 'FortPawnComponent_AscenderMontageProvider_GetSuitableMontage::ReturnValue' has a wrong offset!");
