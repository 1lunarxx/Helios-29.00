...
TOptional<class UEntity_entity*, true> UDevices_creative_prop::_L_2fFortnite_2ecom_2fDevices_2fcreative__prop_N_RGetEntity(const struct VerseDevices_0::FTuple_L_R& __verse_0xB2CDDD72_Argument)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Devices_creative_prop", "_L_2fFortnite_2ecom_2fDevices_2fcreative__prop_N_RGetEntity");

	Params::Devices_creative_prop__L_2fFortnite_2ecom_2fDevices_2fcreative__prop_N_RGetEntity Parms{};
