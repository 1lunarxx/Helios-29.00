...
static_assert(offsetof(TooltipMinusCustomMinusS_C_Get_Icon_Brush, CallFunc_MakeBrushFromAsset_ReturnValue) == 0x0000C0, "Member 'TooltipMinusCustomMinusS_C_Get_Icon_Brush::CallFunc_MakeBrushFromAsset_ReturnValue' has a wrong offset!");
