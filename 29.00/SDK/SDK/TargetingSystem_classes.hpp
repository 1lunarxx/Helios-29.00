...
{
public:
	FMulticastInlineDelegateProperty_             OnTargetReady;                                     // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTargetingSelectionTask_Trace) == 0x000170, "Wrong size on UTargetingSelectionTask_Trace");
...
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSweptTraceCapsuleHalfHeight) == 0x000058, "Member 'UTargetingSelectionTask_Trace::DefaultSweptTraceCapsuleHalfHeight' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentX) == 0x000080, "Member 'UTargetingSelectionTask_Trace::DefaultSweptTraceBoxHalfExtentX' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentY) == 0x0000A8, "Member 'UTargetingSelectionTask_Trace::DefaultSweptTraceBoxHalfExtentY' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentZ) == 0x0000D0, "Member 'UTargetingSelectionTask_Trace::DefaultSweptTraceBoxHalfExtentZ' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSweptTraceRotation) == 0x0000F8, "Member 'UTargetingSelectionTask_Trace::DefaultSweptTraceRotation' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultTraceLength) == 0x000110, "Member 'UTargetingSelectionTask_Trace::DefaultTraceLength' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSourceOffset) == 0x000138, "Member 'UTargetingSelectionTask_Trace::DefaultSourceOffset' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, ExplicitTraceDirection) == 0x000150, "Member 'UTargetingSelectionTask_Trace::ExplicitTraceDirection' has a wrong offset!");
