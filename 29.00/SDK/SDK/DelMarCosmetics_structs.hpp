...
static_assert(alignof(FDelMarPreviewCustomization) == 0x000008, "Wrong alignment on FDelMarPreviewCustomization");
static_assert(sizeof(FDelMarPreviewCustomization) == 0x000018, "Wrong size on FDelMarPreviewCustomization");
static_assert(offsetof(FDelMarPreviewCustomization, SlotTag) == 0x000000, "Member 'FDelMarPreviewCustomization::SlotTag' has a wrong offset!");
static_assert(offsetof(FDelMarPreviewCustomization, CustomizationInfo) == 0x000008, "Member 'FDelMarPreviewCustomization::CustomizationInfo' has a wrong offset!");
