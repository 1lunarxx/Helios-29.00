...
static_assert(offsetof(AFrontendCamera_Manage_C, UberGraphFrame) == 0x000A10, "Member 'AFrontendCamera_Manage_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Manage_C, LoginCamera_0) == 0x000A18, "Member 'AFrontendCamera_Manage_C::LoginCamera_0' has a wrong offset!");
