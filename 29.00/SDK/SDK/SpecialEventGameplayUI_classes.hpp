...
public:
	...
	FMulticastInlineDelegateProperty_             OnRepresentedPlayerStateChanged;                   // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
