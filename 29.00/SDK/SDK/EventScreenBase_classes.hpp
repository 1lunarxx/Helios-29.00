...
static_assert(sizeof(UFortEventModalBase) == 0x000410, "Wrong size on UFortEventModalBase");
...
{
public:
	class UDynamicEntryBox*                       DynamicEntryBox_Groups;                            // 0x0410(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_Back;                                       // 0x0418(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_CloseTouch;                                 // 0x0420(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_428[0x8];                                      // 0x0428(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UScrollBox*                             SB_Vertical;                                       // 0x0430(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortEventMoreInfoModal) == 0x000438, "Wrong size on UFortEventMoreInfoModal");
static_assert(offsetof(UFortEventMoreInfoModal, DynamicEntryBox_Groups) == 0x000410, "Member 'UFortEventMoreInfoModal::DynamicEntryBox_Groups' has a wrong offset!");
static_assert(offsetof(UFortEventMoreInfoModal, Button_Back) == 0x000418, "Member 'UFortEventMoreInfoModal::Button_Back' has a wrong offset!");
static_assert(offsetof(UFortEventMoreInfoModal, Button_CloseTouch) == 0x000420, "Member 'UFortEventMoreInfoModal::Button_CloseTouch' has a wrong offset!");
static_assert(offsetof(UFortEventMoreInfoModal, SB_Vertical) == 0x000430, "Member 'UFortEventMoreInfoModal::SB_Vertical' has a wrong offset!");
...
{
public:
	class UCommonButtonBase*                      Button_Addition;                                   // 0x0410(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_Subtraction;                                // 0x0418(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_Purchase;                                   // 0x0420(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_GetVBucks;                                  // 0x0428(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UCommonButtonBase*                      Button_CloseTouch;                                 // 0x0438(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UEventScreenListView*                   ListView_RewardPreview;                            // 0x0440(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CurrentResourceValue;                              // 0x0448(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         MaxResourceValue;                                  // 0x044C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	int32                                         OfferResourceQuantity;                             // 0x0454(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAnimateListViewFromEmpty;                         // 0x0458(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_459[0x27];                                     // 0x0459(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortEventPurchaseLevelsModal) == 0x000480, "Wrong size on UFortEventPurchaseLevelsModal");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_Addition) == 0x000410, "Member 'UFortEventPurchaseLevelsModal::Button_Addition' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_Subtraction) == 0x000418, "Member 'UFortEventPurchaseLevelsModal::Button_Subtraction' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_Purchase) == 0x000420, "Member 'UFortEventPurchaseLevelsModal::Button_Purchase' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_GetVBucks) == 0x000428, "Member 'UFortEventPurchaseLevelsModal::Button_GetVBucks' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_Back) == 0x000430, "Member 'UFortEventPurchaseLevelsModal::Button_Back' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, Button_CloseTouch) == 0x000438, "Member 'UFortEventPurchaseLevelsModal::Button_CloseTouch' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, ListView_RewardPreview) == 0x000440, "Member 'UFortEventPurchaseLevelsModal::ListView_RewardPreview' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, CurrentResourceValue) == 0x000448, "Member 'UFortEventPurchaseLevelsModal::CurrentResourceValue' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, MaxResourceValue) == 0x00044C, "Member 'UFortEventPurchaseLevelsModal::MaxResourceValue' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, CurrentVBucks) == 0x000450, "Member 'UFortEventPurchaseLevelsModal::CurrentVBucks' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, OfferResourceQuantity) == 0x000454, "Member 'UFortEventPurchaseLevelsModal::OfferResourceQuantity' has a wrong offset!");
static_assert(offsetof(UFortEventPurchaseLevelsModal, bAnimateListViewFromEmpty) == 0x000458, "Member 'UFortEventPurchaseLevelsModal::bAnimateListViewFromEmpty' has a wrong offset!");
...
{
public:
	class UDynamicEntryBox*                       DynamicEntryBox_Body;                              // 0x0410(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UScrollBox*                             ScrollBox_Body;                                    // 0x0418(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortCTAButton*                         Button_Purchase;                                   // 0x0420(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_GetVBucks;                                  // 0x0428(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_Back;                                       // 0x0430(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_CloseTouch;                                 // 0x0438(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonBase*                      Button_PreviewReward;                              // 0x0440(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortEventPurchasePremiumTrackModal) == 0x000480, "Wrong size on UFortEventPurchasePremiumTrackModal");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, DynamicEntryBox_Body) == 0x000410, "Member 'UFortEventPurchasePremiumTrackModal::DynamicEntryBox_Body' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, ScrollBox_Body) == 0x000418, "Member 'UFortEventPurchasePremiumTrackModal::ScrollBox_Body' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, Button_Purchase) == 0x000420, "Member 'UFortEventPurchasePremiumTrackModal::Button_Purchase' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, Button_GetVBucks) == 0x000428, "Member 'UFortEventPurchasePremiumTrackModal::Button_GetVBucks' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, Button_Back) == 0x000430, "Member 'UFortEventPurchasePremiumTrackModal::Button_Back' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, Button_CloseTouch) == 0x000438, "Member 'UFortEventPurchasePremiumTrackModal::Button_CloseTouch' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, Button_PreviewReward) == 0x000440, "Member 'UFortEventPurchasePremiumTrackModal::Button_PreviewReward' has a wrong offset!");
static_assert(offsetof(UFortEventPurchasePremiumTrackModal, CurrentVBucks) == 0x000448, "Member 'UFortEventPurchasePremiumTrackModal::CurrentVBucks' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnProgressBarAnimationStartedEvent;                // 0x0380(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnProgressBarAnimationCompletedEvent;              // 0x0390(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnProgressBarAnimationInterruptedEvent;            // 0x03A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnResourcePreviewOffsetAnimationEvent;             // 0x03B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
