...
static_assert(offsetof(AttachableWheel_AttachTo, SteerAxis) == 0x000038, "Member 'AttachableWheel_AttachTo::SteerAxis' has a wrong offset!");
static_assert(offsetof(AttachableWheel_AttachTo, ReturnValue) == 0x000050, "Member 'AttachableWheel_AttachTo::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AttachableWheel_OnRep_RuntimeData, RuntimeDataPrev) == 0x000000, "Member 'AttachableWheel_OnRep_RuntimeData::RuntimeDataPrev' has a wrong offset!");
...
static_assert(offsetof(AttachableWheel_SetRuntimeData, Torque) == 0x000000, "Member 'AttachableWheel_SetRuntimeData::Torque' has a wrong offset!");
static_assert(offsetof(AttachableWheel_SetRuntimeData, Velocity) == 0x000004, "Member 'AttachableWheel_SetRuntimeData::Velocity' has a wrong offset!");
static_assert(offsetof(AttachableWheel_SetRuntimeData, SteerAngle) == 0x000008, "Member 'AttachableWheel_SetRuntimeData::SteerAngle' has a wrong offset!");
