...
static_assert(offsetof(AsyncAction_ListenForMidiEventBase_OnFinished__DelegateSignature, bCanceled) == 0x000000, "Member 'AsyncAction_ListenForMidiEventBase_OnFinished__DelegateSignature::bCanceled' has a wrong offset!");
...
static_assert(offsetof(AsyncAction_ListenForMidiNoteEvent_OnMidiNoteEventDelegate__DelegateSignature, MidiEventNote) == 0x000000, "Member 'AsyncAction_ListenForMidiNoteEvent_OnMidiNoteEventDelegate__DelegateSignature::MidiEventNote' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiNoteEvent_OnMidiNoteEventDelegate__DelegateSignature, MidiEventData) == 0x000004, "Member 'AsyncAction_ListenForMidiNoteEvent_OnMidiNoteEventDelegate__DelegateSignature::MidiEventData' has a wrong offset!");
...
static_assert(offsetof(AsyncAction_ListenForMidiTextEvent_OnMidiTextEventDelegate__DelegateSignature, MidiEventText) == 0x000000, "Member 'AsyncAction_ListenForMidiTextEvent_OnMidiTextEventDelegate__DelegateSignature::MidiEventText' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiTextEvent_OnMidiTextEventDelegate__DelegateSignature, MidiEventData) == 0x000010, "Member 'AsyncAction_ListenForMidiTextEvent_OnMidiTextEventDelegate__DelegateSignature::MidiEventData' has a wrong offset!");
...
static_assert(offsetof(AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature, MidiNote) == 0x000000, "Member 'AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature::MidiNote' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature, MidiNoteData) == 0x000004, "Member 'AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature::MidiNoteData' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature, WaitPoolID) == 0x000010, "Member 'AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature::WaitPoolID' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature, ActualDelay) == 0x000014, "Member 'AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature::ActualDelay' has a wrong offset!");
static_assert(offsetof(AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature, MaxDelayShortenedBy) == 0x000018, "Member 'AsyncAction_ListenForMidiNoteEventPools_OnMidiNotePoolEventDelegate__DelegateSignature::MaxDelayShortenedBy' has a wrong offset!");
