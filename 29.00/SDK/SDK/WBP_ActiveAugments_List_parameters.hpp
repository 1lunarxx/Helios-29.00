...
static_assert(sizeof(WBP_ActiveAugments_List_C_ScrollDown) == 0x000028, "Wrong size on WBP_ActiveAugments_List_C_ScrollDown");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_GetOwningPlayer_ReturnValue) == 0x000000, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_IsMobileGame_ReturnValue) == 0x000008, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_IsUsingTouch_ReturnValue) == 0x000009, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_BooleanAND_ReturnValue) == 0x00000A, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_SpawnSound2D_ReturnValue) == 0x000010, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_Array_LastIndex_ReturnValue) == 0x000018, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_Array_LastIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00001C, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ActiveAugments_List_C_ScrollDown, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'WBP_ActiveAugments_List_C_ScrollDown::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
