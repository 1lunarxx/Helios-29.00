...
{
public:
	FMulticastInlineDelegateProperty_             OnSongReplayingChanged;                            // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void SongReplayingChanged__DelegateSignature(bool bIsReplaying);
...
static_assert(sizeof(UPilgrimQuickplayState_Pregame) == 0x000140, "Wrong size on UPilgrimQuickplayState_Pregame");
