...
static_assert(offsetof(FJunoMusicElementData, ElementCooldownInSeconds) == 0x0000D8, "Member 'FJunoMusicElementData::ElementCooldownInSeconds' has a wrong offset!");
static_assert(offsetof(FJunoMusicElementData, bReceiveAggregatedData) == 0x0000E8, "Member 'FJunoMusicElementData::bReceiveAggregatedData' has a wrong offset!");
