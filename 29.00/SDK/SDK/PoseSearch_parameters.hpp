...
public:
	...
	struct FPoseSearchQueryTrajectory             OutTrajectory;                                     // 0x0018(0x0010)(Parm, OutParm, NativeAccessSpecifierPublic)
	...
	bool                                          bIgnoreSelf;                                       // 0x0041(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_42[0x2];                                       // 0x0042(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           TraceColor;                                        // 0x0044(0x0010)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           TraceHitColor;                                     // 0x0054(0x0010)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DrawTime;                                          // 0x0064(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions) == 0x000068, "Wrong size on PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions");
...
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, InTrajectory) == 0x000008, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::InTrajectory' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, OutTrajectory) == 0x000018, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::OutTrajectory' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, TraceChannel) == 0x000028, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::TraceChannel' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, bTraceComplex) == 0x000029, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::bTraceComplex' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, ActorsToIgnore) == 0x000030, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::ActorsToIgnore' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, DrawDebugType) == 0x000040, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::DrawDebugType' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, bIgnoreSelf) == 0x000041, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::bIgnoreSelf' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, TraceColor) == 0x000044, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::TraceColor' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, TraceHitColor) == 0x000054, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::TraceHitColor' has a wrong offset!");
static_assert(offsetof(PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions, DrawTime) == 0x000064, "Member 'PoseSearchTrajectoryLibrary_HandleTrajectoryWorldCollisions::DrawTime' has a wrong offset!");
...
public:
	...
	bool                                          bAlwaysApplyGravity;                               // 0x0170(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PoseSearchTrajectoryLibrary_PoseSearchGenerateTrajectory) == 0x000178, "Wrong size on PoseSearchTrajectoryLibrary_PoseSearchGenerateTrajectory");
...
static_assert(offsetof(PoseSearchTrajectoryLibrary_PoseSearchGenerateTrajectory, bAlwaysApplyGravity) == 0x000170, "Member 'PoseSearchTrajectoryLibrary_PoseSearchGenerateTrajectory::bAlwaysApplyGravity' has a wrong offset!");
