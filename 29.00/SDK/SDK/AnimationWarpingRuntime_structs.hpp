...
static_assert(sizeof(FFootPlacemenLegDefinition) == 0x000034, "Wrong size on FFootPlacemenLegDefinition");
...
static_assert(offsetof(FFootPlacemenLegDefinition, DisableLegCurveName) == 0x000030, "Member 'FFootPlacemenLegDefinition::DisableLegCurveName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_20[0xC0];                                      // 0x0020(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_OffsetRootBone) == 0x000010, "Wrong alignment on FAnimNode_OffsetRootBone");
static_assert(sizeof(FAnimNode_OffsetRootBone) == 0x0000E0, "Wrong size on FAnimNode_OffsetRootBone");
