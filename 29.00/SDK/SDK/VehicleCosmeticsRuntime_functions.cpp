...
// Parameters:
// class AVehicleCosmeticsActor*           CosmeticActor                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UVehicleCosmeticsAssembledMeshUserComponent::VehicleCosmeticsOnCosmeticItemSpawned__DelegateSignature(class AVehicleCosmeticsActor* CosmeticActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("VehicleCosmeticsAssembledMeshUserComponent", "VehicleCosmeticsOnCosmeticItemSpawned__DelegateSignature");

	Params::VehicleCosmeticsAssembledMeshUserComponent_VehicleCosmeticsOnCosmeticItemSpawned__DelegateSignature Parms{};
