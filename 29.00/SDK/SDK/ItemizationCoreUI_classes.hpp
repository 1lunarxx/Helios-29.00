...
class UInventoryCollectionViewModel final : public UFortPerUserViewModel
{
public:
	...
	class UInventoryItemEntryViewModel*           SelectedInventoryItemEntryViewModel;               // 0x0080(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UInventoryItemEntryViewModel*           LastAmountChangedInventoryItemEntryViewModel;      // 0x0088(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UInventoryCollectionViewModel) == 0x0000C8, "Wrong size on UInventoryCollectionViewModel");
static_assert(offsetof(UInventoryCollectionViewModel, InventoryViewModels) == 0x000070, "Member 'UInventoryCollectionViewModel::InventoryViewModels' has a wrong offset!");
static_assert(offsetof(UInventoryCollectionViewModel, SelectedInventoryItemEntryViewModel) == 0x000080, "Member 'UInventoryCollectionViewModel::SelectedInventoryItemEntryViewModel' has a wrong offset!");
static_assert(offsetof(UInventoryCollectionViewModel, LastAmountChangedInventoryItemEntryViewModel) == 0x000088, "Member 'UInventoryCollectionViewModel::LastAmountChangedInventoryItemEntryViewModel' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnGridItemsSet;                                    // 0x01B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnGridEntryAdded;                                  // 0x01C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnGridEntryRemoved;                                // 0x01D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
