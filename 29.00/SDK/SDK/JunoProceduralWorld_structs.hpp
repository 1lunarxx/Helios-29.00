...
static_assert(offsetof(FJunoWorldTileCaveSurfaceSaveData_v1, CaveSurfaceData) == 0x000000, "Member 'FJunoWorldTileCaveSurfaceSaveData_v1::CaveSurfaceData' has a wrong offset!");
...
public:
	...
	struct FVector                                ShellBoundsSize;                                   // 0x0110(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ShellBoundsCenter;                                 // 0x0128(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     ExitLocations;                                     // 0x0140(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         NumOfSpawners;                                     // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FJunoCaveGeneratorPOIMarker>    POIMarkers;                                        // 0x0158(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         NumOfAIPointProviders;                             // 0x0168(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_16C[0x4];                                      // 0x016C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EJunoCaveGeneratorLayoutTags, struct FJunoCaveGeneratorWorldsList> SupportedLayouts;                                  // 0x0170(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bHasFixedEntrance;                                 // 0x01C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C1[0x3];                                      // 0x01C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PersistenceVersion;                                // 0x01C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FJunoCaveGeneratorShellData) == 0x000008, "Wrong alignment on FJunoCaveGeneratorShellData");
static_assert(sizeof(FJunoCaveGeneratorShellData) == 0x0001C8, "Wrong size on FJunoCaveGeneratorShellData");
...
static_assert(offsetof(FJunoCaveGeneratorShellData, ShellBoundsSize) == 0x000110, "Member 'FJunoCaveGeneratorShellData::ShellBoundsSize' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, ShellBoundsCenter) == 0x000128, "Member 'FJunoCaveGeneratorShellData::ShellBoundsCenter' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, ExitLocations) == 0x000140, "Member 'FJunoCaveGeneratorShellData::ExitLocations' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, NumOfSpawners) == 0x000150, "Member 'FJunoCaveGeneratorShellData::NumOfSpawners' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, POIMarkers) == 0x000158, "Member 'FJunoCaveGeneratorShellData::POIMarkers' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, NumOfAIPointProviders) == 0x000168, "Member 'FJunoCaveGeneratorShellData::NumOfAIPointProviders' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, SupportedLayouts) == 0x000170, "Member 'FJunoCaveGeneratorShellData::SupportedLayouts' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, bHasFixedEntrance) == 0x0001C0, "Member 'FJunoCaveGeneratorShellData::bHasFixedEntrance' has a wrong offset!");
static_assert(offsetof(FJunoCaveGeneratorShellData, PersistenceVersion) == 0x0001C4, "Member 'FJunoCaveGeneratorShellData::PersistenceVersion' has a wrong offset!");
...
static_assert(sizeof(FJunoWorldTileSaveData_v1) == 0x0000A0, "Wrong size on FJunoWorldTileSaveData_v1");
static_assert(offsetof(FJunoWorldTileSaveData_v1, POISlotMetaDatas) == 0x000000, "Member 'FJunoWorldTileSaveData_v1::POISlotMetaDatas' has a wrong offset!");
static_assert(offsetof(FJunoWorldTileSaveData_v1, CaveSurfaceLayerData) == 0x000050, "Member 'FJunoWorldTileSaveData_v1::CaveSurfaceLayerData' has a wrong offset!");
...
{
public:
	struct FJunoWorldTileSaveData_v1              SaveData;                                          // 0x0000(0x00A0)(NativeAccessSpecifierPublic)
	TArray<struct FJunoWorldTileSaveData_Cave_PersistentInfo> Caves;                                             // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FJunoWorldTileSaveData_POI_PersistentInfo> POIs;                                              // 0x00B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1) == 0x0000C0, "Wrong size on FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1");
...
static_assert(offsetof(FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1, Caves) == 0x0000A0, "Member 'FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1::Caves' has a wrong offset!");
static_assert(offsetof(FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1, POIs) == 0x0000B0, "Member 'FJunoWorldTileSaveData_InGameClass_PersistentInfo_v1::POIs' has a wrong offset!");
...
public:
	...
	float                                         OneEntranceCaveSelectionWeight;                    // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TwoEntranceCaveSelectionWeight;                    // 0x002C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ThreeEntranceCaveSelectionWeight;                  // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDistanceBetweenCaveEntrances;                   // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDistanceBetweenNormalPOIs;                      // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDistanceBetweenCosmeticPOIs;                    // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MinDesired8x8NonCosmeticSlots;                     // 0x0040(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreselectionAttempts;                              // 0x0044(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FJunoPOIPreselectorParams) == 0x000008, "Wrong alignment on FJunoPOIPreselectorParams");
static_assert(sizeof(FJunoPOIPreselectorParams) == 0x000048, "Wrong size on FJunoPOIPreselectorParams");
...
static_assert(offsetof(FJunoPOIPreselectorParams, OneEntranceCaveSelectionWeight) == 0x000028, "Member 'FJunoPOIPreselectorParams::OneEntranceCaveSelectionWeight' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, TwoEntranceCaveSelectionWeight) == 0x00002C, "Member 'FJunoPOIPreselectorParams::TwoEntranceCaveSelectionWeight' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, ThreeEntranceCaveSelectionWeight) == 0x000030, "Member 'FJunoPOIPreselectorParams::ThreeEntranceCaveSelectionWeight' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, MinDistanceBetweenCaveEntrances) == 0x000034, "Member 'FJunoPOIPreselectorParams::MinDistanceBetweenCaveEntrances' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, MinDistanceBetweenNormalPOIs) == 0x000038, "Member 'FJunoPOIPreselectorParams::MinDistanceBetweenNormalPOIs' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, MinDistanceBetweenCosmeticPOIs) == 0x00003C, "Member 'FJunoPOIPreselectorParams::MinDistanceBetweenCosmeticPOIs' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, MinDesired8x8NonCosmeticSlots) == 0x000040, "Member 'FJunoPOIPreselectorParams::MinDesired8x8NonCosmeticSlots' has a wrong offset!");
static_assert(offsetof(FJunoPOIPreselectorParams, PreselectionAttempts) == 0x000044, "Member 'FJunoPOIPreselectorParams::PreselectionAttempts' has a wrong offset!");
...
static_assert(offsetof(FPCGJunoPathfindContext, LandmassProceduralRoute) == 0x0000D0, "Member 'FPCGJunoPathfindContext::LandmassProceduralRoute' has a wrong offset!");
...
static_assert(offsetof(FPCGJunoRoadAINavigationContext, RoadClusterClass) == 0x0000E0, "Member 'FPCGJunoRoadAINavigationContext::RoadClusterClass' has a wrong offset!");
static_assert(offsetof(FPCGJunoRoadAINavigationContext, PatrolPathClass) == 0x0000E8, "Member 'FPCGJunoRoadAINavigationContext::PatrolPathClass' has a wrong offset!");
static_assert(offsetof(FPCGJunoRoadAINavigationContext, PatrolPointClass) == 0x0000F0, "Member 'FPCGJunoRoadAINavigationContext::PatrolPointClass' has a wrong offset!");
static_assert(offsetof(FPCGJunoRoadAINavigationContext, ManagedActors) == 0x0000F8, "Member 'FPCGJunoRoadAINavigationContext::ManagedActors' has a wrong offset!");
...
static_assert(offsetof(FPCGJunoSpawnLivingWorldStaticPointContext, StaticPointClass) == 0x0000E0, "Member 'FPCGJunoSpawnLivingWorldStaticPointContext::StaticPointClass' has a wrong offset!");
static_assert(offsetof(FPCGJunoSpawnLivingWorldStaticPointContext, PointClusterClass) == 0x0000E8, "Member 'FPCGJunoSpawnLivingWorldStaticPointContext::PointClusterClass' has a wrong offset!");
static_assert(offsetof(FPCGJunoSpawnLivingWorldStaticPointContext, ManagedActors) == 0x0000F0, "Member 'FPCGJunoSpawnLivingWorldStaticPointContext::ManagedActors' has a wrong offset!");
