...
void UPilgrimQuickplayBandStateComponent::SongReplayingChanged__DelegateSignature(bool bIsReplaying)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PilgrimQuickplayBandStateComponent", "SongReplayingChanged__DelegateSignature");

	Params::PilgrimQuickplayBandStateComponent_SongReplayingChanged__DelegateSignature Parms{};
