...
static_assert(sizeof(AVaultCamera_Blueprint_C) == 0x000A20, "Wrong size on AVaultCamera_Blueprint_C");
static_assert(offsetof(AVaultCamera_Blueprint_C, UberGraphFrame) == 0x000A10, "Member 'AVaultCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
