...
static_assert(offsetof(RadioPlayerWidgetBase_NativeChangedSeatVehicle, SeatIndex) == 0x000000, "Member 'RadioPlayerWidgetBase_NativeChangedSeatVehicle::SeatIndex' has a wrong offset!");
