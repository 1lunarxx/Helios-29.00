...
// Parameters:
// class USmartObjectDefinition*           Definition                                             (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USmartObjectComponent::SetDefinitionAsset(class USmartObjectDefinition* Definition)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SmartObjectComponent", "SetDefinitionAsset");

	Params::SmartObjectComponent_SetDefinitionAsset Parms{};
...
const class USmartObjectDefinition* USmartObjectComponent::GetDefinitionAsset() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SmartObjectComponent", "GetDefinitionAsset");

	Params::SmartObjectComponent_GetDefinitionAsset Parms{};
