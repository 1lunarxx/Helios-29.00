...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   AngularVelocityPercent                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AJunoWheelActor::SetAngularVelocity(const float AngularVelocityPercent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("JunoWheelActor", "SetAngularVelocity");

	Params::JunoWheelActor_SetAngularVelocity Parms{};

	Parms.AngularVelocityPercent = AngularVelocityPercent;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   SteerAnglePercent                                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AJunoWheelActor::SetSteerAngle(const float SteerAnglePercent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("JunoWheelActor", "SetSteerAngle");

	Params::JunoWheelActor_SetSteerAngle Parms{};

	Parms.SteerAnglePercent = SteerAnglePercent;
