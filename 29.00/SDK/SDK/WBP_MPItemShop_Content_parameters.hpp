...
public:
	...
	class UUserWidget*                            K2Node_CustomEvent_RowWidget;                      // 0x0018(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetRowIndexFromWidget_RowIndex;           // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetFocusedRowIndex_RowIndex;              // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UWBP_MPItemShop_Row_C*                  CallFunc_GetCurrentRowWidget_RowWidget;            // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FFocusEvent                            K2Node_Event_InFocusEvent;                         // 0x0030(0x0008)(NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Event_DestinationIndex;                     // 0x003C(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_MPItemShop_Row_C*                  CallFunc_GetCurrentRowWidget_RowWidget_1;          // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_Event_ScrollAmount;                         // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_HandleScroll_OffsetAmount_ImplicitCast;   // 0x0088(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content) == 0x000090, "Wrong size on WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content");
...
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_IsUsingTouch_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, K2Node_CustomEvent_RowWidget) == 0x000018, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::K2Node_CustomEvent_RowWidget' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_GetRowIndexFromWidget_RowIndex) == 0x000020, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_GetRowIndexFromWidget_RowIndex' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_GetFocusedRowIndex_RowIndex) == 0x000024, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_GetFocusedRowIndex_RowIndex' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_GetCurrentRowWidget_RowWidget) == 0x000028, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_GetCurrentRowWidget_RowWidget' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, K2Node_Event_InFocusEvent) == 0x000030, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_IsValid_ReturnValue) == 0x000038, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, K2Node_Event_DestinationIndex) == 0x00003C, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::K2Node_Event_DestinationIndex' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, K2Node_CustomEvent_OfferId) == 0x000040, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::K2Node_CustomEvent_OfferId' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_IsEmpty_ReturnValue) == 0x000050, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_GetCurrentRowWidget_RowWidget_1) == 0x000058, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_GetCurrentRowWidget_RowWidget_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_IsValid_ReturnValue_1) == 0x000060, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, K2Node_Event_ScrollAmount) == 0x000064, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::K2Node_Event_ScrollAmount' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_SpawnSound2D_ReturnValue) == 0x000080, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content, CallFunc_HandleScroll_OffsetAmount_ImplicitCast) == 0x000088, "Member 'WBP_MPItemShop_Content_C_ExecuteUbergraph_WBP_MPItemShop_Content::CallFunc_HandleScroll_OffsetAmount_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000008, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_GetOwningPlayer_ReturnValue) == 0x000018, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_IsUsingTouch_ReturnValue) == 0x000020, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_Abs_ReturnValue) == 0x000028, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_Abs_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_GreaterEqual_DoubleDouble_ReturnValue) == 0x000030, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_GreaterEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_Greater_DoubleDouble_ReturnValue_1) == 0x000031, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_Greater_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_HandleScroll, CallFunc_GreaterEqual_DoubleDouble_B_ImplicitCast) == 0x000038, "Member 'WBP_MPItemShop_Content_C_HandleScroll::CallFunc_GreaterEqual_DoubleDouble_B_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Content_C_IsQuickNavCollapsible, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'WBP_MPItemShop_Content_C_IsQuickNavCollapsible::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_IsQuickNavCollapsible, CallFunc_IsUsingTouch_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_Content_C_IsQuickNavCollapsible::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_IsQuickNavCollapsible, CallFunc_IsItemPreviewEnabled_ReturnValue) == 0x000011, "Member 'WBP_MPItemShop_Content_C_IsQuickNavCollapsible::CallFunc_IsItemPreviewEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_IsQuickNavCollapsible, CallFunc_Not_PreBool_ReturnValue) == 0x000012, "Member 'WBP_MPItemShop_Content_C_IsQuickNavCollapsible::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_Content_C_IsQuickNavCollapsible, CallFunc_BooleanOR_ReturnValue) == 0x000013, "Member 'WBP_MPItemShop_Content_C_IsQuickNavCollapsible::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_Content_C_OnOfferFocused__DelegateSignature, OfferId) == 0x000000, "Member 'WBP_MPItemShop_Content_C_OnOfferFocused__DelegateSignature::OfferId' has a wrong offset!");
