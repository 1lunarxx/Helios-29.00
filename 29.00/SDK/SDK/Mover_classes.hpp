...
static_assert(offsetof(UBaseMovementMode, Transitions) == 0x000030, "Member 'UBaseMovementMode::Transitions' has a wrong offset!");
...
{
public:
	bool                                          bIgnoreBaseRotation;                               // 0x0048(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                TurnGenerator;                                     // 0x0050(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWalkingMode) == 0x000060, "Wrong size on UWalkingMode");
static_assert(offsetof(UWalkingMode, bIgnoreBaseRotation) == 0x000048, "Member 'UWalkingMode::bIgnoreBaseRotation' has a wrong offset!");
static_assert(offsetof(UWalkingMode, TurnGenerator) == 0x000050, "Member 'UWalkingMode::TurnGenerator' has a wrong offset!");
...
public:
	...
	float                                         RadialForceLimit;                                  // 0x0068(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FrictionForceLimit;                                // 0x006C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TwistTorqueLimit;                                  // 0x0070(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SwingTorqueLimit;                                  // 0x0074(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TargetHeight;                                      // 0x0078(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundDamping;                                     // 0x007C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FractionalVelocityToTarget;                        // 0x0080(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FractionalDownwardVelocityToTarget;                // 0x0084(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxUnsupportedTimeBeforeFalling;                   // 0x0088(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPhysicsDrivenWalkingMode) == 0x000090, "Wrong size on UPhysicsDrivenWalkingMode");
static_assert(offsetof(UPhysicsDrivenWalkingMode, RadialForceLimit) == 0x000068, "Member 'UPhysicsDrivenWalkingMode::RadialForceLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, FrictionForceLimit) == 0x00006C, "Member 'UPhysicsDrivenWalkingMode::FrictionForceLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, TwistTorqueLimit) == 0x000070, "Member 'UPhysicsDrivenWalkingMode::TwistTorqueLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, SwingTorqueLimit) == 0x000074, "Member 'UPhysicsDrivenWalkingMode::SwingTorqueLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, TargetHeight) == 0x000078, "Member 'UPhysicsDrivenWalkingMode::TargetHeight' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, GroundDamping) == 0x00007C, "Member 'UPhysicsDrivenWalkingMode::GroundDamping' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, FractionalVelocityToTarget) == 0x000080, "Member 'UPhysicsDrivenWalkingMode::FractionalVelocityToTarget' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, FractionalDownwardVelocityToTarget) == 0x000084, "Member 'UPhysicsDrivenWalkingMode::FractionalDownwardVelocityToTarget' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenWalkingMode, MaxUnsupportedTimeBeforeFalling) == 0x000088, "Member 'UPhysicsDrivenWalkingMode::MaxUnsupportedTimeBeforeFalling' has a wrong offset!");
...
static_assert(offsetof(UFallingMode, OnLanded) == 0x000048, "Member 'UFallingMode::OnLanded' has a wrong offset!");
static_assert(offsetof(UFallingMode, AirControlPercentage) == 0x000058, "Member 'UFallingMode::AirControlPercentage' has a wrong offset!");
static_assert(offsetof(UFallingMode, FallingDeceleration) == 0x00005C, "Member 'UFallingMode::FallingDeceleration' has a wrong offset!");
static_assert(offsetof(UFallingMode, OverTerminalSpeedFallingDeceleration) == 0x000060, "Member 'UFallingMode::OverTerminalSpeedFallingDeceleration' has a wrong offset!");
static_assert(offsetof(UFallingMode, TerminalMovementPlaneSpeed) == 0x000064, "Member 'UFallingMode::TerminalMovementPlaneSpeed' has a wrong offset!");
static_assert(offsetof(UFallingMode, bShouldClampTerminalVerticalSpeed) == 0x000068, "Member 'UFallingMode::bShouldClampTerminalVerticalSpeed' has a wrong offset!");
static_assert(offsetof(UFallingMode, VerticalFallingDeceleration) == 0x00006C, "Member 'UFallingMode::VerticalFallingDeceleration' has a wrong offset!");
static_assert(offsetof(UFallingMode, TerminalVerticalSpeed) == 0x000070, "Member 'UFallingMode::TerminalVerticalSpeed' has a wrong offset!");
...
static_assert(offsetof(UPhysicsDrivenFallingMode, TwistTorqueLimit) == 0x000088, "Member 'UPhysicsDrivenFallingMode::TwistTorqueLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenFallingMode, SwingTorqueLimit) == 0x00008C, "Member 'UPhysicsDrivenFallingMode::SwingTorqueLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenFallingMode, TargetHeight) == 0x000090, "Member 'UPhysicsDrivenFallingMode::TargetHeight' has a wrong offset!");
...
public:
	...
	class USceneComponent*                        UpdatedComponent;                                  // 0x0180(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPrimitiveComponent*                    UpdatedCompAsPrimitive;                            // 0x0188(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USceneComponent*                        PrimaryVisualComponent;                            // 0x0190(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_198[0x88];                                     // 0x0198(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UObject*>                        SharedSettings;                                    // 0x0220(0x0010)(Edit, ExportObject, EditFixedSize, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	bool                                          bHasGravityOverride;                               // 0x0230(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_231[0x7];                                      // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                GravityAccelOverride;                              // 0x0238(0x0018)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoverComponent) == 0x000278, "Wrong size on UMoverComponent");
...
static_assert(offsetof(UMoverComponent, OnPostMovement) == 0x0000B0, "Member 'UMoverComponent::OnPostMovement' has a wrong offset!");
static_assert(offsetof(UMoverComponent, OnPostSimulationTick) == 0x0000C0, "Member 'UMoverComponent::OnPostSimulationTick' has a wrong offset!");
static_assert(offsetof(UMoverComponent, OnPostSimulationRollback) == 0x0000D0, "Member 'UMoverComponent::OnPostSimulationRollback' has a wrong offset!");
...
static_assert(offsetof(UMoverComponent, Transitions) == 0x000150, "Member 'UMoverComponent::Transitions' has a wrong offset!");
static_assert(offsetof(UMoverComponent, PersistentSyncStateDataTypes) == 0x000160, "Member 'UMoverComponent::PersistentSyncStateDataTypes' has a wrong offset!");
static_assert(offsetof(UMoverComponent, InputProducer) == 0x000170, "Member 'UMoverComponent::InputProducer' has a wrong offset!");
static_assert(offsetof(UMoverComponent, MovementMixer) == 0x000178, "Member 'UMoverComponent::MovementMixer' has a wrong offset!");
static_assert(offsetof(UMoverComponent, UpdatedComponent) == 0x000180, "Member 'UMoverComponent::UpdatedComponent' has a wrong offset!");
static_assert(offsetof(UMoverComponent, UpdatedCompAsPrimitive) == 0x000188, "Member 'UMoverComponent::UpdatedCompAsPrimitive' has a wrong offset!");
static_assert(offsetof(UMoverComponent, PrimaryVisualComponent) == 0x000190, "Member 'UMoverComponent::PrimaryVisualComponent' has a wrong offset!");
static_assert(offsetof(UMoverComponent, SharedSettings) == 0x000220, "Member 'UMoverComponent::SharedSettings' has a wrong offset!");
static_assert(offsetof(UMoverComponent, bHasGravityOverride) == 0x000230, "Member 'UMoverComponent::bHasGravityOverride' has a wrong offset!");
static_assert(offsetof(UMoverComponent, GravityAccelOverride) == 0x000238, "Member 'UMoverComponent::GravityAccelOverride' has a wrong offset!");
static_assert(offsetof(UMoverComponent, ModeFSM) == 0x000258, "Member 'UMoverComponent::ModeFSM' has a wrong offset!");
static_assert(offsetof(UMoverComponent, SimBlackboard) == 0x000260, "Member 'UMoverComponent::SimBlackboard' has a wrong offset!");
...
static_assert(sizeof(UMoverNetworkPhysicsLiaisonComponent) == 0x000120, "Wrong size on UMoverNetworkPhysicsLiaisonComponent");
...
static_assert(offsetof(UPhysicsJumpCheck, JumpUpwardsSpeed) == 0x000030, "Member 'UPhysicsJumpCheck::JumpUpwardsSpeed' has a wrong offset!");
static_assert(offsetof(UPhysicsJumpCheck, TransitionToMode) == 0x000034, "Member 'UPhysicsJumpCheck::TransitionToMode' has a wrong offset!");
...
static_assert(offsetof(USwimmingMode, SurfaceSwimmingWaterControlSettings) == 0x000048, "Member 'USwimmingMode::SurfaceSwimmingWaterControlSettings' has a wrong offset!");
...
static_assert(offsetof(UMovementModeStateMachine, QueuedModeTransition) == 0x000078, "Member 'UMovementModeStateMachine::QueuedModeTransition' has a wrong offset!");
...
static_assert(offsetof(UPhysicsDrivenFlyingMode, TwistTorqueLimit) == 0x000058, "Member 'UPhysicsDrivenFlyingMode::TwistTorqueLimit' has a wrong offset!");
static_assert(offsetof(UPhysicsDrivenFlyingMode, SwingTorqueLimit) == 0x00005C, "Member 'UPhysicsDrivenFlyingMode::SwingTorqueLimit' has a wrong offset!");
...
static_assert(offsetof(UPhysicsDrivenSwimmingMode, TargetHeight) == 0x000100, "Member 'UPhysicsDrivenSwimmingMode::TargetHeight' has a wrong offset!");
