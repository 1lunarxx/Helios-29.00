...
// 0x0030 (0x1CD0 - 0x1CA0)
class USwingingObjectCameraMode final : public UFortCameraMode_ThirdPerson
{
public:
	struct FVector                                MaxSwingAdditionalViewTargetOffset;                // 0x1CA0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxSwingFOV;                                       // 0x1CB8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1CBC[0x14];                                    // 0x1CBC(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USwingingObjectCameraMode) == 0x001CD0, "Wrong size on USwingingObjectCameraMode");
static_assert(offsetof(USwingingObjectCameraMode, MaxSwingAdditionalViewTargetOffset) == 0x001CA0, "Member 'USwingingObjectCameraMode::MaxSwingAdditionalViewTargetOffset' has a wrong offset!");
static_assert(offsetof(USwingingObjectCameraMode, MaxSwingFOV) == 0x001CB8, "Member 'USwingingObjectCameraMode::MaxSwingFOV' has a wrong offset!");
