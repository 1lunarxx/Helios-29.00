...
public:
	...
	class UGameplayCameraComponentEvaluationContext* EvaluationContext;                                 // 0x0228(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayCameraComponent) == 0x000230, "Wrong size on UGameplayCameraComponent");
static_assert(offsetof(UGameplayCameraComponent, Camera) == 0x000220, "Member 'UGameplayCameraComponent::Camera' has a wrong offset!");
static_assert(offsetof(UGameplayCameraComponent, EvaluationContext) == 0x000228, "Member 'UGameplayCameraComponent::EvaluationContext' has a wrong offset!");
...
{
public:
	class UCameraSystemEvaluator*                 Evaluator;                                         // 0x0220(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayCameraSystemComponent) == 0x000230, "Wrong size on UGameplayCameraSystemComponent");
static_assert(offsetof(UGameplayCameraSystemComponent, Evaluator) == 0x000220, "Member 'UGameplayCameraSystemComponent::Evaluator' has a wrong offset!");
