...
public:
	...
	struct FHitResult                             OutHit;                                            // 0x0008(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(RockVehicle_OnSpringImpact__DelegateSignature) == 0x0000F0, "Wrong size on RockVehicle_OnSpringImpact__DelegateSignature");
static_assert(offsetof(RockVehicle_OnSpringImpact__DelegateSignature, Socket) == 0x000000, "Member 'RockVehicle_OnSpringImpact__DelegateSignature::Socket' has a wrong offset!");
static_assert(offsetof(RockVehicle_OnSpringImpact__DelegateSignature, ImpactSpeed) == 0x000004, "Member 'RockVehicle_OnSpringImpact__DelegateSignature::ImpactSpeed' has a wrong offset!");
static_assert(offsetof(RockVehicle_OnSpringImpact__DelegateSignature, OutHit) == 0x000008, "Member 'RockVehicle_OnSpringImpact__DelegateSignature::OutHit' has a wrong offset!");
...
static_assert(offsetof(RockVehicle_RockFreeCamToggledDelegate__DelegateSignature, bFreeCam) == 0x000000, "Member 'RockVehicle_RockFreeCamToggledDelegate__DelegateSignature::bFreeCam' has a wrong offset!");
