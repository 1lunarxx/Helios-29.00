...
static_assert(sizeof(ULimeBaseLayerAnimInstance) == 0x000460, "Wrong size on ULimeBaseLayerAnimInstance");
static_assert(offsetof(ULimeBaseLayerAnimInstance, MainAnimInstanceWeakPtr) == 0x000458, "Member 'ULimeBaseLayerAnimInstance::MainAnimInstanceWeakPtr' has a wrong offset!");
...
static_assert(offsetof(ULimeDBNOAnimInstance, AnimBodyType) == 0x000460, "Member 'ULimeDBNOAnimInstance::AnimBodyType' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, LeanAngle) == 0x000464, "Member 'ULimeDBNOAnimInstance::LeanAngle' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, SpeedAdjustedPlayrate) == 0x000468, "Member 'ULimeDBNOAnimInstance::SpeedAdjustedPlayrate' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, LeanAdditiveAlpha) == 0x00046C, "Member 'ULimeDBNOAnimInstance::LeanAdditiveAlpha' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, Speed2D) == 0x000470, "Member 'ULimeDBNOAnimInstance::Speed2D' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, MovementBlendSpaceSpeed2D) == 0x000474, "Member 'ULimeDBNOAnimInstance::MovementBlendSpaceSpeed2D' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, MaxMovementBlendSpaceSpeed) == 0x000478, "Member 'ULimeDBNOAnimInstance::MaxMovementBlendSpaceSpeed' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, LocalVelocityYawAngle) == 0x00047C, "Member 'ULimeDBNOAnimInstance::LocalVelocityYawAngle' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, DBNOTurnPlayRate) == 0x000480, "Member 'ULimeDBNOAnimInstance::DBNOTurnPlayRate' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, YawDeltaCurrentTick) == 0x000484, "Member 'ULimeDBNOAnimInstance::YawDeltaCurrentTick' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, YawDeltaLastTick) == 0x000488, "Member 'ULimeDBNOAnimInstance::YawDeltaLastTick' has a wrong offset!");
static_assert(offsetof(ULimeDBNOAnimInstance, YawDeltaSmoothed) == 0x00048C, "Member 'ULimeDBNOAnimInstance::YawDeltaSmoothed' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnLevelSettingsChanged;                            // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnLevelSettingsChanged__DelegateSignature();
...
{
public:
	struct FFortAnimInput_Skydiving               Skydiving;                                         // 0x0460(0x0080)(Edit, BlueprintVisible, BlueprintReadOnly, Transient, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         FreeFall_AimPitch;                                 // 0x04E0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AimPitch;                                          // 0x04E4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsAccelerating2D : 1;                             // 0x04E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, Transient, DisableEditOnInstance, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(ULimeSkydivingAnimInstance) == 0x0004F0, "Wrong size on ULimeSkydivingAnimInstance");
static_assert(offsetof(ULimeSkydivingAnimInstance, Skydiving) == 0x000460, "Member 'ULimeSkydivingAnimInstance::Skydiving' has a wrong offset!");
static_assert(offsetof(ULimeSkydivingAnimInstance, FreeFall_AimPitch) == 0x0004E0, "Member 'ULimeSkydivingAnimInstance::FreeFall_AimPitch' has a wrong offset!");
static_assert(offsetof(ULimeSkydivingAnimInstance, AimPitch) == 0x0004E4, "Member 'ULimeSkydivingAnimInstance::AimPitch' has a wrong offset!");
...
{
public:
	uint8                                         bPlayerFiredCooldownActive : 1;                    // 0x08F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerAimDownSights : 1;                          // 0x08F8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(ULimeArmedPlayerAnimInstance) == 0x000900, "Wrong size on ULimeArmedPlayerAnimInstance");
...
static_assert(sizeof(ULimeCameraMode_OrbitCam) == 0x001CA0, "Wrong size on ULimeCameraMode_OrbitCam");
...
{
public:
	FMulticastInlineDelegateProperty_             OnLimeMoodChangedDelegate;                         // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnLimeCurrentEmotionalStateChangedDelegate;        // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLimeCurrentEmotionalStateStartedChange;          // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLimeCurrentEmotionChangeFinished;                // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
