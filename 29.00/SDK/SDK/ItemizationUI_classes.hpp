...
{
public:
	FMulticastInlineDelegateProperty_             OnDropItemInputDelegate;                           // 0x0400(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDropAllInputDelegate;                            // 0x0410(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDropStackInputDelegate;                          // 0x0420(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDropHalfInputDelegate;                           // 0x0430(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMakeItemActiveInputDelegate;                     // 0x0440(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMakeItemInactiveInputDelegate;                   // 0x0450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnInputDelegate__DelegateSignature();
...
public:
	...
	TSoftClassPtr<class UClass>                   SoftInventoryScreenWidgetClass;                    // 0x02C0(0x0020)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AItemizationDynamicUIDirector) == 0x0002F0, "Wrong size on AItemizationDynamicUIDirector");
...
static_assert(offsetof(AItemizationDynamicUIDirector, SoftInventoryScreenWidgetClass) == 0x0002C0, "Member 'AItemizationDynamicUIDirector::SoftInventoryScreenWidgetClass' has a wrong offset!");
