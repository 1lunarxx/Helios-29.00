...
public:
	...
	struct FCosmeticLoadout                       PreviewLoadout;                                    // 0x1F18(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FDelMarPreviewCustomization>    PreviewCustomizations;                             // 0x1F28(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, Protected, NativeAccessSpecifierProtected)
	class UDelMarVehicleCosmeticComponent*        CosmeticComponent;                                 // 0x1F38(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FDelMarPreviewConfigs                  PreviewConfigs;                                    // 0x1F40(0x00F8)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2038[0x88];                                    // 0x2038(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 SpringTravelOffset;                                // 0x20C0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FDelMarBouncyChassisState              BouncyChassisConfig;                               // 0x20D0(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_20DC[0x54];                                    // 0x20DC(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitWall;                            // 0x2130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitVehicle;                         // 0x2140(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnDelMarVehicleHitByVehicle;                       // 0x2150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2160[0x388];                                   // 0x2160(0x0388)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnHazardHit;                                       // 0x24E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleTeleportEntered;                          // 0x24F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleTeleportExit;                             // 0x2508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleAppliedTeleportRotation;                  // 0x2518(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2528[0x38];                                    // 0x2528(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ADelMarPreviewVehicle) == 0x002560, "Wrong size on ADelMarPreviewVehicle");
static_assert(offsetof(ADelMarPreviewVehicle, PreviewLoadout) == 0x001F18, "Member 'ADelMarPreviewVehicle::PreviewLoadout' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, PreviewCustomizations) == 0x001F28, "Member 'ADelMarPreviewVehicle::PreviewCustomizations' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, CosmeticComponent) == 0x001F38, "Member 'ADelMarPreviewVehicle::CosmeticComponent' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, PreviewConfigs) == 0x001F40, "Member 'ADelMarPreviewVehicle::PreviewConfigs' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, SpringTravelOffset) == 0x0020C0, "Member 'ADelMarPreviewVehicle::SpringTravelOffset' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, BouncyChassisConfig) == 0x0020D0, "Member 'ADelMarPreviewVehicle::BouncyChassisConfig' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnDelMarVehicleHitWall) == 0x002130, "Member 'ADelMarPreviewVehicle::OnDelMarVehicleHitWall' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnDelMarVehicleHitVehicle) == 0x002140, "Member 'ADelMarPreviewVehicle::OnDelMarVehicleHitVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnDelMarVehicleHitByVehicle) == 0x002150, "Member 'ADelMarPreviewVehicle::OnDelMarVehicleHitByVehicle' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnHazardHit) == 0x0024E8, "Member 'ADelMarPreviewVehicle::OnHazardHit' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnVehicleTeleportEntered) == 0x0024F8, "Member 'ADelMarPreviewVehicle::OnVehicleTeleportEntered' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnVehicleTeleportExit) == 0x002508, "Member 'ADelMarPreviewVehicle::OnVehicleTeleportExit' has a wrong offset!");
static_assert(offsetof(ADelMarPreviewVehicle, OnVehicleAppliedTeleportRotation) == 0x002518, "Member 'ADelMarPreviewVehicle::OnVehicleAppliedTeleportRotation' has a wrong offset!");

// Class DelMarCosmetics.DelMarGaragePreviewVehicle
// 0x0200 (0x2760 - 0x2560)
class ADelMarGaragePreviewVehicle final : public ADelMarPreviewVehicle
{
public:
	FMulticastInlineDelegateProperty_             OnActiveCameraUpdatedDelegate;                     // 0x2560(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRotationTransitionStateChanged;                  // 0x2570(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class USceneComponent*                        PreviewPivotComponent;                             // 0x2580(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2588[0x8];                                     // 0x2588(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UCameraComponent*                       ActiveCameraComponent;                             // 0x2590(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCameraComponent*                       DefaultZoomInCameraComponent;                      // 0x2598(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCameraComponent*                       DefaultZoomOutCameraComponent;                     // 0x25A0(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_25A8[0xA0];                                    // 0x25A8(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGameplayTag, struct FRotator>    SlotPreviewRotations;                              // 0x2648(0x0050)(Edit, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FDelMarPreviewConfigs> SlotPreviewConfigs;                                // 0x2698(0x0050)(Edit, NativeAccessSpecifierPrivate)
	float                                         ZoomLevel;                                         // 0x26E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_26EC[0x4];                                     // 0x26EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               UserRotationOffset;                                // 0x26F0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           PreviewSlot;                                       // 0x2708(0x0004)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           PreviewVehicleTag;                                 // 0x270C(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         RotationTransitionTime;                            // 0x2710(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2714[0x4C];                                    // 0x2714(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ADelMarGaragePreviewVehicle) == 0x002760, "Wrong size on ADelMarGaragePreviewVehicle");
static_assert(offsetof(ADelMarGaragePreviewVehicle, OnActiveCameraUpdatedDelegate) == 0x002560, "Member 'ADelMarGaragePreviewVehicle::OnActiveCameraUpdatedDelegate' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, OnRotationTransitionStateChanged) == 0x002570, "Member 'ADelMarGaragePreviewVehicle::OnRotationTransitionStateChanged' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, PreviewPivotComponent) == 0x002580, "Member 'ADelMarGaragePreviewVehicle::PreviewPivotComponent' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, ActiveCameraComponent) == 0x002590, "Member 'ADelMarGaragePreviewVehicle::ActiveCameraComponent' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, DefaultZoomInCameraComponent) == 0x002598, "Member 'ADelMarGaragePreviewVehicle::DefaultZoomInCameraComponent' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, DefaultZoomOutCameraComponent) == 0x0025A0, "Member 'ADelMarGaragePreviewVehicle::DefaultZoomOutCameraComponent' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, SlotPreviewRotations) == 0x002648, "Member 'ADelMarGaragePreviewVehicle::SlotPreviewRotations' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, SlotPreviewConfigs) == 0x002698, "Member 'ADelMarGaragePreviewVehicle::SlotPreviewConfigs' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, ZoomLevel) == 0x0026E8, "Member 'ADelMarGaragePreviewVehicle::ZoomLevel' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, UserRotationOffset) == 0x0026F0, "Member 'ADelMarGaragePreviewVehicle::UserRotationOffset' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, PreviewSlot) == 0x002708, "Member 'ADelMarGaragePreviewVehicle::PreviewSlot' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, PreviewVehicleTag) == 0x00270C, "Member 'ADelMarGaragePreviewVehicle::PreviewVehicleTag' has a wrong offset!");
static_assert(offsetof(ADelMarGaragePreviewVehicle, RotationTransitionTime) == 0x002710, "Member 'ADelMarGaragePreviewVehicle::RotationTransitionTime' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           PreviewSlot;                                       // 0x09C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EDelMarPreviewCameraType                      PreviewType;                                       // 0x09C4(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDelMarPreviewCameraComponent) == 0x0009D0, "Wrong size on UDelMarPreviewCameraComponent");
static_assert(offsetof(UDelMarPreviewCameraComponent, PreviewSlot) == 0x0009C0, "Member 'UDelMarPreviewCameraComponent::PreviewSlot' has a wrong offset!");
static_assert(offsetof(UDelMarPreviewCameraComponent, PreviewType) == 0x0009C4, "Member 'UDelMarPreviewCameraComponent::PreviewType' has a wrong offset!");
