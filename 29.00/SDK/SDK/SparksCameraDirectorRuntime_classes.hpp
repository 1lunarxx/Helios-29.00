...
static_assert(sizeof(USparksLevelSequencePlayer) == 0x0005A8, "Wrong size on USparksLevelSequencePlayer");
static_assert(offsetof(USparksLevelSequencePlayer, SpawnedCamera) == 0x000588, "Member 'USparksLevelSequencePlayer::SpawnedCamera' has a wrong offset!");
static_assert(offsetof(USparksLevelSequencePlayer, TargetMesh) == 0x000590, "Member 'USparksLevelSequencePlayer::TargetMesh' has a wrong offset!");
static_assert(offsetof(USparksLevelSequencePlayer, SpawnedLookAtTraget) == 0x000598, "Member 'USparksLevelSequencePlayer::SpawnedLookAtTraget' has a wrong offset!");
