...
static_assert(offsetof(FFortAIInjectedDecisionServiceData, InjectedService) == 0x000008, "Member 'FFortAIInjectedDecisionServiceData::InjectedService' has a wrong offset!");
...
static_assert(offsetof(FFortAIInjectedDecisionStateTreeData, DecisionInstanceData) == 0x000000, "Member 'FFortAIInjectedDecisionStateTreeData::DecisionInstanceData' has a wrong offset!");
...
static_assert(offsetof(FFortAIInjectedDecision, InjectedBehavior) == 0x000000, "Member 'FFortAIInjectedDecision::InjectedBehavior' has a wrong offset!");
static_assert(offsetof(FFortAIInjectedDecision, OwnerComp) == 0x000008, "Member 'FFortAIInjectedDecision::OwnerComp' has a wrong offset!");
static_assert(offsetof(FFortAIInjectedDecision, ServiceData) == 0x000010, "Member 'FFortAIInjectedDecision::ServiceData' has a wrong offset!");
static_assert(offsetof(FFortAIInjectedDecision, StateTreeData) == 0x000038, "Member 'FFortAIInjectedDecision::StateTreeData' has a wrong offset!");
...
static_assert(offsetof(FFortAIInjectedDecisionsByTag, InjectedDecisions) == 0x000000, "Member 'FFortAIInjectedDecisionsByTag::InjectedDecisions' has a wrong offset!");
...
static_assert(offsetof(FFortAIInjectedBehaviorInjectorRuntime, InjectedDecisionsByTag) == 0x000000, "Member 'FFortAIInjectedBehaviorInjectorRuntime::InjectedDecisionsByTag' has a wrong offset!");
...
public:
	...
	struct FFortAISpawnGroupUpgradeUIData         UpgradeUIData;                                     // 0x00C0(0x0068)(NativeAccessSpecifierPublic)
	TStructCycleFixup<struct FFortAIPawnLootDropData, 0x0010, 0x04> LootDropData;                                      // 0x0128(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPendingSpawnInfo) == 0x000008, "Wrong alignment on FPendingSpawnInfo");
static_assert(sizeof(FPendingSpawnInfo) == 0x000138, "Wrong size on FPendingSpawnInfo");
...
static_assert(offsetof(FPendingSpawnInfo, bIsEncounterAI) == 0x000049, "Member 'FPendingSpawnInfo::bIsEncounterAI' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, EncounterInfo) == 0x000050, "Member 'FPendingSpawnInfo::EncounterInfo' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, DifficultyLevel) == 0x000058, "Member 'FPendingSpawnInfo::DifficultyLevel' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, SpawnGroup) == 0x000060, "Member 'FPendingSpawnInfo::SpawnGroup' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, SpawnGroupGuid) == 0x000068, "Member 'FPendingSpawnInfo::SpawnGroupGuid' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, EnemyIndexInSpawnGroup) == 0x000078, "Member 'FPendingSpawnInfo::EnemyIndexInSpawnGroup' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, TimeToSpawn) == 0x00007C, "Member 'FPendingSpawnInfo::TimeToSpawn' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, PendingSpawnInfoGuid) == 0x000080, "Member 'FPendingSpawnInfo::PendingSpawnInfoGuid' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, bIgnoreCollision) == 0x000090, "Member 'FPendingSpawnInfo::bIgnoreCollision' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, bKillBuildingActorsAtSpawnLocation) == 0x000091, "Member 'FPendingSpawnInfo::bKillBuildingActorsAtSpawnLocation' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, EncounterAILifespan) == 0x000094, "Member 'FPendingSpawnInfo::EncounterAILifespan' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, ScoreMultiplier) == 0x000098, "Member 'FPendingSpawnInfo::ScoreMultiplier' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, bDebugSpawnedAI) == 0x00009C, "Member 'FPendingSpawnInfo::bDebugSpawnedAI' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, AbilitySetsToGrantOnSpawn) == 0x0000A0, "Member 'FPendingSpawnInfo::AbilitySetsToGrantOnSpawn' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, ModifiersToApplyOnSpawn) == 0x0000B0, "Member 'FPendingSpawnInfo::ModifiersToApplyOnSpawn' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, UpgradeUIData) == 0x0000C0, "Member 'FPendingSpawnInfo::UpgradeUIData' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, LootDropData) == 0x000128, "Member 'FPendingSpawnInfo::LootDropData' has a wrong offset!");
...
static_assert(offsetof(FAILootInfoRowEntry, OptionalPlaylistTagQuery) == 0x000048, "Member 'FAILootInfoRowEntry::OptionalPlaylistTagQuery' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, LootTiers) == 0x000098, "Member 'FAILootInfoRowEntry::LootTiers' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemClassToDropOnDeathInsteadOfGrant) == 0x0000A8, "Member 'FAILootInfoRowEntry::ItemClassToDropOnDeathInsteadOfGrant' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemToDropOnDeathInsteadOfGrant) == 0x0000B8, "Member 'FAILootInfoRowEntry::ItemToDropOnDeathInsteadOfGrant' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemTagQueryToDropOnDeathInsteadOfGrant) == 0x0000C8, "Member 'FAILootInfoRowEntry::ItemTagQueryToDropOnDeathInsteadOfGrant' has a wrong offset!");
