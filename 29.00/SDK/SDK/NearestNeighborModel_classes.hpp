...
public:
	...
	bool                                          bUseDualQuaternionDeltas;                          // 0x01E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E9[0x3];                                      // 0x01E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DecayFactor;                                       // 0x01EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         NearestNeighborOffsetWeight;                       // 0x01F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUseRBF;                                           // 0x01F4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F5[0x3];                                      // 0x01F5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RBFSigma;                                          // 0x01F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UNearestNeighborModelSection*>   Sections;                                          // 0x0200(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<int32>                                 PCACoeffStarts;                                    // 0x0210(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	bool                                          bIsReadyForTraining;                               // 0x0220(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsReadyForInference;                              // 0x0221(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_222[0x6];                                      // 0x0222(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UNearestNeighborOptimizedNetwork*       OptimizedNetwork;                                  // 0x0228(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNearestNeighborModel) == 0x000238, "Wrong size on UNearestNeighborModel");
static_assert(offsetof(UNearestNeighborModel, InputDim) == 0x0001A8, "Member 'UNearestNeighborModel::InputDim' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, OutputDim) == 0x0001AC, "Member 'UNearestNeighborModel::OutputDim' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, bUseInputMultipliers) == 0x0001B0, "Member 'UNearestNeighborModel::bUseInputMultipliers' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, InputMultipliers) == 0x0001B8, "Member 'UNearestNeighborModel::InputMultipliers' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, InputsMin) == 0x0001C8, "Member 'UNearestNeighborModel::InputsMin' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, InputsMax) == 0x0001D8, "Member 'UNearestNeighborModel::InputsMax' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, bUseDualQuaternionDeltas) == 0x0001E8, "Member 'UNearestNeighborModel::bUseDualQuaternionDeltas' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, DecayFactor) == 0x0001EC, "Member 'UNearestNeighborModel::DecayFactor' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, NearestNeighborOffsetWeight) == 0x0001F0, "Member 'UNearestNeighborModel::NearestNeighborOffsetWeight' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, bUseRBF) == 0x0001F4, "Member 'UNearestNeighborModel::bUseRBF' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, RBFSigma) == 0x0001F8, "Member 'UNearestNeighborModel::RBFSigma' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, Sections) == 0x000200, "Member 'UNearestNeighborModel::Sections' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, PCACoeffStarts) == 0x000210, "Member 'UNearestNeighborModel::PCACoeffStarts' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, bIsReadyForTraining) == 0x000220, "Member 'UNearestNeighborModel::bIsReadyForTraining' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, bIsReadyForInference) == 0x000221, "Member 'UNearestNeighborModel::bIsReadyForInference' has a wrong offset!");
static_assert(offsetof(UNearestNeighborModel, OptimizedNetwork) == 0x000228, "Member 'UNearestNeighborModel::OptimizedNetwork' has a wrong offset!");
...
public:
	...
	class UNearestNeighborOptimizedNetworkInstance* OptimizedNetworkInstance;                          // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNearestNeighborModelInstance) == 0x0000B8, "Wrong size on UNearestNeighborModelInstance");
static_assert(offsetof(UNearestNeighborModelInstance, OptimizedNetworkInstance) == 0x0000B0, "Member 'UNearestNeighborModelInstance::OptimizedNetworkInstance' has a wrong offset!");
