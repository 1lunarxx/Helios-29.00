...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x07F0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0800(0x07F0)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LegacyCameraShake_BlueprintUpdateCameraShake) == 0x000FF0, "Wrong size on LegacyCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(LegacyCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000800, "Member 'LegacyCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
