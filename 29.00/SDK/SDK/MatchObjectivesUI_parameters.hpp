...
static_assert(alignof(FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted) == 0x000001, "Wrong alignment on FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted");
static_assert(sizeof(FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted) == 0x000001, "Wrong size on FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted");
static_assert(offsetof(FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted, bSkydivedFromBusAndLanded) == 0x000000, "Member 'FortMobileHUDElement_ObjectiveSelectorWrapper_HandleSkydiveFromBusAndLandingCompleted::bSkydivedFromBusAndLanded' has a wrong offset!");
