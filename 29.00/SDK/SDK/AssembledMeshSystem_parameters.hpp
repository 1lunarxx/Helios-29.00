...
static_assert(offsetof(AssembledMeshUserComponent_SetMeshParts, InMeshParts) == 0x000000, "Member 'AssembledMeshUserComponent_SetMeshParts::InMeshParts' has a wrong offset!");
