...
// 0x0218 (0x0528 - 0x0310)
class UEncounterItemDefinition final : public UFortItemDefinition
{
public:
	bool                                          bAutoHandleSuccessFailure;                         // 0x0310(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_311[0x7];                                      // 0x0311(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UWorld>                  Level;                                             // 0x0318(0x0020)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UStateTree>              StateTreeOverride;                                 // 0x0338(0x0020)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        ProximityGameplayCueTag;                           // 0x0358(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        ActorCleanupGameplayCueTag;                        // 0x035C(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<class FName>                           SuccessRewards;                                    // 0x0360(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FEncounterRewardBehavior               SuccessRewardBehavior;                             // 0x0370(0x0080)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        ActorSuccessGameplayCueTag;                        // 0x03F0(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        PlayerSuccessGameplayCueTag;                       // 0x03F4(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<class FName>                           FailureRewards;                                    // 0x03F8(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FEncounterRewardBehavior               FailureRewardBehavior;                             // 0x0408(0x0080)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        ActorFailureGameplayCueTag;                        // 0x0488(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayCueTag                        PlayerFailureGameplayCueTag;                       // 0x048C(0x0004)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         LWMDensityWeight;                                  // 0x0490(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         LWMDensityRange;                                   // 0x04B8(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FInstancedStruct>               Vars;                                              // 0x04E0(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FInstancedStruct>               VariableSelections;                                // 0x04F0(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FWorldConditionQueryDefinition         CanSpawnWorldConditionDefinition;                  // 0x0500(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FFortAthenaLivingWorldPrefabActorSpawnerData> ActorSpawnerDatas;                                 // 0x0518(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEncounterItemDefinition) == 0x000528, "Wrong size on UEncounterItemDefinition");
static_assert(offsetof(UEncounterItemDefinition, bAutoHandleSuccessFailure) == 0x000310, "Member 'UEncounterItemDefinition::bAutoHandleSuccessFailure' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, Level) == 0x000318, "Member 'UEncounterItemDefinition::Level' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, StateTreeOverride) == 0x000338, "Member 'UEncounterItemDefinition::StateTreeOverride' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, ProximityGameplayCueTag) == 0x000358, "Member 'UEncounterItemDefinition::ProximityGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, ActorCleanupGameplayCueTag) == 0x00035C, "Member 'UEncounterItemDefinition::ActorCleanupGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, SuccessRewards) == 0x000360, "Member 'UEncounterItemDefinition::SuccessRewards' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, SuccessRewardBehavior) == 0x000370, "Member 'UEncounterItemDefinition::SuccessRewardBehavior' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, ActorSuccessGameplayCueTag) == 0x0003F0, "Member 'UEncounterItemDefinition::ActorSuccessGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, PlayerSuccessGameplayCueTag) == 0x0003F4, "Member 'UEncounterItemDefinition::PlayerSuccessGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, FailureRewards) == 0x0003F8, "Member 'UEncounterItemDefinition::FailureRewards' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, FailureRewardBehavior) == 0x000408, "Member 'UEncounterItemDefinition::FailureRewardBehavior' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, ActorFailureGameplayCueTag) == 0x000488, "Member 'UEncounterItemDefinition::ActorFailureGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, PlayerFailureGameplayCueTag) == 0x00048C, "Member 'UEncounterItemDefinition::PlayerFailureGameplayCueTag' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, LWMDensityWeight) == 0x000490, "Member 'UEncounterItemDefinition::LWMDensityWeight' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, LWMDensityRange) == 0x0004B8, "Member 'UEncounterItemDefinition::LWMDensityRange' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, Vars) == 0x0004E0, "Member 'UEncounterItemDefinition::Vars' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, VariableSelections) == 0x0004F0, "Member 'UEncounterItemDefinition::VariableSelections' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, CanSpawnWorldConditionDefinition) == 0x000500, "Member 'UEncounterItemDefinition::CanSpawnWorldConditionDefinition' has a wrong offset!");
static_assert(offsetof(UEncounterItemDefinition, ActorSpawnerDatas) == 0x000518, "Member 'UEncounterItemDefinition::ActorSpawnerDatas' has a wrong offset!");
...
static_assert(sizeof(UEncounterStateTreeComponent) == 0x000160, "Wrong size on UEncounterStateTreeComponent");
