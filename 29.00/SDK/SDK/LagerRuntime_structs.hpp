...
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCheckForActorDensity) == 0x0000A4, "Member 'FFortAthenaLivingWorldEvent::bCheckForActorDensity' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxActorDensityOverride) == 0x0000A8, "Member 'FFortAthenaLivingWorldEvent::MaxActorDensityOverride' has a wrong offset!");
...
static_assert(offsetof(FFortAthenaLivingWorldEvent, InstantDeathMinRespawnTime) == 0x0000D0, "Member 'FFortAthenaLivingWorldEvent::InstantDeathMinRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, InstantDeathMaxRespawnTime) == 0x0000E0, "Member 'FFortAthenaLivingWorldEvent::InstantDeathMaxRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInSafeZone) == 0x0000F0, "Member 'FFortAthenaLivingWorldEvent::bOnlyInSafeZone' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInNextSafeZone) == 0x0000F1, "Member 'FFortAthenaLivingWorldEvent::bOnlyInNextSafeZone' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInNextSafeZoneIfStormShrinking) == 0x0000F2, "Member 'FFortAthenaLivingWorldEvent::bOnlyInNextSafeZoneIfStormShrinking' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, CanSpawnCondition) == 0x0000F8, "Member 'FFortAthenaLivingWorldEvent::CanSpawnCondition' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationGamePhaseStep) == 0x000110, "Member 'FFortAthenaLivingWorldEvent::ActivationGamePhaseStep' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationSafezoneIndex) == 0x000114, "Member 'FFortAthenaLivingWorldEvent::ActivationSafezoneIndex' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationMinDelay) == 0x000118, "Member 'FFortAthenaLivingWorldEvent::ActivationMinDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationMaxDelay) == 0x00011C, "Member 'FFortAthenaLivingWorldEvent::ActivationMaxDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DeactivationMinDelay) == 0x000120, "Member 'FFortAthenaLivingWorldEvent::DeactivationMinDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DeactivationMaxDelay) == 0x000124, "Member 'FFortAthenaLivingWorldEvent::DeactivationMaxDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, TagDensityConditions) == 0x000128, "Member 'FFortAthenaLivingWorldEvent::TagDensityConditions' has a wrong offset!");
