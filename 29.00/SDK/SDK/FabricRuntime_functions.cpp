...
// Parameters:
// class APlayerController*                InteractingController_0                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    IsToggle                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFabricButtonBase::ToggleStateChanged__DelegateSignature(class APlayerController* InteractingController_0, bool IsToggle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricButtonBase", "ToggleStateChanged__DelegateSignature");

	Params::FabricButtonBase_ToggleStateChanged__DelegateSignature Parms{};

	Parms.InteractingController_0 = InteractingController_0;
...
void UFabricButtonComponentBase::ToggleStateChanged__DelegateSignature(class APlayerController* InteractingController_0, bool IsToggle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricButtonComponentBase", "ToggleStateChanged__DelegateSignature");

	Params::FabricButtonComponentBase_ToggleStateChanged__DelegateSignature Parms{};
...
void UFabricFloatProviderBase::OnFloatChanged__DelegateSignature(float Float)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricFloatProviderBase", "OnFloatChanged__DelegateSignature");

	Params::FabricFloatProviderBase_OnFloatChanged__DelegateSignature Parms{};
...
void AFabricInteractionTool::OnCableHeldStateChanged__DelegateSignature(class AFortCreativeDeviceProp* Device)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricInteractionTool", "OnCableHeldStateChanged__DelegateSignature");

	Params::FabricInteractionTool_OnCableHeldStateChanged__DelegateSignature Parms{};
...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// EFabricInteractionToolStates            NewState                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class AFortCreativeDeviceProp*          Device                                                 (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFabricInteractionTool::OnInteractionStateChanged__DelegateSignature(EFabricInteractionToolStates NewState, class AFortCreativeDeviceProp* Device)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricInteractionTool", "OnInteractionStateChanged__DelegateSignature");

	Params::FabricInteractionTool_OnInteractionStateChanged__DelegateSignature Parms{};
...
void AFabricInteractionTool::OnMetasoundGeneratorCrossfadeStarted__DelegateSignature(float CrossfadeSeconds)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricInteractionTool", "OnMetasoundGeneratorCrossfadeStarted__DelegateSignature");

	Params::FabricInteractionTool_OnMetasoundGeneratorCrossfadeStarted__DelegateSignature Parms{};
...
// DelegateFunction FabricRuntime.FabricProgressorManager.OnProgressionChanged__DelegateSignature
// (MulticastDelegate, Public, Delegate)

void UFabricProgressorManager::OnProgressionChanged__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricProgressorManager", "OnProgressionChanged__DelegateSignature");
...
// Parameters:
// TArray<struct FFabricTextureProviderTexture>Textures                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UFabricTextureModifierBase::OnSourceTextureChanged__DelegateSignature(const TArray<struct FFabricTextureProviderTexture>& Textures)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricTextureModifierBase", "OnSourceTextureChanged__DelegateSignature");

	Params::FabricTextureModifierBase_OnSourceTextureChanged__DelegateSignature Parms{};
...
// (MulticastDelegate, Public, Delegate, HasOutParams)
// Parameters:
// struct FFabricTextureProviderTexture    Texture                                                (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UFabricTextureProviderBase::OnTextureChanged__DelegateSignature(const struct FFabricTextureProviderTexture& Texture)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FabricTextureProviderBase", "OnTextureChanged__DelegateSignature");

	Params::FabricTextureProviderBase_OnTextureChanged__DelegateSignature Parms{};
