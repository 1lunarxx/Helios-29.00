...
static_assert(offsetof(InventoryCollection_GetItemEntryIDBySlot, TargetInventoryID) == 0x000000, "Member 'InventoryCollection_GetItemEntryIDBySlot::TargetInventoryID' has a wrong offset!");
static_assert(offsetof(InventoryCollection_GetItemEntryIDBySlot, SlotNumber) == 0x000010, "Member 'InventoryCollection_GetItemEntryIDBySlot::SlotNumber' has a wrong offset!");
static_assert(offsetof(InventoryCollection_GetItemEntryIDBySlot, ReturnValue) == 0x000014, "Member 'InventoryCollection_GetItemEntryIDBySlot::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InventoryCollection_IsEquippableItemActive, ItemEntryID) == 0x000000, "Member 'InventoryCollection_IsEquippableItemActive::ItemEntryID' has a wrong offset!");
static_assert(offsetof(InventoryCollection_IsEquippableItemActive, ReturnValue) == 0x000010, "Member 'InventoryCollection_IsEquippableItemActive::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemDefinitionBase_GetDisallowedComponents, ReturnValue) == 0x000000, "Member 'ItemDefinitionBase_GetDisallowedComponents::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemizationLootPoolAsset_GetAllowedLootPoolItemClasses, ReturnValue) == 0x000000, "Member 'ItemizationLootPoolAsset_GetAllowedLootPoolItemClasses::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemizationLootPoolAsset_GetDisallowedLootPoolItemClasses, ReturnValue) == 0x000000, "Member 'ItemizationLootPoolAsset_GetDisallowedLootPoolItemClasses::ReturnValue' has a wrong offset!");

// Function ItemizationCoreRuntime.ItemizationLootCountCalculator_SetAttribute.GetAllowedItemAttributeClasses
// 0x0010 (0x0010 - 0x0000)
struct ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses final
{
public:
	TArray<class UClass*>                         ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses) == 0x000008, "Wrong alignment on ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses");
static_assert(sizeof(ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses) == 0x000010, "Wrong size on ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses");
static_assert(offsetof(ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses, ReturnValue) == 0x000000, "Member 'ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses::ReturnValue' has a wrong offset!");

// Function ItemizationCoreRuntime.ItemizationLootCountCalculator_SetAttribute.GetDisallowedItemAttributeClasses
// 0x0010 (0x0010 - 0x0000)
struct ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses final
{
public:
	TArray<class UClass*>                         ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses) == 0x000008, "Wrong alignment on ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses");
static_assert(sizeof(ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses) == 0x000010, "Wrong size on ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses");
static_assert(offsetof(ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses, ReturnValue) == 0x000000, "Member 'ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses::ReturnValue' has a wrong offset!");
