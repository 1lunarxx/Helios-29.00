...
static_assert(offsetof(CommonTabListWidgetLegacy_OnTabButtonCreated__DelegateSignature, TabID) == 0x000000, "Member 'CommonTabListWidgetLegacy_OnTabButtonCreated__DelegateSignature::TabID' has a wrong offset!");
static_assert(offsetof(CommonTabListWidgetLegacy_OnTabButtonCreated__DelegateSignature, TabButton) == 0x000008, "Member 'CommonTabListWidgetLegacy_OnTabButtonCreated__DelegateSignature::TabButton' has a wrong offset!");
...
static_assert(offsetof(CommonTabListWidgetLegacy_OnTabButtonRemoved__DelegateSignature, TabID) == 0x000000, "Member 'CommonTabListWidgetLegacy_OnTabButtonRemoved__DelegateSignature::TabID' has a wrong offset!");
static_assert(offsetof(CommonTabListWidgetLegacy_OnTabButtonRemoved__DelegateSignature, TabButton) == 0x000008, "Member 'CommonTabListWidgetLegacy_OnTabButtonRemoved__DelegateSignature::TabButton' has a wrong offset!");
...
static_assert(offsetof(CommonUISubsystemLegacy_InputSuspensionChanged__DelegateSignature, bInputSuspended) == 0x000000, "Member 'CommonUISubsystemLegacy_InputSuspensionChanged__DelegateSignature::bInputSuspended' has a wrong offset!");
...
static_assert(offsetof(CommonWidgetStackLegacy_OnActiveWidgetChangedLegacy__DelegateSignature, InActiveWidget) == 0x000000, "Member 'CommonWidgetStackLegacy_OnActiveWidgetChangedLegacy__DelegateSignature::InActiveWidget' has a wrong offset!");
static_assert(offsetof(CommonWidgetStackLegacy_OnActiveWidgetChangedLegacy__DelegateSignature, InActiveWidgetIndex) == 0x000008, "Member 'CommonWidgetStackLegacy_OnActiveWidgetChangedLegacy__DelegateSignature::InActiveWidgetIndex' has a wrong offset!");
