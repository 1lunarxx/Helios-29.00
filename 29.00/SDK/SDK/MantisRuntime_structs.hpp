...
static_assert(sizeof(FFortMantisRootMotionWarpInfo) == 0x000068, "Wrong size on FFortMantisRootMotionWarpInfo");
...
static_assert(offsetof(FFortRootMotionSource_Mantis, LatestRepMovementLocation) == 0x000150, "Member 'FFortRootMotionSource_Mantis::LatestRepMovementLocation' has a wrong offset!");
...
static_assert(sizeof(FFortMantisTargetData) == 0x0001C0, "Wrong size on FFortMantisTargetData");
...
static_assert(offsetof(FFortMantisTargetData, TechniqueDataIndex) == 0x000070, "Member 'FFortMantisTargetData::TechniqueDataIndex' has a wrong offset!");
static_assert(offsetof(FFortMantisTargetData, bIsLockedOn) == 0x000074, "Member 'FFortMantisTargetData::bIsLockedOn' has a wrong offset!");
static_assert(offsetof(FFortMantisTargetData, DynamicMontageName) == 0x000078, "Member 'FFortMantisTargetData::DynamicMontageName' has a wrong offset!");
static_assert(offsetof(FFortMantisTargetData, TechniqueMetadata) == 0x000080, "Member 'FFortMantisTargetData::TechniqueMetadata' has a wrong offset!");
