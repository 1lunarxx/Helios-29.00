...
public:
	...
	class UFortInputMappingContext*               KeyboardAsPlasticGuitarBeatmatchIMC;               // 0x01E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortInputMappingContext*               PlasticGuitarBeatmatchIMC;                         // 0x01E8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	void OnServerTimedInputReceived__DelegateSignature(class UPilgrimPlayerControllerComponent* PlayerControllerComponent, const struct FPilgrimTimedInput& TimedInput);
...
static_assert(sizeof(UPilgrimPlayerControllerComponent) == 0x0002C8, "Wrong size on UPilgrimPlayerControllerComponent");
...
static_assert(offsetof(UPilgrimPlayerControllerComponent, FallbackKeyboardLaneInputMappingConfigs) == 0x000140, "Member 'UPilgrimPlayerControllerComponent::FallbackKeyboardLaneInputMappingConfigs' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, FallbackControllerLaneInputMappingConfigs) == 0x000190, "Member 'UPilgrimPlayerControllerComponent::FallbackControllerLaneInputMappingConfigs' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, KeyboardAsPlasticGuitarBeatmatchIMC) == 0x0001E0, "Member 'UPilgrimPlayerControllerComponent::KeyboardAsPlasticGuitarBeatmatchIMC' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, PlasticGuitarBeatmatchIMC) == 0x0001E8, "Member 'UPilgrimPlayerControllerComponent::PlasticGuitarBeatmatchIMC' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, LaneInputMappingConfigs) == 0x0001F0, "Member 'UPilgrimPlayerControllerComponent::LaneInputMappingConfigs' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, TouchBrushesConfig) == 0x000240, "Member 'UPilgrimPlayerControllerComponent::TouchBrushesConfig' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, SelectedNumInputLanes) == 0x000250, "Member 'UPilgrimPlayerControllerComponent::SelectedNumInputLanes' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, SelectedPCBeatmatchIMC) == 0x000258, "Member 'UPilgrimPlayerControllerComponent::SelectedPCBeatmatchIMC' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, SelectedConsoleBeatmatchIMC) == 0x000260, "Member 'UPilgrimPlayerControllerComponent::SelectedConsoleBeatmatchIMC' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, PilgrimGameUserSettings) == 0x0002B8, "Member 'UPilgrimPlayerControllerComponent::PilgrimGameUserSettings' has a wrong offset!");
static_assert(offsetof(UPilgrimPlayerControllerComponent, PilgrimPresetConfiguration) == 0x0002C0, "Member 'UPilgrimPlayerControllerComponent::PilgrimPresetConfiguration' has a wrong offset!");
...
public:
	...
	void RequestFeedFailureDelegate__DelegateSignature(const class FText& Error, const struct FPilgrimPlayerFeedParams& RequestParams);
...
public:
	...
	bool                                          OverdriveClearsGems;                               // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0x26];                                      // 0x0032(0x0026)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void SetOverdriveClearsGems(bool NewValue);
	...
	bool GetOverdriveClearsGems() const;
...
static_assert(offsetof(UPilgrimClientSettingRecordPartition, OverdriveClearsGems) == 0x000031, "Member 'UPilgrimClientSettingRecordPartition::OverdriveClearsGems' has a wrong offset!");
...
public:
	...
	void PilgrimGameScoreUpdated__DelegateSignature(const struct FPilgrimGameProgress& Score);
...
static_assert(sizeof(UPilgrimGame) == 0x000640, "Wrong size on UPilgrimGame");
...
static_assert(sizeof(UPilgrimGameEvaluator) == 0x000260, "Wrong size on UPilgrimGameEvaluator");
...
static_assert(sizeof(UPilgrimInputConfig) == 0x0000E8, "Wrong size on UPilgrimInputConfig");
...
public:
	...
	void OnMusicBattleFinished__DelegateSignature(const EMusicBattleEndReason EndReason);
...
static_assert(sizeof(UPilgrimTrackCaptureComponent) == 0x000AF0, "Wrong size on UPilgrimTrackCaptureComponent");
static_assert(offsetof(UPilgrimTrackCaptureComponent, ViewOwner) == 0x000AE0, "Member 'UPilgrimTrackCaptureComponent::ViewOwner' has a wrong offset!");
