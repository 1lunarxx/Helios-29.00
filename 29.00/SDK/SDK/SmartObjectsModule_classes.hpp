...
public:
	...
	class USmartObjectDefinition*                 CachedDefinitionAssetVariation;                    // 0x0290(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	void SetDefinitionAsset(class USmartObjectDefinition* Definition);

	const class USmartObjectDefinition* GetDefinition() const;
	const class USmartObjectDefinition* GetDefinitionAsset() const;
...
static_assert(sizeof(USmartObjectComponent) == 0x0002A0, "Wrong size on USmartObjectComponent");
...
static_assert(offsetof(USmartObjectComponent, DefinitionRef) == 0x000248, "Member 'USmartObjectComponent::DefinitionRef' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, RegisteredHandle) == 0x000270, "Member 'USmartObjectComponent::RegisteredHandle' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, bCanBePartOfCollection) == 0x000288, "Member 'USmartObjectComponent::bCanBePartOfCollection' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, CachedDefinitionAssetVariation) == 0x000290, "Member 'USmartObjectComponent::CachedDefinitionAssetVariation' has a wrong offset!");
