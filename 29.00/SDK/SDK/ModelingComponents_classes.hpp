...
static_assert(offsetof(UBaseCreateFromSelectedTool, CollisionProperties) == 0x0000E0, "Member 'UBaseCreateFromSelectedTool::CollisionProperties' has a wrong offset!");
