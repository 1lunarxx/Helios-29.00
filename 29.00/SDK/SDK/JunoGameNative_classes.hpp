...
public:
	void OnJunoPlayerPersistenceDataAvailable(const struct FUniqueNetIdRepl& UniquePlayerId, const struct FJunoPlayerSaveData& SaveData, const struct FJunoPlayerAccountSaveData& AccountSaveData);
...
public:
	...
	FMulticastInlineDelegateProperty_             OnInventoryChangedEvent;                           // 0x02D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	void OnInventoryChangedEvent__DelegateSignature(const TArray<class UFortItem*>& AddedItems, const TArray<class UFortItem*>& RemovedItems);
...
public:
	...
	TSoftObjectPtr<class UAthenaCharacterItemDefinition> BaseAthenaCharacterItemDefinition;                 // 0x00B0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAssembledMeshSchema>    AssembledMeshSchema;                               // 0x00D0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAssembledMeshSchema>    LowDetailsAssembledMeshSchema;                     // 0x00F0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimMontage>            FrontendAnimMontageIdleOverride;                   // 0x0110(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PreviewPawnScale;                                  // 0x0130(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoAthenaCharacterItemOverrideDefinition) == 0x000138, "Wrong size on UJunoAthenaCharacterItemOverrideDefinition");
static_assert(offsetof(UJunoAthenaCharacterItemOverrideDefinition, BaseAthenaCharacterItemDefinition) == 0x0000B0, "Member 'UJunoAthenaCharacterItemOverrideDefinition::BaseAthenaCharacterItemDefinition' has a wrong offset!");
static_assert(offsetof(UJunoAthenaCharacterItemOverrideDefinition, AssembledMeshSchema) == 0x0000D0, "Member 'UJunoAthenaCharacterItemOverrideDefinition::AssembledMeshSchema' has a wrong offset!");
static_assert(offsetof(UJunoAthenaCharacterItemOverrideDefinition, LowDetailsAssembledMeshSchema) == 0x0000F0, "Member 'UJunoAthenaCharacterItemOverrideDefinition::LowDetailsAssembledMeshSchema' has a wrong offset!");
static_assert(offsetof(UJunoAthenaCharacterItemOverrideDefinition, FrontendAnimMontageIdleOverride) == 0x000110, "Member 'UJunoAthenaCharacterItemOverrideDefinition::FrontendAnimMontageIdleOverride' has a wrong offset!");
static_assert(offsetof(UJunoAthenaCharacterItemOverrideDefinition, PreviewPawnScale) == 0x000130, "Member 'UJunoAthenaCharacterItemOverrideDefinition::PreviewPawnScale' has a wrong offset!");
...
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UAthenaDanceItemDefinition> BaseAthenaDanceItemDefinition;                     // 0x00B0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimMontage>            Animation;                                         // 0x00D0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimMontage>            AnimationFemaleOverride;                           // 0x00F0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FFortEmoteMapping>              AnimationOverrides;                                // 0x0110(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimMontage>            FrontEndAnimation;                                 // 0x0120(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimMontage>            FrontEndAnimationFemaleOverride;                   // 0x0140(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FFortEmoteMapping>              FrontEndAnimationOverrides;                        // 0x0160(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FVector                                GroupEmotePositionOffset;                          // 0x0170(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         GroupEmotePositionOffsetTolerance;                 // 0x0188(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         GroupEmoteFollowDistance;                          // 0x018C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WalkForwardSpeed;                                  // 0x0190(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoAthenaDanceItemOverrideDefinition) == 0x000198, "Wrong size on UJunoAthenaDanceItemOverrideDefinition");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, BaseAthenaDanceItemDefinition) == 0x0000B0, "Member 'UJunoAthenaDanceItemOverrideDefinition::BaseAthenaDanceItemDefinition' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, Animation) == 0x0000D0, "Member 'UJunoAthenaDanceItemOverrideDefinition::Animation' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, AnimationFemaleOverride) == 0x0000F0, "Member 'UJunoAthenaDanceItemOverrideDefinition::AnimationFemaleOverride' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, AnimationOverrides) == 0x000110, "Member 'UJunoAthenaDanceItemOverrideDefinition::AnimationOverrides' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, FrontEndAnimation) == 0x000120, "Member 'UJunoAthenaDanceItemOverrideDefinition::FrontEndAnimation' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, FrontEndAnimationFemaleOverride) == 0x000140, "Member 'UJunoAthenaDanceItemOverrideDefinition::FrontEndAnimationFemaleOverride' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, FrontEndAnimationOverrides) == 0x000160, "Member 'UJunoAthenaDanceItemOverrideDefinition::FrontEndAnimationOverrides' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, GroupEmotePositionOffset) == 0x000170, "Member 'UJunoAthenaDanceItemOverrideDefinition::GroupEmotePositionOffset' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, GroupEmotePositionOffsetTolerance) == 0x000188, "Member 'UJunoAthenaDanceItemOverrideDefinition::GroupEmotePositionOffsetTolerance' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, GroupEmoteFollowDistance) == 0x00018C, "Member 'UJunoAthenaDanceItemOverrideDefinition::GroupEmoteFollowDistance' has a wrong offset!");
static_assert(offsetof(UJunoAthenaDanceItemOverrideDefinition, WalkForwardSpeed) == 0x000190, "Member 'UJunoAthenaDanceItemOverrideDefinition::WalkForwardSpeed' has a wrong offset!");
...
// Class JunoGameNative.JunoPlayerAccountPersistenceFeatureDataInterface
// 0x0000 (0x0028 - 0x0028)
class IJunoPlayerAccountPersistenceFeatureDataInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JunoPlayerAccountPersistenceFeatureDataInterface">();
	}
	static class IJunoPlayerAccountPersistenceFeatureDataInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IJunoPlayerAccountPersistenceFeatureDataInterface>();
	}
};
static_assert(alignof(IJunoPlayerAccountPersistenceFeatureDataInterface) == 0x000008, "Wrong alignment on IJunoPlayerAccountPersistenceFeatureDataInterface");
static_assert(sizeof(IJunoPlayerAccountPersistenceFeatureDataInterface) == 0x000028, "Wrong size on IJunoPlayerAccountPersistenceFeatureDataInterface");
...
public:
	...
	class FString                                 WorldId;                                           // 0x0038(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NewWorldAdventureSeed;                             // 0x0048(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_BuildMode            Mode;                                              // 0x004C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          HostileCreatures;                                  // 0x004D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          FriendlyCreatures;                                 // 0x004E(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          DropInventoryOnDeath;                              // 0x004F(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          Hunger;                                            // 0x0050(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          StaminaDrain;                                      // 0x0051(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          NPCs;                                              // 0x0052(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          Temperature;                                       // 0x0053(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          Death;                                             // 0x0054(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EJunoWorldSettingOptions_WorldSwitch          FriendlyFire;                                      // 0x0055(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoPersistenceDeveloperSettings) == 0x000058, "Wrong size on UJunoPersistenceDeveloperSettings");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, PersistenceType) == 0x000030, "Member 'UJunoPersistenceDeveloperSettings::PersistenceType' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, ReadOnly) == 0x000034, "Member 'UJunoPersistenceDeveloperSettings::ReadOnly' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, WorldId) == 0x000038, "Member 'UJunoPersistenceDeveloperSettings::WorldId' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, NewWorldAdventureSeed) == 0x000048, "Member 'UJunoPersistenceDeveloperSettings::NewWorldAdventureSeed' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, Mode) == 0x00004C, "Member 'UJunoPersistenceDeveloperSettings::Mode' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, HostileCreatures) == 0x00004D, "Member 'UJunoPersistenceDeveloperSettings::HostileCreatures' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, FriendlyCreatures) == 0x00004E, "Member 'UJunoPersistenceDeveloperSettings::FriendlyCreatures' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, DropInventoryOnDeath) == 0x00004F, "Member 'UJunoPersistenceDeveloperSettings::DropInventoryOnDeath' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, Hunger) == 0x000050, "Member 'UJunoPersistenceDeveloperSettings::Hunger' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, StaminaDrain) == 0x000051, "Member 'UJunoPersistenceDeveloperSettings::StaminaDrain' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, NPCs) == 0x000052, "Member 'UJunoPersistenceDeveloperSettings::NPCs' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, Temperature) == 0x000053, "Member 'UJunoPersistenceDeveloperSettings::Temperature' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, Death) == 0x000054, "Member 'UJunoPersistenceDeveloperSettings::Death' has a wrong offset!");
static_assert(offsetof(UJunoPersistenceDeveloperSettings, FriendlyFire) == 0x000055, "Member 'UJunoPersistenceDeveloperSettings::FriendlyFire' has a wrong offset!");
...
public:
	...
	class UJunoHarvestingComponent*               HarvestingComponent;                               // 0x0C18(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UJunoPhysicsPersistenceComponent*       PhysicsPersistenceComponent;                       // 0x0C20(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C28[0x10];                                     // 0x0C28(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UItemDefinitionBase*                    AssociatedItem;                                    // 0x0C38(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, SaveGame, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AJunoBuildingProp) == 0x000C40, "Wrong size on AJunoBuildingProp");
static_assert(offsetof(AJunoBuildingProp, HarvestingComponent) == 0x000C18, "Member 'AJunoBuildingProp::HarvestingComponent' has a wrong offset!");
static_assert(offsetof(AJunoBuildingProp, PhysicsPersistenceComponent) == 0x000C20, "Member 'AJunoBuildingProp::PhysicsPersistenceComponent' has a wrong offset!");
static_assert(offsetof(AJunoBuildingProp, AssociatedItem) == 0x000C38, "Member 'AJunoBuildingProp::AssociatedItem' has a wrong offset!");
...
// Class JunoGameNative.JunoPlayerSaveDataBase_Container
// 0x0058 (0x0238 - 0x01E0)
class UJunoPlayerSaveDataBase_Container : public UJunoBasePFWContainer
{
public:
	struct FPersistenceFrameworkPlayerInfo        PlayerInfo;                                        // 0x01E0(0x0020)(Protected, NativeAccessSpecifierProtected)
	struct FUniqueNetIdRepl                       PlayerNetId;                                       // 0x0200(0x0030)(Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_230[0x8];                                      // 0x0230(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JunoPlayerSaveDataBase_Container">();
	}
	static class UJunoPlayerSaveDataBase_Container* GetDefaultObj()
	{
		return GetDefaultObjImpl<UJunoPlayerSaveDataBase_Container>();
	}
};
static_assert(alignof(UJunoPlayerSaveDataBase_Container) == 0x000008, "Wrong alignment on UJunoPlayerSaveDataBase_Container");
static_assert(sizeof(UJunoPlayerSaveDataBase_Container) == 0x000238, "Wrong size on UJunoPlayerSaveDataBase_Container");
static_assert(offsetof(UJunoPlayerSaveDataBase_Container, PlayerInfo) == 0x0001E0, "Member 'UJunoPlayerSaveDataBase_Container::PlayerInfo' has a wrong offset!");
static_assert(offsetof(UJunoPlayerSaveDataBase_Container, PlayerNetId) == 0x000200, "Member 'UJunoPlayerSaveDataBase_Container::PlayerNetId' has a wrong offset!");

// Class JunoGameNative.JunoPlayerAccountSaveData_Container
// 0x0010 (0x0248 - 0x0238)
class UJunoPlayerAccountSaveData_Container final : public UJunoPlayerSaveDataBase_Container
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JunoPlayerAccountSaveData_Container">();
	}
	static class UJunoPlayerAccountSaveData_Container* GetDefaultObj()
	{
		return GetDefaultObjImpl<UJunoPlayerAccountSaveData_Container>();
	}
};
static_assert(alignof(UJunoPlayerAccountSaveData_Container) == 0x000008, "Wrong alignment on UJunoPlayerAccountSaveData_Container");
static_assert(sizeof(UJunoPlayerAccountSaveData_Container) == 0x000248, "Wrong size on UJunoPlayerAccountSaveData_Container");
...
public:
	...
	TSoftClassPtr<class UClass>                   BuildingActorClassToPreview;                       // 0x0730(0x0020)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         JunoBuildingFrontendPreviewScale;                  // 0x0750(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_754[0x4];                                      // 0x0754(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              JunoBuildingFrontendFramingCenterOffsetRatio;      // 0x0758(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoBuildingAccountItemDefBase) == 0x000768, "Wrong size on UJunoBuildingAccountItemDefBase");
static_assert(offsetof(UJunoBuildingAccountItemDefBase, BuildingActorClassToPreview) == 0x000730, "Member 'UJunoBuildingAccountItemDefBase::BuildingActorClassToPreview' has a wrong offset!");
static_assert(offsetof(UJunoBuildingAccountItemDefBase, JunoBuildingFrontendPreviewScale) == 0x000750, "Member 'UJunoBuildingAccountItemDefBase::JunoBuildingFrontendPreviewScale' has a wrong offset!");
static_assert(offsetof(UJunoBuildingAccountItemDefBase, JunoBuildingFrontendFramingCenterOffsetRatio) == 0x000758, "Member 'UJunoBuildingAccountItemDefBase::JunoBuildingFrontendFramingCenterOffsetRatio' has a wrong offset!");
...
{
public:
	float                                         FoundationPiecesHeightToShow;                      // 0x0768(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UJunoBuildingSetAccountItemDefinition, FoundationPiecesHeightToShow) == 0x000768, "Member 'UJunoBuildingSetAccountItemDefinition::FoundationPiecesHeightToShow' has a wrong offset!");
...
static_assert(alignof(AJunoBuildingItemPreviewActor) == 0x000008, "Wrong alignment on AJunoBuildingItemPreviewActor");
static_assert(sizeof(AJunoBuildingItemPreviewActor) == 0x000488, "Wrong size on AJunoBuildingItemPreviewActor");
...
{
public:
	FMulticastInlineDelegateProperty_             OnGameplayEventRouterAvailable;                    // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void OnGameplayEventRouterAvailable__DelegateSignature(class UGameplayEventRouterComponent* EventRouter);
...
// Class JunoGameNative.JunoPlayerAccountPersistenceFeatureModule
// 0x0000 (0x00E0 - 0x00E0)
class UJunoPlayerAccountPersistenceFeatureModule final : public UPersistenceFrameworkModule
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JunoPlayerAccountPersistenceFeatureModule">();
	}
	static class UJunoPlayerAccountPersistenceFeatureModule* GetDefaultObj()
	{
		return GetDefaultObjImpl<UJunoPlayerAccountPersistenceFeatureModule>();
	}
};
static_assert(alignof(UJunoPlayerAccountPersistenceFeatureModule) == 0x000008, "Wrong alignment on UJunoPlayerAccountPersistenceFeatureModule");
static_assert(sizeof(UJunoPlayerAccountPersistenceFeatureModule) == 0x0000E0, "Wrong size on UJunoPlayerAccountPersistenceFeatureModule");
...
static_assert(sizeof(UJunoBuildingPropAccountItemDefinition) == 0x000768, "Wrong size on UJunoBuildingPropAccountItemDefinition");
...
static_assert(sizeof(UJunoBuildingCosmeticsSettings) == 0x0000B8, "Wrong size on UJunoBuildingCosmeticsSettings");
...
static_assert(offsetof(UJunoBuildingCosmeticsSettings, BuildingPartSubCategoryTag) == 0x0000B0, "Member 'UJunoBuildingCosmeticsSettings::BuildingPartSubCategoryTag' has a wrong offset!");
...
static_assert(sizeof(AJunoBuildingPreviewPrefabAsset) == 0x000380, "Wrong size on AJunoBuildingPreviewPrefabAsset");
...
{
public:
	class UActorComponent*                        LifeCycleComponent;                                // 0x0C40(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AJunoBuildingPropTree) == 0x000C48, "Wrong size on AJunoBuildingPropTree");
static_assert(offsetof(AJunoBuildingPropTree, LifeCycleComponent) == 0x000C40, "Member 'AJunoBuildingPropTree::LifeCycleComponent' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnJunoCampAwesomeLevelChangedDelegate;             // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJunoCampAwesomePointModificationDelegate;        // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoCampMembershipChanged;                       // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	struct FNamedPOISaveData                      NamedPOISaveData;                                  // 0x00E8(0x00B0)(SaveGame, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoCampPersistenceComponent) == 0x0001B0, "Wrong size on UJunoCampPersistenceComponent");
...
static_assert(offsetof(UJunoCampPersistenceComponent, AICampManagementSaveData) == 0x0000C8, "Member 'UJunoCampPersistenceComponent::AICampManagementSaveData' has a wrong offset!");
static_assert(offsetof(UJunoCampPersistenceComponent, NamedPOISaveData) == 0x0000E8, "Member 'UJunoCampPersistenceComponent::NamedPOISaveData' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoRecruitmentObjectAssignedChangedDelegate;    // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B0[0x18];                                      // 0x00B0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnJunoRecruitmentObjectEnableChangeDelegate;       // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoChannelValueReceived;                        // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_B0[0x20];                                      // 0x00B0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class AJunoClusterUnionActor*                 SourceClusterUnionActor;                           // 0x00D0(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	void OnAttachedToNewIsland(const struct FGraphIslandHandle& IslandHandle);
	void OnDetached();
...
static_assert(alignof(UJunoControlChannelComponent) == 0x000008, "Wrong alignment on UJunoControlChannelComponent");
static_assert(sizeof(UJunoControlChannelComponent) == 0x0000D8, "Wrong size on UJunoControlChannelComponent");
static_assert(offsetof(UJunoControlChannelComponent, OnJunoChannelValueReceived) == 0x0000A0, "Member 'UJunoControlChannelComponent::OnJunoChannelValueReceived' has a wrong offset!");
static_assert(offsetof(UJunoControlChannelComponent, SourceClusterUnionActor) == 0x0000D0, "Member 'UJunoControlChannelComponent::SourceClusterUnionActor' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnPlayerSpawnedActorWithBuilderTool;               // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOffhandInputPressed;                             // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOffhandInputReleased;                            // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAssemblyVisualsAnimationStart;                   // 0x01D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnAssemblyVisualsAnimationUpdated;                 // 0x01E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnAssemblyVisualsAnimationEnd;                     // 0x01F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	uint8                                         Pad_A0[0x8];                                       // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnPassiveCraftingDone;                             // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAutoCraftingFormulaRowChanged;                   // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPassiveResourceGeneratedOnPawnDelegate;          // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPassiveResourceGeneratedDelegate;                // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
// Class JunoGameNative.JunoPlayerAccountSaveDataProviderInterface
// 0x0000 (0x0028 - 0x0028)
class IJunoPlayerAccountSaveDataProviderInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"JunoPlayerAccountSaveDataProviderInterface">();
	}
	static class IJunoPlayerAccountSaveDataProviderInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IJunoPlayerAccountSaveDataProviderInterface>();
	}
};
static_assert(alignof(IJunoPlayerAccountSaveDataProviderInterface) == 0x000008, "Wrong alignment on IJunoPlayerAccountSaveDataProviderInterface");
static_assert(sizeof(IJunoPlayerAccountSaveDataProviderInterface) == 0x000028, "Wrong size on IJunoPlayerAccountSaveDataProviderInterface");
...
// 0x0010 (0x0248 - 0x0238)
class UJunoPlayerSaveData_Container final : public UJunoPlayerSaveDataBase_Container
{
public:
	uint8                                         Pad_238[0x10];                                     // 0x0238(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FVector                                GridSizeOverride;                                  // 0x09F0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A08[0x8];                                      // 0x0A08(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             BuildingPivotOffset;                               // 0x0A10(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                BuildingGridSnapOffset;                            // 0x0A70(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FJunoBuildingBehaviorGridLimits        GridOffsetLimits;                                  // 0x0A88(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	struct FJunoBuilderToolInteractionActorClassSet OverlappableClasses;                               // 0x0A98(0x00A0)(Edit, NativeAccessSpecifierPrivate)
	class UItemDefinitionBase*                    AssociatedItem;                                    // 0x0B38(0x0008)(Net, ZeroConstructor, SaveGame, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<class FName, TSubclassOf<class UJunoBuildingPreviewComponent>> PreviewComponentTemplates;                         // 0x0B40(0x0050)(Edit, UObjectWrapper, NativeAccessSpecifierPrivate)
	bool                                          bShouldPersist;                                    // 0x0B90(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B91[0x1F];                                     // 0x0B91(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoBuildingGameplayActor) == 0x000BB0, "Wrong size on AJunoBuildingGameplayActor");
static_assert(offsetof(AJunoBuildingGameplayActor, GridSizeOverride) == 0x0009F0, "Member 'AJunoBuildingGameplayActor::GridSizeOverride' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, BuildingPivotOffset) == 0x000A10, "Member 'AJunoBuildingGameplayActor::BuildingPivotOffset' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, BuildingGridSnapOffset) == 0x000A70, "Member 'AJunoBuildingGameplayActor::BuildingGridSnapOffset' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, GridOffsetLimits) == 0x000A88, "Member 'AJunoBuildingGameplayActor::GridOffsetLimits' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, OverlappableClasses) == 0x000A98, "Member 'AJunoBuildingGameplayActor::OverlappableClasses' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, AssociatedItem) == 0x000B38, "Member 'AJunoBuildingGameplayActor::AssociatedItem' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, PreviewComponentTemplates) == 0x000B40, "Member 'AJunoBuildingGameplayActor::PreviewComponentTemplates' has a wrong offset!");
static_assert(offsetof(AJunoBuildingGameplayActor, bShouldPersist) == 0x000B90, "Member 'AJunoBuildingGameplayActor::bShouldPersist' has a wrong offset!");
...
static_assert(sizeof(AJunoPhysicsToyActor) == 0x000BB0, "Wrong size on AJunoPhysicsToyActor");
...
public:
	...
	class UCurveFloat*                            LootTierPercentageToSlotPickingModifier;           // 0x02F8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoSmartObjectComponent) == 0x000300, "Wrong size on UJunoSmartObjectComponent");
static_assert(offsetof(UJunoSmartObjectComponent, LootTierPercentageToSlotPickingModifier) == 0x0002F8, "Member 'UJunoSmartObjectComponent::LootTierPercentageToSlotPickingModifier' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnTemperatureChanged;                              // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTemperatureRangesChanged;                        // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnLocationChanged;                                 // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnWeatherPhaseChanged;                             // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTemperatureChanged;                              // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoDeltaFileApplier) == 0x0005A0, "Wrong size on UJunoDeltaFileApplier");
static_assert(offsetof(UJunoDeltaFileApplier, UpdateActionMap) == 0x000500, "Member 'UJunoDeltaFileApplier::UpdateActionMap' has a wrong offset!");
static_assert(offsetof(UJunoDeltaFileApplier, DeleteActionMap) == 0x000550, "Member 'UJunoDeltaFileApplier::DeleteActionMap' has a wrong offset!");
...
// 0x0280 (0x0EC0 - 0x0C40)
class AJunoBuildingActor : public AJunoBuildingProp
{
public:
	uint8                                         Pad_C40[0x20];                                     // 0x0C40(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                GridSizeOverride;                                  // 0x0C60(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FJunoBuildingBehaviorGridLimits        GridOffsetLimits;                                  // 0x0C78(0x0010)(Edit, BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FJunoBuilderToolInteractionActorClassSet OverlappableClasses;                               // 0x0C88(0x00A0)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	struct FJunoBuilderToolInteractionActorClassSet SupportableClasses;                                // 0x0D28(0x00A0)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	class UJunoConnectivityComponent*             Connectivity;                                      // 0x0DC8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UJunoGeometryCollectionAssemblerComponent* GeometryCollectionAssemblerComponent;              // 0x0DD0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AJunoGuidedBuildingLandscapeVisualModifierActor* TerrainVisualModifierActor;                        // 0x0DD8(0x0008)(ZeroConstructor, SaveGame, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FTransform                             BuildingPivotOffset;                               // 0x0DE0(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                BuildingGridSnapOffset;                            // 0x0E40(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FJunoBuildingSnapEntry>         SnapEntries;                                       // 0x0E58(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPrivate)
	TMap<class FName, TSubclassOf<class UJunoBuildingPreviewComponent>> PreviewComponentTemplates;                         // 0x0E68(0x0050)(Edit, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         bCanRegenHealth : 1;                               // 0x0EB8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	bool                                          bShouldPersist;                                    // 0x0EB9(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bForceOverrideDestroyFoliageWhenPlaced;            // 0x0EBA(0x0001)(Net, ZeroConstructor, SaveGame, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AJunoBuildingActor) == 0x000EC0, "Wrong size on AJunoBuildingActor");
static_assert(offsetof(AJunoBuildingActor, GridSizeOverride) == 0x000C60, "Member 'AJunoBuildingActor::GridSizeOverride' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, GridOffsetLimits) == 0x000C78, "Member 'AJunoBuildingActor::GridOffsetLimits' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, OverlappableClasses) == 0x000C88, "Member 'AJunoBuildingActor::OverlappableClasses' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, SupportableClasses) == 0x000D28, "Member 'AJunoBuildingActor::SupportableClasses' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, Connectivity) == 0x000DC8, "Member 'AJunoBuildingActor::Connectivity' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, GeometryCollectionAssemblerComponent) == 0x000DD0, "Member 'AJunoBuildingActor::GeometryCollectionAssemblerComponent' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, TerrainVisualModifierActor) == 0x000DD8, "Member 'AJunoBuildingActor::TerrainVisualModifierActor' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, BuildingPivotOffset) == 0x000DE0, "Member 'AJunoBuildingActor::BuildingPivotOffset' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, BuildingGridSnapOffset) == 0x000E40, "Member 'AJunoBuildingActor::BuildingGridSnapOffset' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, SnapEntries) == 0x000E58, "Member 'AJunoBuildingActor::SnapEntries' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, PreviewComponentTemplates) == 0x000E68, "Member 'AJunoBuildingActor::PreviewComponentTemplates' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, bShouldPersist) == 0x000EB9, "Member 'AJunoBuildingActor::bShouldPersist' has a wrong offset!");
static_assert(offsetof(AJunoBuildingActor, bForceOverrideDestroyFoliageWhenPlaced) == 0x000EBA, "Member 'AJunoBuildingActor::bForceOverrideDestroyFoliageWhenPlaced' has a wrong offset!");
...
{
public:
	uint8                                         bUseOffsetOrientation : 1;                         // 0x0EC0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_EC1[0x7];                                      // 0x0EC1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EJunoContactDirection>                 FloatingValidationDirections;                      // 0x0EC8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AJunoPhysicsToySpawnerActor) == 0x000EE0, "Wrong size on AJunoPhysicsToySpawnerActor");
static_assert(offsetof(AJunoPhysicsToySpawnerActor, FloatingValidationDirections) == 0x000EC8, "Member 'AJunoPhysicsToySpawnerActor::FloatingValidationDirections' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAwesomeLevelChanged;                             // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoAwesomeLevelChangedDelegate;                 // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJunoAwesomePointModification;                    // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJunoAwesomeComponentReadyDelegate;               // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoPOIMarkerChangedDelegate;                    // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void JunoForEachActorComponentConstDelegate__DelegateSignature(const class UActorComponent* Component);
...
static_assert(sizeof(UJunoPawnAnimInstance) == 0x000590, "Wrong size on UJunoPawnAnimInstance");
static_assert(offsetof(UJunoPawnAnimInstance, AggressiveGameplayTag) == 0x000470, "Member 'UJunoPawnAnimInstance::AggressiveGameplayTag' has a wrong offset!");
static_assert(offsetof(UJunoPawnAnimInstance, PawnMovingSpeedThreshold) == 0x000474, "Member 'UJunoPawnAnimInstance::PawnMovingSpeedThreshold' has a wrong offset!");
static_assert(offsetof(UJunoPawnAnimInstance, bIsFalling) == 0x000478, "Member 'UJunoPawnAnimInstance::bIsFalling' has a wrong offset!");
static_assert(offsetof(UJunoPawnAnimInstance, PawnSpeed2D) == 0x00047C, "Member 'UJunoPawnAnimInstance::PawnSpeed2D' has a wrong offset!");
...
// 0x0370 (0x0900 - 0x0590)
#pragma pack(push, 0x1)
class alignas(0x10) UJunoPlayerAnimInstance : public UJunoPawnAnimInstance
{
public:
	float                                         PlayerLookAngleFromPawnMax;                        // 0x0588(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerLookAngleFromRootMax;                        // 0x058C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerFaceVisibleAngle;                            // 0x0590(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerRunningAccelerationThreshold;                // 0x0594(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerWalkingAccelerationThreshold;                // 0x0598(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59C[0x4];                                      // 0x059C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveVector*                           PlayerStrafeCurve;                                 // 0x05A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AFortPlayerPawn*                        FortPlayerPawn;                                    // 0x05A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsAccelerating2D : 1;                             // 0x05B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsSurfaceSwimming : 1;                            // 0x05B0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsMovingAndInMotionEmote : 1;                     // 0x05B0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bIsSlopeSliding;                                   // 0x05B1(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsInVehicle : 1;                                  // 0x05B2(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_5B3[0x5];                                      // 0x05B3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LocalAcceleration;                                 // 0x05B8(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocalAccelYawAngle;                                // 0x05D0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5D4[0x4];                                      // 0x05D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LocalVelocity;                                     // 0x05D8(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocalVelocityYawAngle;                             // 0x05F0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxSpeed;                                          // 0x05F4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxSwimSpeed;                                      // 0x05F8(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VelocityZ;                                         // 0x05FC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WorldAcceleration;                                 // 0x0600(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WorldVelocity;                                     // 0x0618(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               ActorRotationLastTick;                             // 0x0630(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         YawDeltaCurrentTick;                               // 0x0648(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         YawDeltaLastTick;                                  // 0x064C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         YawDeltaSmoothed;                                  // 0x0650(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsTacticalSprint : 1;                             // 0x0654(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsSkydiving : 1;                                  // 0x0654(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsParachuteOpen : 1;                              // 0x0654(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bGliderUseFastDeploy : 1;                          // 0x0654(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bGliderIsOpen : 1;                                 // 0x0654(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bGliderWasOpen : 1;                                // 0x0654(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerProp1Aim : 1;                               // 0x0654(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerProp2Aim : 1;                               // 0x0654(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsCold : 1;                                 // 0x0655(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsMildCold : 1;                             // 0x0655(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsVeryCold : 1;                             // 0x0655(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsHot : 1;                                  // 0x0655(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsMildHot : 1;                              // 0x0655(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsVeryHot : 1;                              // 0x0655(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsHumanControlled : 1;                      // 0x0655(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsSneaking : 1;                             // 0x0655(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsFishing : 1;                              // 0x0656(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerWasFishing : 1;                             // 0x0656(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsFocusing : 1;                             // 0x0656(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsFlying : 1;                               // 0x0656(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsFacingController : 1;                     // 0x0656(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsMovingBackwards : 1;                      // 0x0656(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsProp1AimTargetValid : 1;                  // 0x0656(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsPushing : 1;                              // 0x0656(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerWasPushing : 1;                             // 0x0657(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsRunning : 1;                              // 0x0657(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsSprinting : 1;                            // 0x0657(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsWalking : 1;                              // 0x0657(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerIsWaterJumping : 1;                         // 0x0657(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerShouldMove : 1;                             // 0x0657(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerShouldTurnInPlace : 1;                      // 0x0657(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerFaceIsVisible : 1;                          // 0x0657(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerUpperBodyIsSwinging : 1;                    // 0x0658(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerProp1MontageActive : 1;                     // 0x0658(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerProp2MontageActive : 1;                     // 0x0658(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPlayerHeadShouldFollowCamera : 1;                 // 0x0658(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	EFortMovementStyle                            PlayerMovementStyle;                               // 0x0659(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65A[0x2];                                      // 0x065A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlayerAccelerationAmount;                          // 0x065C(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               PlayerLookAtRotation;                              // 0x0660(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               PlayerRotationTarget;                              // 0x0678(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               PlayerPreviousRotationTarget;                      // 0x0690(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PlayerRotationTargetRate;                          // 0x06A8(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerVelocityYawRate;                             // 0x06AC(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerUseProceduralFaceAnim;                       // 0x06B0(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FJunoMinifigLayeringMask               LayeringMask;                                      // 0x06B4(0x00A0)(BlueprintVisible, Transient, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_754[0x4];                                      // 0x0754(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInputAlphaBoolBlend                   SecondaryMotionLODBlend;                           // 0x0758(0x0048)(BlueprintVisible, Transient, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         SecondaryMotionLODThreshold;                       // 0x07A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SecondaryMotionLODBlendTime;                       // 0x07A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GliderPitch;                                       // 0x07A8(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GliderRoll;                                        // 0x07AC(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AFortWeapon*                            PlayerMainHandItem;                                // 0x07B0(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AFortWeapon*                            PlayerOffHandItem;                                 // 0x07B8(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              PlayerAimOffset;                                   // 0x07C0(0x0010)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PlayerAimOffsetTemp;                               // 0x07D0(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              PlayerProp1AimOffset;                              // 0x07E8(0x0010)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PlayerProp1AimTargetLocation;                      // 0x07F8(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               PlayerSlopeMatchingRotationOffset;                 // 0x0810(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PlayerSlopeMatchingWeight;                         // 0x0828(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_82C[0x4];                                      // 0x082C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               PlayerPreviousRootRotation;                        // 0x0830(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EJunoMinifigRotationMode                      PlayerRotationMode;                                // 0x0848(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_849[0x7];                                      // 0x0849(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               SmoothedRotationTarget;                            // 0x0850(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               SuperSmoothedRotationTarget;                       // 0x0868(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               PlayerStartingRotation;                            // 0x0880(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PlayerStartingAngle;                               // 0x0898(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlayerEmotionHasChanged;                          // 0x089C(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89D[0x5B];                                     // 0x089D(0x005B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UJunoPlayerAnimInstance) == 0x000900, "Wrong size on UJunoPlayerAnimInstance");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerLookAngleFromPawnMax) == 0x000588, "Member 'UJunoPlayerAnimInstance::PlayerLookAngleFromPawnMax' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerLookAngleFromRootMax) == 0x00058C, "Member 'UJunoPlayerAnimInstance::PlayerLookAngleFromRootMax' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerFaceVisibleAngle) == 0x000590, "Member 'UJunoPlayerAnimInstance::PlayerFaceVisibleAngle' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerRunningAccelerationThreshold) == 0x000594, "Member 'UJunoPlayerAnimInstance::PlayerRunningAccelerationThreshold' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerWalkingAccelerationThreshold) == 0x000598, "Member 'UJunoPlayerAnimInstance::PlayerWalkingAccelerationThreshold' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerStrafeCurve) == 0x0005A0, "Member 'UJunoPlayerAnimInstance::PlayerStrafeCurve' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, FortPlayerPawn) == 0x0005A8, "Member 'UJunoPlayerAnimInstance::FortPlayerPawn' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, bIsSlopeSliding) == 0x0005B1, "Member 'UJunoPlayerAnimInstance::bIsSlopeSliding' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, LocalAcceleration) == 0x0005B8, "Member 'UJunoPlayerAnimInstance::LocalAcceleration' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, LocalAccelYawAngle) == 0x0005D0, "Member 'UJunoPlayerAnimInstance::LocalAccelYawAngle' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, LocalVelocity) == 0x0005D8, "Member 'UJunoPlayerAnimInstance::LocalVelocity' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, LocalVelocityYawAngle) == 0x0005F0, "Member 'UJunoPlayerAnimInstance::LocalVelocityYawAngle' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, MaxSpeed) == 0x0005F4, "Member 'UJunoPlayerAnimInstance::MaxSpeed' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, MaxSwimSpeed) == 0x0005F8, "Member 'UJunoPlayerAnimInstance::MaxSwimSpeed' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, VelocityZ) == 0x0005FC, "Member 'UJunoPlayerAnimInstance::VelocityZ' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, WorldAcceleration) == 0x000600, "Member 'UJunoPlayerAnimInstance::WorldAcceleration' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, WorldVelocity) == 0x000618, "Member 'UJunoPlayerAnimInstance::WorldVelocity' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, ActorRotationLastTick) == 0x000630, "Member 'UJunoPlayerAnimInstance::ActorRotationLastTick' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, YawDeltaCurrentTick) == 0x000648, "Member 'UJunoPlayerAnimInstance::YawDeltaCurrentTick' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, YawDeltaLastTick) == 0x00064C, "Member 'UJunoPlayerAnimInstance::YawDeltaLastTick' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, YawDeltaSmoothed) == 0x000650, "Member 'UJunoPlayerAnimInstance::YawDeltaSmoothed' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerMovementStyle) == 0x000659, "Member 'UJunoPlayerAnimInstance::PlayerMovementStyle' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerAccelerationAmount) == 0x00065C, "Member 'UJunoPlayerAnimInstance::PlayerAccelerationAmount' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerLookAtRotation) == 0x000660, "Member 'UJunoPlayerAnimInstance::PlayerLookAtRotation' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerRotationTarget) == 0x000678, "Member 'UJunoPlayerAnimInstance::PlayerRotationTarget' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerPreviousRotationTarget) == 0x000690, "Member 'UJunoPlayerAnimInstance::PlayerPreviousRotationTarget' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerRotationTargetRate) == 0x0006A8, "Member 'UJunoPlayerAnimInstance::PlayerRotationTargetRate' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerVelocityYawRate) == 0x0006AC, "Member 'UJunoPlayerAnimInstance::PlayerVelocityYawRate' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerUseProceduralFaceAnim) == 0x0006B0, "Member 'UJunoPlayerAnimInstance::PlayerUseProceduralFaceAnim' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, LayeringMask) == 0x0006B4, "Member 'UJunoPlayerAnimInstance::LayeringMask' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, SecondaryMotionLODBlend) == 0x000758, "Member 'UJunoPlayerAnimInstance::SecondaryMotionLODBlend' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, SecondaryMotionLODThreshold) == 0x0007A0, "Member 'UJunoPlayerAnimInstance::SecondaryMotionLODThreshold' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, SecondaryMotionLODBlendTime) == 0x0007A4, "Member 'UJunoPlayerAnimInstance::SecondaryMotionLODBlendTime' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, GliderPitch) == 0x0007A8, "Member 'UJunoPlayerAnimInstance::GliderPitch' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, GliderRoll) == 0x0007AC, "Member 'UJunoPlayerAnimInstance::GliderRoll' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerMainHandItem) == 0x0007B0, "Member 'UJunoPlayerAnimInstance::PlayerMainHandItem' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerOffHandItem) == 0x0007B8, "Member 'UJunoPlayerAnimInstance::PlayerOffHandItem' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerAimOffset) == 0x0007C0, "Member 'UJunoPlayerAnimInstance::PlayerAimOffset' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerAimOffsetTemp) == 0x0007D0, "Member 'UJunoPlayerAnimInstance::PlayerAimOffsetTemp' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerProp1AimOffset) == 0x0007E8, "Member 'UJunoPlayerAnimInstance::PlayerProp1AimOffset' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerProp1AimTargetLocation) == 0x0007F8, "Member 'UJunoPlayerAnimInstance::PlayerProp1AimTargetLocation' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerSlopeMatchingRotationOffset) == 0x000810, "Member 'UJunoPlayerAnimInstance::PlayerSlopeMatchingRotationOffset' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerSlopeMatchingWeight) == 0x000828, "Member 'UJunoPlayerAnimInstance::PlayerSlopeMatchingWeight' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerPreviousRootRotation) == 0x000830, "Member 'UJunoPlayerAnimInstance::PlayerPreviousRootRotation' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerRotationMode) == 0x000848, "Member 'UJunoPlayerAnimInstance::PlayerRotationMode' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, SmoothedRotationTarget) == 0x000850, "Member 'UJunoPlayerAnimInstance::SmoothedRotationTarget' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, SuperSmoothedRotationTarget) == 0x000868, "Member 'UJunoPlayerAnimInstance::SuperSmoothedRotationTarget' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerStartingRotation) == 0x000880, "Member 'UJunoPlayerAnimInstance::PlayerStartingRotation' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, PlayerStartingAngle) == 0x000898, "Member 'UJunoPlayerAnimInstance::PlayerStartingAngle' has a wrong offset!");
static_assert(offsetof(UJunoPlayerAnimInstance, bPlayerEmotionHasChanged) == 0x00089C, "Member 'UJunoPlayerAnimInstance::bPlayerEmotionHasChanged' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSoundBreakEvents;                                // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSoundCollisionEvents;                            // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnActiveSoundBreakEventsUpdated;                   // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnActiveSoundCollisionEventsUpdated;               // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x00C0 (0x1D60 - 0x1CA0)
class UJunoCameraMode_OrbitCam final : public UFortCameraMode_ThirdPerson
{
public:
	bool                                          bIsBuildPreviewMode;                               // 0x1CA0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1CA1[0xF];                                     // 0x1CA1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             BuildPreviewActorTransform;                        // 0x1CB0(0x0060)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FBox                                   BuildPreviewLocalBounds;                           // 0x1D10(0x0038)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bOverrideCameraOriginDuringBuildPreview;           // 0x1D48(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1D49[0x7];                                     // 0x1D49(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            BuildPreviewBoundsToForwardDistanceScale;          // 0x1D50(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoCameraMode_OrbitCam) == 0x001D60, "Wrong size on UJunoCameraMode_OrbitCam");
static_assert(offsetof(UJunoCameraMode_OrbitCam, bIsBuildPreviewMode) == 0x001CA0, "Member 'UJunoCameraMode_OrbitCam::bIsBuildPreviewMode' has a wrong offset!");
static_assert(offsetof(UJunoCameraMode_OrbitCam, BuildPreviewActorTransform) == 0x001CB0, "Member 'UJunoCameraMode_OrbitCam::BuildPreviewActorTransform' has a wrong offset!");
static_assert(offsetof(UJunoCameraMode_OrbitCam, BuildPreviewLocalBounds) == 0x001D10, "Member 'UJunoCameraMode_OrbitCam::BuildPreviewLocalBounds' has a wrong offset!");
static_assert(offsetof(UJunoCameraMode_OrbitCam, bOverrideCameraOriginDuringBuildPreview) == 0x001D48, "Member 'UJunoCameraMode_OrbitCam::bOverrideCameraOriginDuringBuildPreview' has a wrong offset!");
static_assert(offsetof(UJunoCameraMode_OrbitCam, BuildPreviewBoundsToForwardDistanceScale) == 0x001D50, "Member 'UJunoCameraMode_OrbitCam::BuildPreviewBoundsToForwardDistanceScale' has a wrong offset!");
...
static_assert(sizeof(UJunoHarvestingComponent) == 0x000140, "Wrong size on UJunoHarvestingComponent");
...
static_assert(offsetof(UJunoHarvestingComponent, ResourceIdentifierTags) == 0x0000B8, "Member 'UJunoHarvestingComponent::ResourceIdentifierTags' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, BuildingTagsToIgnoreForResourceSplitting) == 0x0000D8, "Member 'UJunoHarvestingComponent::BuildingTagsToIgnoreForResourceSplitting' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, CraftingIngredientRegistryType) == 0x0000F8, "Member 'UJunoHarvestingComponent::CraftingIngredientRegistryType' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, TimeToRegenHealth) == 0x0000FC, "Member 'UJunoHarvestingComponent::TimeToRegenHealth' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, BuildingsHitList) == 0x000100, "Member 'UJunoHarvestingComponent::BuildingsHitList' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, ResourcePercentToReturn) == 0x000110, "Member 'UJunoHarvestingComponent::ResourcePercentToReturn' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, PickupsPerResource) == 0x000114, "Member 'UJunoHarvestingComponent::PickupsPerResource' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, PickupClassPtr) == 0x000118, "Member 'UJunoHarvestingComponent::PickupClassPtr' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, TossSpeed) == 0x000138, "Member 'UJunoHarvestingComponent::TossSpeed' has a wrong offset!");
static_assert(offsetof(UJunoHarvestingComponent, ConeHalfAngleDegrees) == 0x00013C, "Member 'UJunoHarvestingComponent::ConeHalfAngleDegrees' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnPawnLoaded;                                      // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnClientInitialLoadingFinished;                    // 0x0348(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	struct FJunoReplicatedWorldMetadata           MetadataForReplication;                            // 0x0888(0x0090)(Net, Transient, RepNotify, NativeAccessSpecifierPrivate)
	uint8                                         Pad_918[0x10];                                     // 0x0918(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UJunoPlayerPersistenceComponent*        JunoPlayerPersistenceComponent;                    // 0x0928(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AJunoRootPlayspace) == 0x000930, "Wrong size on AJunoRootPlayspace");
...
static_assert(offsetof(AJunoRootPlayspace, JunoPlayerPersistenceComponent) == 0x000928, "Member 'AJunoRootPlayspace::JunoPlayerPersistenceComponent' has a wrong offset!");
...
{
public:
	bool                                          bIsTurning;                                        // 0x0588(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWasTurning;                                       // 0x0589(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIdleShuffleTurnDirection;                         // 0x058A(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_58B[0x1];                                      // 0x058B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IdleShufflePlayRate;                               // 0x058C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsIdleShuffleTurn;                                // 0x0590(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_591[0x7];                                      // 0x0591(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CreaturePosition;                                  // 0x0598(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CreaturePositionDelta;                             // 0x05B0(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               CreatureRootRotation;                              // 0x05C8(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               CreatureRootRotationOffset;                        // 0x05E0(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               CreatureRotation;                                  // 0x05F8(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               CreatureRotationDelta;                             // 0x0610(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                CreatureVelocity;                                  // 0x0628(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CreatureYaw;                                       // 0x0640(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CreatureYawDelta;                                  // 0x0644(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          RootSmoothing_Enabled;                             // 0x0648(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_649[0x3];                                      // 0x0649(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RootSmoothing_Distance;                            // 0x064C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSlopeWarpingIsEnabled;                            // 0x0650(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_651[0x3];                                      // 0x0651(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SlopeWarpingFloorCheckFrequency;                   // 0x0654(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SlopeWarpingRollAlpha;                             // 0x0658(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStartingInPlace;                                  // 0x065C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65D[0x3];                                      // 0x065D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                StartInPlace_RootTranslation;                      // 0x0660(0x0018)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAnimSequence*                          StartInPlace_Sequence;                             // 0x0678(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StartInPlace_SequenceTime;                         // 0x0680(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTurningInPlace;                                   // 0x0684(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTurnInPlace_UseAuthoredAngle;                     // 0x0685(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_686[0x2];                                      // 0x0686(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimSequence*                          TurnAnimation;                                     // 0x0688(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_AnimationAuthoredAngle;                // 0x0690(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnPlayRate;                                      // 0x0694(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_RootRotationZ;                         // 0x0698(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_RotationAngle;                         // 0x069C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_RotationAngle_Min;                     // 0x06A0(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_RotationRate;                          // 0x06A4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAnimSequence*                          TurnInPlace_Sequence;                              // 0x06A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnInPlace_SequenceTime;                          // 0x06B0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStateRule_Idle_Moving;                            // 0x06B4(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B5[0x3];                                      // 0x06B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IdleShuffleTurnThreshold;                          // 0x06B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IdleShuffleTurnDirectionThreshold;                 // 0x06BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IdleShufflePlayRateInRangeA;                       // 0x06C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IdleShufflePlayRateInRangeB;                       // 0x06C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IdleShufflePlayRateOutRangeA;                      // 0x06C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IdleShufflePlayRateOutRangeB;                      // 0x06CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasValidAimTarget;                                // 0x06D0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D1[0x7];                                      // 0x06D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                AimTargetLocation;                                 // 0x06D8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AimTime;                                           // 0x06F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LookAtAlpha;                                       // 0x06F4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDistanceToPlayerForLookAt;                      // 0x06F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LookAtTooFarFromPlayerTimeOut;                     // 0x06FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableLookAtDuringMontage;                       // 0x0700(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStartTurn;                                        // 0x0701(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_702[0x2];                                      // 0x0702(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TurnAngle;                                         // 0x0704(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TurnRate;                                          // 0x0708(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   DisableHeadTrackingCurveName;                      // 0x070C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Speed;                                             // 0x0710(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlayLandAdditive;                                 // 0x0714(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsFloating;                                       // 0x0715(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsSurfaceSwimming;                                // 0x0716(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTurningInPlace;                                 // 0x0717(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_718[0xE8];                                     // 0x0718(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UJunoCreatureAnimInstance, bIsTurning) == 0x000588, "Member 'UJunoCreatureAnimInstance::bIsTurning' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bWasTurning) == 0x000589, "Member 'UJunoCreatureAnimInstance::bWasTurning' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bIdleShuffleTurnDirection) == 0x00058A, "Member 'UJunoCreatureAnimInstance::bIdleShuffleTurnDirection' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShufflePlayRate) == 0x00058C, "Member 'UJunoCreatureAnimInstance::IdleShufflePlayRate' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bIsIdleShuffleTurn) == 0x000590, "Member 'UJunoCreatureAnimInstance::bIsIdleShuffleTurn' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreaturePosition) == 0x000598, "Member 'UJunoCreatureAnimInstance::CreaturePosition' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreaturePositionDelta) == 0x0005B0, "Member 'UJunoCreatureAnimInstance::CreaturePositionDelta' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureRootRotation) == 0x0005C8, "Member 'UJunoCreatureAnimInstance::CreatureRootRotation' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureRootRotationOffset) == 0x0005E0, "Member 'UJunoCreatureAnimInstance::CreatureRootRotationOffset' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureRotation) == 0x0005F8, "Member 'UJunoCreatureAnimInstance::CreatureRotation' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureRotationDelta) == 0x000610, "Member 'UJunoCreatureAnimInstance::CreatureRotationDelta' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureVelocity) == 0x000628, "Member 'UJunoCreatureAnimInstance::CreatureVelocity' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureYaw) == 0x000640, "Member 'UJunoCreatureAnimInstance::CreatureYaw' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, CreatureYawDelta) == 0x000644, "Member 'UJunoCreatureAnimInstance::CreatureYawDelta' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, RootSmoothing_Enabled) == 0x000648, "Member 'UJunoCreatureAnimInstance::RootSmoothing_Enabled' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, RootSmoothing_Distance) == 0x00064C, "Member 'UJunoCreatureAnimInstance::RootSmoothing_Distance' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bSlopeWarpingIsEnabled) == 0x000650, "Member 'UJunoCreatureAnimInstance::bSlopeWarpingIsEnabled' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, SlopeWarpingFloorCheckFrequency) == 0x000654, "Member 'UJunoCreatureAnimInstance::SlopeWarpingFloorCheckFrequency' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, SlopeWarpingRollAlpha) == 0x000658, "Member 'UJunoCreatureAnimInstance::SlopeWarpingRollAlpha' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bStartingInPlace) == 0x00065C, "Member 'UJunoCreatureAnimInstance::bStartingInPlace' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, StartInPlace_RootTranslation) == 0x000660, "Member 'UJunoCreatureAnimInstance::StartInPlace_RootTranslation' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, StartInPlace_Sequence) == 0x000678, "Member 'UJunoCreatureAnimInstance::StartInPlace_Sequence' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, StartInPlace_SequenceTime) == 0x000680, "Member 'UJunoCreatureAnimInstance::StartInPlace_SequenceTime' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bTurningInPlace) == 0x000684, "Member 'UJunoCreatureAnimInstance::bTurningInPlace' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bTurnInPlace_UseAuthoredAngle) == 0x000685, "Member 'UJunoCreatureAnimInstance::bTurnInPlace_UseAuthoredAngle' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnAnimation) == 0x000688, "Member 'UJunoCreatureAnimInstance::TurnAnimation' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_AnimationAuthoredAngle) == 0x000690, "Member 'UJunoCreatureAnimInstance::TurnInPlace_AnimationAuthoredAngle' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnPlayRate) == 0x000694, "Member 'UJunoCreatureAnimInstance::TurnPlayRate' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_RootRotationZ) == 0x000698, "Member 'UJunoCreatureAnimInstance::TurnInPlace_RootRotationZ' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_RotationAngle) == 0x00069C, "Member 'UJunoCreatureAnimInstance::TurnInPlace_RotationAngle' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_RotationAngle_Min) == 0x0006A0, "Member 'UJunoCreatureAnimInstance::TurnInPlace_RotationAngle_Min' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_RotationRate) == 0x0006A4, "Member 'UJunoCreatureAnimInstance::TurnInPlace_RotationRate' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_Sequence) == 0x0006A8, "Member 'UJunoCreatureAnimInstance::TurnInPlace_Sequence' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnInPlace_SequenceTime) == 0x0006B0, "Member 'UJunoCreatureAnimInstance::TurnInPlace_SequenceTime' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bStateRule_Idle_Moving) == 0x0006B4, "Member 'UJunoCreatureAnimInstance::bStateRule_Idle_Moving' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShuffleTurnThreshold) == 0x0006B8, "Member 'UJunoCreatureAnimInstance::IdleShuffleTurnThreshold' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShuffleTurnDirectionThreshold) == 0x0006BC, "Member 'UJunoCreatureAnimInstance::IdleShuffleTurnDirectionThreshold' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShufflePlayRateInRangeA) == 0x0006C0, "Member 'UJunoCreatureAnimInstance::IdleShufflePlayRateInRangeA' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShufflePlayRateInRangeB) == 0x0006C4, "Member 'UJunoCreatureAnimInstance::IdleShufflePlayRateInRangeB' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShufflePlayRateOutRangeA) == 0x0006C8, "Member 'UJunoCreatureAnimInstance::IdleShufflePlayRateOutRangeA' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, IdleShufflePlayRateOutRangeB) == 0x0006CC, "Member 'UJunoCreatureAnimInstance::IdleShufflePlayRateOutRangeB' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bHasValidAimTarget) == 0x0006D0, "Member 'UJunoCreatureAnimInstance::bHasValidAimTarget' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, AimTargetLocation) == 0x0006D8, "Member 'UJunoCreatureAnimInstance::AimTargetLocation' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, AimTime) == 0x0006F0, "Member 'UJunoCreatureAnimInstance::AimTime' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, LookAtAlpha) == 0x0006F4, "Member 'UJunoCreatureAnimInstance::LookAtAlpha' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, MaxDistanceToPlayerForLookAt) == 0x0006F8, "Member 'UJunoCreatureAnimInstance::MaxDistanceToPlayerForLookAt' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, LookAtTooFarFromPlayerTimeOut) == 0x0006FC, "Member 'UJunoCreatureAnimInstance::LookAtTooFarFromPlayerTimeOut' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bDisableLookAtDuringMontage) == 0x000700, "Member 'UJunoCreatureAnimInstance::bDisableLookAtDuringMontage' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bStartTurn) == 0x000701, "Member 'UJunoCreatureAnimInstance::bStartTurn' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnAngle) == 0x000704, "Member 'UJunoCreatureAnimInstance::TurnAngle' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, TurnRate) == 0x000708, "Member 'UJunoCreatureAnimInstance::TurnRate' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, DisableHeadTrackingCurveName) == 0x00070C, "Member 'UJunoCreatureAnimInstance::DisableHeadTrackingCurveName' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, Speed) == 0x000710, "Member 'UJunoCreatureAnimInstance::Speed' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bPlayLandAdditive) == 0x000714, "Member 'UJunoCreatureAnimInstance::bPlayLandAdditive' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bIsFloating) == 0x000715, "Member 'UJunoCreatureAnimInstance::bIsFloating' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bIsSurfaceSwimming) == 0x000716, "Member 'UJunoCreatureAnimInstance::bIsSurfaceSwimming' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance, bIsTurningInPlace) == 0x000717, "Member 'UJunoCreatureAnimInstance::bIsTurningInPlace' has a wrong offset!");
...
{
public:
	bool                                          bHighVelocity;                                     // 0x0800(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsInterruptible;                                  // 0x0801(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLocoToIdle;                                       // 0x0802(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIdleToLoco;                                       // 0x0803(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bJumpStartToJumpLoop;                              // 0x0804(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bJumpLandToMovement;                               // 0x0805(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsRunning;                                        // 0x0806(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIdleToFalling;                                    // 0x0807(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bToppledOnGround;                                  // 0x0808(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTransitionToLand;                                 // 0x0809(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_80A[0x2];                                      // 0x080A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TargetDistance;                                    // 0x080C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTargetIsClose;                                    // 0x0810(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsToppled;                                        // 0x0811(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLeaking;                                        // 0x0812(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_813[0x1];                                      // 0x0813(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinHighVelocityMagnitude;                          // 0x0814(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxInterruptibleCurveValue;                        // 0x0818(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocoIdleTransitionThreshold;                       // 0x081C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RunSpeedThreshold;                                 // 0x0820(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         JumpLandToMovementInterruptibleThreshold;          // 0x0824(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinTargetIsCloseDistance;                          // 0x0828(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   CurveName_Interruptible;                           // 0x082C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bHighVelocity) == 0x000800, "Member 'UJunoCreatureAnimInstance_LootLlama::bHighVelocity' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIsInterruptible) == 0x000801, "Member 'UJunoCreatureAnimInstance_LootLlama::bIsInterruptible' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bLocoToIdle) == 0x000802, "Member 'UJunoCreatureAnimInstance_LootLlama::bLocoToIdle' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIdleToLoco) == 0x000803, "Member 'UJunoCreatureAnimInstance_LootLlama::bIdleToLoco' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bJumpStartToJumpLoop) == 0x000804, "Member 'UJunoCreatureAnimInstance_LootLlama::bJumpStartToJumpLoop' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bJumpLandToMovement) == 0x000805, "Member 'UJunoCreatureAnimInstance_LootLlama::bJumpLandToMovement' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIsRunning) == 0x000806, "Member 'UJunoCreatureAnimInstance_LootLlama::bIsRunning' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIdleToFalling) == 0x000807, "Member 'UJunoCreatureAnimInstance_LootLlama::bIdleToFalling' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bToppledOnGround) == 0x000808, "Member 'UJunoCreatureAnimInstance_LootLlama::bToppledOnGround' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bTransitionToLand) == 0x000809, "Member 'UJunoCreatureAnimInstance_LootLlama::bTransitionToLand' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, TargetDistance) == 0x00080C, "Member 'UJunoCreatureAnimInstance_LootLlama::TargetDistance' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bTargetIsClose) == 0x000810, "Member 'UJunoCreatureAnimInstance_LootLlama::bTargetIsClose' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIsToppled) == 0x000811, "Member 'UJunoCreatureAnimInstance_LootLlama::bIsToppled' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, bIsLeaking) == 0x000812, "Member 'UJunoCreatureAnimInstance_LootLlama::bIsLeaking' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, MinHighVelocityMagnitude) == 0x000814, "Member 'UJunoCreatureAnimInstance_LootLlama::MinHighVelocityMagnitude' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, MaxInterruptibleCurveValue) == 0x000818, "Member 'UJunoCreatureAnimInstance_LootLlama::MaxInterruptibleCurveValue' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, LocoIdleTransitionThreshold) == 0x00081C, "Member 'UJunoCreatureAnimInstance_LootLlama::LocoIdleTransitionThreshold' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, RunSpeedThreshold) == 0x000820, "Member 'UJunoCreatureAnimInstance_LootLlama::RunSpeedThreshold' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, JumpLandToMovementInterruptibleThreshold) == 0x000824, "Member 'UJunoCreatureAnimInstance_LootLlama::JumpLandToMovementInterruptibleThreshold' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, MinTargetIsCloseDistance) == 0x000828, "Member 'UJunoCreatureAnimInstance_LootLlama::MinTargetIsCloseDistance' has a wrong offset!");
static_assert(offsetof(UJunoCreatureAnimInstance_LootLlama, CurveName_Interruptible) == 0x00082C, "Member 'UJunoCreatureAnimInstance_LootLlama::CurveName_Interruptible' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoCurrentEmotionalStateChangedDelegate;        // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJunoCurrentEmotionalStateStartedChange;          // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJunoCurrentEmotionChangeFinished;                // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCheatEmotionIndexChanged;                        // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	FMulticastInlineDelegateProperty_             OnBuilderToolInteractionStarted;                   // 0x1550(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBuilderToolInteractionStopped;                   // 0x1560(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FJunoInputMapping                      InputMapping;                                      // 0x1570(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
	class UInputAction*                           UnEquipInputAction;                                // 0x1580(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  ActivatedTags;                                     // 0x1588(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<class UJunoBuilderToolInteractionBehavior*> InteractionBehaviors;                              // 0x15A8(0x0010)(Edit, ExportObject, Net, ZeroConstructor, Transient, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UJunoBuilderToolInteractionBehavior*    ActiveInteractionBehavior;                         // 0x15B8(0x0008)(Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AJunoBuilderTool) == 0x0015C0, "Wrong size on AJunoBuilderTool");
static_assert(offsetof(AJunoBuilderTool, OnBuilderToolInteractionStarted) == 0x001550, "Member 'AJunoBuilderTool::OnBuilderToolInteractionStarted' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, OnBuilderToolInteractionStopped) == 0x001560, "Member 'AJunoBuilderTool::OnBuilderToolInteractionStopped' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, InputMapping) == 0x001570, "Member 'AJunoBuilderTool::InputMapping' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, UnEquipInputAction) == 0x001580, "Member 'AJunoBuilderTool::UnEquipInputAction' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, ActivatedTags) == 0x001588, "Member 'AJunoBuilderTool::ActivatedTags' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, InteractionBehaviors) == 0x0015A8, "Member 'AJunoBuilderTool::InteractionBehaviors' has a wrong offset!");
static_assert(offsetof(AJunoBuilderTool, ActiveInteractionBehavior) == 0x0015B8, "Member 'AJunoBuilderTool::ActiveInteractionBehavior' has a wrong offset!");
...
{
public:
	uint8                                         Pad_330[0x98];                                     // 0x0330(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoClusterUnionActor) == 0x0003C8, "Wrong size on AJunoClusterUnionActor");
...
{
public:
	FMulticastInlineDelegateProperty_             OnInteractionStart;                                // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInteractionTrigger;                              // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInteractionEnd;                                  // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInteractionExit;                                 // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoClusterUnionCustomRepNode) == 0x000070, "Wrong size on UJunoClusterUnionCustomRepNode");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnBuildingStateChanged;                            // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnBuildingStateTagsChanged;                        // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnEnterPreviewMode;                                // 0x02F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnExitPreviewMode;                                 // 0x0300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	...
	FMulticastInlineDelegateProperty_             OnPositionInterpStart;                             // 0x0520(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnPositionInterpEnd;                               // 0x0530(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnToggleSnapping;                                  // 0x1178(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	...
	FMulticastInlineDelegateProperty_             OnPlacementTypeChanged;                            // 0x11B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	...
	FMulticastInlineDelegateProperty_             OnBuildingStateContextChanged;                     // 0x11F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
// 0x0760 (0x13A0 - 0x0C40)
class AJunoGuidedBuildingActor final : public AJunoBuildingProp
{
public:
	uint8                                         Pad_C40[0x20];                                     // 0x0C40(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnCurrentStageUpdateDelegate;                      // 0x0C60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStageUpdateDelegate;                             // 0x0C70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStageCompleteDelegate;                           // 0x0C80(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSectionCompleteDelegate;                         // 0x0C90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSetCompleteDelegate;                             // 0x0CA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSetUnfinishedDelegate;                           // 0x0CB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCurrentStageChange;                              // 0x0CC0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSnapsUpdatedDelegate;                            // 0x0CD0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_CE0[0x10];                                     // 0x0CE0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             BuildingPivotOffset;                               // 0x0CF0(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                BuildingGridSnapOffset;                            // 0x0D50(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FJunoBuilderToolInteractionActorClassSet OverlappableClasses;                               // 0x0D68(0x00A0)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	struct FVector                                GridSizeOverride;                                  // 0x0E08(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FJunoBuildingBehaviorGridLimits        GridOffsetLimits;                                  // 0x0E20(0x0010)(Edit, BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         MinDistanceOverride;                               // 0x0E30(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E34[0x4];                                      // 0x0E34(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, TSubclassOf<class UJunoBuildingPreviewComponent>> PreviewComponentTemplates;                         // 0x0E38(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  DestroyOnPlacementTags;                            // 0x0E88(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FJunoGuidedBuildingData>        DataArray;                                         // 0x0EA8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FJunoGuidedBuildingStateArray          StateArray;                                        // 0x0EB8(0x0120)(Net, Protected, NativeAccessSpecifierProtected)
	struct FJunoStageKey                          CurrentStage;                                      // 0x0FD8(0x0008)(Net, SaveGame, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FJunoGuidedBuildingSetCompleteState    SetCompleteState;                                  // 0x0FE0(0x0010)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FDateTime                              TimeStarted;                                       // 0x0FF0(0x0008)(ZeroConstructor, SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FUniqueNetIdRepl                       OwningPlayerID;                                    // 0x0FF8(0x0030)(Net, SaveGame, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UMaterial>               GuidedBuildingMaterial;                            // 0x1028(0x0020)(Edit, Config, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FJunoGuidedBuildingSetData             SetData;                                           // 0x1048(0x0070)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	float                                         LifespanAfterCompletion;                           // 0x10B8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         LifespanAfterUnfinished;                           // 0x10BC(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TimeDelayBeforeShowingNewStageGhostBrushes;        // 0x10C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_10C4[0x4];                                     // 0x10C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerController*                  LocalRegisteredController;                         // 0x10C8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AJunoGuidedBuildingLandscapeVisualModifierActor* TerrainVisualModifierActor;                        // 0x10D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_10D8[0x68];                                    // 0x10D8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	struct FJunoGuidedBuildingRegisteredPlayerArray RegisteredPlayers;                                 // 0x1140(0x0148)(Net, RepNotify, Protected, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class APawn>                   AutoCompleteInstigatingPawn;                       // 0x1288(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UJunoGuidedBuildingInteractionComponent> InteractionComponentClass;                         // 0x1290(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                         FoundationVerticalOffset;                          // 0x1298(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGuid                                  BuildId;                                           // 0x12C0(0x0010)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<TWeakObjectPtr<class AActor>>          PendingInstantAutoCompleteActors;                  // 0x12D0(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<struct FJunoBuildingSnapEntry>         SnapEntries;                                       // 0x12E0(0x0010)(Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_12F0[0xB0];                                    // 0x12F0(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoGuidedBuildingActor) == 0x0013A0, "Wrong size on AJunoGuidedBuildingActor");
static_assert(offsetof(AJunoGuidedBuildingActor, OnCurrentStageUpdateDelegate) == 0x000C60, "Member 'AJunoGuidedBuildingActor::OnCurrentStageUpdateDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnStageUpdateDelegate) == 0x000C70, "Member 'AJunoGuidedBuildingActor::OnStageUpdateDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnStageCompleteDelegate) == 0x000C80, "Member 'AJunoGuidedBuildingActor::OnStageCompleteDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnSectionCompleteDelegate) == 0x000C90, "Member 'AJunoGuidedBuildingActor::OnSectionCompleteDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnSetCompleteDelegate) == 0x000CA0, "Member 'AJunoGuidedBuildingActor::OnSetCompleteDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnSetUnfinishedDelegate) == 0x000CB0, "Member 'AJunoGuidedBuildingActor::OnSetUnfinishedDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnCurrentStageChange) == 0x000CC0, "Member 'AJunoGuidedBuildingActor::OnCurrentStageChange' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OnSnapsUpdatedDelegate) == 0x000CD0, "Member 'AJunoGuidedBuildingActor::OnSnapsUpdatedDelegate' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, BuildingPivotOffset) == 0x000CF0, "Member 'AJunoGuidedBuildingActor::BuildingPivotOffset' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, BuildingGridSnapOffset) == 0x000D50, "Member 'AJunoGuidedBuildingActor::BuildingGridSnapOffset' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OverlappableClasses) == 0x000D68, "Member 'AJunoGuidedBuildingActor::OverlappableClasses' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, GridSizeOverride) == 0x000E08, "Member 'AJunoGuidedBuildingActor::GridSizeOverride' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, GridOffsetLimits) == 0x000E20, "Member 'AJunoGuidedBuildingActor::GridOffsetLimits' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, MinDistanceOverride) == 0x000E30, "Member 'AJunoGuidedBuildingActor::MinDistanceOverride' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, PreviewComponentTemplates) == 0x000E38, "Member 'AJunoGuidedBuildingActor::PreviewComponentTemplates' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, DestroyOnPlacementTags) == 0x000E88, "Member 'AJunoGuidedBuildingActor::DestroyOnPlacementTags' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, DataArray) == 0x000EA8, "Member 'AJunoGuidedBuildingActor::DataArray' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, StateArray) == 0x000EB8, "Member 'AJunoGuidedBuildingActor::StateArray' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, CurrentStage) == 0x000FD8, "Member 'AJunoGuidedBuildingActor::CurrentStage' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, SetCompleteState) == 0x000FE0, "Member 'AJunoGuidedBuildingActor::SetCompleteState' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, TimeStarted) == 0x000FF0, "Member 'AJunoGuidedBuildingActor::TimeStarted' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, OwningPlayerID) == 0x000FF8, "Member 'AJunoGuidedBuildingActor::OwningPlayerID' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, GuidedBuildingMaterial) == 0x001028, "Member 'AJunoGuidedBuildingActor::GuidedBuildingMaterial' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, SetData) == 0x001048, "Member 'AJunoGuidedBuildingActor::SetData' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, LifespanAfterCompletion) == 0x0010B8, "Member 'AJunoGuidedBuildingActor::LifespanAfterCompletion' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, LifespanAfterUnfinished) == 0x0010BC, "Member 'AJunoGuidedBuildingActor::LifespanAfterUnfinished' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, TimeDelayBeforeShowingNewStageGhostBrushes) == 0x0010C0, "Member 'AJunoGuidedBuildingActor::TimeDelayBeforeShowingNewStageGhostBrushes' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, LocalRegisteredController) == 0x0010C8, "Member 'AJunoGuidedBuildingActor::LocalRegisteredController' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, TerrainVisualModifierActor) == 0x0010D0, "Member 'AJunoGuidedBuildingActor::TerrainVisualModifierActor' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, RegisteredPlayers) == 0x001140, "Member 'AJunoGuidedBuildingActor::RegisteredPlayers' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, AutoCompleteInstigatingPawn) == 0x001288, "Member 'AJunoGuidedBuildingActor::AutoCompleteInstigatingPawn' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, InteractionComponentClass) == 0x001290, "Member 'AJunoGuidedBuildingActor::InteractionComponentClass' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, FoundationVerticalOffset) == 0x001298, "Member 'AJunoGuidedBuildingActor::FoundationVerticalOffset' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, BuildId) == 0x0012C0, "Member 'AJunoGuidedBuildingActor::BuildId' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, PendingInstantAutoCompleteActors) == 0x0012D0, "Member 'AJunoGuidedBuildingActor::PendingInstantAutoCompleteActors' has a wrong offset!");
static_assert(offsetof(AJunoGuidedBuildingActor, SnapEntries) == 0x0012E0, "Member 'AJunoGuidedBuildingActor::SnapEntries' has a wrong offset!");
...
{
public:
	uint8                                         Pad_C40[0x18];                                     // 0x0C40(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UGeometryCollectionComponent*           GeometryCollectionComponent;                       // 0x0C58(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UJunoInventoryComponent*                ChestInventoryComponent;                           // 0x0C60(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UJunoCampMembershipActorComponent*      CampMembershipComponent;                           // 0x0C68(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bTakeAllItemsOnInteract;                           // 0x0C70(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDestroyOnInteract;                                // 0x0C71(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C72[0x6];                                      // 0x0C72(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                GridSizeOverride;                                  // 0x0C78(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             BuildingPivotOffset;                               // 0x0C90(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                BuildingGridSnapOffset;                            // 0x0CF0(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FJunoBuildingBehaviorGridLimits        GridOffsetLimits;                                  // 0x0D08(0x0010)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FJunoBuilderToolInteractionActorClassSet OverlappableClasses;                               // 0x0D18(0x00A0)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, TSubclassOf<class UJunoBuildingPreviewComponent>> PreviewComponentTemplates;                         // 0x0DB8(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FUniqueNetIdRepl                       OwnerPlayerId;                                     // 0x0E08(0x0030)(Net, SaveGame, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   BaseLootTierGroup;                                 // 0x0E38(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         DefaultInteractTime;                               // 0x0E3C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PlayerPlacedInteractTime;                          // 0x0E40(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SearchedInteractTime;                              // 0x0E44(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUsePlayerPlacedInteractionTime;                   // 0x0E48(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E49[0x7];                                      // 0x0E49(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMesh*                            SearchedMesh;                                      // 0x0E50(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         LootTossSpeed;                                     // 0x0E58(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         LootTossAngle;                                     // 0x0E5C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bChestSearched;                                    // 0x0E60(0x0001)(Net, ZeroConstructor, SaveGame, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bChestLooted;                                      // 0x0E61(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, SaveGame, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E62[0x2];                                      // 0x0E62(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class AActor>                  LastInteractor;                                    // 0x0E64(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E6C[0x4];                                      // 0x0E6C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoStorageChest) == 0x000E70, "Wrong size on AJunoStorageChest");
static_assert(offsetof(AJunoStorageChest, GeometryCollectionComponent) == 0x000C58, "Member 'AJunoStorageChest::GeometryCollectionComponent' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, ChestInventoryComponent) == 0x000C60, "Member 'AJunoStorageChest::ChestInventoryComponent' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, CampMembershipComponent) == 0x000C68, "Member 'AJunoStorageChest::CampMembershipComponent' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, bTakeAllItemsOnInteract) == 0x000C70, "Member 'AJunoStorageChest::bTakeAllItemsOnInteract' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, bDestroyOnInteract) == 0x000C71, "Member 'AJunoStorageChest::bDestroyOnInteract' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, GridSizeOverride) == 0x000C78, "Member 'AJunoStorageChest::GridSizeOverride' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, BuildingPivotOffset) == 0x000C90, "Member 'AJunoStorageChest::BuildingPivotOffset' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, BuildingGridSnapOffset) == 0x000CF0, "Member 'AJunoStorageChest::BuildingGridSnapOffset' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, GridOffsetLimits) == 0x000D08, "Member 'AJunoStorageChest::GridOffsetLimits' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, OverlappableClasses) == 0x000D18, "Member 'AJunoStorageChest::OverlappableClasses' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, PreviewComponentTemplates) == 0x000DB8, "Member 'AJunoStorageChest::PreviewComponentTemplates' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, OwnerPlayerId) == 0x000E08, "Member 'AJunoStorageChest::OwnerPlayerId' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, BaseLootTierGroup) == 0x000E38, "Member 'AJunoStorageChest::BaseLootTierGroup' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, DefaultInteractTime) == 0x000E3C, "Member 'AJunoStorageChest::DefaultInteractTime' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, PlayerPlacedInteractTime) == 0x000E40, "Member 'AJunoStorageChest::PlayerPlacedInteractTime' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, SearchedInteractTime) == 0x000E44, "Member 'AJunoStorageChest::SearchedInteractTime' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, bUsePlayerPlacedInteractionTime) == 0x000E48, "Member 'AJunoStorageChest::bUsePlayerPlacedInteractionTime' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, SearchedMesh) == 0x000E50, "Member 'AJunoStorageChest::SearchedMesh' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, LootTossSpeed) == 0x000E58, "Member 'AJunoStorageChest::LootTossSpeed' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, LootTossAngle) == 0x000E5C, "Member 'AJunoStorageChest::LootTossAngle' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, bChestSearched) == 0x000E60, "Member 'AJunoStorageChest::bChestSearched' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, bChestLooted) == 0x000E61, "Member 'AJunoStorageChest::bChestLooted' has a wrong offset!");
static_assert(offsetof(AJunoStorageChest, LastInteractor) == 0x000E64, "Member 'AJunoStorageChest::LastInteractor' has a wrong offset!");
...
{
public:
	uint8                                         bGiveResourcesOnDestroy : 1;                       // 0x0828(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_829[0x3];                                      // 0x0829(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SelfCraftingFormulaName;                           // 0x082C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           PrerequisiteCraftingFormulaNames;                  // 0x0830(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TSoftClassPtr<class UClass>                   ActorClassToBuild;                                 // 0x0840(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortPlaysetPropItemDefinition*         PlaysetPropToBuild;                                // 0x0860(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FText                                   SizeDescription;                                   // 0x0868(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	class FText                                   SetDescription;                                    // 0x0880(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoBuildInstructionsItemDefinition) == 0x0008A0, "Wrong size on UJunoBuildInstructionsItemDefinition");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, SelfCraftingFormulaName) == 0x00082C, "Member 'UJunoBuildInstructionsItemDefinition::SelfCraftingFormulaName' has a wrong offset!");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, PrerequisiteCraftingFormulaNames) == 0x000830, "Member 'UJunoBuildInstructionsItemDefinition::PrerequisiteCraftingFormulaNames' has a wrong offset!");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, ActorClassToBuild) == 0x000840, "Member 'UJunoBuildInstructionsItemDefinition::ActorClassToBuild' has a wrong offset!");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, PlaysetPropToBuild) == 0x000860, "Member 'UJunoBuildInstructionsItemDefinition::PlaysetPropToBuild' has a wrong offset!");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, SizeDescription) == 0x000868, "Member 'UJunoBuildInstructionsItemDefinition::SizeDescription' has a wrong offset!");
static_assert(offsetof(UJunoBuildInstructionsItemDefinition, SetDescription) == 0x000880, "Member 'UJunoBuildInstructionsItemDefinition::SetDescription' has a wrong offset!");

// Class JunoGameNative.JunoCraftingObjectBGA
// 0x0208 (0x0BF0 - 0x09E8)
class AJunoCraftingObjectBGA final : public ACraftingObjectBGA
{
public:
	uint8                                         Pad_9E8[0x60];                                     // 0x09E8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                GridSizeOverride;                                  // 0x0A48(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FTransform                             BuildingPivotOffset;                               // 0x0A60(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                BuildingGridSnapOffset;                            // 0x0AC0(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FJunoBuildingBehaviorGridLimits        GridOffsetLimits;                                  // 0x0AD8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	struct FJunoBuilderToolInteractionActorClassSet OverlappableClasses;                               // 0x0AE8(0x00A0)(Edit, NativeAccessSpecifierPrivate)
	class UItemDefinitionBase*                    AssociatedItem;                                    // 0x0B88(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, SaveGame, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<class FName, TSubclassOf<class UJunoBuildingPreviewComponent>> PreviewComponentTemplates;                         // 0x0B90(0x0050)(Edit, UObjectWrapper, NativeAccessSpecifierPrivate)
	class FName                                   UpgradeRecipe;                                     // 0x0BE0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bShouldPersist;                                    // 0x0BE4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_BE5[0xB];                                      // 0x0BE5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoCraftingObjectBGA) == 0x000BF0, "Wrong size on AJunoCraftingObjectBGA");
static_assert(offsetof(AJunoCraftingObjectBGA, GridSizeOverride) == 0x000A48, "Member 'AJunoCraftingObjectBGA::GridSizeOverride' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, BuildingPivotOffset) == 0x000A60, "Member 'AJunoCraftingObjectBGA::BuildingPivotOffset' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, BuildingGridSnapOffset) == 0x000AC0, "Member 'AJunoCraftingObjectBGA::BuildingGridSnapOffset' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, GridOffsetLimits) == 0x000AD8, "Member 'AJunoCraftingObjectBGA::GridOffsetLimits' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, OverlappableClasses) == 0x000AE8, "Member 'AJunoCraftingObjectBGA::OverlappableClasses' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, AssociatedItem) == 0x000B88, "Member 'AJunoCraftingObjectBGA::AssociatedItem' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, PreviewComponentTemplates) == 0x000B90, "Member 'AJunoCraftingObjectBGA::PreviewComponentTemplates' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, UpgradeRecipe) == 0x000BE0, "Member 'AJunoCraftingObjectBGA::UpgradeRecipe' has a wrong offset!");
static_assert(offsetof(AJunoCraftingObjectBGA, bShouldPersist) == 0x000BE4, "Member 'AJunoCraftingObjectBGA::bShouldPersist' has a wrong offset!");
...
{
public:
	TArray<struct FDataTableRowHandle>            CraftingFormulas;                                  // 0x0828(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UJunoRecipeBundleItemDefinition) == 0x000840, "Wrong size on UJunoRecipeBundleItemDefinition");
static_assert(offsetof(UJunoRecipeBundleItemDefinition, CraftingFormulas) == 0x000828, "Member 'UJunoRecipeBundleItemDefinition::CraftingFormulas' has a wrong offset!");
...
public:
	uint8                                         Pad_A0[0x8];                                       // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             NotifyAddedIntoClusterUnion;                       // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             NotifyRemovedFromClusterUnion;                     // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoConnectivityComponent) == 0x0001C8, "Wrong size on UJunoConnectivityComponent");
...
static_assert(offsetof(UJunoConnectivityComponent, ContactDistance) == 0x0000E0, "Member 'UJunoConnectivityComponent::ContactDistance' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bIsInGraph) == 0x0000E4, "Member 'UJunoConnectivityComponent::bIsInGraph' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, GeometryCollectionsToIgnoreBreaksForConnectivity) == 0x0000E8, "Member 'UJunoConnectivityComponent::GeometryCollectionsToIgnoreBreaksForConnectivity' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, RootDoorComponentReferences) == 0x0000F8, "Member 'UJunoConnectivityComponent::RootDoorComponentReferences' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, DoorComponents) == 0x000108, "Member 'UJunoConnectivityComponent::DoorComponents' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bAreDoorsEjected) == 0x000118, "Member 'UJunoConnectivityComponent::bAreDoorsEjected' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bAreDoorsEjectedInternal) == 0x000119, "Member 'UJunoConnectivityComponent::bAreDoorsEjectedInternal' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, GraphHandle) == 0x000120, "Member 'UJunoConnectivityComponent::GraphHandle' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bRootPlayspaceInitialized) == 0x000148, "Member 'UJunoConnectivityComponent::bRootPlayspaceInitialized' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bIsDebris) == 0x000149, "Member 'UJunoConnectivityComponent::bIsDebris' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bHasBeenSaved) == 0x00014A, "Member 'UJunoConnectivityComponent::bHasBeenSaved' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, AutomaticConnectionMethod) == 0x00014B, "Member 'UJunoConnectivityComponent::AutomaticConnectionMethod' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, CustomConnectionDirections) == 0x000150, "Member 'UJunoConnectivityComponent::CustomConnectionDirections' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bCanBeConnectedTo) == 0x000160, "Member 'UJunoConnectivityComponent::bCanBeConnectedTo' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bMustConnectToDynamic) == 0x000161, "Member 'UJunoConnectivityComponent::bMustConnectToDynamic' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bForceIndependentlySupported) == 0x000162, "Member 'UJunoConnectivityComponent::bForceIndependentlySupported' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bForceWorldSupportWhenPotentialConnectionsAreNotFound) == 0x000163, "Member 'UJunoConnectivityComponent::bForceWorldSupportWhenPotentialConnectionsAreNotFound' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bAddToConnectivityGraphOnBeginPlay) == 0x000164, "Member 'UJunoConnectivityComponent::bAddToConnectivityGraphOnBeginPlay' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, bCanBeWorldSupported) == 0x000165, "Member 'UJunoConnectivityComponent::bCanBeWorldSupported' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, ClassesThatAreAlwaysValidForWorldSupport) == 0x000168, "Member 'UJunoConnectivityComponent::ClassesThatAreAlwaysValidForWorldSupport' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, OverlapMargin) == 0x000178, "Member 'UJunoConnectivityComponent::OverlapMargin' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, MinimumIslandSize) == 0x000190, "Member 'UJunoConnectivityComponent::MinimumIslandSize' has a wrong offset!");
static_assert(offsetof(UJunoConnectivityComponent, AttachedToys) == 0x000198, "Member 'UJunoConnectivityComponent::AttachedToys' has a wrong offset!");
...
static_assert(offsetof(UJunoConnectivityManagerComponent, bIsNewPlayspace) == 0x0000BA, "Member 'UJunoConnectivityManagerComponent::bIsNewPlayspace' has a wrong offset!");
...
public:
	uint8                                         Pad_A0[0x8];                                       // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             NotifyAttachedToConnectivityComponent;             // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             NotifyRemovedFromConnectivityComponent;            // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoPhysicsToyConnectivityComponent) == 0x0000E0, "Wrong size on UJunoPhysicsToyConnectivityComponent");
static_assert(offsetof(UJunoPhysicsToyConnectivityComponent, NotifyAttachedToConnectivityComponent) == 0x0000A8, "Member 'UJunoPhysicsToyConnectivityComponent::NotifyAttachedToConnectivityComponent' has a wrong offset!");
static_assert(offsetof(UJunoPhysicsToyConnectivityComponent, NotifyRemovedFromConnectivityComponent) == 0x0000B8, "Member 'UJunoPhysicsToyConnectivityComponent::NotifyRemovedFromConnectivityComponent' has a wrong offset!");
static_assert(offsetof(UJunoPhysicsToyConnectivityComponent, bPlayspaceInitialized) == 0x0000D0, "Member 'UJunoPhysicsToyConnectivityComponent::bPlayspaceInitialized' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnJunoMoodChangedDelegate;                         // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x18];                                      // 0x00B8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnJunoMoodReactionTriggeredDelegate;               // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_E0[0x18];                                      // 0x00E0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnJunoMoodReactionFinishedDelegate;                // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_108[0x18];                                     // 0x0108(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnJunoMoodReactionCanceledDelegate;                // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UJunoDeltasLevelSaveComponent) == 0x000900, "Wrong size on UJunoDeltasLevelSaveComponent");
...
public:
	...
	TMap<struct FUniqueNetIdRepl, int32>          PlayerSaveDataRefCount;                            // 0x0148(0x0050)(NativeAccessSpecifierPrivate)
	TMap<struct FUniqueNetIdRepl, struct FJunoPlayerSaveData> PlayerSaveData;                                    // 0x0198(0x0050)(NativeAccessSpecifierPrivate)
	TMap<struct FUniqueNetIdRepl, TWeakObjectPtr<class UJunoPlayerSaveData_Container>> PlayerSaveDataContainers;                          // 0x01E8(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<struct FUniqueNetIdRepl, struct FJunoPlayerAccountSaveData> PlayerAccountSaveData;                             // 0x0238(0x0050)(NativeAccessSpecifierPrivate)
	TMap<struct FUniqueNetIdRepl, TWeakObjectPtr<class UJunoPlayerAccountSaveData_Container>> PlayerAccountSaveDataContainers;                   // 0x0288(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	TSet<struct FUniqueNetIdRepl>                 InFlightPlayerSaves;                               // 0x02D8(0x0050)(NativeAccessSpecifierPrivate)
	TSet<struct FUniqueNetIdRepl>                 InFlightPlayerAccountSaves;                        // 0x0328(0x0050)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UJunoPlayerPersistenceComponent) == 0x000398, "Wrong size on UJunoPlayerPersistenceComponent");
static_assert(offsetof(UJunoPlayerPersistenceComponent, PlayerSaveDataRefCount) == 0x000148, "Member 'UJunoPlayerPersistenceComponent::PlayerSaveDataRefCount' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, PlayerSaveData) == 0x000198, "Member 'UJunoPlayerPersistenceComponent::PlayerSaveData' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, PlayerSaveDataContainers) == 0x0001E8, "Member 'UJunoPlayerPersistenceComponent::PlayerSaveDataContainers' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, PlayerAccountSaveData) == 0x000238, "Member 'UJunoPlayerPersistenceComponent::PlayerAccountSaveData' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, PlayerAccountSaveDataContainers) == 0x000288, "Member 'UJunoPlayerPersistenceComponent::PlayerAccountSaveDataContainers' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, InFlightPlayerSaves) == 0x0002D8, "Member 'UJunoPlayerPersistenceComponent::InFlightPlayerSaves' has a wrong offset!");
static_assert(offsetof(UJunoPlayerPersistenceComponent, InFlightPlayerAccountSaves) == 0x000328, "Member 'UJunoPlayerPersistenceComponent::InFlightPlayerAccountSaves' has a wrong offset!");
...
// 0x0028 (0x1A18 - 0x19F0)
class AJunoPlayerState final : public AFortPlayerStateAthena
{
public:
	struct FGuid                                  CaveId;                                            // 0x19F0(0x0010)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FLinearColor>                   PinColorForPlayer;                                 // 0x1A00(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           GameplayTagPresentWhenTeleporting;                 // 0x1A10(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1A14[0x4];                                     // 0x1A14(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AJunoPlayerState) == 0x001A18, "Wrong size on AJunoPlayerState");
static_assert(offsetof(AJunoPlayerState, CaveId) == 0x0019F0, "Member 'AJunoPlayerState::CaveId' has a wrong offset!");
static_assert(offsetof(AJunoPlayerState, PinColorForPlayer) == 0x001A00, "Member 'AJunoPlayerState::PinColorForPlayer' has a wrong offset!");
static_assert(offsetof(AJunoPlayerState, GameplayTagPresentWhenTeleporting) == 0x001A10, "Member 'AJunoPlayerState::GameplayTagPresentWhenTeleporting' has a wrong offset!");
