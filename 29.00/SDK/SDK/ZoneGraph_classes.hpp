...
public:
	...
	struct FZoneGraphBuildSettings                BuildSettings;                                     // 0x01C8(0x0048)(Edit, Config, Protected, NativeAccessSpecifierProtected)
	bool                                          bBuildZoneGraphWhileEditing;                       // 0x0210(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UZoneGraphSettings) == 0x000218, "Wrong size on UZoneGraphSettings");
...
static_assert(offsetof(UZoneGraphSettings, bBuildZoneGraphWhileEditing) == 0x000210, "Member 'UZoneGraphSettings::bBuildZoneGraphWhileEditing' has a wrong offset!");
