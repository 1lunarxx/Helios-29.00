...
static_assert(sizeof(SlateAccessibleWidgetData_GetText__DelegateSignature) == 0x000018, "Wrong size on SlateAccessibleWidgetData_GetText__DelegateSignature");
...
static_assert(offsetof(ComboBoxKey_OnSelectionChangedEvent__DelegateSignature, SelectionType) == 0x000004, "Member 'ComboBoxKey_OnSelectionChangedEvent__DelegateSignature::SelectionType' has a wrong offset!");
