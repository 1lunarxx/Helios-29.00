...
// Parameters:
// float                                   NewCurrentHeight                                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortPawnComponent_WingedFlying::HandleCurrentHeightUpdated(const float NewCurrentHeight)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_WingedFlying", "HandleCurrentHeightUpdated");

	Params::FortPawnComponent_WingedFlying_HandleCurrentHeightUpdated Parms{};

	Parms.NewCurrentHeight = NewCurrentHeight;
...
void UFortPawnComponent_WingedFlying::HandleHeightCheckTagChange(const struct FGameplayTag& Tag, int32 NewCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_WingedFlying", "HandleHeightCheckTagChange");

	Params::FortPawnComponent_WingedFlying_HandleHeightCheckTagChange Parms{};
...
void UFortPawnComponent_WingedFlying::HandleSkimmingTagsChange(const struct FGameplayTag& Tag, int32 NewCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_WingedFlying", "HandleSkimmingTagsChange");

	Params::FortPawnComponent_WingedFlying_HandleSkimmingTagsChange Parms{};
