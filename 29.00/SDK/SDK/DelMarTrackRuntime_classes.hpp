...
public:
	...
	class UDelMarTrackSplineComponent*            Spline;                                            // 0x0C08(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FDelMarTrackPropSection>        TrackPropData;                                     // 0x0C10(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FDelMarSegmentActorCollection>  SegmentCollections;                                // 0x0C20(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NonTransactional, ContainsInstancedReference, Protected, TextExportTransient, NonPIEDuplicateTransient, NativeAccessSpecifierProtected)
	float                                         DefaultMaxTrackWidth;                              // 0x0C30(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UDelMarTrackPalette*                    TrackPalette;                                      // 0x0C40(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableGlobalMaterialCollectionIndex;              // 0x0C48(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C49[0x3];                                      // 0x0C49(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        GlobalMaterialCollectionIndex;                     // 0x0C4C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bForceValidOOBTube;                                // 0x0C50(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bForceValidTrack;                                  // 0x0C51(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ADelMarTrackBase) == 0x000C58, "Wrong size on ADelMarTrackBase");
static_assert(offsetof(ADelMarTrackBase, TrackPalette_V2) == 0x000BF8, "Member 'ADelMarTrackBase::TrackPalette_V2' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, TrackSplinePointData) == 0x000C00, "Member 'ADelMarTrackBase::TrackSplinePointData' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, Spline) == 0x000C08, "Member 'ADelMarTrackBase::Spline' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, TrackPropData) == 0x000C10, "Member 'ADelMarTrackBase::TrackPropData' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, SegmentCollections) == 0x000C20, "Member 'ADelMarTrackBase::SegmentCollections' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, DefaultMaxTrackWidth) == 0x000C30, "Member 'ADelMarTrackBase::DefaultMaxTrackWidth' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, TotalSegmentActors) == 0x000C34, "Member 'ADelMarTrackBase::TotalSegmentActors' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, TrackLength) == 0x000C38, "Member 'ADelMarTrackBase::TrackLength' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, TrackPalette) == 0x000C40, "Member 'ADelMarTrackBase::TrackPalette' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, bEnableGlobalMaterialCollectionIndex) == 0x000C48, "Member 'ADelMarTrackBase::bEnableGlobalMaterialCollectionIndex' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, GlobalMaterialCollectionIndex) == 0x000C4C, "Member 'ADelMarTrackBase::GlobalMaterialCollectionIndex' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, bForceValidOOBTube) == 0x000C50, "Member 'ADelMarTrackBase::bForceValidOOBTube' has a wrong offset!");
static_assert(offsetof(ADelMarTrackBase, bForceValidTrack) == 0x000C51, "Member 'ADelMarTrackBase::bForceValidTrack' has a wrong offset!");
...
{
public:
	EDelMarTrackType                              TrackType;                                         // 0x0C58(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUserSelectedStartTrack;                           // 0x0C59(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C5A[0x6];                                      // 0x0C5A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarTrack*                           StartTrackConnection;                              // 0x0C60(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUserSelectedEndTrack;                             // 0x0C68(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C69[0x7];                                      // 0x0C69(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ADelMarTrack*                           EndTrackConnection;                                // 0x0C70(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ParentStartDistance;                               // 0x0C78(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ParentEndDistance;                                 // 0x0C7C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PrimaryStartDistance;                              // 0x0C80(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PrimaryEndDistance;                                // 0x0C84(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PrimarySegmentLength;                              // 0x0C88(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C8C[0x4];                                      // 0x0C8C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ADelMarTrackOobTube>        OobTubeClass;                                      // 0x0C90(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class ADelMarTrackOobTube>     AttachedOobTube;                                   // 0x0C98(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ADelMarTrack) == 0x000CB0, "Wrong size on ADelMarTrack");
static_assert(offsetof(ADelMarTrack, TrackType) == 0x000C58, "Member 'ADelMarTrack::TrackType' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, bUserSelectedStartTrack) == 0x000C59, "Member 'ADelMarTrack::bUserSelectedStartTrack' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, StartTrackConnection) == 0x000C60, "Member 'ADelMarTrack::StartTrackConnection' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, bUserSelectedEndTrack) == 0x000C68, "Member 'ADelMarTrack::bUserSelectedEndTrack' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, EndTrackConnection) == 0x000C70, "Member 'ADelMarTrack::EndTrackConnection' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, ParentStartDistance) == 0x000C78, "Member 'ADelMarTrack::ParentStartDistance' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, ParentEndDistance) == 0x000C7C, "Member 'ADelMarTrack::ParentEndDistance' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, PrimaryStartDistance) == 0x000C80, "Member 'ADelMarTrack::PrimaryStartDistance' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, PrimaryEndDistance) == 0x000C84, "Member 'ADelMarTrack::PrimaryEndDistance' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, PrimarySegmentLength) == 0x000C88, "Member 'ADelMarTrack::PrimarySegmentLength' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, OobTubeClass) == 0x000C90, "Member 'ADelMarTrack::OobTubeClass' has a wrong offset!");
static_assert(offsetof(ADelMarTrack, AttachedOobTube) == 0x000C98, "Member 'ADelMarTrack::AttachedOobTube' has a wrong offset!");
