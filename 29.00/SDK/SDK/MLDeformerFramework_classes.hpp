...
static_assert(offsetof(UMLDeformerModel, MaxNumLODs) == 0x0000C8, "Member 'UMLDeformerModel::MaxNumLODs' has a wrong offset!");
static_assert(offsetof(UMLDeformerModel, InputInfo) == 0x0000D0, "Member 'UMLDeformerModel::InputInfo' has a wrong offset!");
static_assert(offsetof(UMLDeformerModel, VertexMap) == 0x0000D8, "Member 'UMLDeformerModel::VertexMap' has a wrong offset!");
static_assert(offsetof(UMLDeformerModel, SkeletalMesh) == 0x0000E8, "Member 'UMLDeformerModel::SkeletalMesh' has a wrong offset!");
...
static_assert(offsetof(UMLDeformerMorphModel, bClampMorphWeights) == 0x000110, "Member 'UMLDeformerMorphModel::bClampMorphWeights' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphTargetDeltas) == 0x000118, "Member 'UMLDeformerMorphModel::MorphTargetDeltas' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, NumMorphTargets) == 0x000128, "Member 'UMLDeformerMorphModel::NumMorphTargets' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, CompressedMorphDataSizeInBytes) == 0x000130, "Member 'UMLDeformerMorphModel::CompressedMorphDataSizeInBytes' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, UncompressedMorphDataSizeInBytes) == 0x000138, "Member 'UMLDeformerMorphModel::UncompressedMorphDataSizeInBytes' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphTargetErrorOrder) == 0x000140, "Member 'UMLDeformerMorphModel::MorphTargetErrorOrder' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphTargetErrors) == 0x000150, "Member 'UMLDeformerMorphModel::MorphTargetErrors' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MaxMorphWeights) == 0x000160, "Member 'UMLDeformerMorphModel::MaxMorphWeights' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphTargetsMinMaxWeights) == 0x000170, "Member 'UMLDeformerMorphModel::MorphTargetsMinMaxWeights' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, QualityLevels) == 0x000180, "Member 'UMLDeformerMorphModel::QualityLevels' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, bIncludeNormals) == 0x000190, "Member 'UMLDeformerMorphModel::bIncludeNormals' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphDeltaZeroThreshold) == 0x000194, "Member 'UMLDeformerMorphModel::MorphDeltaZeroThreshold' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MorphCompressionLevel) == 0x000198, "Member 'UMLDeformerMorphModel::MorphCompressionLevel' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, MaskChannel) == 0x00019C, "Member 'UMLDeformerMorphModel::MaskChannel' has a wrong offset!");
static_assert(offsetof(UMLDeformerMorphModel, bInvertMaskChannel) == 0x00019D, "Member 'UMLDeformerMorphModel::bInvertMaskChannel' has a wrong offset!");
