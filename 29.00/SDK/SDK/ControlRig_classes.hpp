...
static_assert(sizeof(UControlRig) == 0x000AA0, "Wrong size on UControlRig");
...
static_assert(offsetof(UControlRig, RigModuleNameSpace) == 0x000A90, "Member 'UControlRig::RigModuleNameSpace' has a wrong offset!");
...
static_assert(sizeof(UModularRig) == 0x000C30, "Wrong size on UModularRig");
static_assert(offsetof(UModularRig, Modules) == 0x000AA0, "Member 'UModularRig::Modules' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigSettings) == 0x000AD0, "Member 'UModularRig::ModularRigSettings' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigModel) == 0x000AD8, "Member 'UModularRig::ModularRigModel' has a wrong offset!");
static_assert(offsetof(UModularRig, ExecutionQueue) == 0x000B78, "Member 'UModularRig::ExecutionQueue' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPreInitializeDelegate;                           // 0x0508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostInitializeDelegate;                          // 0x0518(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreConstructionDelegate;                         // 0x0528(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostConstructionDelegate;                        // 0x0538(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreForwardsSolveDelegate;                        // 0x0548(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostForwardsSolveDelegate;                       // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_5A8[0xC8];                                     // 0x05A8(0x00C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAdditiveControlRig) == 0x000AB0, "Wrong size on UAdditiveControlRig");
...
static_assert(sizeof(UFKControlRig) == 0x000AE0, "Wrong size on UFKControlRig");
static_assert(offsetof(UFKControlRig, IsControlActive) == 0x000AA0, "Member 'UFKControlRig::IsControlActive' has a wrong offset!");
static_assert(offsetof(UFKControlRig, ApplyMode) == 0x000AB0, "Member 'UFKControlRig::ApplyMode' has a wrong offset!");
