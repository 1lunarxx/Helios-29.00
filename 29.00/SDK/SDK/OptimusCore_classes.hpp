...
static_assert(sizeof(UOptimusImplicitPersistentBufferDataProvider) == 0x0000A0, "Wrong size on UOptimusImplicitPersistentBufferDataProvider");
...
public:
	...
	struct FOptimusNode_ComponentSource_DuplicationInfo DuplicationInfo;                                   // 0x0128(0x0010)(DuplicateTransient, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusNode_ComponentSource) == 0x000138, "Wrong size on UOptimusNode_ComponentSource");
...
static_assert(offsetof(UOptimusNode_ComponentSource, DuplicationInfo) == 0x000128, "Member 'UOptimusNode_ComponentSource::DuplicationInfo' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x18];                                     // 0x0110(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UOptimusFunctionNodeGraph> FunctionGraph;                                     // 0x0128(0x0020)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UOptimusNode_FunctionReference, FunctionGraph) == 0x000128, "Member 'UOptimusNode_FunctionReference::FunctionGraph' has a wrong offset!");
...
public:
	...
	struct FOptimusNode_ResourceAccessorBase_DuplicationInfo DuplicationInfo;                                   // 0x0140(0x0050)(DuplicateTransient, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UOptimusNode_ResourceAccessorBase, ResourceDesc) == 0x000130, "Member 'UOptimusNode_ResourceAccessorBase::ResourceDesc' has a wrong offset!");
static_assert(offsetof(UOptimusNode_ResourceAccessorBase, WriteType) == 0x000138, "Member 'UOptimusNode_ResourceAccessorBase::WriteType' has a wrong offset!");
static_assert(offsetof(UOptimusNode_ResourceAccessorBase, DuplicationInfo) == 0x000140, "Member 'UOptimusNode_ResourceAccessorBase::DuplicationInfo' has a wrong offset!");
...
public:
	...
	struct FOptimusNode_GetVariable_DuplicationInfo DuplicationInfo;                                   // 0x0130(0x0020)(DuplicateTransient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UOptimusNode_GetVariable, VariableDesc) == 0x000128, "Member 'UOptimusNode_GetVariable::VariableDesc' has a wrong offset!");
static_assert(offsetof(UOptimusNode_GetVariable, DuplicationInfo) == 0x000130, "Member 'UOptimusNode_GetVariable::DuplicationInfo' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class UOptimusNodeSubGraph>    OwningGraph;                                       // 0x012C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UOptimusNode_GraphTerminal, OwningGraph) == 0x00012C, "Member 'UOptimusNode_GraphTerminal::OwningGraph' has a wrong offset!");
static_assert(offsetof(UOptimusNode_GraphTerminal, DefaultComponentPin) == 0x000134, "Member 'UOptimusNode_GraphTerminal::DefaultComponentPin' has a wrong offset!");
...
public:
	...
	class UOptimusNodePin*                        IndexPin;                                          // 0x0158(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UOptimusNodePin*                        CountPin;                                          // 0x0160(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOptimusNode_LoopTerminal) == 0x000178, "Wrong size on UOptimusNode_LoopTerminal");
static_assert(offsetof(UOptimusNode_LoopTerminal, TerminalType) == 0x000138, "Member 'UOptimusNode_LoopTerminal::TerminalType' has a wrong offset!");
static_assert(offsetof(UOptimusNode_LoopTerminal, LoopInfo) == 0x000140, "Member 'UOptimusNode_LoopTerminal::LoopInfo' has a wrong offset!");
static_assert(offsetof(UOptimusNode_LoopTerminal, IndexPin) == 0x000158, "Member 'UOptimusNode_LoopTerminal::IndexPin' has a wrong offset!");
static_assert(offsetof(UOptimusNode_LoopTerminal, CountPin) == 0x000160, "Member 'UOptimusNode_LoopTerminal::CountPin' has a wrong offset!");
static_assert(offsetof(UOptimusNode_LoopTerminal, PinPairInfos) == 0x000168, "Member 'UOptimusNode_LoopTerminal::PinPairInfos' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x18];                                     // 0x0110(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SubgraphName;                                      // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TWeakObjectPtr<class UOptimusNodeSubGraph>    SubGraph;                                          // 0x0134(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_13C[0x4];                                      // 0x013C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOptimusNode_SubGraphReference) == 0x000140, "Wrong size on UOptimusNode_SubGraphReference");
static_assert(offsetof(UOptimusNode_SubGraphReference, SubgraphName) == 0x000128, "Member 'UOptimusNode_SubGraphReference::SubgraphName' has a wrong offset!");
static_assert(offsetof(UOptimusNode_SubGraphReference, DefaultComponentPin) == 0x00012C, "Member 'UOptimusNode_SubGraphReference::DefaultComponentPin' has a wrong offset!");
static_assert(offsetof(UOptimusNode_SubGraphReference, SubGraph) == 0x000134, "Member 'UOptimusNode_SubGraphReference::SubGraph' has a wrong offset!");
...
public:
	...
	TArray<class UOptimusNodeGraph*>              Subgraphs;                                         // 0x0068(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	TWeakObjectPtr<class UOptimusNode_GraphTerminal> EntryNode;                                         // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UOptimusNode_GraphTerminal> ReturnNode;                                        // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusNodeSubGraph) == 0x000158, "Wrong size on UOptimusNodeSubGraph");
...
static_assert(offsetof(UOptimusNodeSubGraph, EntryNode) == 0x0000B8, "Member 'UOptimusNodeSubGraph::EntryNode' has a wrong offset!");
static_assert(offsetof(UOptimusNodeSubGraph, ReturnNode) == 0x0000C0, "Member 'UOptimusNodeSubGraph::ReturnNode' has a wrong offset!");
...
{
public:
	class FName                                   Category;                                          // 0x0158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AccessSpecifier;                                   // 0x015C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusFunctionNodeGraph) == 0x000160, "Wrong size on UOptimusFunctionNodeGraph");
static_assert(offsetof(UOptimusFunctionNodeGraph, Category) == 0x000158, "Member 'UOptimusFunctionNodeGraph::Category' has a wrong offset!");
static_assert(offsetof(UOptimusFunctionNodeGraph, AccessSpecifier) == 0x00015C, "Member 'UOptimusFunctionNodeGraph::AccessSpecifier' has a wrong offset!");
