...
public:
	...
	FMulticastInlineDelegateProperty_             OnCategoryClicked;                                 // 0x02F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TArray<class UFortLockerCategoryItemVM*>      VisibleItems;                                      // 0x0308(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	FMulticastInlineDelegateProperty_             OnCategoryItemSetup;                               // 0x0318(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UCommonButtonGroupBase*                 ButtonGroup;                                       // 0x0328(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_CategorySet_C) == 0x000330, "Wrong size on UWBP_CategorySet_C");
...
static_assert(offsetof(UWBP_CategorySet_C, ButtonGroup) == 0x000328, "Member 'UWBP_CategorySet_C::ButtonGroup' has a wrong offset!");
