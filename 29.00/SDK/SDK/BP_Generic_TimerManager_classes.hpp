...
public:
	...
	FMulticastInlineDelegateProperty_             OnSecondsRemainingUpdated;                         // 0x02F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             FadeOut;                                           // 0x0300(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnTimerStateChange;                                // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	FMulticastInlineDelegateProperty_             OnTimerActive;                                     // 0x0338(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnTimerFinished;                                   // 0x0348(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnSecondsRemainingUpdated__DelegateSignature(int32 SecondsRemaining_0);
	void OnTimerActive__DelegateSignature();
	void OnTimerFinished__DelegateSignature();
	void OnTimerStateChange__DelegateSignature(int32 NewTimerState);
