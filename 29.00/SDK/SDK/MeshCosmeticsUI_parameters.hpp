...
static_assert(offsetof(FortVariantRedirectorTile_OnVariantChangedEvent__DelegateSignature, InChannelInfo) == 0x000000, "Member 'FortVariantRedirectorTile_OnVariantChangedEvent__DelegateSignature::InChannelInfo' has a wrong offset!");
