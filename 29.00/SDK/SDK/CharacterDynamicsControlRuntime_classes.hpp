...
static_assert(sizeof(UFortCharacterDynamicsStateLogic) == 0x000078, "Wrong size on UFortCharacterDynamicsStateLogic");
...
static_assert(offsetof(UFortCharacterDynamicsStateLogic, MinMovementSpeed) == 0x000060, "Member 'UFortCharacterDynamicsStateLogic::MinMovementSpeed' has a wrong offset!");
static_assert(offsetof(UFortCharacterDynamicsStateLogic, MinRidingMovementSpeed) == 0x000064, "Member 'UFortCharacterDynamicsStateLogic::MinRidingMovementSpeed' has a wrong offset!");
static_assert(offsetof(UFortCharacterDynamicsStateLogic, MinUpwardVelocityThreshold) == 0x000068, "Member 'UFortCharacterDynamicsStateLogic::MinUpwardVelocityThreshold' has a wrong offset!");
static_assert(offsetof(UFortCharacterDynamicsStateLogic, MaxFallingThreshold) == 0x00006C, "Member 'UFortCharacterDynamicsStateLogic::MaxFallingThreshold' has a wrong offset!");
static_assert(offsetof(UFortCharacterDynamicsStateLogic, HighRevolutionsPerSecondThreshold) == 0x000070, "Member 'UFortCharacterDynamicsStateLogic::HighRevolutionsPerSecondThreshold' has a wrong offset!");
...
static_assert(sizeof(UFortCharacterDynamicsComponent) == 0x000150, "Wrong size on UFortCharacterDynamicsComponent");
static_assert(offsetof(UFortCharacterDynamicsComponent, DefaultStateLogic) == 0x0000A0, "Member 'UFortCharacterDynamicsComponent::DefaultStateLogic' has a wrong offset!");
static_assert(offsetof(UFortCharacterDynamicsComponent, DefaultParameters) == 0x0000A8, "Member 'UFortCharacterDynamicsComponent::DefaultParameters' has a wrong offset!");
