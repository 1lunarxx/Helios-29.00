...
static_assert(offsetof(FStateTreeExternalDataDesc, Requirement) == 0x000012, "Member 'FStateTreeExternalDataDesc::Requirement' has a wrong offset!");
...
public:
	...
	uint8                                         bIsGlobalFrame : 1;                                // 0x002E(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FStateTreeNodeBase, InstanceTemplateIndex) == 0x00000E, "Member 'FStateTreeNodeBase::InstanceTemplateIndex' has a wrong offset!");
static_assert(offsetof(FStateTreeNodeBase, InstanceDataHandle) == 0x000010, "Member 'FStateTreeNodeBase::InstanceDataHandle' has a wrong offset!");
...
static_assert(offsetof(FStateTreeBindableStructDesc, DataHandle) == 0x00000C, "Member 'FStateTreeBindableStructDesc::DataHandle' has a wrong offset!");
static_assert(offsetof(FStateTreeBindableStructDesc, DataSource) == 0x000012, "Member 'FStateTreeBindableStructDesc::DataSource' has a wrong offset!");
...
static_assert(offsetof(FCompactStateTreeState, LinkedAsset) == 0x000008, "Member 'FCompactStateTreeState::LinkedAsset' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Parent) == 0x000010, "Member 'FCompactStateTreeState::Parent' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenBegin) == 0x000012, "Member 'FCompactStateTreeState::ChildrenBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenEnd) == 0x000014, "Member 'FCompactStateTreeState::ChildrenEnd' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsBegin) == 0x000016, "Member 'FCompactStateTreeState::EnterConditionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsBegin) == 0x000018, "Member 'FCompactStateTreeState::TransitionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksBegin) == 0x00001A, "Member 'FCompactStateTreeState::TasksBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterTemplateIndex) == 0x00001C, "Member 'FCompactStateTreeState::ParameterTemplateIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterDataHandle) == 0x00001E, "Member 'FCompactStateTreeState::ParameterDataHandle' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterBindingsBatch) == 0x000024, "Member 'FCompactStateTreeState::ParameterBindingsBatch' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsNum) == 0x000026, "Member 'FCompactStateTreeState::EnterConditionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsNum) == 0x000027, "Member 'FCompactStateTreeState::TransitionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksNum) == 0x000028, "Member 'FCompactStateTreeState::TasksNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, InstanceDataNum) == 0x000029, "Member 'FCompactStateTreeState::InstanceDataNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Type) == 0x00002A, "Member 'FCompactStateTreeState::Type' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, SelectionBehavior) == 0x00002B, "Member 'FCompactStateTreeState::SelectionBehavior' has a wrong offset!");
