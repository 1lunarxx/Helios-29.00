...
static_assert(sizeof(UBakeMeshAttributeTool) == 0x0001B0, "Wrong size on UBakeMeshAttributeTool");
static_assert(offsetof(UBakeMeshAttributeTool, OcclusionSettings) == 0x0000D0, "Member 'UBakeMeshAttributeTool::OcclusionSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeTool, CurvatureSettings) == 0x0000D8, "Member 'UBakeMeshAttributeTool::CurvatureSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeTool, TextureSettings) == 0x0000E0, "Member 'UBakeMeshAttributeTool::TextureSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeTool, MultiTextureSettings) == 0x0000E8, "Member 'UBakeMeshAttributeTool::MultiTextureSettings' has a wrong offset!");
...
static_assert(sizeof(UBakeMeshAttributeMapsToolBase) == 0x000328, "Wrong size on UBakeMeshAttributeMapsToolBase");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, VisualizationProps) == 0x0001B8, "Member 'UBakeMeshAttributeMapsToolBase::VisualizationProps' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, PreviewMesh) == 0x0001C0, "Member 'UBakeMeshAttributeMapsToolBase::PreviewMesh' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, PreviewMaterial) == 0x0001C8, "Member 'UBakeMeshAttributeMapsToolBase::PreviewMaterial' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, BentNormalPreviewMaterial) == 0x0001D0, "Member 'UBakeMeshAttributeMapsToolBase::BentNormalPreviewMaterial' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, CachedMaps) == 0x000228, "Member 'UBakeMeshAttributeMapsToolBase::CachedMaps' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyNormalMap) == 0x000310, "Member 'UBakeMeshAttributeMapsToolBase::EmptyNormalMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapBlack) == 0x000318, "Member 'UBakeMeshAttributeMapsToolBase::EmptyColorMapBlack' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapWhite) == 0x000320, "Member 'UBakeMeshAttributeMapsToolBase::EmptyColorMapWhite' has a wrong offset!");
...
static_assert(sizeof(UBakeMeshAttributeMapsTool) == 0x000398, "Wrong size on UBakeMeshAttributeMapsTool");
static_assert(offsetof(UBakeMeshAttributeMapsTool, InputMeshSettings) == 0x000328, "Member 'UBakeMeshAttributeMapsTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, Settings) == 0x000330, "Member 'UBakeMeshAttributeMapsTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, ResultSettings) == 0x000338, "Member 'UBakeMeshAttributeMapsTool::ResultSettings' has a wrong offset!");
...
static_assert(offsetof(UBakeMeshAttributeVertexTool, InputMeshSettings) == 0x0001B8, "Member 'UBakeMeshAttributeVertexTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeVertexTool, Settings) == 0x0001C0, "Member 'UBakeMeshAttributeVertexTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewMesh) == 0x0001C8, "Member 'UBakeMeshAttributeVertexTool::PreviewMesh' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewMaterial) == 0x0001D0, "Member 'UBakeMeshAttributeVertexTool::PreviewMaterial' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewAlphaMaterial) == 0x0001D8, "Member 'UBakeMeshAttributeVertexTool::PreviewAlphaMaterial' has a wrong offset!");
...
static_assert(sizeof(USetCollisionGeometryTool) == 0x000390, "Wrong size on USetCollisionGeometryTool");
static_assert(offsetof(USetCollisionGeometryTool, Settings) == 0x0000D0, "Member 'USetCollisionGeometryTool::Settings' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, PolygroupLayerProperties) == 0x0000D8, "Member 'USetCollisionGeometryTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, VizSettings) == 0x0000E0, "Member 'USetCollisionGeometryTool::VizSettings' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, CollisionProps) == 0x0000E8, "Member 'USetCollisionGeometryTool::CollisionProps' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, PreviewGeom) == 0x0000F8, "Member 'USetCollisionGeometryTool::PreviewGeom' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, GeometrySelectionVizProperties) == 0x000380, "Member 'USetCollisionGeometryTool::GeometrySelectionVizProperties' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, GeometrySelectionViz) == 0x000388, "Member 'USetCollisionGeometryTool::GeometrySelectionViz' has a wrong offset!");
...
static_assert(sizeof(UBakeMultiMeshAttributeMapsTool) == 0x0003D0, "Wrong size on UBakeMultiMeshAttributeMapsTool");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, Settings) == 0x000328, "Member 'UBakeMultiMeshAttributeMapsTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, InputMeshSettings) == 0x000330, "Member 'UBakeMultiMeshAttributeMapsTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, ResultSettings) == 0x000338, "Member 'UBakeMultiMeshAttributeMapsTool::ResultSettings' has a wrong offset!");
...
static_assert(sizeof(UBakeTransformTool) == 0x0000E0, "Wrong size on UBakeTransformTool");
static_assert(offsetof(UBakeTransformTool, BasicProperties) == 0x0000C8, "Member 'UBakeTransformTool::BasicProperties' has a wrong offset!");
...
static_assert(offsetof(UConvertMeshesTool, BasicProperties) == 0x0000A8, "Member 'UConvertMeshesTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UConvertMeshesTool, OutputTypeProperties) == 0x0000B0, "Member 'UConvertMeshesTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UConvertMeshesTool, Inputs) == 0x0000B8, "Member 'UConvertMeshesTool::Inputs' has a wrong offset!");
...
static_assert(offsetof(UDeformMeshPolygonsTool, PreviewMeshActor) == 0x000118, "Member 'UDeformMeshPolygonsTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UDeformMeshPolygonsTool, DynamicMeshComponent) == 0x000120, "Member 'UDeformMeshPolygonsTool::DynamicMeshComponent' has a wrong offset!");
static_assert(offsetof(UDeformMeshPolygonsTool, TransformProps) == 0x000128, "Member 'UDeformMeshPolygonsTool::TransformProps' has a wrong offset!");
...
public:
	...
	class UMeshStatisticsProperties*              MeshStatistics;                                    // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDisplaceMeshTool, MeshStatistics) == 0x0000F0, "Member 'UDisplaceMeshTool::MeshStatistics' has a wrong offset!");
...
static_assert(offsetof(UTransformMeshesTool, TransformProps) == 0x0000D0, "Member 'UTransformMeshesTool::TransformProps' has a wrong offset!");
static_assert(offsetof(UTransformMeshesTool, ActiveGizmos) == 0x0000D8, "Member 'UTransformMeshesTool::ActiveGizmos' has a wrong offset!");
static_assert(offsetof(UTransformMeshesTool, DragAlignmentMechanic) == 0x0000E8, "Member 'UTransformMeshesTool::DragAlignmentMechanic' has a wrong offset!");
...
static_assert(sizeof(UEditNormalsTool) == 0x0002D0, "Wrong size on UEditNormalsTool");
static_assert(offsetof(UEditNormalsTool, BasicProperties) == 0x0000C8, "Member 'UEditNormalsTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UEditNormalsTool, PolygroupLayerProperties) == 0x0000D0, "Member 'UEditNormalsTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UEditNormalsTool, Previews) == 0x0000D8, "Member 'UEditNormalsTool::Previews' has a wrong offset!");
static_assert(offsetof(UEditNormalsTool, GeometrySelectionVizProperties) == 0x000160, "Member 'UEditNormalsTool::GeometrySelectionVizProperties' has a wrong offset!");
static_assert(offsetof(UEditNormalsTool, GeometrySelectionViz) == 0x000168, "Member 'UEditNormalsTool::GeometrySelectionViz' has a wrong offset!");
...
static_assert(offsetof(UEditPivotTool, TransformProps) == 0x0000D0, "Member 'UEditPivotTool::TransformProps' has a wrong offset!");
static_assert(offsetof(UEditPivotTool, EditPivotActions) == 0x0000D8, "Member 'UEditPivotTool::EditPivotActions' has a wrong offset!");
...
static_assert(sizeof(UVoxelBlendMeshesTool) == 0x000130, "Wrong size on UVoxelBlendMeshesTool");
static_assert(offsetof(UVoxelBlendMeshesTool, BlendProperties) == 0x000128, "Member 'UVoxelBlendMeshesTool::BlendProperties' has a wrong offset!");
...
static_assert(sizeof(UEditUVIslandsTool) == 0x0004F0, "Wrong size on UEditUVIslandsTool");
static_assert(offsetof(UEditUVIslandsTool, MaterialSettings) == 0x000110, "Member 'UEditUVIslandsTool::MaterialSettings' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, CheckerMaterial) == 0x000118, "Member 'UEditUVIslandsTool::CheckerMaterial' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, PreviewMeshActor) == 0x000120, "Member 'UEditUVIslandsTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, DynamicMeshComponent) == 0x000128, "Member 'UEditUVIslandsTool::DynamicMeshComponent' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, SelectionMechanic) == 0x000130, "Member 'UEditUVIslandsTool::SelectionMechanic' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, TransformGizmo) == 0x000140, "Member 'UEditUVIslandsTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, TransformProxy) == 0x000148, "Member 'UEditUVIslandsTool::TransformProxy' has a wrong offset!");
...
static_assert(sizeof(UVoxelSolidifyMeshesTool) == 0x000130, "Wrong size on UVoxelSolidifyMeshesTool");
static_assert(offsetof(UVoxelSolidifyMeshesTool, SolidifyProperties) == 0x000128, "Member 'UVoxelSolidifyMeshesTool::SolidifyProperties' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2E8[0x4E8];                                    // 0x02E8(0x04E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x0002D8, "Member 'UMeshAttributePaintTool::BrushActionProps' has a wrong offset!");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0002E0, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
static_assert(offsetof(UPhysicsInspectorTool, VizSettings) == 0x0000C8, "Member 'UPhysicsInspectorTool::VizSettings' has a wrong offset!");
...
static_assert(offsetof(USeamSculptTool, Settings) == 0x0002D8, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0002E0, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
...
static_assert(sizeof(USelfUnionMeshesTool) == 0x000158, "Wrong size on USelfUnionMeshesTool");
static_assert(offsetof(USelfUnionMeshesTool, Properties) == 0x000110, "Member 'USelfUnionMeshesTool::Properties' has a wrong offset!");
static_assert(offsetof(USelfUnionMeshesTool, DrawnLineSet) == 0x000118, "Member 'USelfUnionMeshesTool::DrawnLineSet' has a wrong offset!");
...
public:
	...
	class USmoothMeshToolProperties*              SmoothProperties;                                  // 0x0418(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UIterativeSmoothProperties*             IterativeProperties;                               // 0x0420(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDiffusionSmoothProperties*             DiffusionProperties;                               // 0x0428(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UImplicitSmoothProperties*              ImplicitProperties;                                // 0x0430(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USmoothWeightMapSetProperties*          WeightMapProperties;                               // 0x0438(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(USmoothMeshTool, SmoothProperties) == 0x000418, "Member 'USmoothMeshTool::SmoothProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, IterativeProperties) == 0x000420, "Member 'USmoothMeshTool::IterativeProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, DiffusionProperties) == 0x000428, "Member 'USmoothMeshTool::DiffusionProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, ImplicitProperties) == 0x000430, "Member 'USmoothMeshTool::ImplicitProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, WeightMapProperties) == 0x000438, "Member 'USmoothMeshTool::WeightMapProperties' has a wrong offset!");
...
static_assert(sizeof(UVoxelMorphologyMeshesTool) == 0x000130, "Wrong size on UVoxelMorphologyMeshesTool");
static_assert(offsetof(UVoxelMorphologyMeshesTool, MorphologyProperties) == 0x000128, "Member 'UVoxelMorphologyMeshesTool::MorphologyProperties' has a wrong offset!");
