...
static_assert(offsetof(PlayspaceComponent_LipSyncAssetManager_LipSyncAnimDecidedDelegate__DelegateSignature, LipSyncAnimSequence) == 0x000000, "Member 'PlayspaceComponent_LipSyncAssetManager_LipSyncAnimDecidedDelegate__DelegateSignature::LipSyncAnimSequence' has a wrong offset!");
static_assert(offsetof(PlayspaceComponent_LipSyncAssetManager_LipSyncAnimDecidedDelegate__DelegateSignature, PlayerStates) == 0x000020, "Member 'PlayspaceComponent_LipSyncAssetManager_LipSyncAnimDecidedDelegate__DelegateSignature::PlayerStates' has a wrong offset!");
...
static_assert(offsetof(SparksMusicPlayspace_MidiEventDataParsedDelegate__DelegateSignature, MidiEventDriver) == 0x000000, "Member 'SparksMusicPlayspace_MidiEventDataParsedDelegate__DelegateSignature::MidiEventDriver' has a wrong offset!");
static_assert(offsetof(SparksMusicPlayspace_MidiEventDataParsedDelegate__DelegateSignature, ParsedMidiEventData) == 0x000010, "Member 'SparksMusicPlayspace_MidiEventDataParsedDelegate__DelegateSignature::ParsedMidiEventData' has a wrong offset!");
...
static_assert(offsetof(SparksMusicPlayspace_MidiEventDriverChangedDelegate__DelegateSignature, MidiEventDriver) == 0x000000, "Member 'SparksMusicPlayspace_MidiEventDriverChangedDelegate__DelegateSignature::MidiEventDriver' has a wrong offset!");
