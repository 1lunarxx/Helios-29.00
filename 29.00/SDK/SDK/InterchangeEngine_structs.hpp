...
static_assert(offsetof(FInterchangeImportSettings, bShowImportDialog) == 0x000078, "Member 'FInterchangeImportSettings::bShowImportDialog' has a wrong offset!");
...
static_assert(offsetof(FInterchangePerTranslatorDialogOverride, bShowImportDialog) == 0x000020, "Member 'FInterchangePerTranslatorDialogOverride::bShowImportDialog' has a wrong offset!");
...
static_assert(offsetof(FInterchangeContentImportSettings, ShowImportDialogOverride) == 0x0000D0, "Member 'FInterchangeContentImportSettings::ShowImportDialogOverride' has a wrong offset!");
