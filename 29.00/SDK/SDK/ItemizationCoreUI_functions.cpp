...
// Parameters:
// class UWidget*                          GridEntry                                              (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUniformGridEntryPanel::OnGridEntryAdded__DelegateSignature(class UWidget* GridEntry)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UniformGridEntryPanel", "OnGridEntryAdded__DelegateSignature");

	Params::UniformGridEntryPanel_OnGridEntryAdded__DelegateSignature Parms{};

	Parms.GridEntry = GridEntry;
...
void UUniformGridEntryPanel::OnGridEntryRemoved__DelegateSignature(class UWidget* GridEntry)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UniformGridEntryPanel", "OnGridEntryRemoved__DelegateSignature");

	Params::UniformGridEntryPanel_OnGridEntryRemoved__DelegateSignature Parms{};
...
// DelegateFunction ItemizationCoreUI.UniformGridEntryPanel.OnGridItemsSet__DelegateSignature
// (MulticastDelegate, Public, Delegate)

void UUniformGridEntryPanel::OnGridItemsSet__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UniformGridEntryPanel", "OnGridItemsSet__DelegateSignature");
