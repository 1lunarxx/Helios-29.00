...
static_assert(offsetof(ULearningAgentsManagerListener, bIsSetup) == 0x000028, "Member 'ULearningAgentsManagerListener::bIsSetup' has a wrong offset!");
static_assert(offsetof(ULearningAgentsManagerListener, Manager) == 0x000030, "Member 'ULearningAgentsManagerListener::Manager' has a wrong offset!");
static_assert(offsetof(ULearningAgentsManagerListener, VisualLoggerObjects) == 0x000038, "Member 'ULearningAgentsManagerListener::VisualLoggerObjects' has a wrong offset!");
...
static_assert(offsetof(ULearningAgentsController, Interactor) == 0x000088, "Member 'ULearningAgentsController::Interactor' has a wrong offset!");
...
static_assert(offsetof(ULearningAgentsCritic, Interactor) == 0x000088, "Member 'ULearningAgentsCritic::Interactor' has a wrong offset!");
static_assert(offsetof(ULearningAgentsCritic, Policy) == 0x000090, "Member 'ULearningAgentsCritic::Policy' has a wrong offset!");
static_assert(offsetof(ULearningAgentsCritic, CriticNetwork) == 0x000098, "Member 'ULearningAgentsCritic::CriticNetwork' has a wrong offset!");
...
static_assert(offsetof(ULearningAgentsInteractor, ObservationSchema) == 0x000088, "Member 'ULearningAgentsInteractor::ObservationSchema' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ObservationSchemaElement) == 0x000090, "Member 'ULearningAgentsInteractor::ObservationSchemaElement' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ActionSchema) == 0x000098, "Member 'ULearningAgentsInteractor::ActionSchema' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ActionSchemaElement) == 0x0000A0, "Member 'ULearningAgentsInteractor::ActionSchemaElement' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ObservationObject) == 0x0000A8, "Member 'ULearningAgentsInteractor::ObservationObject' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ObservationObjectElements) == 0x0000B0, "Member 'ULearningAgentsInteractor::ObservationObjectElements' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ActionObject) == 0x0000C0, "Member 'ULearningAgentsInteractor::ActionObject' has a wrong offset!");
static_assert(offsetof(ULearningAgentsInteractor, ActionObjectElements) == 0x0000C8, "Member 'ULearningAgentsInteractor::ActionObjectElements' has a wrong offset!");
...
static_assert(offsetof(ULearningAgentsManager, MaxAgentNum) == 0x0000A0, "Member 'ULearningAgentsManager::MaxAgentNum' has a wrong offset!");
static_assert(offsetof(ULearningAgentsManager, Agents) == 0x0000A8, "Member 'ULearningAgentsManager::Agents' has a wrong offset!");
static_assert(offsetof(ULearningAgentsManager, Listeners) == 0x0000B8, "Member 'ULearningAgentsManager::Listeners' has a wrong offset!");
...
static_assert(offsetof(ULearningAgentsPolicy, Interactor) == 0x000088, "Member 'ULearningAgentsPolicy::Interactor' has a wrong offset!");
static_assert(offsetof(ULearningAgentsPolicy, EncoderNetwork) == 0x000090, "Member 'ULearningAgentsPolicy::EncoderNetwork' has a wrong offset!");
static_assert(offsetof(ULearningAgentsPolicy, PolicyNetwork) == 0x000098, "Member 'ULearningAgentsPolicy::PolicyNetwork' has a wrong offset!");
static_assert(offsetof(ULearningAgentsPolicy, DecoderNetwork) == 0x0000A0, "Member 'ULearningAgentsPolicy::DecoderNetwork' has a wrong offset!");
