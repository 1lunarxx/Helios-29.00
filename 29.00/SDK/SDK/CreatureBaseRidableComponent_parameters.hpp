...
struct CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature final
{
public:
...
static_assert(alignof(CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature) == 0x000008, "Wrong alignment on CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature");
static_assert(sizeof(CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature) == 0x000008, "Wrong size on CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature");
static_assert(offsetof(CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature, JumpPitchInterpSpeed) == 0x000000, "Member 'CreatureBaseRidableComponent_C_AudioOnJump__DelegateSignature::JumpPitchInterpSpeed' has a wrong offset!");
...
struct CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature final
{
public:
...
static_assert(alignof(CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature) == 0x000010, "Wrong alignment on CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature");
static_assert(sizeof(CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature) == 0x0000E0, "Wrong size on CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature");
static_assert(offsetof(CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature, Name_0) == 0x000000, "Member 'CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature::Name_0' has a wrong offset!");
static_assert(offsetof(CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature, Icon) == 0x000020, "Member 'CreatureBaseRidableComponent_C_RidableUIStart__DelegateSignature::Icon' has a wrong offset!");

// Function CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.RidableUIUpdateEnergy__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature final
{
public:
	double                                        Energy;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsResting;                                        // 0x0008(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature) == 0x000008, "Wrong alignment on CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature");
static_assert(sizeof(CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature) == 0x000010, "Wrong size on CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature");
static_assert(offsetof(CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature, Energy) == 0x000000, "Member 'CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature::Energy' has a wrong offset!");
static_assert(offsetof(CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature, bIsResting) == 0x000008, "Member 'CreatureBaseRidableComponent_C_RidableUIUpdateEnergy__DelegateSignature::bIsResting' has a wrong offset!");
