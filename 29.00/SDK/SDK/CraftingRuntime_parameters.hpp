...
static_assert(offsetof(CraftingObjectComponent_CraftingObjectOnFormulaCraftableChanged__DelegateSignature, FormulaRowName) == 0x000000, "Member 'CraftingObjectComponent_CraftingObjectOnFormulaCraftableChanged__DelegateSignature::FormulaRowName' has a wrong offset!");
static_assert(offsetof(CraftingObjectComponent_CraftingObjectOnFormulaCraftableChanged__DelegateSignature, bIsCraftable) == 0x000004, "Member 'CraftingObjectComponent_CraftingObjectOnFormulaCraftableChanged__DelegateSignature::bIsCraftable' has a wrong offset!");
