...
public:
	...
	E_UI_BadgeSize                                Temp_byte_Variable_1;                              // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	E_UI_BadgeSize                                Temp_byte_Variable_2;                              // 0x000D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	E_UI_BadgeType                                Temp_byte_Variable_3;                              // 0x000E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	E_UI_BadgeSize                                Temp_byte_Variable_4;                              // 0x000F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateFontInfo                         K2Node_Select_Default_3;                           // 0x0088(0x0058)(HasGetValueTypeHash)
	struct FSlateFontInfo                         K2Node_Select_Default_4;                           // 0x00E0(0x0058)(HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_UIKit_Badge_Base_C_RefreshBadge) == 0x000138, "Wrong size on WBP_UIKit_Badge_Base_C_RefreshBadge");
...
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, Temp_byte_Variable_1) == 0x00000C, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, Temp_byte_Variable_2) == 0x00000D, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, Temp_byte_Variable_3) == 0x00000E, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, Temp_byte_Variable_4) == 0x00000F, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::Temp_byte_Variable_4' has a wrong offset!");
...
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, K2Node_Select_Default_2) == 0x000030, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, K2Node_Select_Default_3) == 0x000088, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Badge_Base_C_RefreshBadge, K2Node_Select_Default_4) == 0x0000E0, "Member 'WBP_UIKit_Badge_Base_C_RefreshBadge::K2Node_Select_Default_4' has a wrong offset!");
