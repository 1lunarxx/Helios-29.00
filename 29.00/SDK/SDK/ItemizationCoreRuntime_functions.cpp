...
TArray<class UClass*> UItemDefinitionBase::GetDisallowedComponents() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemDefinitionBase", "GetDisallowedComponents");

	Params::ItemDefinitionBase_GetDisallowedComponents Parms{};
...
TArray<class UClass*> UItemizationLootCountCalculator_SetAttribute::GetAllowedItemAttributeClasses() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemizationLootCountCalculator_SetAttribute", "GetAllowedItemAttributeClasses");

	Params::ItemizationLootCountCalculator_SetAttribute_GetAllowedItemAttributeClasses Parms{};
...
TArray<class UClass*> UItemizationLootCountCalculator_SetAttribute::GetDisallowedItemAttributeClasses() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemizationLootCountCalculator_SetAttribute", "GetDisallowedItemAttributeClasses");

	Params::ItemizationLootCountCalculator_SetAttribute_GetDisallowedItemAttributeClasses Parms{};
