...
static_assert(sizeof(FJamLoadResult) == 0x000028, "Wrong size on FJamLoadResult");
...
static_assert(offsetof(FJamLoadResult, ItemDef) == 0x000018, "Member 'FJamLoadResult::ItemDef' has a wrong offset!");
