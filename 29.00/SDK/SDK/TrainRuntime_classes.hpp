...
static_assert(offsetof(UFortTrainManager, CachedAudioShapeLineList) == 0x000238, "Member 'UFortTrainManager::CachedAudioShapeLineList' has a wrong offset!");
...
static_assert(offsetof(AFortTrainRail, SplineComponent) == 0x0002B0, "Member 'AFortTrainRail::SplineComponent' has a wrong offset!");
