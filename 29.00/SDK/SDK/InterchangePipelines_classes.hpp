...
static_assert(sizeof(UInterchangeGenericAssetsPipeline) == 0x000278, "Wrong size on UInterchangeGenericAssetsPipeline");
...
static_assert(offsetof(UInterchangeGenericMaterialPipeline, TexturePipeline) == 0x000150, "Member 'UInterchangeGenericMaterialPipeline::TexturePipeline' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, BaseNodeContainer) == 0x000158, "Member 'UInterchangeGenericMaterialPipeline::BaseNodeContainer' has a wrong offset!");
...
static_assert(offsetof(UInterchangeGenericMeshPipeline, bImportCollision) == 0x000120, "Member 'UInterchangeGenericMeshPipeline::bImportCollision' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bImportCollisionAccordingToMeshName) == 0x000121, "Member 'UInterchangeGenericMeshPipeline::bImportCollisionAccordingToMeshName' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bOneConvexHullPerUCX) == 0x000122, "Member 'UInterchangeGenericMeshPipeline::bOneConvexHullPerUCX' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bBuildNanite) == 0x000123, "Member 'UInterchangeGenericMeshPipeline::bBuildNanite' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bBuildReversedIndexBuffer) == 0x000124, "Member 'UInterchangeGenericMeshPipeline::bBuildReversedIndexBuffer' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bGenerateLightmapUVs) == 0x000125, "Member 'UInterchangeGenericMeshPipeline::bGenerateLightmapUVs' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bGenerateDistanceFieldAsIfTwoSided) == 0x000126, "Member 'UInterchangeGenericMeshPipeline::bGenerateDistanceFieldAsIfTwoSided' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bSupportFaceRemap) == 0x000127, "Member 'UInterchangeGenericMeshPipeline::bSupportFaceRemap' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, MinLightmapResolution) == 0x000128, "Member 'UInterchangeGenericMeshPipeline::MinLightmapResolution' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, SrcLightmapIndex) == 0x00012C, "Member 'UInterchangeGenericMeshPipeline::SrcLightmapIndex' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, DstLightmapIndex) == 0x000130, "Member 'UInterchangeGenericMeshPipeline::DstLightmapIndex' has a wrong offset!");
