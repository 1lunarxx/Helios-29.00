...
{
public:
	struct FPerPlatformBool                       EnableRequestedFullBodyPBAByDefault;               // 0x0530(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformBool                       EnableSkydivingFullBodyPBAByDefault;               // 0x0531(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformBool                       EnableDBNOCarriedFullBodyPBAByDefault;             // 0x0532(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformBool                       SkydivingEnablePhysicsBasedAnimationByDefault;     // 0x0533(0x0001)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ULocomotionInitiativeGameFeatureData, EnableRequestedFullBodyPBAByDefault) == 0x000530, "Member 'ULocomotionInitiativeGameFeatureData::EnableRequestedFullBodyPBAByDefault' has a wrong offset!");
static_assert(offsetof(ULocomotionInitiativeGameFeatureData, EnableSkydivingFullBodyPBAByDefault) == 0x000531, "Member 'ULocomotionInitiativeGameFeatureData::EnableSkydivingFullBodyPBAByDefault' has a wrong offset!");
static_assert(offsetof(ULocomotionInitiativeGameFeatureData, EnableDBNOCarriedFullBodyPBAByDefault) == 0x000532, "Member 'ULocomotionInitiativeGameFeatureData::EnableDBNOCarriedFullBodyPBAByDefault' has a wrong offset!");
static_assert(offsetof(ULocomotionInitiativeGameFeatureData, SkydivingEnablePhysicsBasedAnimationByDefault) == 0x000533, "Member 'ULocomotionInitiativeGameFeatureData::SkydivingEnablePhysicsBasedAnimationByDefault' has a wrong offset!");
