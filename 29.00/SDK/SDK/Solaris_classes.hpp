...
static_assert(offsetof(UVerseDigest, ClassImports) == 0x000058, "Member 'UVerseDigest::ClassImports' has a wrong offset!");
static_assert(offsetof(UVerseDigest, ProjectName) == 0x0000A8, "Member 'UVerseDigest::ProjectName' has a wrong offset!");
static_assert(offsetof(UVerseDigest, Variant) == 0x0000B8, "Member 'UVerseDigest::Variant' has a wrong offset!");
static_assert(offsetof(UVerseDigest, VerseVersion) == 0x0000BC, "Member 'UVerseDigest::VerseVersion' has a wrong offset!");
...
static_assert(sizeof(UVerseClass) == 0x000338, "Wrong size on UVerseClass");
...
static_assert(offsetof(UVerseClass, VarAccessors) == 0x0002E0, "Member 'UVerseClass::VarAccessors' has a wrong offset!");
static_assert(offsetof(UVerseClass, ConstructorEffects) == 0x000330, "Member 'UVerseClass::ConstructorEffects' has a wrong offset!");
