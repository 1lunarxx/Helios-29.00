...
public:
	...
	FMulticastInlineDelegateProperty_             OnWorldKeyGranted;                                 // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnWorldKeyRevoked;                                 // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	void GrantWorldKey();
	void KickWorldUser();
	void OnWorldKeyGranted__DelegateSignature();
	void OnWorldKeyRevoked__DelegateSignature();
...
{
public:
	FMulticastInlineDelegateProperty_             OnTextureUpdated;                                  // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
