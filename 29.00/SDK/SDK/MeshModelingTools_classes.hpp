...
static_assert(offsetof(UEditMeshPolygonsTool, TopologyProperties) == 0x000180, "Member 'UEditMeshPolygonsTool::TopologyProperties' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeActivity) == 0x000188, "Member 'UEditMeshPolygonsTool::ExtrudeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsetOutsetActivity) == 0x000190, "Member 'UEditMeshPolygonsTool::InsetOutsetActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, CutFacesActivity) == 0x000198, "Member 'UEditMeshPolygonsTool::CutFacesActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, PlanarProjectionUVActivity) == 0x0001A0, "Member 'UEditMeshPolygonsTool::PlanarProjectionUVActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsertEdgeActivity) == 0x0001A8, "Member 'UEditMeshPolygonsTool::InsertEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsertEdgeLoopActivity) == 0x0001B0, "Member 'UEditMeshPolygonsTool::InsertEdgeLoopActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, BevelEdgeActivity) == 0x0001B8, "Member 'UEditMeshPolygonsTool::BevelEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeEdgeActivity) == 0x0001C0, "Member 'UEditMeshPolygonsTool::ExtrudeEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ActivityContext) == 0x0002A0, "Member 'UEditMeshPolygonsTool::ActivityContext' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SelectionMechanic) == 0x0002A8, "Member 'UEditMeshPolygonsTool::SelectionMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, DragAlignmentMechanic) == 0x0002B0, "Member 'UEditMeshPolygonsTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformGizmo) == 0x0002B8, "Member 'UEditMeshPolygonsTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformProxy) == 0x0002C0, "Member 'UEditMeshPolygonsTool::TransformProxy' has a wrong offset!");
