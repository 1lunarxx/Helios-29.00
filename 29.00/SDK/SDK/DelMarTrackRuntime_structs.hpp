...
public:
	...
	bool                                          bUseStableRoll;                                    // 0x0009(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseFrontEndcap;                                   // 0x000A(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseBackEndcap;                                    // 0x000B(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FDelMarSplinePointMetaData, TrackRadius) == 0x000004, "Member 'FDelMarSplinePointMetaData::TrackRadius' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, bForceValidTrack) == 0x000008, "Member 'FDelMarSplinePointMetaData::bForceValidTrack' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, bUseStableRoll) == 0x000009, "Member 'FDelMarSplinePointMetaData::bUseStableRoll' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, bUseFrontEndcap) == 0x00000A, "Member 'FDelMarSplinePointMetaData::bUseFrontEndcap' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, bUseBackEndcap) == 0x00000B, "Member 'FDelMarSplinePointMetaData::bUseBackEndcap' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, SegmentClass) == 0x000010, "Member 'FDelMarSplinePointMetaData::SegmentClass' has a wrong offset!");
static_assert(offsetof(FDelMarSplinePointMetaData, EnabledMeshCustomizations) == 0x000030, "Member 'FDelMarSplinePointMetaData::EnabledMeshCustomizations' has a wrong offset!");
