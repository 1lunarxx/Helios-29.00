...
static_assert(sizeof(FPropertyBindingPathSegment) == 0x000010, "Wrong size on FPropertyBindingPathSegment");
...
static_assert(offsetof(FPropertyBindingPathSegment, ArrayIndex) == 0x000004, "Member 'FPropertyBindingPathSegment::ArrayIndex' has a wrong offset!");
static_assert(offsetof(FPropertyBindingPathSegment, InstanceStruct) == 0x000008, "Member 'FPropertyBindingPathSegment::InstanceStruct' has a wrong offset!");
