...
public:
	...
	struct FSlateColor                            PrimaryColor;                                      // 0x0908(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateColor                            ShadowColor;                                       // 0x091C(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateColor                            HighlightColor;                                    // 0x0930(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          DEVhasBranding;                                    // 0x0944(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UShowdownLobbyPanel_C) == 0x000948, "Wrong size on UShowdownLobbyPanel_C");
...
static_assert(offsetof(UShowdownLobbyPanel_C, PrimaryColor) == 0x000908, "Member 'UShowdownLobbyPanel_C::PrimaryColor' has a wrong offset!");
static_assert(offsetof(UShowdownLobbyPanel_C, ShadowColor) == 0x00091C, "Member 'UShowdownLobbyPanel_C::ShadowColor' has a wrong offset!");
static_assert(offsetof(UShowdownLobbyPanel_C, HighlightColor) == 0x000930, "Member 'UShowdownLobbyPanel_C::HighlightColor' has a wrong offset!");
static_assert(offsetof(UShowdownLobbyPanel_C, DEVhasBranding) == 0x000944, "Member 'UShowdownLobbyPanel_C::DEVhasBranding' has a wrong offset!");
