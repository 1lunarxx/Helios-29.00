...
static_assert(sizeof(AFrontendCamera_Main_C) == 0x000A20, "Wrong size on AFrontendCamera_Main_C");
static_assert(offsetof(AFrontendCamera_Main_C, UberGraphFrame) == 0x000A10, "Member 'AFrontendCamera_Main_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Main_C, LoginCamera_0) == 0x000A18, "Member 'AFrontendCamera_Main_C::LoginCamera_0' has a wrong offset!");
