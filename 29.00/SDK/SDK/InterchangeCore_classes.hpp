...
static_assert(sizeof(UInterchangeResultWarning_Generic) == 0x000088, "Wrong size on UInterchangeResultWarning_Generic");
...
static_assert(sizeof(UInterchangeResultError_Generic) == 0x000088, "Wrong size on UInterchangeResultError_Generic");
...
static_assert(sizeof(UInterchangeResultDisplay_Generic) == 0x000088, "Wrong size on UInterchangeResultDisplay_Generic");
