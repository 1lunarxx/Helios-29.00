...
void UPoseSearchTrajectoryLibrary::HandleTrajectoryWorldCollisions(const class UObject* WorldContextObject, const struct FPoseSearchQueryTrajectory& InTrajectory, struct FPoseSearchQueryTrajectory* OutTrajectory, ETraceTypeQuery TraceChannel, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, EDrawDebugTrace DrawDebugType, bool bIgnoreSelf, const struct FLinearColor& TraceColor, const struct FLinearColor& TraceHitColor, float DrawTime)
{
	static class UFunction* Func = nullptr;
...
// bool                                    bAlwaysApplyGravity                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UPoseSearchTrajectoryLibrary::PoseSearchGenerateTrajectory(const class UAnimInstance* InAnimInstance, const struct FPoseSearchTrajectoryData& InTrajectoryData, float InDeltaTime, struct FPoseSearchQueryTrajectory& InOutTrajectory, float& InOutDesiredControllerYawLastUpdate, struct FPoseSearchQueryTrajectory* OutTrajectory, float InHistorySamplingInterval, int32 InTrajectoryHistoryCount, float InPredictionSamplingInterval, int32 InTrajectoryPredictionCount, bool bAlwaysApplyGravity)
{
	...
	Parms.bAlwaysApplyGravity = bAlwaysApplyGravity;
...
// struct FPoseSearchFutureProperties      Future                                                 (Parm, NoDestructor, NativeAccessSpecifierPublic)
// struct FPoseSearchBlueprintResult       Result                                                 (Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
...
void UPoseSearchLibrary::MotionMatch(class UAnimInstance* AnimInstance, const TArray<class UObject*>& AssetsToSearch, const class FName PoseHistoryName, const struct FPoseSearchFutureProperties& Future, struct FPoseSearchBlueprintResult* Result, const int32 DebugSessionUniqueIdentifier)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// TArray<class ACharacter*>               AnimInstances                                          (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
void UPoseSearchLibrary::MotionMatchMulti(const TArray<class ACharacter*>& AnimInstances, const TArray<class FName>& Roles, const TArray<class UObject*>& AssetsToSearch, const class FName PoseHistoryName, struct FPoseSearchBlueprintResult* Result, const int32 DebugSessionUniqueIdentifier)
{
	static class UFunction* Func = nullptr;
	...
	Parms.AnimInstances = std::move(AnimInstances);
