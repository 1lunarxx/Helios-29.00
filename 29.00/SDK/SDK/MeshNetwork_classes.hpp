...
public:
	...
	TArray<class AActor*>                         ClientDormantDynamicActors;                        // 0x08F0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMeshNetDriver) == 0x000900, "Wrong size on UMeshNetDriver");
static_assert(offsetof(UMeshNetDriver, ClientDormantDynamicActors) == 0x0008F0, "Member 'UMeshNetDriver::ClientDormantDynamicActors' has a wrong offset!");
