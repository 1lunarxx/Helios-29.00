...
public:
	...
	class UAtomPrimitiveGeometryContainer*        ReturnValue;                                       // 0x0010(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AtomPrimitive_GetGeometryContainerForBestExportStyle) == 0x000018, "Wrong size on AtomPrimitive_GetGeometryContainerForBestExportStyle");
...
static_assert(offsetof(AtomPrimitive_GetGeometryContainerForBestExportStyle, ReturnValue) == 0x000010, "Member 'AtomPrimitive_GetGeometryContainerForBestExportStyle::ReturnValue' has a wrong offset!");
