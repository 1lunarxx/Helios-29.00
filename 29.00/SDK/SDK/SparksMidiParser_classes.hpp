...
public:
	void OnFinished__DelegateSignature(const bool bCanceled);
...
public:
	...
	void OnMidiNoteEventDelegate__DelegateSignature(const uint8 MidiEventNote, const struct FParsedMidiNoteEvent& MidiEventData);
...
public:
	...
	void OnMidiTextEventDelegate__DelegateSignature(const class FString& MidiEventText, const struct FParsedMidiTextEvent& MidiEventData);
...
public:
	...
	void OnMidiNotePoolEventDelegate__DelegateSignature(const uint8 MidiNote, const struct FParsedMidiNoteEvent& MidiNoteData, const class FName WaitPoolID, const float ActualDelay, const float MaxDelayShortenedBy);
