...
void UDelMarMatchEventViewModel::OnMatchEventOccured__DelegateSignature(class AFortPlayerState* PlayerState, const struct FGameplayTag& EventTag, const class FString& Context)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarMatchEventViewModel", "OnMatchEventOccured__DelegateSignature");

	Params::DelMarMatchEventViewModel_OnMatchEventOccured__DelegateSignature Parms{};
...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// class UWidgetTransitioner*              Transitioner                                           (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EWidgetTransitionerStatus               Status                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetTransitioner::WidgetTransitionerStatusChange__DelegateSignature(class UWidgetTransitioner* Transitioner, EWidgetTransitionerStatus Status)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WidgetTransitioner", "WidgetTransitionerStatusChange__DelegateSignature");

	Params::WidgetTransitioner_WidgetTransitionerStatusChange__DelegateSignature Parms{};

	Parms.Transitioner = Transitioner;
	Parms.Status = Status;
...
void UDelMarActionWidget::OnInputMethodChanged__DelegateSignature(bool bUsingGamepad)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarActionWidget", "OnInputMethodChanged__DelegateSignature");

	Params::DelMarActionWidget_OnInputMethodChanged__DelegateSignature Parms{};
