...
public:
	...
	class FText                                   ButtonLabel;                                       // 0x02E8(0x0018)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	class FText                                   ButtonDescription;                                 // 0x0300(0x0018)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0318(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	bool                                          bEnabled;                                          // 0x0338(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHovered;                                          // 0x0339(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bPressed;                                          // 0x033A(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ECheckBoxState                                ToggleState;                                       // 0x033B(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_33C[0x4];                                      // 0x033C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFabricInteractableViewModel*           WidgetViewModel;                                   // 0x0340(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AFabricButtonBase) == 0x000348, "Wrong size on AFabricButtonBase");
static_assert(offsetof(AFabricButtonBase, ToggleStateChanged) == 0x0002A8, "Member 'AFabricButtonBase::ToggleStateChanged' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, OpenTimeSeconds) == 0x0002B8, "Member 'AFabricButtonBase::OpenTimeSeconds' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, CloseTimeSeconds) == 0x0002C0, "Member 'AFabricButtonBase::CloseTimeSeconds' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, bHasToggle) == 0x0002C8, "Member 'AFabricButtonBase::bHasToggle' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, ClickMethod) == 0x0002C9, "Member 'AFabricButtonBase::ClickMethod' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, InteractingController) == 0x0002D0, "Member 'AFabricButtonBase::InteractingController' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, ButtonId) == 0x0002D8, "Member 'AFabricButtonBase::ButtonId' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, ButtonLabel) == 0x0002E8, "Member 'AFabricButtonBase::ButtonLabel' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, ButtonDescription) == 0x000300, "Member 'AFabricButtonBase::ButtonDescription' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, GameplayTags) == 0x000318, "Member 'AFabricButtonBase::GameplayTags' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, bEnabled) == 0x000338, "Member 'AFabricButtonBase::bEnabled' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, bHovered) == 0x000339, "Member 'AFabricButtonBase::bHovered' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, bPressed) == 0x00033A, "Member 'AFabricButtonBase::bPressed' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, ToggleState) == 0x00033B, "Member 'AFabricButtonBase::ToggleState' has a wrong offset!");
static_assert(offsetof(AFabricButtonBase, WidgetViewModel) == 0x000340, "Member 'AFabricButtonBase::WidgetViewModel' has a wrong offset!");
...
public:
	...
	class FText                                   ButtonDescription;                                 // 0x0628(0x0018)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFabricButtonComponentBase) == 0x000690, "Wrong size on UFabricButtonComponentBase");
...
static_assert(offsetof(UFabricButtonComponentBase, ButtonDescription) == 0x000628, "Member 'UFabricButtonComponentBase::ButtonDescription' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, GameplayTags) == 0x000640, "Member 'UFabricButtonComponentBase::GameplayTags' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, bUseScreenGrid) == 0x000660, "Member 'UFabricButtonComponentBase::bUseScreenGrid' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, ScreenGridPosition) == 0x000668, "Member 'UFabricButtonComponentBase::ScreenGridPosition' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, bEnabled) == 0x000678, "Member 'UFabricButtonComponentBase::bEnabled' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, bHovered) == 0x000679, "Member 'UFabricButtonComponentBase::bHovered' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, bPressed) == 0x00067A, "Member 'UFabricButtonComponentBase::bPressed' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, ToggleState) == 0x00067B, "Member 'UFabricButtonComponentBase::ToggleState' has a wrong offset!");
static_assert(offsetof(UFabricButtonComponentBase, WidgetViewModel) == 0x000680, "Member 'UFabricButtonComponentBase::WidgetViewModel' has a wrong offset!");
...
public:
	void OnFloatChanged__DelegateSignature(float Float);
...
public:
	...
	FMulticastInlineDelegateProperty_             OnFloatProviderStepInitialized;                    // 0x03C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UFabricInteractableControllerComponent, FabricInteractionToolItemDefSoftPtr) == 0x0000C0, "Member 'UFabricInteractableControllerComponent::FabricInteractionToolItemDefSoftPtr' has a wrong offset!");
static_assert(offsetof(UFabricInteractableControllerComponent, OverriddenFabricInteractionToolItemDefSoftPtr) == 0x0000E0, "Member 'UFabricInteractableControllerComponent::OverriddenFabricInteractionToolItemDefSoftPtr' has a wrong offset!");
static_assert(offsetof(UFabricInteractableControllerComponent, FabricInteractionToolItemDef) == 0x000100, "Member 'UFabricInteractableControllerComponent::FabricInteractionToolItemDef' has a wrong offset!");
static_assert(offsetof(UFabricInteractableControllerComponent, EnsurePlayerHasInteractionToolRetryDelay) == 0x000108, "Member 'UFabricInteractableControllerComponent::EnsurePlayerHasInteractionToolRetryDelay' has a wrong offset!");
static_assert(offsetof(UFabricInteractableControllerComponent, SoftFabricDeviceBaseClass) == 0x000120, "Member 'UFabricInteractableControllerComponent::SoftFabricDeviceBaseClass' has a wrong offset!");
...
// 0x0198 (0x16E8 - 0x1550)
class AFabricInteractionTool final : public AFortWeapon
{
public:
	FMulticastInlineDelegateProperty_             OnInteractionStateChanged;                         // 0x1550(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCablesGrabbed;                                   // 0x1560(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCablesDropped;                                   // 0x1570(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMetasoundGeneratorCrossfadeStarted;              // 0x1580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class USplineComponent*                       SplineComponent;                                   // 0x1590(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxRange;                                          // 0x1598(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MinDragAndDropTriggerTime;                         // 0x159C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FiringRate;                                        // 0x15A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SplineEndForwardMultiplier;                        // 0x15A4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SplineStartForwardMultiplier;                      // 0x15A8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_15AC[0x4];                                     // 0x15AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                HoveredInteractable;                               // 0x15B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                        HoveredInteractableHitComponent;                   // 0x15B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UObject*                                PressedInteractable;                               // 0x15C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TWeakObjectPtr<class UObject>                 LastPressedInteractable;                           // 0x15C8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                        PressedInteractableHitComponent;                   // 0x15D0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TWeakObjectPtr<class AFortCreativeDeviceProp> InteractableOwnerDevice;                           // 0x15D8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AccumulatedDragAndDropTriggerTime;                 // 0x15E0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FInteractionData                       ServerInteractionData;                             // 0x15E4(0x000C)(Net, Transient, RepNotify, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_15F0[0x11];                                    // 0x15F0(0x0011)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bServerTriggerPressed;                             // 0x1601(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1602[0x1];                                     // 0x1602(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bServerIsHoldingCable;                             // 0x1603(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1604[0x14];                                    // 0x1604(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInteractionSplinePoints               ServerSplinePoints;                                // 0x1618(0x0060)(Net, Transient, NoDestructor, NativeAccessSpecifierPrivate)
	float                                         ServerContinuousInteractableValue;                 // 0x1678(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_167C[0x6C];                                    // 0x167C(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFabricInteractionTool) == 0x0016E8, "Wrong size on AFabricInteractionTool");
static_assert(offsetof(AFabricInteractionTool, OnInteractionStateChanged) == 0x001550, "Member 'AFabricInteractionTool::OnInteractionStateChanged' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, OnCablesGrabbed) == 0x001560, "Member 'AFabricInteractionTool::OnCablesGrabbed' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, OnCablesDropped) == 0x001570, "Member 'AFabricInteractionTool::OnCablesDropped' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, OnMetasoundGeneratorCrossfadeStarted) == 0x001580, "Member 'AFabricInteractionTool::OnMetasoundGeneratorCrossfadeStarted' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, SplineComponent) == 0x001590, "Member 'AFabricInteractionTool::SplineComponent' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, MaxRange) == 0x001598, "Member 'AFabricInteractionTool::MaxRange' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, MinDragAndDropTriggerTime) == 0x00159C, "Member 'AFabricInteractionTool::MinDragAndDropTriggerTime' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, FiringRate) == 0x0015A0, "Member 'AFabricInteractionTool::FiringRate' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, SplineEndForwardMultiplier) == 0x0015A4, "Member 'AFabricInteractionTool::SplineEndForwardMultiplier' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, SplineStartForwardMultiplier) == 0x0015A8, "Member 'AFabricInteractionTool::SplineStartForwardMultiplier' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, HoveredInteractable) == 0x0015B0, "Member 'AFabricInteractionTool::HoveredInteractable' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, HoveredInteractableHitComponent) == 0x0015B8, "Member 'AFabricInteractionTool::HoveredInteractableHitComponent' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, PressedInteractable) == 0x0015C0, "Member 'AFabricInteractionTool::PressedInteractable' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, LastPressedInteractable) == 0x0015C8, "Member 'AFabricInteractionTool::LastPressedInteractable' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, PressedInteractableHitComponent) == 0x0015D0, "Member 'AFabricInteractionTool::PressedInteractableHitComponent' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, InteractableOwnerDevice) == 0x0015D8, "Member 'AFabricInteractionTool::InteractableOwnerDevice' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, AccumulatedDragAndDropTriggerTime) == 0x0015E0, "Member 'AFabricInteractionTool::AccumulatedDragAndDropTriggerTime' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, ServerInteractionData) == 0x0015E4, "Member 'AFabricInteractionTool::ServerInteractionData' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, bServerTriggerPressed) == 0x001601, "Member 'AFabricInteractionTool::bServerTriggerPressed' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, bServerIsHoldingCable) == 0x001603, "Member 'AFabricInteractionTool::bServerIsHoldingCable' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, ServerSplinePoints) == 0x001618, "Member 'AFabricInteractionTool::ServerSplinePoints' has a wrong offset!");
static_assert(offsetof(AFabricInteractionTool, ServerContinuousInteractableValue) == 0x001678, "Member 'AFabricInteractionTool::ServerContinuousInteractableValue' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnSimpleSignalBindingUpdate;                       // 0x0428(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	...
	FMulticastInlineDelegateProperty_             OnMetaSoundOutputIntChangedBatch;                  // 0x04B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMetaSoundOutputFloatChangedBatch;                // 0x04C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnFabricMetaSoundDrumPlayerPatchDrumAmplitudesUpdate; // 0x0710(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnFabricMetaSoundDrumPlayerSampleBanksLoaded;      // 0x0720(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnWetDryOutputSignalUpdate;                        // 0x0738(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
{
public:
	FMulticastInlineDelegateProperty_             OnFFTResultsUpdated;                               // 0x06A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPatchWrapperVisibilityChanged;                   // 0x06B8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnMetasoundGeneratorCrossfadeStarted;              // 0x0238(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_248[0x78];                                     // 0x0248(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnMusicEventPriorityChanged;                       // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class FString>                         TriggerNoteParams;                                 // 0x06B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMatchingMidiEventPassed;                         // 0x06C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D0[0x18];                                     // 0x06D0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFabricNoteReceivedPatchWrapper) == 0x0006E8, "Wrong size on UFabricNoteReceivedPatchWrapper");
static_assert(offsetof(UFabricNoteReceivedPatchWrapper, NoteOutputName) == 0x0006A8, "Member 'UFabricNoteReceivedPatchWrapper::NoteOutputName' has a wrong offset!");
static_assert(offsetof(UFabricNoteReceivedPatchWrapper, TriggerNoteParams) == 0x0006B0, "Member 'UFabricNoteReceivedPatchWrapper::TriggerNoteParams' has a wrong offset!");
static_assert(offsetof(UFabricNoteReceivedPatchWrapper, OnMatchingMidiEventPassed) == 0x0006C0, "Member 'UFabricNoteReceivedPatchWrapper::OnMatchingMidiEventPassed' has a wrong offset!");
...
{
public:
	class FString                                 OctaveParam;                                       // 0x06E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnyMidiEventPassed;                              // 0x06F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UFabricNoteTriggerPatchWrapper, OctaveParam) == 0x0006E8, "Member 'UFabricNoteTriggerPatchWrapper::OctaveParam' has a wrong offset!");
static_assert(offsetof(UFabricNoteTriggerPatchWrapper, OnAnyMidiEventPassed) == 0x0006F8, "Member 'UFabricNoteTriggerPatchWrapper::OnAnyMidiEventPassed' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnFabricMetaSoundSpeakerPatchEqBandUpdate;         // 0x06C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
{
public:
	class FName                                   MidiTrackIndexUserOptionName;                      // 0x06E8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6EC[0x4];                                      // 0x06EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMidiFile*                              CurrentMidiFile;                                   // 0x06F0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         CurrentMidiTrackIndex;                             // 0x06F8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFabricMIDIPlayerPatchWrapper) == 0x000700, "Wrong size on UFabricMIDIPlayerPatchWrapper");
static_assert(offsetof(UFabricMIDIPlayerPatchWrapper, MidiTrackIndexUserOptionName) == 0x0006E8, "Member 'UFabricMIDIPlayerPatchWrapper::MidiTrackIndexUserOptionName' has a wrong offset!");
static_assert(offsetof(UFabricMIDIPlayerPatchWrapper, CurrentMidiFile) == 0x0006F0, "Member 'UFabricMIDIPlayerPatchWrapper::CurrentMidiFile' has a wrong offset!");
static_assert(offsetof(UFabricMIDIPlayerPatchWrapper, CurrentMidiTrackIndex) == 0x0006F8, "Member 'UFabricMIDIPlayerPatchWrapper::CurrentMidiTrackIndex' has a wrong offset!");
...
static_assert(offsetof(UFabricSteppedPreviewFXComponent, NumberOfSteps) == 0x000958, "Member 'UFabricSteppedPreviewFXComponent::NumberOfSteps' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, bManuallySpaceMeshInstances) == 0x00095C, "Member 'UFabricSteppedPreviewFXComponent::bManuallySpaceMeshInstances' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, bAlignToTransformCenter) == 0x00095D, "Member 'UFabricSteppedPreviewFXComponent::bAlignToTransformCenter' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, CenterAlignmentBounds) == 0x000960, "Member 'UFabricSteppedPreviewFXComponent::CenterAlignmentBounds' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, DistanceBetweenInstances) == 0x000964, "Member 'UFabricSteppedPreviewFXComponent::DistanceBetweenInstances' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, DistanceBetweenTripletIntances) == 0x000968, "Member 'UFabricSteppedPreviewFXComponent::DistanceBetweenTripletIntances' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, DistanceBetweenInstanceSets) == 0x00096C, "Member 'UFabricSteppedPreviewFXComponent::DistanceBetweenInstanceSets' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, DistanceBetweenTripletInstanceSets) == 0x000970, "Member 'UFabricSteppedPreviewFXComponent::DistanceBetweenTripletInstanceSets' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, NoteStyle) == 0x000974, "Member 'UFabricSteppedPreviewFXComponent::NoteStyle' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, CPDDeviceEnabled) == 0x000978, "Member 'UFabricSteppedPreviewFXComponent::CPDDeviceEnabled' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, CPDNumSteps) == 0x00097C, "Member 'UFabricSteppedPreviewFXComponent::CPDNumSteps' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, PICDNoteOn) == 0x000980, "Member 'UFabricSteppedPreviewFXComponent::PICDNoteOn' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, PICDNoteLength) == 0x000984, "Member 'UFabricSteppedPreviewFXComponent::PICDNoteLength' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, PICDSpanLength) == 0x000988, "Member 'UFabricSteppedPreviewFXComponent::PICDSpanLength' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, PICDNoteTime) == 0x00098C, "Member 'UFabricSteppedPreviewFXComponent::PICDNoteTime' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, PICDGenericFloatIndex) == 0x000990, "Member 'UFabricSteppedPreviewFXComponent::PICDGenericFloatIndex' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, LengthStepBeats) == 0x000994, "Member 'UFabricSteppedPreviewFXComponent::LengthStepBeats' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, StepLengthQuarterNotes) == 0x000998, "Member 'UFabricSteppedPreviewFXComponent::StepLengthQuarterNotes' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, StepBeatScale) == 0x00099C, "Member 'UFabricSteppedPreviewFXComponent::StepBeatScale' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, StepBeatOffset) == 0x0009A0, "Member 'UFabricSteppedPreviewFXComponent::StepBeatOffset' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, LengthTrackBeats) == 0x0009A4, "Member 'UFabricSteppedPreviewFXComponent::LengthTrackBeats' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, InstanceSpace) == 0x0009A8, "Member 'UFabricSteppedPreviewFXComponent::InstanceSpace' has a wrong offset!");
static_assert(offsetof(UFabricSteppedPreviewFXComponent, InstanceSetSpace) == 0x0009B0, "Member 'UFabricSteppedPreviewFXComponent::InstanceSetSpace' has a wrong offset!");
...
static_assert(offsetof(UFabricSequencerPreviewFXComponent, StepSequencer) == 0x0009C0, "Member 'UFabricSequencerPreviewFXComponent::StepSequencer' has a wrong offset!");
static_assert(offsetof(UFabricSequencerPreviewFXComponent, StepSequencerGrid) == 0x0009C8, "Member 'UFabricSequencerPreviewFXComponent::StepSequencerGrid' has a wrong offset!");
...
static_assert(offsetof(UFabricSequencerSustainComponent, StepToInstanceMapping) == 0x000958, "Member 'UFabricSequencerSustainComponent::StepToInstanceMapping' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, PICDStartBeat) == 0x0009A8, "Member 'UFabricSequencerSustainComponent::PICDStartBeat' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, PICDEndBeat) == 0x0009AC, "Member 'UFabricSequencerSustainComponent::PICDEndBeat' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, PICDLoopBeat) == 0x0009B0, "Member 'UFabricSequencerSustainComponent::PICDLoopBeat' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, CPDDeviceEnabled) == 0x0009B4, "Member 'UFabricSequencerSustainComponent::CPDDeviceEnabled' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, GridSquareExtents) == 0x0009B8, "Member 'UFabricSequencerSustainComponent::GridSquareExtents' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, SustainInstanceYLocation) == 0x0009BC, "Member 'UFabricSequencerSustainComponent::SustainInstanceYLocation' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, SustainInstanceYScale) == 0x0009C0, "Member 'UFabricSequencerSustainComponent::SustainInstanceYScale' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, SustainInstanceZScale) == 0x0009C4, "Member 'UFabricSequencerSustainComponent::SustainInstanceZScale' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, StepSequencer) == 0x0009C8, "Member 'UFabricSequencerSustainComponent::StepSequencer' has a wrong offset!");
static_assert(offsetof(UFabricSequencerSustainComponent, StepSequencerGrid) == 0x0009D0, "Member 'UFabricSequencerSustainComponent::StepSequencerGrid' has a wrong offset!");
