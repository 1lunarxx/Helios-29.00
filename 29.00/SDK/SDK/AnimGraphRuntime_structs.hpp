...
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0002F8, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0002F9, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x0002FA, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bUseExternalClothCollision) == 0x0002FB, "Member 'FAnimNode_RigidBody::bUseExternalClothCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceMinimumScale) == 0x000300, "Member 'FAnimNode_RigidBody::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, EvaluationResetTime) == 0x000304, "Member 'FAnimNode_RigidBody::EvaluationResetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationTiming) == 0x000309, "Member 'FAnimNode_RigidBody::SimulationTiming' has a wrong offset!");
