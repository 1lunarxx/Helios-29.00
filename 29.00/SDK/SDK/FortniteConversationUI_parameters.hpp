...
public:
	...
	int32                                         TokenReward;                                       // 0x00A4(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UTexture2D>              TokenRewardIcon;                                   // 0x00A8(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortQuestBrief_OnQuestInformationRecieved) == 0x0000C8, "Wrong size on FortQuestBrief_OnQuestInformationRecieved");
...
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, TokenReward) == 0x0000A4, "Member 'FortQuestBrief_OnQuestInformationRecieved::TokenReward' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, TokenRewardIcon) == 0x0000A8, "Member 'FortQuestBrief_OnQuestInformationRecieved::TokenRewardIcon' has a wrong offset!");
