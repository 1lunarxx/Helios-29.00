...
public:
	...
	class UWBP_UIKit_Block_Outline_C*             Block_Outline;                                     // 0x14E0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                 Image_Backing;                                     // 0x14F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	FMulticastInlineDelegateProperty_             OnTileFocused;                                     // 0x1850(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Block_Outline) == 0x0014E0, "Member 'UWBP_ItemShopTile_Base_C::Block_Outline' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_AnimatedWrap) == 0x0014E8, "Member 'UWBP_ItemShopTile_Base_C::Image_AnimatedWrap' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_Backing) == 0x0014F0, "Member 'UWBP_ItemShopTile_Base_C::Image_Backing' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_NextOffer) == 0x0014F8, "Member 'UWBP_ItemShopTile_Base_C::Image_NextOffer' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_Offer) == 0x001500, "Member 'UWBP_ItemShopTile_Base_C::Image_Offer' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_OffscreenOverlay) == 0x001508, "Member 'UWBP_ItemShopTile_Base_C::Image_OffscreenOverlay' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, Image_UnfocusedHovered) == 0x001510, "Member 'UWBP_ItemShopTile_Base_C::Image_UnfocusedHovered' has a wrong offset!");
static_assert(offsetof(UWBP_ItemShopTile_Base_C, LoadGuard_Image) == 0x001518, "Member 'UWBP_ItemShopTile_Base_C::LoadGuard_Image' has a wrong offset!");
