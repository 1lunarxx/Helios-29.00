...
static_assert(offsetof(ULiveLinkCustomTimeStep, bLockStepMode) == 0x00004C, "Member 'ULiveLinkCustomTimeStep::bLockStepMode' has a wrong offset!");
static_assert(offsetof(ULiveLinkCustomTimeStep, FrameRateDivider) == 0x000050, "Member 'ULiveLinkCustomTimeStep::FrameRateDivider' has a wrong offset!");
