...
{
public:
	TSoftObjectPtr<class UItemDefinition>         ItemDefinition;                                    // 0x0000(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FInventoryStartingItem, Amount) == 0x000020, "Member 'FInventoryStartingItem::Amount' has a wrong offset!");
...
static_assert(offsetof(FItemInstanceClassEntry, Class) == 0x000000, "Member 'FItemInstanceClassEntry::Class' has a wrong offset!");
...
static_assert(offsetof(FItemInstanceClassOverride, SortedOverrideList) == 0x000000, "Member 'FItemInstanceClassOverride::SortedOverrideList' has a wrong offset!");
...
static_assert(offsetof(FItemizationLootEntry, Item) == 0x000000, "Member 'FItemizationLootEntry::Item' has a wrong offset!");
...
static_assert(offsetof(FItemizationLootEntry_Guaranteed, Count) == 0x000008, "Member 'FItemizationLootEntry_Guaranteed::Count' has a wrong offset!");
...
static_assert(offsetof(FItemizationLootEntry_Chance, Count) == 0x000008, "Member 'FItemizationLootEntry_Chance::Count' has a wrong offset!");
static_assert(offsetof(FItemizationLootEntry_Chance, Weight) == 0x000010, "Member 'FItemizationLootEntry_Chance::Weight' has a wrong offset!");
static_assert(offsetof(FItemizationLootEntry_Chance, MaxSelectCount) == 0x000018, "Member 'FItemizationLootEntry_Chance::MaxSelectCount' has a wrong offset!");
