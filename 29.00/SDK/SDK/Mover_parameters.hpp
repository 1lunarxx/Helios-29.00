...
static_assert(offsetof(AirMovementUtils_ComputeControlledFreeMove, ReturnValue) == 0x000080, "Member 'AirMovementUtils_ComputeControlledFreeMove::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AirMovementUtils_IsValidLandingSpot) == 0x000218, "Wrong size on AirMovementUtils_IsValidLandingSpot");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, UpdatedComponent) == 0x000000, "Member 'AirMovementUtils_IsValidLandingSpot::UpdatedComponent' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, UpdatedPrimitive) == 0x000008, "Member 'AirMovementUtils_IsValidLandingSpot::UpdatedPrimitive' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, Location) == 0x000010, "Member 'AirMovementUtils_IsValidLandingSpot::Location' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, Hit) == 0x000028, "Member 'AirMovementUtils_IsValidLandingSpot::Hit' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, FloorSweepDistance) == 0x000110, "Member 'AirMovementUtils_IsValidLandingSpot::FloorSweepDistance' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, MaxWalkSlopeCosine) == 0x000114, "Member 'AirMovementUtils_IsValidLandingSpot::MaxWalkSlopeCosine' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, OutFloorResult) == 0x000118, "Member 'AirMovementUtils_IsValidLandingSpot::OutFloorResult' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_IsValidLandingSpot, ReturnValue) == 0x000210, "Member 'AirMovementUtils_IsValidLandingSpot::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AirMovementUtils_TryMoveToFallAlongSurface) == 0x0002C0, "Wrong size on AirMovementUtils_TryMoveToFallAlongSurface");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, UpdatedComponent) == 0x000000, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::UpdatedComponent' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, UpdatedPrimitive) == 0x000008, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::UpdatedPrimitive' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, MoverComponent) == 0x000010, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::MoverComponent' has a wrong offset!");
...
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, bHandleImpact) == 0x000160, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::bHandleImpact' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, FloorSweepDistance) == 0x000164, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::FloorSweepDistance' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, MaxWalkSlopeCosine) == 0x000168, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::MaxWalkSlopeCosine' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, OutFloorResult) == 0x000170, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::OutFloorResult' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, MoveRecord) == 0x000268, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::MoveRecord' has a wrong offset!");
static_assert(offsetof(AirMovementUtils_TryMoveToFallAlongSurface, ReturnValue) == 0x0002B0, "Member 'AirMovementUtils_TryMoveToFallAlongSurface::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(FloorQueryUtils_IsHitSurfaceWalkable) == 0x0000F0, "Wrong size on FloorQueryUtils_IsHitSurfaceWalkable");
...
static_assert(offsetof(FloorQueryUtils_IsHitSurfaceWalkable, MaxWalkSlopeCosine) == 0x0000E8, "Member 'FloorQueryUtils_IsHitSurfaceWalkable::MaxWalkSlopeCosine' has a wrong offset!");
static_assert(offsetof(FloorQueryUtils_IsHitSurfaceWalkable, ReturnValue) == 0x0000EC, "Member 'FloorQueryUtils_IsHitSurfaceWalkable::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GroundMovementUtils_CanStepUpOnHitSurface) == 0x0000F0, "Wrong size on GroundMovementUtils_CanStepUpOnHitSurface");
...
static_assert(offsetof(GroundMovementUtils_CanStepUpOnHitSurface, ReturnValue) == 0x0000E8, "Member 'GroundMovementUtils_CanStepUpOnHitSurface::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GroundMovementUtils_ComputeControlledGroundMove, ReturnValue) == 0x0000A0, "Member 'GroundMovementUtils_ComputeControlledGroundMove::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GroundMovementUtils_ComputeDeflectedMoveOntoRamp) == 0x000120, "Wrong size on GroundMovementUtils_ComputeDeflectedMoveOntoRamp");
...
static_assert(offsetof(GroundMovementUtils_ComputeDeflectedMoveOntoRamp, RampHitResult) == 0x000018, "Member 'GroundMovementUtils_ComputeDeflectedMoveOntoRamp::RampHitResult' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_ComputeDeflectedMoveOntoRamp, MaxWalkSlopeCosine) == 0x000100, "Member 'GroundMovementUtils_ComputeDeflectedMoveOntoRamp::MaxWalkSlopeCosine' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_ComputeDeflectedMoveOntoRamp, bHitFromLineTrace) == 0x000104, "Member 'GroundMovementUtils_ComputeDeflectedMoveOntoRamp::bHitFromLineTrace' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_ComputeDeflectedMoveOntoRamp, ReturnValue) == 0x000108, "Member 'GroundMovementUtils_ComputeDeflectedMoveOntoRamp::ReturnValue' has a wrong offset!");
...
public:
	...
	float                                         MaxStepHeight;                                     // 0x01B4(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GroundMovementUtils_TryWalkToSlideAlongSurface) == 0x0001C0, "Wrong size on GroundMovementUtils_TryWalkToSlideAlongSurface");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, UpdatedComponent) == 0x000000, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::UpdatedComponent' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, UpdatedPrimitive) == 0x000008, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::UpdatedPrimitive' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, MoverComponent) == 0x000010, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::MoverComponent' has a wrong offset!");
...
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, bHandleImpact) == 0x000160, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::bHandleImpact' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, MoveRecord) == 0x000168, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::MoveRecord' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, MaxWalkSlopeCosine) == 0x0001B0, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::MaxWalkSlopeCosine' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, MaxStepHeight) == 0x0001B4, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::MaxStepHeight' has a wrong offset!");
static_assert(offsetof(GroundMovementUtils_TryWalkToSlideAlongSurface, ReturnValue) == 0x0001B8, "Member 'GroundMovementUtils_TryWalkToSlideAlongSurface::ReturnValue' has a wrong offset!");
...
{
public:
	struct FSimulationTickParams                  Params_0;                                          // 0x0000(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FMoverTickEndData                      ReturnValue;                                       // 0x00E8(0x0070)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(BaseMovementMode_K2_OnSimulationTick) == 0x000158, "Wrong size on BaseMovementMode_K2_OnSimulationTick");
...
static_assert(offsetof(BaseMovementMode_K2_OnSimulationTick, ReturnValue) == 0x0000E8, "Member 'BaseMovementMode_K2_OnSimulationTick::ReturnValue' has a wrong offset!");
...
public:
	struct FSimulationTickParams                  Params_0;                                          // 0x0000(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FMoverTickEndData                      OutputState;                                       // 0x00E8(0x0070)(Parm, OutParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(WalkingMode_OnSimulationTick) == 0x000008, "Wrong alignment on WalkingMode_OnSimulationTick");
static_assert(sizeof(WalkingMode_OnSimulationTick) == 0x000158, "Wrong size on WalkingMode_OnSimulationTick");
...
static_assert(offsetof(WalkingMode_OnSimulationTick, OutputState) == 0x0000E8, "Member 'WalkingMode_OnSimulationTick::OutputState' has a wrong offset!");
...
public:
	...
	struct FMoverDefaultSyncState                 MoverState;                                        // 0x0050(0x0110)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(TurnGeneratorInterface_GetTurn, SimBlackboard) == 0x0001F8, "Member 'TurnGeneratorInterface_GetTurn::SimBlackboard' has a wrong offset!");
static_assert(offsetof(TurnGeneratorInterface_GetTurn, ReturnValue) == 0x000200, "Member 'TurnGeneratorInterface_GetTurn::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(FallingMode_OnSimulationTick) == 0x000158, "Wrong size on FallingMode_OnSimulationTick");
...
static_assert(offsetof(FallingMode_OnSimulationTick, OutputState) == 0x0000E8, "Member 'FallingMode_OnSimulationTick::OutputState' has a wrong offset!");
...
{
public:
	struct FMoverDefaultSyncState                 SyncState;                                         // 0x0000(0x0110)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MoverDataModelBlueprintLibrary_GetLocationFromSyncState) == 0x000130, "Wrong size on MoverDataModelBlueprintLibrary_GetLocationFromSyncState");
...
static_assert(offsetof(MoverDataModelBlueprintLibrary_GetLocationFromSyncState, ReturnValue) == 0x000110, "Member 'MoverDataModelBlueprintLibrary_GetLocationFromSyncState::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MoverDataModelBlueprintLibrary_GetMoveDirectionIntentFromSyncState) == 0x000130, "Wrong size on MoverDataModelBlueprintLibrary_GetMoveDirectionIntentFromSyncState");
...
static_assert(offsetof(MoverDataModelBlueprintLibrary_GetMoveDirectionIntentFromSyncState, ReturnValue) == 0x000110, "Member 'MoverDataModelBlueprintLibrary_GetMoveDirectionIntentFromSyncState::ReturnValue' has a wrong offset!");
...
public:
	struct FMoverDefaultSyncState                 SyncState;                                         // 0x0000(0x0110)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FRotator                               ReturnValue;                                       // 0x0110(0x0018)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_128[0x8];                                      // 0x0128(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(MoverDataModelBlueprintLibrary_GetOrientationFromSyncState) == 0x000130, "Wrong size on MoverDataModelBlueprintLibrary_GetOrientationFromSyncState");
...
static_assert(offsetof(MoverDataModelBlueprintLibrary_GetOrientationFromSyncState, ReturnValue) == 0x000110, "Member 'MoverDataModelBlueprintLibrary_GetOrientationFromSyncState::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MoverDataModelBlueprintLibrary_GetVelocityFromSyncState) == 0x000130, "Wrong size on MoverDataModelBlueprintLibrary_GetVelocityFromSyncState");
...
static_assert(offsetof(MoverDataModelBlueprintLibrary_GetVelocityFromSyncState, ReturnValue) == 0x000110, "Member 'MoverDataModelBlueprintLibrary_GetVelocityFromSyncState::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MoverNetworkPhysicsLiaisonComponent_OnComponentPhysicsStateChanged, ChangedComponent) == 0x000000, "Member 'MoverNetworkPhysicsLiaisonComponent_OnComponentPhysicsStateChanged::ChangedComponent' has a wrong offset!");
static_assert(offsetof(MoverNetworkPhysicsLiaisonComponent_OnComponentPhysicsStateChanged, StateChange) == 0x000008, "Member 'MoverNetworkPhysicsLiaisonComponent_OnComponentPhysicsStateChanged::StateChange' has a wrong offset!");
...
static_assert(sizeof(BaseMovementModeTransition_K2_OnTrigger) == 0x0000E8, "Wrong size on BaseMovementModeTransition_K2_OnTrigger");
static_assert(offsetof(BaseMovementModeTransition_K2_OnTrigger, Params_0) == 0x000000, "Member 'BaseMovementModeTransition_K2_OnTrigger::Params_0' has a wrong offset!");
...
public:
	struct FSimulationTickParams                  Params_0;                                          // 0x0000(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FTransitionEvalResult                  ReturnValue;                                       // 0x00E8(0x0004)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(BaseMovementModeTransition_K2_OnEvaluate) == 0x0000F0, "Wrong size on BaseMovementModeTransition_K2_OnEvaluate");
static_assert(offsetof(BaseMovementModeTransition_K2_OnEvaluate, Params_0) == 0x000000, "Member 'BaseMovementModeTransition_K2_OnEvaluate::Params_0' has a wrong offset!");
static_assert(offsetof(BaseMovementModeTransition_K2_OnEvaluate, ReturnValue) == 0x0000E8, "Member 'BaseMovementModeTransition_K2_OnEvaluate::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WaterMovementUtils_ComputeControlledWaterMove, ReturnValue) == 0x0000A8, "Member 'WaterMovementUtils_ComputeControlledWaterMove::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FWaterCheckResult                      OutWaterResult;                                    // 0x0048(0x01D8)(Parm, OutParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(WaterMovementUtils_UpdateWaterSplineData) == 0x000220, "Wrong size on WaterMovementUtils_UpdateWaterSplineData");
...
static_assert(offsetof(WaterMovementUtils_UpdateWaterSplineData, OutWaterResult) == 0x000048, "Member 'WaterMovementUtils_UpdateWaterSplineData::OutWaterResult' has a wrong offset!");
...
static_assert(sizeof(FlyingMode_OnSimulationTick) == 0x000158, "Wrong size on FlyingMode_OnSimulationTick");
...
static_assert(offsetof(FlyingMode_OnSimulationTick, OutputState) == 0x0000E8, "Member 'FlyingMode_OnSimulationTick::OutputState' has a wrong offset!");
...
static_assert(sizeof(SwimmingMode_OnSimulationTick) == 0x000158, "Wrong size on SwimmingMode_OnSimulationTick");
...
static_assert(offsetof(SwimmingMode_OnSimulationTick, OutputState) == 0x0000E8, "Member 'SwimmingMode_OnSimulationTick::OutputState' has a wrong offset!");
