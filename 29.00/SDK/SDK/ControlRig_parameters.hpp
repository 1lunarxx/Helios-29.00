...
static_assert(offsetof(ControlRig_OnControlSelectedBP__DelegateSignature, bSelected) == 0x000870, "Member 'ControlRig_OnControlSelectedBP__DelegateSignature::bSelected' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, bCheckValidConnection) == 0x000012, "Member 'ModularRigController_ConnectConnectorToElement::bCheckValidConnection' has a wrong offset!");
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, ReturnValue) == 0x000013, "Member 'ModularRigController_ConnectConnectorToElement::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_DisconnectConnector, bDisconnectSubModules) == 0x000008, "Member 'ModularRigController_DisconnectConnector::bDisconnectSubModules' has a wrong offset!");
static_assert(offsetof(ModularRigController_DisconnectConnector, bSetupUndo) == 0x000009, "Member 'ModularRigController_DisconnectConnector::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_DisconnectConnector, ReturnValue) == 0x00000A, "Member 'ModularRigController_DisconnectConnector::ReturnValue' has a wrong offset!");
