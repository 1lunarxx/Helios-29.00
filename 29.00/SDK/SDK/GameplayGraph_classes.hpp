...
public:
	...
	TMap<struct FGraphEdgeHandle, class UGraphEdge*> Edges;                                             // 0x00C0(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<struct FGraphIslandHandle, class UGraphIsland*> Islands;                                           // 0x0110(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGraph) == 0x000168, "Wrong size on UGraph");
static_assert(offsetof(UGraph, Vertices) == 0x000070, "Member 'UGraph::Vertices' has a wrong offset!");
static_assert(offsetof(UGraph, Edges) == 0x0000C0, "Member 'UGraph::Edges' has a wrong offset!");
static_assert(offsetof(UGraph, Islands) == 0x000110, "Member 'UGraph::Islands' has a wrong offset!");
...
{
public:
	struct FGraphVertexHandle                     A;                                                 // 0x0048(0x0028)(SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGraphVertexHandle                     B;                                                 // 0x0070(0x0028)(SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGraphEdge) == 0x000098, "Wrong size on UGraphEdge");
static_assert(offsetof(UGraphEdge, A) == 0x000048, "Member 'UGraphEdge::A' has a wrong offset!");
static_assert(offsetof(UGraphEdge, B) == 0x000070, "Member 'UGraphEdge::B' has a wrong offset!");
...
static_assert(offsetof(UGraphIsland, AllowedOperations) == 0x0000F8, "Member 'UGraphIsland::AllowedOperations' has a wrong offset!");
