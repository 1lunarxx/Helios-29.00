...
static_assert(offsetof(UPCGApplyOnActorSettings, PropertyOverrideDescriptions) == 0x0000C8, "Member 'UPCGApplyOnActorSettings::PropertyOverrideDescriptions' has a wrong offset!");
static_assert(offsetof(UPCGApplyOnActorSettings, PostProcessFunctionNames) == 0x0000D8, "Member 'UPCGApplyOnActorSettings::PostProcessFunctionNames' has a wrong offset!");
...
static_assert(sizeof(UPCGAttributeFilteringSettings) == 0x000270, "Wrong size on UPCGAttributeFilteringSettings");
...
static_assert(sizeof(UPCGAttributeFilteringRangeSettings) == 0x000410, "Wrong size on UPCGAttributeFilteringRangeSettings");
...
static_assert(offsetof(UPCGAttributeFilteringRangeSettings, MaxThreshold) == 0x000270, "Member 'UPCGAttributeFilteringRangeSettings::MaxThreshold' has a wrong offset!");
...
static_assert(offsetof(UPCGLoadDataTableSettings, OutputType) == 0x000118, "Member 'UPCGLoadDataTableSettings::OutputType' has a wrong offset!");
static_assert(offsetof(UPCGLoadDataTableSettings, bSynchronousLoad) == 0x000119, "Member 'UPCGLoadDataTableSettings::bSynchronousLoad' has a wrong offset!");
...
static_assert(offsetof(UPCGEngineSettings, bDisplayCullingStateWhenDebugging) == 0x000049, "Member 'UPCGEngineSettings::bDisplayCullingStateWhenDebugging' has a wrong offset!");
...
static_assert(offsetof(UPCGGetActorPropertySettings, bForceObjectAndStructExtraction) == 0x0000DC, "Member 'UPCGGetActorPropertySettings::bForceObjectAndStructExtraction' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, OutputAttributeName) == 0x0000E0, "Member 'UPCGGetActorPropertySettings::OutputAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, bAlwaysRequeryActors) == 0x0000E4, "Member 'UPCGGetActorPropertySettings::bAlwaysRequeryActors' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, ActorSelection) == 0x0000E5, "Member 'UPCGGetActorPropertySettings::ActorSelection' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, ActorSelectionTag) == 0x0000E8, "Member 'UPCGGetActorPropertySettings::ActorSelectionTag' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, ActorSelectionName) == 0x0000EC, "Member 'UPCGGetActorPropertySettings::ActorSelectionName' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, ActorSelectionClass) == 0x0000F0, "Member 'UPCGGetActorPropertySettings::ActorSelectionClass' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, ActorFilter) == 0x0000F8, "Member 'UPCGGetActorPropertySettings::ActorFilter' has a wrong offset!");
static_assert(offsetof(UPCGGetActorPropertySettings, bIncludeChildren) == 0x0000F9, "Member 'UPCGGetActorPropertySettings::bIncludeChildren' has a wrong offset!");
...
static_assert(offsetof(APCGUnitTestDummyActor, LinearColorProperty) == 0x0003F4, "Member 'APCGUnitTestDummyActor::LinearColorProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, PCGColorProperty) == 0x000408, "Member 'APCGUnitTestDummyActor::PCGColorProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfIntsProperty) == 0x000428, "Member 'APCGUnitTestDummyActor::ArrayOfIntsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfVectorsProperty) == 0x000438, "Member 'APCGUnitTestDummyActor::ArrayOfVectorsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfStructsProperty) == 0x000448, "Member 'APCGUnitTestDummyActor::ArrayOfStructsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfObjectsProperty) == 0x000458, "Member 'APCGUnitTestDummyActor::ArrayOfObjectsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, DummyStruct) == 0x000468, "Member 'APCGUnitTestDummyActor::DummyStruct' has a wrong offset!");
...
static_assert(offsetof(UPCGGetPropertyFromObjectPathSettings, bForceObjectAndStructExtraction) == 0x0000E4, "Member 'UPCGGetPropertyFromObjectPathSettings::bForceObjectAndStructExtraction' has a wrong offset!");
static_assert(offsetof(UPCGGetPropertyFromObjectPathSettings, OutputAttributeName) == 0x0000E8, "Member 'UPCGGetPropertyFromObjectPathSettings::OutputAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGGetPropertyFromObjectPathSettings, bSynchronousLoad) == 0x0000EC, "Member 'UPCGGetPropertyFromObjectPathSettings::bSynchronousLoad' has a wrong offset!");
static_assert(offsetof(UPCGGetPropertyFromObjectPathSettings, bPersistAllData) == 0x0000ED, "Member 'UPCGGetPropertyFromObjectPathSettings::bPersistAllData' has a wrong offset!");
static_assert(offsetof(UPCGGetPropertyFromObjectPathSettings, bSilenceErrorOnEmptyObjectPath) == 0x0000EE, "Member 'UPCGGetPropertyFromObjectPathSettings::bSilenceErrorOnEmptyObjectPath' has a wrong offset!");
...
{
public:
	EPCGHiGenGrid                                 HiGenGridSize;                                     // 0x00A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_AC[0x4];                                       // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UPCGLoadDataAssetSettings, Pins) == 0x0000C8, "Member 'UPCGLoadDataAssetSettings::Pins' has a wrong offset!");
static_assert(offsetof(UPCGLoadDataAssetSettings, AssetName) == 0x0000D8, "Member 'UPCGLoadDataAssetSettings::AssetName' has a wrong offset!");
static_assert(offsetof(UPCGLoadDataAssetSettings, bWarnIfNoAsset) == 0x0000E8, "Member 'UPCGLoadDataAssetSettings::bWarnIfNoAsset' has a wrong offset!");
static_assert(offsetof(UPCGLoadDataAssetSettings, bSynchronousLoad) == 0x0000E9, "Member 'UPCGLoadDataAssetSettings::bSynchronousLoad' has a wrong offset!");
...
static_assert(offsetof(UPCGPointNeighborhoodSettings, bSetAveragePositionToAttribute) == 0x0000B8, "Member 'UPCGPointNeighborhoodSettings::bSetAveragePositionToAttribute' has a wrong offset!");
static_assert(offsetof(UPCGPointNeighborhoodSettings, AveragePositionAttribute) == 0x0000BC, "Member 'UPCGPointNeighborhoodSettings::AveragePositionAttribute' has a wrong offset!");
static_assert(offsetof(UPCGPointNeighborhoodSettings, SetDensity) == 0x0000C0, "Member 'UPCGPointNeighborhoodSettings::SetDensity' has a wrong offset!");
static_assert(offsetof(UPCGPointNeighborhoodSettings, bSetAveragePosition) == 0x0000C4, "Member 'UPCGPointNeighborhoodSettings::bSetAveragePosition' has a wrong offset!");
static_assert(offsetof(UPCGPointNeighborhoodSettings, bSetAverageColor) == 0x0000C5, "Member 'UPCGPointNeighborhoodSettings::bSetAverageColor' has a wrong offset!");
static_assert(offsetof(UPCGPointNeighborhoodSettings, bWeightedAverage) == 0x0000C6, "Member 'UPCGPointNeighborhoodSettings::bWeightedAverage' has a wrong offset!");
...
static_assert(offsetof(UPCGUserParameterGetSettings, bForceObjectAndStructExtraction) == 0x0000BC, "Member 'UPCGUserParameterGetSettings::bForceObjectAndStructExtraction' has a wrong offset!");
...
static_assert(offsetof(UPCGMetadataRenameSettings, NewAttributeName) == 0x0000AC, "Member 'UPCGMetadataRenameSettings::NewAttributeName' has a wrong offset!");
...
static_assert(offsetof(UPCGAttributeReduceSettings, Operation) == 0x0000D4, "Member 'UPCGAttributeReduceSettings::Operation' has a wrong offset!");
static_assert(offsetof(UPCGAttributeReduceSettings, bMergeOutputAttributes) == 0x0000D8, "Member 'UPCGAttributeReduceSettings::bMergeOutputAttributes' has a wrong offset!");
...
static_assert(offsetof(UPCGAttributeSelectSettings, Operation) == 0x0000D4, "Member 'UPCGAttributeSelectSettings::Operation' has a wrong offset!");
static_assert(offsetof(UPCGAttributeSelectSettings, Axis) == 0x0000D8, "Member 'UPCGAttributeSelectSettings::Axis' has a wrong offset!");
...
static_assert(offsetof(UPCGAddAttributeSettings, bCopyAllAttributes) == 0x000260, "Member 'UPCGAddAttributeSettings::bCopyAllAttributes' has a wrong offset!");
...
static_assert(offsetof(UPCGCreateAttributeSetSettings, OutputTarget) == 0x000210, "Member 'UPCGCreateAttributeSetSettings::OutputTarget' has a wrong offset!");
...
static_assert(offsetof(UPCGCreateSplineSettings, LeaveTangentAttribute) == 0x0000B0, "Member 'UPCGCreateSplineSettings::LeaveTangentAttribute' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, TargetActor) == 0x0000B8, "Member 'UPCGCreateSplineSettings::TargetActor' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, AttachOptions) == 0x0000D8, "Member 'UPCGCreateSplineSettings::AttachOptions' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, PostProcessFunctionNames) == 0x0000E0, "Member 'UPCGCreateSplineSettings::PostProcessFunctionNames' has a wrong offset!");
...
{
public:
	TSubclassOf<class AActor>                     TemplateActorClass;                                // 0x00A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 TemplateActor;                                     // 0x00B0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowTemplateActorEditing;                        // 0x00B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EPCGAttachOptions                             AttachOptions;                                     // 0x00BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class AActor>                  RootActor;                                         // 0x00C0(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGCreateTargetActor) == 0x000170, "Wrong size on UPCGCreateTargetActor");
static_assert(offsetof(UPCGCreateTargetActor, TemplateActorClass) == 0x0000A8, "Member 'UPCGCreateTargetActor::TemplateActorClass' has a wrong offset!");
static_assert(offsetof(UPCGCreateTargetActor, TemplateActor) == 0x0000B0, "Member 'UPCGCreateTargetActor::TemplateActor' has a wrong offset!");
static_assert(offsetof(UPCGCreateTargetActor, bAllowTemplateActorEditing) == 0x0000B8, "Member 'UPCGCreateTargetActor::bAllowTemplateActorEditing' has a wrong offset!");
static_assert(offsetof(UPCGCreateTargetActor, AttachOptions) == 0x0000BC, "Member 'UPCGCreateTargetActor::AttachOptions' has a wrong offset!");
static_assert(offsetof(UPCGCreateTargetActor, RootActor) == 0x0000C0, "Member 'UPCGCreateTargetActor::RootActor' has a wrong offset!");
...
static_assert(offsetof(UPCGDataTableRowToParamDataSettings, bSynchronousLoad) == 0x0000D0, "Member 'UPCGDataTableRowToParamDataSettings::bSynchronousLoad' has a wrong offset!");
...
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bKeepUnmatched) == 0x0000DC, "Member 'UPCGMatchAndSetAttributesSettings::bKeepUnmatched' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bFindNearest) == 0x0000DD, "Member 'UPCGMatchAndSetAttributesSettings::bFindNearest' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, MaxDistanceMode) == 0x0000E0, "Member 'UPCGMatchAndSetAttributesSettings::MaxDistanceMode' has a wrong offset!");
...
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, MaxDistanceInputAttribute) == 0x000250, "Member 'UPCGMatchAndSetAttributesSettings::MaxDistanceInputAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bUseInputWeightAttribute) == 0x000278, "Member 'UPCGMatchAndSetAttributesSettings::bUseInputWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, InputWeightAttribute) == 0x000280, "Member 'UPCGMatchAndSetAttributesSettings::InputWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bUseWeightAttribute) == 0x0002A8, "Member 'UPCGMatchAndSetAttributesSettings::bUseWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, WeightAttribute) == 0x0002AC, "Member 'UPCGMatchAndSetAttributesSettings::WeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bWarnIfNoMatchData) == 0x0002B0, "Member 'UPCGMatchAndSetAttributesSettings::bWarnIfNoMatchData' has a wrong offset!");
...
static_assert(offsetof(UPCGPointFromMeshSettings, MeshPathAttributeName) == 0x0000C8, "Member 'UPCGPointFromMeshSettings::MeshPathAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGPointFromMeshSettings, bSynchronousLoad) == 0x0000CC, "Member 'UPCGPointFromMeshSettings::bSynchronousLoad' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_E1[0x3];                                       // 0x00E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EPCGMetadataTypesConstantStructStringMode     SetTargetStringMode;                               // 0x00E4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGPointMatchAndSetSettings, SetTargetStringMode) == 0x0000E4, "Member 'UPCGPointMatchAndSetSettings::SetTargetStringMode' has a wrong offset!");
...
public:
	TSubclassOf<class AActor>                     TemplateActorClass;                                // 0x00A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           PostSpawnFunctionNames;                            // 0x00B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EPCGSpawnActorOption                          Option;                                            // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceDisableActorParsing;                         // 0x00C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGSpawnActorGenerationTrigger               GenerationTrigger;                                 // 0x00C2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bInheritActorTags;                                 // 0x00C3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           TagsToAddOnActors;                                 // 0x00C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bAllowTemplateActorEditing;                        // 0x00D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TSoftObjectPtr<class AActor>                  RootActor;                                         // 0x00F8(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGAttachOptions                             AttachOptions;                                     // 0x0118(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSpawnByAttribute;                                 // 0x011C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11D[0x3];                                      // 0x011D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SpawnAttribute;                                    // 0x0120(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGSpawnActorSettings, TemplateActorClass) == 0x0000A8, "Member 'UPCGSpawnActorSettings::TemplateActorClass' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, PostSpawnFunctionNames) == 0x0000B0, "Member 'UPCGSpawnActorSettings::PostSpawnFunctionNames' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, Option) == 0x0000C0, "Member 'UPCGSpawnActorSettings::Option' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, bForceDisableActorParsing) == 0x0000C1, "Member 'UPCGSpawnActorSettings::bForceDisableActorParsing' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, GenerationTrigger) == 0x0000C2, "Member 'UPCGSpawnActorSettings::GenerationTrigger' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, bInheritActorTags) == 0x0000C3, "Member 'UPCGSpawnActorSettings::bInheritActorTags' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, TagsToAddOnActors) == 0x0000C8, "Member 'UPCGSpawnActorSettings::TagsToAddOnActors' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, bAllowTemplateActorEditing) == 0x0000D8, "Member 'UPCGSpawnActorSettings::bAllowTemplateActorEditing' has a wrong offset!");
...
static_assert(offsetof(UPCGSpawnActorSettings, AttachOptions) == 0x000118, "Member 'UPCGSpawnActorSettings::AttachOptions' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, bSpawnByAttribute) == 0x00011C, "Member 'UPCGSpawnActorSettings::bSpawnByAttribute' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, SpawnAttribute) == 0x000120, "Member 'UPCGSpawnActorSettings::SpawnAttribute' has a wrong offset!");
...
public:
	...
	TArray<struct FPCGStaticMeshSpawnerEntry>     Meshes;                                            // 0x0110(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, bApplyMeshBoundsToPoints) == 0x0000DC, "Member 'UPCGStaticMeshSpawnerSettings::bApplyMeshBoundsToPoints' has a wrong offset!");
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, TargetActor) == 0x0000E0, "Member 'UPCGStaticMeshSpawnerSettings::TargetActor' has a wrong offset!");
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, PostProcessFunctionNames) == 0x000100, "Member 'UPCGStaticMeshSpawnerSettings::PostProcessFunctionNames' has a wrong offset!");
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, Meshes) == 0x000110, "Member 'UPCGStaticMeshSpawnerSettings::Meshes' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UTexture>                Texture;                                           // 0x0118(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TextureArrayIndex;                                 // 0x0138(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGTextureDensityFunction                    DensityFunction;                                   // 0x013C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGTextureColorChannel                       ColorChannel;                                      // 0x013D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGTextureFilter                             Filter;                                            // 0x013E(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_13F[0x1];                                      // 0x013F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TexelSize;                                         // 0x0140(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAdvancedTiling;                                // 0x0144(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGTextureSamplerSettings, Texture) == 0x000118, "Member 'UPCGTextureSamplerSettings::Texture' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TextureArrayIndex) == 0x000138, "Member 'UPCGTextureSamplerSettings::TextureArrayIndex' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, DensityFunction) == 0x00013C, "Member 'UPCGTextureSamplerSettings::DensityFunction' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, ColorChannel) == 0x00013D, "Member 'UPCGTextureSamplerSettings::ColorChannel' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, Filter) == 0x00013E, "Member 'UPCGTextureSamplerSettings::Filter' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TexelSize) == 0x000140, "Member 'UPCGTextureSamplerSettings::TexelSize' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, bUseAdvancedTiling) == 0x000144, "Member 'UPCGTextureSamplerSettings::bUseAdvancedTiling' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, Tiling) == 0x000148, "Member 'UPCGTextureSamplerSettings::Tiling' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, CenterOffset) == 0x000158, "Member 'UPCGTextureSamplerSettings::CenterOffset' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, Rotation) == 0x000168, "Member 'UPCGTextureSamplerSettings::Rotation' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, bUseTileBounds) == 0x00016C, "Member 'UPCGTextureSamplerSettings::bUseTileBounds' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TileBoundsMin) == 0x000170, "Member 'UPCGTextureSamplerSettings::TileBoundsMin' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TileBoundsMax) == 0x000180, "Member 'UPCGTextureSamplerSettings::TileBoundsMax' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, bSynchronousLoad) == 0x000190, "Member 'UPCGTextureSamplerSettings::bSynchronousLoad' has a wrong offset!");
...
static_assert(offsetof(UPCGTransformPointsSettings, OffsetMin) == 0x0000B0, "Member 'UPCGTransformPointsSettings::OffsetMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, OffsetMax) == 0x0000C8, "Member 'UPCGTransformPointsSettings::OffsetMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteOffset) == 0x0000E0, "Member 'UPCGTransformPointsSettings::bAbsoluteOffset' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, RotationMin) == 0x0000E8, "Member 'UPCGTransformPointsSettings::RotationMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, RotationMax) == 0x000100, "Member 'UPCGTransformPointsSettings::RotationMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteRotation) == 0x000118, "Member 'UPCGTransformPointsSettings::bAbsoluteRotation' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, ScaleMin) == 0x000120, "Member 'UPCGTransformPointsSettings::ScaleMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, ScaleMax) == 0x000138, "Member 'UPCGTransformPointsSettings::ScaleMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteScale) == 0x000150, "Member 'UPCGTransformPointsSettings::bAbsoluteScale' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bUniformScale) == 0x000151, "Member 'UPCGTransformPointsSettings::bUniformScale' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bRecomputeSeed) == 0x000152, "Member 'UPCGTransformPointsSettings::bRecomputeSeed' has a wrong offset!");
...
static_assert(offsetof(UPCGGetLandscapeSettings, SamplingProperties) == 0x0000F0, "Member 'UPCGGetLandscapeSettings::SamplingProperties' has a wrong offset!");
...
public:
	...
	bool                                          bGenerated;                                        // 0x0120(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRuntimeGenerated;                                 // 0x0121(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, NonPIEDuplicateTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_122[0x6];                                      // 0x0122(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           PostGenerateFunctionNames;                         // 0x0128(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class UPCGGraphInstance*                      GraphInstance;                                     // 0x0138(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint32                                        GenerationGridSize;                                // 0x0140(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPCGEditorDirtyMode                           CurrentEditingMode;                                // 0x0144(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPCGEditorDirtyMode                           SerializedEditingMode;                             // 0x0145(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_146[0x1];                                      // 0x0146(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	EPCGComponentInput                            InputType;                                         // 0x0147(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bParseActorComponents;                             // 0x0148(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPCGData*                               CachedPCGData;                                     // 0x0150(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedInputData;                                   // 0x0158(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedActorData;                                   // 0x0160(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedLandscapeData;                               // 0x0168(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedLandscapeHeightData;                         // 0x0170(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UPCGManagedResource*>            GeneratedResources;                                // 0x0178(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_188[0x8];                                      // 0x0188(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBox                                   LastGeneratedBounds;                               // 0x0190(0x0038)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	struct FPCGDataCollection                     GeneratedGraphOutput;                              // 0x01C8(0x0030)(Edit, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
	TMap<class FString, struct FPCGDataCollection> PerPinGeneratedOutput;                             // 0x01F8(0x0050)(Edit, Transient, EditConst, NativeAccessSpecifierPrivate)
	uint8                                         Pad_248[0x18];                                     // 0x0248(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsComponentLocal;                                 // 0x0260(0x0001)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_261[0x2F];                                     // 0x0261(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPCGComponent) == 0x000290, "Wrong size on UPCGComponent");
...
static_assert(offsetof(UPCGComponent, bGenerated) == 0x000120, "Member 'UPCGComponent::bGenerated' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bRuntimeGenerated) == 0x000121, "Member 'UPCGComponent::bRuntimeGenerated' has a wrong offset!");
static_assert(offsetof(UPCGComponent, PostGenerateFunctionNames) == 0x000128, "Member 'UPCGComponent::PostGenerateFunctionNames' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GraphInstance) == 0x000138, "Member 'UPCGComponent::GraphInstance' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GenerationGridSize) == 0x000140, "Member 'UPCGComponent::GenerationGridSize' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CurrentEditingMode) == 0x000144, "Member 'UPCGComponent::CurrentEditingMode' has a wrong offset!");
static_assert(offsetof(UPCGComponent, SerializedEditingMode) == 0x000145, "Member 'UPCGComponent::SerializedEditingMode' has a wrong offset!");
static_assert(offsetof(UPCGComponent, InputType) == 0x000147, "Member 'UPCGComponent::InputType' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bParseActorComponents) == 0x000148, "Member 'UPCGComponent::bParseActorComponents' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedPCGData) == 0x000150, "Member 'UPCGComponent::CachedPCGData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedInputData) == 0x000158, "Member 'UPCGComponent::CachedInputData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedActorData) == 0x000160, "Member 'UPCGComponent::CachedActorData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedLandscapeData) == 0x000168, "Member 'UPCGComponent::CachedLandscapeData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedLandscapeHeightData) == 0x000170, "Member 'UPCGComponent::CachedLandscapeHeightData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GeneratedResources) == 0x000178, "Member 'UPCGComponent::GeneratedResources' has a wrong offset!");
static_assert(offsetof(UPCGComponent, LastGeneratedBounds) == 0x000190, "Member 'UPCGComponent::LastGeneratedBounds' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GeneratedGraphOutput) == 0x0001C8, "Member 'UPCGComponent::GeneratedGraphOutput' has a wrong offset!");
static_assert(offsetof(UPCGComponent, PerPinGeneratedOutput) == 0x0001F8, "Member 'UPCGComponent::PerPinGeneratedOutput' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bIsComponentLocal) == 0x000260, "Member 'UPCGComponent::bIsComponentLocal' has a wrong offset!");
...
{
public:
	TSet<class FName>                             PinLabels;                                         // 0x00A8(0x0050)(Deprecated, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPCGPinProperties>              CustomPins;                                        // 0x00F8(0x0010)(ZeroConstructor, Deprecated, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPCGPinProperties>              Pins;                                              // 0x0108(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UPCGGraphInputOutputSettings, PinLabels) == 0x0000A8, "Member 'UPCGGraphInputOutputSettings::PinLabels' has a wrong offset!");
static_assert(offsetof(UPCGGraphInputOutputSettings, CustomPins) == 0x0000F8, "Member 'UPCGGraphInputOutputSettings::CustomPins' has a wrong offset!");
static_assert(offsetof(UPCGGraphInputOutputSettings, Pins) == 0x000108, "Member 'UPCGGraphInputOutputSettings::Pins' has a wrong offset!");
...
{
public:
	uint8                                         Pad_40[0x640];                                     // 0x0040(0x0640)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPCGSubsystem) == 0x000680, "Wrong size on UPCGSubsystem");
...
public:
	...
	TSet<struct FPCGPartitionActorRecord>         SerializedPartitionActorRecords;                   // 0x0358(0x0050)(Edit, EditConst, NativeAccessSpecifierPrivate)
