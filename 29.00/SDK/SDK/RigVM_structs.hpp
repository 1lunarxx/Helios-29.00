...
public:
	...
	class FText                                   ToolTip;                                           // 0x0058(0x0018)(Deprecated, NativeAccessSpecifierPublic)
	class FString                                 Description;                                       // 0x0070(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Category;                                          // 0x0080(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Keywords;                                          // 0x0090(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRigVMGraphFunctionArgument>    Arguments;                                         // 0x00A0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigVMGraphFunctionHeader, Description) == 0x000070, "Member 'FRigVMGraphFunctionHeader::Description' has a wrong offset!");
...
public:
	...
	struct FRigVMFunctionCompilationData          CompilationData;                                   // 0x0110(0x0238)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SerializedCollapsedNode;                           // 0x0348(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMGraphFunctionData) == 0x000008, "Wrong alignment on FRigVMGraphFunctionData");
static_assert(sizeof(FRigVMGraphFunctionData) == 0x000358, "Wrong size on FRigVMGraphFunctionData");
...
static_assert(offsetof(FRigVMGraphFunctionData, SerializedCollapsedNode) == 0x000348, "Member 'FRigVMGraphFunctionData::SerializedCollapsedNode' has a wrong offset!");
