...
static_assert(sizeof(UNeuralMorphModelInstance) == 0x0000B8, "Wrong size on UNeuralMorphModelInstance");
static_assert(offsetof(UNeuralMorphModelInstance, NetworkInstance) == 0x000090, "Member 'UNeuralMorphModelInstance::NetworkInstance' has a wrong offset!");
...
static_assert(sizeof(UNeuralMorphModel) == 0x0002A8, "Wrong size on UNeuralMorphModel");
static_assert(offsetof(UNeuralMorphModel, BoneGroups) == 0x0001A8, "Member 'UNeuralMorphModel::BoneGroups' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, CurveGroups) == 0x0001B8, "Member 'UNeuralMorphModel::CurveGroups' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneMaskInfos) == 0x0001C8, "Member 'UNeuralMorphModel::BoneMaskInfos' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneGroupMaskInfos) == 0x000218, "Member 'UNeuralMorphModel::BoneGroupMaskInfos' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, Mode) == 0x000268, "Member 'UNeuralMorphModel::Mode' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumMorphTargetsPerBone) == 0x00026C, "Member 'UNeuralMorphModel::LocalNumMorphTargetsPerBone' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumMorphTargets) == 0x000270, "Member 'UNeuralMorphModel::GlobalNumMorphTargets' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, NumIterations) == 0x000274, "Member 'UNeuralMorphModel::NumIterations' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumHiddenLayers) == 0x000278, "Member 'UNeuralMorphModel::LocalNumHiddenLayers' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumNeuronsPerLayer) == 0x00027C, "Member 'UNeuralMorphModel::LocalNumNeuronsPerLayer' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumHiddenLayers) == 0x000280, "Member 'UNeuralMorphModel::GlobalNumHiddenLayers' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumNeuronsPerLayer) == 0x000284, "Member 'UNeuralMorphModel::GlobalNumNeuronsPerLayer' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BatchSize) == 0x000288, "Member 'UNeuralMorphModel::BatchSize' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LearningRate) == 0x00028C, "Member 'UNeuralMorphModel::LearningRate' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, RegularizationFactor) == 0x000290, "Member 'UNeuralMorphModel::RegularizationFactor' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, bEnableBoneMasks) == 0x000294, "Member 'UNeuralMorphModel::bEnableBoneMasks' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, SmoothLossBeta) == 0x000298, "Member 'UNeuralMorphModel::SmoothLossBeta' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, NeuralMorphNetwork) == 0x0002A0, "Member 'UNeuralMorphModel::NeuralMorphNetwork' has a wrong offset!");
