...
static_assert(alignof(EpicGamesEngine::FTuple_L_R) == 0x000001, "Wrong alignment on EpicGamesEngine::FTuple_L_R");
static_assert(sizeof(EpicGamesEngine::FTuple_L_R) == 0x000001, "Wrong size on EpicGamesEngine::FTuple_L_R");
static_assert(offsetof(EpicGamesEngine::FTuple_L_R, _StructPaddingDummy) == 0x000000, "Member 'EpicGamesEngine::FTuple_L_R::_StructPaddingDummy' has a wrong offset!");
