...
static_assert(offsetof(PilgrimDelayUntilTimeBeforeMidiTick_OnPilgrimDelayUntilTimeBeforeMidiTickDelegate__DelegateSignature, PassthroughObject) == 0x000000, "Member 'PilgrimDelayUntilTimeBeforeMidiTick_OnPilgrimDelayUntilTimeBeforeMidiTickDelegate__DelegateSignature::PassthroughObject' has a wrong offset!");
...
static_assert(offsetof(PilgrimPlayerControllerComponent_InputPresetEvent__DelegateSignature, FortPlayerController) == 0x000000, "Member 'PilgrimPlayerControllerComponent_InputPresetEvent__DelegateSignature::FortPlayerController' has a wrong offset!");
static_assert(offsetof(PilgrimPlayerControllerComponent_InputPresetEvent__DelegateSignature, InputMappingContext) == 0x000008, "Member 'PilgrimPlayerControllerComponent_InputPresetEvent__DelegateSignature::InputMappingContext' has a wrong offset!");
...
static_assert(offsetof(PilgrimPlayerControllerComponent_OnMusicBattleClientUpdateReceived__DelegateSignature, PlayerControllerComponent) == 0x000000, "Member 'PilgrimPlayerControllerComponent_OnMusicBattleClientUpdateReceived__DelegateSignature::PlayerControllerComponent' has a wrong offset!");
static_assert(offsetof(PilgrimPlayerControllerComponent_OnMusicBattleClientUpdateReceived__DelegateSignature, MusicBattleUpdate) == 0x000008, "Member 'PilgrimPlayerControllerComponent_OnMusicBattleClientUpdateReceived__DelegateSignature::MusicBattleUpdate' has a wrong offset!");
...
static_assert(offsetof(PilgrimPlayerControllerComponent_OnPlayerSentStateMachineMessage__DelegateSignature, PlayerControllerComponent) == 0x000000, "Member 'PilgrimPlayerControllerComponent_OnPlayerSentStateMachineMessage__DelegateSignature::PlayerControllerComponent' has a wrong offset!");
static_assert(offsetof(PilgrimPlayerControllerComponent_OnPlayerSentStateMachineMessage__DelegateSignature, StateMachineMessage) == 0x000008, "Member 'PilgrimPlayerControllerComponent_OnPlayerSentStateMachineMessage__DelegateSignature::StateMachineMessage' has a wrong offset!");
...
static_assert(offsetof(PilgrimPlayerControllerComponent_OnServerSyncHeartbeatMessageReceived__DelegateSignature, PlayerControllerComponent) == 0x000000, "Member 'PilgrimPlayerControllerComponent_OnServerSyncHeartbeatMessageReceived__DelegateSignature::PlayerControllerComponent' has a wrong offset!");
...
static_assert(offsetof(PilgrimPlayerControllerComponent_OnServerTimedInputReceived__DelegateSignature, PlayerControllerComponent) == 0x000000, "Member 'PilgrimPlayerControllerComponent_OnServerTimedInputReceived__DelegateSignature::PlayerControllerComponent' has a wrong offset!");
static_assert(offsetof(PilgrimPlayerControllerComponent_OnServerTimedInputReceived__DelegateSignature, TimedInput) == 0x000008, "Member 'PilgrimPlayerControllerComponent_OnServerTimedInputReceived__DelegateSignature::TimedInput' has a wrong offset!");
...
static_assert(offsetof(PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestFailureDelegate__DelegateSignature, Error) == 0x000000, "Member 'PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestFailureDelegate__DelegateSignature::Error' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestFailureDelegate__DelegateSignature, RequestParams) == 0x000010, "Member 'PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestFailureDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
static_assert(offsetof(PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestSuccessDelegate__DelegateSignature, ResultPage) == 0x000000, "Member 'PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestSuccessDelegate__DelegateSignature::ResultPage' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestSuccessDelegate__DelegateSignature, RequestParams) == 0x000038, "Member 'PilgrimAsyncAction_RequestLeaderboard_LeaderboardRequestSuccessDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
static_assert(offsetof(PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestFailureDelegate__DelegateSignature, Error) == 0x000000, "Member 'PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestFailureDelegate__DelegateSignature::Error' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestFailureDelegate__DelegateSignature, RequestParams) == 0x000010, "Member 'PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestFailureDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
static_assert(offsetof(PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestSuccessDelegate__DelegateSignature, PersonalBestResult) == 0x000000, "Member 'PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestSuccessDelegate__DelegateSignature::PersonalBestResult' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestSuccessDelegate__DelegateSignature, RequestParams) == 0x000198, "Member 'PilgrimAsyncAction_RequestPersonalBest_PersonalBestRequestSuccessDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
{
public:
	class FText                                   Error;                                             // 0x0000(0x0018)(Parm, NativeAccessSpecifierPublic)
	struct FPilgrimPlayerFeedParams               RequestParams;                                     // 0x0018(0x0098)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature) == 0x0000B0, "Wrong size on PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature");
static_assert(offsetof(PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature, Error) == 0x000000, "Member 'PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature::Error' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature, RequestParams) == 0x000018, "Member 'PilgrimAsyncAction_RequestPlayerFeed_RequestFeedFailureDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
static_assert(offsetof(PilgrimAsyncAction_RequestPlayerFeed_RequestFeedSuccessDelegate__DelegateSignature, FeedResult) == 0x000000, "Member 'PilgrimAsyncAction_RequestPlayerFeed_RequestFeedSuccessDelegate__DelegateSignature::FeedResult' has a wrong offset!");
static_assert(offsetof(PilgrimAsyncAction_RequestPlayerFeed_RequestFeedSuccessDelegate__DelegateSignature, RequestParams) == 0x000020, "Member 'PilgrimAsyncAction_RequestPlayerFeed_RequestFeedSuccessDelegate__DelegateSignature::RequestParams' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct PilgrimClientSettingRecordPartition_SetOverdriveClearsGems final
{
public:
...
static_assert(alignof(PilgrimClientSettingRecordPartition_SetOverdriveClearsGems) == 0x000001, "Wrong alignment on PilgrimClientSettingRecordPartition_SetOverdriveClearsGems");
static_assert(sizeof(PilgrimClientSettingRecordPartition_SetOverdriveClearsGems) == 0x000001, "Wrong size on PilgrimClientSettingRecordPartition_SetOverdriveClearsGems");
static_assert(offsetof(PilgrimClientSettingRecordPartition_SetOverdriveClearsGems, NewValue) == 0x000000, "Member 'PilgrimClientSettingRecordPartition_SetOverdriveClearsGems::NewValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct PilgrimClientSettingRecordPartition_GetOverdriveClearsGems final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PilgrimClientSettingRecordPartition_GetOverdriveClearsGems) == 0x000001, "Wrong alignment on PilgrimClientSettingRecordPartition_GetOverdriveClearsGems");
static_assert(sizeof(PilgrimClientSettingRecordPartition_GetOverdriveClearsGems) == 0x000001, "Wrong size on PilgrimClientSettingRecordPartition_GetOverdriveClearsGems");
static_assert(offsetof(PilgrimClientSettingRecordPartition_GetOverdriveClearsGems, ReturnValue) == 0x000000, "Member 'PilgrimClientSettingRecordPartition_GetOverdriveClearsGems::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PilgrimCustomSetlist_SetlistLockedStateChangedDelegate__DelegateSignature, Setlist) == 0x000000, "Member 'PilgrimCustomSetlist_SetlistLockedStateChangedDelegate__DelegateSignature::Setlist' has a wrong offset!");
static_assert(offsetof(PilgrimCustomSetlist_SetlistLockedStateChangedDelegate__DelegateSignature, bIsLocked) == 0x000008, "Member 'PilgrimCustomSetlist_SetlistLockedStateChangedDelegate__DelegateSignature::bIsLocked' has a wrong offset!");
...
static_assert(offsetof(PilgrimGame_PilgrimGameAutoplayUpdated__DelegateSignature, Enabled) == 0x000000, "Member 'PilgrimGame_PilgrimGameAutoplayUpdated__DelegateSignature::Enabled' has a wrong offset!");
...
static_assert(offsetof(PilgrimGame_PilgrimGameDisableMissUpdated__DelegateSignature, Enabled) == 0x000000, "Member 'PilgrimGame_PilgrimGameDisableMissUpdated__DelegateSignature::Enabled' has a wrong offset!");
...
{
public:
	struct FPilgrimGameProgress                   Score;                                             // 0x0000(0x006C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PilgrimGame_PilgrimGameScoreUpdated__DelegateSignature) == 0x00006C, "Wrong size on PilgrimGame_PilgrimGameScoreUpdated__DelegateSignature");
static_assert(offsetof(PilgrimGame_PilgrimGameScoreUpdated__DelegateSignature, Score) == 0x000000, "Member 'PilgrimGame_PilgrimGameScoreUpdated__DelegateSignature::Score' has a wrong offset!");
...
static_assert(offsetof(PilgrimGem_OnPilgrimGemEvent__DelegateSignature, Gem) == 0x000000, "Member 'PilgrimGem_OnPilgrimGemEvent__DelegateSignature::Gem' has a wrong offset!");
...
static_assert(offsetof(PilgrimLeaderboardPlayerComponent_OnBandFriendLeaderboardOptionChanged__DelegateSignature, bOptionEnabled) == 0x000000, "Member 'PilgrimLeaderboardPlayerComponent_OnBandFriendLeaderboardOptionChanged__DelegateSignature::bOptionEnabled' has a wrong offset!");
...
static_assert(offsetof(PilgrimLeaderboardPlayerComponent_OnFriendsSurpassed__DelegateSignature, HighestFriendEntry) == 0x000000, "Member 'PilgrimLeaderboardPlayerComponent_OnFriendsSurpassed__DelegateSignature::HighestFriendEntry' has a wrong offset!");
static_assert(offsetof(PilgrimLeaderboardPlayerComponent_OnFriendsSurpassed__DelegateSignature, TotalFriendsSurpassed) == 0x000038, "Member 'PilgrimLeaderboardPlayerComponent_OnFriendsSurpassed__DelegateSignature::TotalFriendsSurpassed' has a wrong offset!");
...
static_assert(offsetof(PilgrimMusicBattleInstance_OnMusicBattleFinished__DelegateSignature, EndReason) == 0x000000, "Member 'PilgrimMusicBattleInstance_OnMusicBattleFinished__DelegateSignature::EndReason' has a wrong offset!");
...
static_assert(offsetof(PilgrimWaitForEventRouterAction_PilgrimEventRouterAvailableDelegate__DelegateSignature, EventRouter) == 0x000000, "Member 'PilgrimWaitForEventRouterAction_PilgrimEventRouterAvailableDelegate__DelegateSignature::EventRouter' has a wrong offset!");
