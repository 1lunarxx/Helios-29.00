...
static_assert(sizeof(UFortCameraMode_Motorcycle) == 0x001CC0, "Wrong size on UFortCameraMode_Motorcycle");

// Class MotorcycleRuntime.FortMotorcycleVehicle
// 0x0450 (0x2470 - 0x2020)
class AFortMotorcycleVehicle : public AFortAthenaSKMotorVehicle
{
public:
	FMulticastInlineDelegateProperty_             OnStartChargingJumpDelegate;                       // 0x2018(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCancelChargingJumpDelegate;                      // 0x2028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnJumpDelegate;                                    // 0x2038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnChargingJumpDelegate;                            // 0x2048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartAirTrickDelegate;                           // 0x2058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFinishAirTrickDelegate;                          // 0x2068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartWheelieDelegate;                            // 0x2078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnReleaseWheelieDelegate;                          // 0x2088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLandWheelieDelegate;                             // 0x2098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailWheelieDelegate;                             // 0x20A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStartStoppieDelegate;                            // 0x20B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnReleaseStoppieDelegate;                          // 0x20C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLandStoppieDelegate;                             // 0x20D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInventoryModeChangedDelegate;                    // 0x20E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSuperSlidingChangedDelegate;                     // 0x20F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortCameraMode_AthenaVehicle> InventoryCameraModeClass;                          // 0x2108(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortCameraMode_AthenaVehicle> InventoryCameraModeClassADS;                       // 0x2110(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortCameraMode_AthenaVehicle> PassengerCameraModeClass;                          // 0x2118(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortCameraMode>            PassengerCameraModeClassADS;                       // 0x2120(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortMotorcycleVehicleConfigs*          FortMotorcycleVehicleConfigs;                      // 0x2128(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   RearAxleSocket;                                    // 0x2130(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2134[0x4];                                     // 0x2134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FActionDefForUI>                ActionDefForUI;                                    // 0x2138(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	float                                         SwingArmRotation;                                  // 0x2148(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_214C[0x7C];                                    // 0x214C(0x007C)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<int32>                                 BoostShapeIndices;                                 // 0x21C8(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	bool                                          bIsBoostAttacking;                                 // 0x21D8(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_21D9[0xF];                                     // 0x21D9(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	EFortMotorcycleAirTrickType                   CachedTrickType;                                   // 0x21E8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHadPassengerAtTrickStart;                         // 0x21E9(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_21EA[0x36];                                    // 0x21EA(0x0036)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           PassengerADSSockets;                               // 0x2220(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVector>                        PassengerADSRelativeOffsets;                       // 0x2230(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UNiagaraComponent*                      CachedNiagaraComponentRoadAndExhaust;              // 0x2240(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustNiagaraComponentName;                // 0x2248(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustVehicleSpeedName;                    // 0x2258(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustSlideDirectionName;                  // 0x225C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustMinSpeedForDust;                     // 0x2260(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustDustRearName;                        // 0x2264(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustDustColorLerpName;                   // 0x2268(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustColorLerp;                       // 0x226C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustDustAlphaMultiplierName;             // 0x2270(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustAlphaMultiplier;                 // 0x2274(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustPeelOutColorIndexName;               // 0x2278(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustPeelOutRearName;                     // 0x227C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustIsPeelOutOnRoadName;                 // 0x2280(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustIsPeelOutOnRoadRewindName;           // 0x2284(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustIsInAirName;                         // 0x2288(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           RoadAndExhaustCameraDirtGameplayCueTag;            // 0x228C(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           RoadAndExhaustCameraWaterGameplayCueTag;           // 0x2290(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2294[0x4];                                     // 0x2294(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EPhysicalSurface>                      RoadAndExhaustSurfaceTypeArrayForFX;               // 0x2298(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class ULegacyCameraShake*                     DriverCameraShakeInstance;                         // 0x22A8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULegacyCameraShake*                     AcceleratingCameraShakeInstance;                   // 0x22B0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_22B8[0x8];                                     // 0x22B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   RoadAndExhaustHeadlightsName;                      // 0x22C0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   RoadAndExhaustBrakelightsName;                     // 0x22C4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashMinSpeed;                                  // 0x22C8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashMaxSpeed;                                  // 0x22F0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashForwardDistanceMin;                        // 0x2318(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashForwardDistanceMax;                        // 0x2340(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTag                           DoorBashGameplayCueTag;                            // 0x2368(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_236C[0x4];                                     // 0x236C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      DoorBashCollisionTypesForDoor;                     // 0x2370(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TArray<EObjectTypeQuery>                      DoorBashCollisionTypesForPawn;                     // 0x2380(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashSphereRadiusForPawnLaunch;                 // 0x2390(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DoorBashScalarForPawnLaunch;                       // 0x23B8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTag                           DoorBashPawnLaunchGameplayCueTag;                  // 0x23E0(0x0004)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_23E4[0x4];                                     // 0x23E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      InventoryModeTagQuery;                             // 0x23E8(0x0048)(Edit, Transient, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  InputContextBlockedTags;                           // 0x2430(0x0020)(Edit, Transient, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2450[0x18];                                    // 0x2450(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           MobileHUDTag;                                      // 0x2468(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_246C[0x4];                                     // 0x246C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFortMotorcycleVehicle) == 0x002470, "Wrong size on AFortMotorcycleVehicle");
static_assert(offsetof(AFortMotorcycleVehicle, OnStartChargingJumpDelegate) == 0x002018, "Member 'AFortMotorcycleVehicle::OnStartChargingJumpDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnCancelChargingJumpDelegate) == 0x002028, "Member 'AFortMotorcycleVehicle::OnCancelChargingJumpDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnJumpDelegate) == 0x002038, "Member 'AFortMotorcycleVehicle::OnJumpDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnChargingJumpDelegate) == 0x002048, "Member 'AFortMotorcycleVehicle::OnChargingJumpDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnStartAirTrickDelegate) == 0x002058, "Member 'AFortMotorcycleVehicle::OnStartAirTrickDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnFinishAirTrickDelegate) == 0x002068, "Member 'AFortMotorcycleVehicle::OnFinishAirTrickDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnStartWheelieDelegate) == 0x002078, "Member 'AFortMotorcycleVehicle::OnStartWheelieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnReleaseWheelieDelegate) == 0x002088, "Member 'AFortMotorcycleVehicle::OnReleaseWheelieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnLandWheelieDelegate) == 0x002098, "Member 'AFortMotorcycleVehicle::OnLandWheelieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnFailWheelieDelegate) == 0x0020A8, "Member 'AFortMotorcycleVehicle::OnFailWheelieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnStartStoppieDelegate) == 0x0020B8, "Member 'AFortMotorcycleVehicle::OnStartStoppieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnReleaseStoppieDelegate) == 0x0020C8, "Member 'AFortMotorcycleVehicle::OnReleaseStoppieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnLandStoppieDelegate) == 0x0020D8, "Member 'AFortMotorcycleVehicle::OnLandStoppieDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnInventoryModeChangedDelegate) == 0x0020E8, "Member 'AFortMotorcycleVehicle::OnInventoryModeChangedDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, OnSuperSlidingChangedDelegate) == 0x0020F8, "Member 'AFortMotorcycleVehicle::OnSuperSlidingChangedDelegate' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, InventoryCameraModeClass) == 0x002108, "Member 'AFortMotorcycleVehicle::InventoryCameraModeClass' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, InventoryCameraModeClassADS) == 0x002110, "Member 'AFortMotorcycleVehicle::InventoryCameraModeClassADS' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, PassengerCameraModeClass) == 0x002118, "Member 'AFortMotorcycleVehicle::PassengerCameraModeClass' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, PassengerCameraModeClassADS) == 0x002120, "Member 'AFortMotorcycleVehicle::PassengerCameraModeClassADS' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, FortMotorcycleVehicleConfigs) == 0x002128, "Member 'AFortMotorcycleVehicle::FortMotorcycleVehicleConfigs' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RearAxleSocket) == 0x002130, "Member 'AFortMotorcycleVehicle::RearAxleSocket' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, ActionDefForUI) == 0x002138, "Member 'AFortMotorcycleVehicle::ActionDefForUI' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, SwingArmRotation) == 0x002148, "Member 'AFortMotorcycleVehicle::SwingArmRotation' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, BoostShapeIndices) == 0x0021C8, "Member 'AFortMotorcycleVehicle::BoostShapeIndices' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, bIsBoostAttacking) == 0x0021D8, "Member 'AFortMotorcycleVehicle::bIsBoostAttacking' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, CachedTrickType) == 0x0021E8, "Member 'AFortMotorcycleVehicle::CachedTrickType' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, bHadPassengerAtTrickStart) == 0x0021E9, "Member 'AFortMotorcycleVehicle::bHadPassengerAtTrickStart' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, PassengerADSSockets) == 0x002220, "Member 'AFortMotorcycleVehicle::PassengerADSSockets' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, PassengerADSRelativeOffsets) == 0x002230, "Member 'AFortMotorcycleVehicle::PassengerADSRelativeOffsets' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, CachedNiagaraComponentRoadAndExhaust) == 0x002240, "Member 'AFortMotorcycleVehicle::CachedNiagaraComponentRoadAndExhaust' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustNiagaraComponentName) == 0x002248, "Member 'AFortMotorcycleVehicle::RoadAndExhaustNiagaraComponentName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustVehicleSpeedName) == 0x002258, "Member 'AFortMotorcycleVehicle::RoadAndExhaustVehicleSpeedName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustSlideDirectionName) == 0x00225C, "Member 'AFortMotorcycleVehicle::RoadAndExhaustSlideDirectionName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustMinSpeedForDust) == 0x002260, "Member 'AFortMotorcycleVehicle::RoadAndExhaustMinSpeedForDust' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustDustRearName) == 0x002264, "Member 'AFortMotorcycleVehicle::RoadAndExhaustDustRearName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustDustColorLerpName) == 0x002268, "Member 'AFortMotorcycleVehicle::RoadAndExhaustDustColorLerpName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustDustColorLerp) == 0x00226C, "Member 'AFortMotorcycleVehicle::RoadAndExhaustDustColorLerp' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustDustAlphaMultiplierName) == 0x002270, "Member 'AFortMotorcycleVehicle::RoadAndExhaustDustAlphaMultiplierName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustDustAlphaMultiplier) == 0x002274, "Member 'AFortMotorcycleVehicle::RoadAndExhaustDustAlphaMultiplier' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustPeelOutColorIndexName) == 0x002278, "Member 'AFortMotorcycleVehicle::RoadAndExhaustPeelOutColorIndexName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustPeelOutRearName) == 0x00227C, "Member 'AFortMotorcycleVehicle::RoadAndExhaustPeelOutRearName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustIsPeelOutOnRoadName) == 0x002280, "Member 'AFortMotorcycleVehicle::RoadAndExhaustIsPeelOutOnRoadName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustIsPeelOutOnRoadRewindName) == 0x002284, "Member 'AFortMotorcycleVehicle::RoadAndExhaustIsPeelOutOnRoadRewindName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustIsInAirName) == 0x002288, "Member 'AFortMotorcycleVehicle::RoadAndExhaustIsInAirName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustCameraDirtGameplayCueTag) == 0x00228C, "Member 'AFortMotorcycleVehicle::RoadAndExhaustCameraDirtGameplayCueTag' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustCameraWaterGameplayCueTag) == 0x002290, "Member 'AFortMotorcycleVehicle::RoadAndExhaustCameraWaterGameplayCueTag' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustSurfaceTypeArrayForFX) == 0x002298, "Member 'AFortMotorcycleVehicle::RoadAndExhaustSurfaceTypeArrayForFX' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DriverCameraShakeInstance) == 0x0022A8, "Member 'AFortMotorcycleVehicle::DriverCameraShakeInstance' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, AcceleratingCameraShakeInstance) == 0x0022B0, "Member 'AFortMotorcycleVehicle::AcceleratingCameraShakeInstance' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustHeadlightsName) == 0x0022C0, "Member 'AFortMotorcycleVehicle::RoadAndExhaustHeadlightsName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, RoadAndExhaustBrakelightsName) == 0x0022C4, "Member 'AFortMotorcycleVehicle::RoadAndExhaustBrakelightsName' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashMinSpeed) == 0x0022C8, "Member 'AFortMotorcycleVehicle::DoorBashMinSpeed' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashMaxSpeed) == 0x0022F0, "Member 'AFortMotorcycleVehicle::DoorBashMaxSpeed' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashForwardDistanceMin) == 0x002318, "Member 'AFortMotorcycleVehicle::DoorBashForwardDistanceMin' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashForwardDistanceMax) == 0x002340, "Member 'AFortMotorcycleVehicle::DoorBashForwardDistanceMax' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashGameplayCueTag) == 0x002368, "Member 'AFortMotorcycleVehicle::DoorBashGameplayCueTag' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashCollisionTypesForDoor) == 0x002370, "Member 'AFortMotorcycleVehicle::DoorBashCollisionTypesForDoor' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashCollisionTypesForPawn) == 0x002380, "Member 'AFortMotorcycleVehicle::DoorBashCollisionTypesForPawn' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashSphereRadiusForPawnLaunch) == 0x002390, "Member 'AFortMotorcycleVehicle::DoorBashSphereRadiusForPawnLaunch' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashScalarForPawnLaunch) == 0x0023B8, "Member 'AFortMotorcycleVehicle::DoorBashScalarForPawnLaunch' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, DoorBashPawnLaunchGameplayCueTag) == 0x0023E0, "Member 'AFortMotorcycleVehicle::DoorBashPawnLaunchGameplayCueTag' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, InventoryModeTagQuery) == 0x0023E8, "Member 'AFortMotorcycleVehicle::InventoryModeTagQuery' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, InputContextBlockedTags) == 0x002430, "Member 'AFortMotorcycleVehicle::InputContextBlockedTags' has a wrong offset!");
static_assert(offsetof(AFortMotorcycleVehicle, MobileHUDTag) == 0x002468, "Member 'AFortMotorcycleVehicle::MobileHUDTag' has a wrong offset!");
