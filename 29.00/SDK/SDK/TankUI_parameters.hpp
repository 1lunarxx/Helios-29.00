...
static_assert(offsetof(TankVehicleReticle_HandleOnDamageablePartHealthChanged, bNewlyDisabled) == 0x000058, "Member 'TankVehicleReticle_HandleOnDamageablePartHealthChanged::bNewlyDisabled' has a wrong offset!");
static_assert(offsetof(TankVehicleReticle_HandleOnDamageablePartHealthChanged, bNewlyEnabled) == 0x000059, "Member 'TankVehicleReticle_HandleOnDamageablePartHealthChanged::bNewlyEnabled' has a wrong offset!");
