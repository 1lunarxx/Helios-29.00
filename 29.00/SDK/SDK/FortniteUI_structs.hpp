...
{
	NoError                                  = 0,
	WaitingForIslandRefresh                  = 1,
	PartyTooLarge                            = 2,
	SmallSquadSizeForPrivateMatch            = 3,
	CannotUseWhileLookingForParty            = 4,
	CannotUseWhileUsingPartySignal           = 5,
	DownloadingData                          = 6,
	ModeUnavailable                          = 7,
	CabinRestricted                          = 8,
	...
	WorldOwnerPartyLeader                    = 20,
	YouMustSelectWorldFirst                  = 21,
	YouMustWaitForWorldToBeSelected          = 22,
	WorldUnavailable                         = 23,
	EFortUIMatchmakingError_MAX              = 24,
};
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAnimationsFinished;                              // 0x0018(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class UItemDefinitionBase*                    Item;                                              // 0x0018(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FTrackedInputPointer) == 0x000088, "Wrong size on FTrackedInputPointer");
