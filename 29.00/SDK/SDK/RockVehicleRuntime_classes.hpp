...
// 0x0240 (0x21E0 - 0x1FA0)
class ARockVehicle final : public AFortAthenaSKVehicle
{
public:
	float                                         InputSwivelPitch;                                  // 0x1FA0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InputSwivelYaw;                                    // 0x1FA4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bInputReverseCamera : 1;                           // 0x1FA8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasDoubleJumped : 1;                              // 0x1FA8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasDodged : 1;                                    // 0x1FA8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bFreeLookCamera;                                   // 0x1FA9(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1FAA[0x6];                                     // 0x1FAA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnFreeCamToggled;                                  // 0x1FB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1FC0[0x1];                                     // 0x1FC0(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRockRuntimeConfigOverrides            RockRuntimeConfigs;                                // 0x1FC1(0x0004)(Net, Transient, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1FC5[0x1B];                                    // 0x1FC5(0x001B)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnSpringImpact;                                    // 0x1FE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1FF0[0x78];                                    // 0x1FF0(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	class URockVehicleAnalyticsComponent*         RockAnalyticsComp;                                 // 0x2068(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class URockVehicleAbility*>            VehicleAbilities;                                  // 0x2070(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<TSoftClassPtr<class UClass>>           VehicleAbilityTickOrder;                           // 0x2080(0x0010)(Edit, ZeroConstructor, Config, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class AFortVehicleAudioController*            CachedVehicleAudioController;                      // 0x2090(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class URockVehicleAbility_Supersonic*         SupersonicAbility;                                 // 0x2098(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class URockVehicleAnimInstance*               RockAnimInstance;                                  // 0x20A0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FFortAthenaVehicleInputState           PendingDriverInputState;                           // 0x20A8(0x0040)(Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FFortAthenaVehicleInputState           PrevDriverInputState;                              // 0x20E8(0x0040)(Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FVector                                EnterExitImpulse;                                  // 0x2128(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2140[0xA0];                                    // 0x2140(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ARockVehicle) == 0x0021E0, "Wrong size on ARockVehicle");
static_assert(offsetof(ARockVehicle, InputSwivelPitch) == 0x001FA0, "Member 'ARockVehicle::InputSwivelPitch' has a wrong offset!");
static_assert(offsetof(ARockVehicle, InputSwivelYaw) == 0x001FA4, "Member 'ARockVehicle::InputSwivelYaw' has a wrong offset!");
static_assert(offsetof(ARockVehicle, bFreeLookCamera) == 0x001FA9, "Member 'ARockVehicle::bFreeLookCamera' has a wrong offset!");
static_assert(offsetof(ARockVehicle, OnFreeCamToggled) == 0x001FB0, "Member 'ARockVehicle::OnFreeCamToggled' has a wrong offset!");
static_assert(offsetof(ARockVehicle, RockRuntimeConfigs) == 0x001FC1, "Member 'ARockVehicle::RockRuntimeConfigs' has a wrong offset!");
static_assert(offsetof(ARockVehicle, OnSpringImpact) == 0x001FE0, "Member 'ARockVehicle::OnSpringImpact' has a wrong offset!");
static_assert(offsetof(ARockVehicle, RockAnalyticsComp) == 0x002068, "Member 'ARockVehicle::RockAnalyticsComp' has a wrong offset!");
static_assert(offsetof(ARockVehicle, VehicleAbilities) == 0x002070, "Member 'ARockVehicle::VehicleAbilities' has a wrong offset!");
static_assert(offsetof(ARockVehicle, VehicleAbilityTickOrder) == 0x002080, "Member 'ARockVehicle::VehicleAbilityTickOrder' has a wrong offset!");
static_assert(offsetof(ARockVehicle, CachedVehicleAudioController) == 0x002090, "Member 'ARockVehicle::CachedVehicleAudioController' has a wrong offset!");
static_assert(offsetof(ARockVehicle, SupersonicAbility) == 0x002098, "Member 'ARockVehicle::SupersonicAbility' has a wrong offset!");
static_assert(offsetof(ARockVehicle, RockAnimInstance) == 0x0020A0, "Member 'ARockVehicle::RockAnimInstance' has a wrong offset!");
static_assert(offsetof(ARockVehicle, PendingDriverInputState) == 0x0020A8, "Member 'ARockVehicle::PendingDriverInputState' has a wrong offset!");
static_assert(offsetof(ARockVehicle, PrevDriverInputState) == 0x0020E8, "Member 'ARockVehicle::PrevDriverInputState' has a wrong offset!");
static_assert(offsetof(ARockVehicle, EnterExitImpulse) == 0x002128, "Member 'ARockVehicle::EnterExitImpulse' has a wrong offset!");
...
// 0x0200 (0x1EC0 - 0x1CC0)
class URockVehicleCameraMode final : public UFortCameraMode_AthenaVehicle
{
public:
	float                                         SwivelPitchMax;                                    // 0x1CB8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SwivelYawMax;                                      // 0x1CBC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundNormalInterpRate;                            // 0x1CC0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundNormalAirInterpRate;                         // 0x1CC4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GroundYawRate;                                     // 0x1CC8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WallYawRate;                                       // 0x1CCC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InterpToGroundTime;                                // 0x1CD0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InterpToAirTime;                                   // 0x1CD4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AverageVelocityInterpRate;                         // 0x1CD8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1CDC[0x4];                                     // 0x1CDC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     AirRotationInterpRateForSpeed;                     // 0x1CE0(0x0088)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	float                                         FocusOffsetInterpRate;                             // 0x1D68(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceSpeedScale;                                // 0x1D6C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceOffsetMin;                                 // 0x1D70(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceOffsetMax;                                 // 0x1D74(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceInterpRate;                                // 0x1D78(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxSpeedFOVOffset;                                 // 0x1D7C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SupersonicFOVOffset;                               // 0x1D80(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FOVInterpRate;                                     // 0x1D84(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRockCameraSettings                    CameraSettings;                                    // 0x1D88(0x001C)(Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DA4[0x4];                                     // 0x1DA4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ARockVehicle*                           VehicleTarget;                                     // 0x1DA8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class URockVehicleAbility_Jump*               JumpAbility;                                       // 0x1DB0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1DB8[0x108];                                   // 0x1DB8(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URockVehicleCameraMode) == 0x001EC0, "Wrong size on URockVehicleCameraMode");
static_assert(offsetof(URockVehicleCameraMode, SwivelPitchMax) == 0x001CB8, "Member 'URockVehicleCameraMode::SwivelPitchMax' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, SwivelYawMax) == 0x001CBC, "Member 'URockVehicleCameraMode::SwivelYawMax' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, GroundNormalInterpRate) == 0x001CC0, "Member 'URockVehicleCameraMode::GroundNormalInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, GroundNormalAirInterpRate) == 0x001CC4, "Member 'URockVehicleCameraMode::GroundNormalAirInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, GroundYawRate) == 0x001CC8, "Member 'URockVehicleCameraMode::GroundYawRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, WallYawRate) == 0x001CCC, "Member 'URockVehicleCameraMode::WallYawRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, InterpToGroundTime) == 0x001CD0, "Member 'URockVehicleCameraMode::InterpToGroundTime' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, InterpToAirTime) == 0x001CD4, "Member 'URockVehicleCameraMode::InterpToAirTime' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, AverageVelocityInterpRate) == 0x001CD8, "Member 'URockVehicleCameraMode::AverageVelocityInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, AirRotationInterpRateForSpeed) == 0x001CE0, "Member 'URockVehicleCameraMode::AirRotationInterpRateForSpeed' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, FocusOffsetInterpRate) == 0x001D68, "Member 'URockVehicleCameraMode::FocusOffsetInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, DistanceSpeedScale) == 0x001D6C, "Member 'URockVehicleCameraMode::DistanceSpeedScale' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, DistanceOffsetMin) == 0x001D70, "Member 'URockVehicleCameraMode::DistanceOffsetMin' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, DistanceOffsetMax) == 0x001D74, "Member 'URockVehicleCameraMode::DistanceOffsetMax' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, DistanceInterpRate) == 0x001D78, "Member 'URockVehicleCameraMode::DistanceInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, MaxSpeedFOVOffset) == 0x001D7C, "Member 'URockVehicleCameraMode::MaxSpeedFOVOffset' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, SupersonicFOVOffset) == 0x001D80, "Member 'URockVehicleCameraMode::SupersonicFOVOffset' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, FOVInterpRate) == 0x001D84, "Member 'URockVehicleCameraMode::FOVInterpRate' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, CameraSettings) == 0x001D88, "Member 'URockVehicleCameraMode::CameraSettings' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, VehicleTarget) == 0x001DA8, "Member 'URockVehicleCameraMode::VehicleTarget' has a wrong offset!");
static_assert(offsetof(URockVehicleCameraMode, JumpAbility) == 0x001DB0, "Member 'URockVehicleCameraMode::JumpAbility' has a wrong offset!");
