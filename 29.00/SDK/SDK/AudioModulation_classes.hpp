...
public:
	...
	static class UAudioModulationDestination* CreateModulationWatcher(class UObject* WorldContextObject, class FName Name_0, class USoundModulatorBase* Modulator);
