...
class UAtomPrimitiveGeometryContainer* UAtomPrimitive::GetGeometryContainerForBestExportStyle(const TArray<class FString>& GeometryStylePriorityList) const
{
	static class UFunction* Func = nullptr;
