...
static_assert(sizeof(UInterchangeAssetImportData) == 0x0000D0, "Wrong size on UInterchangeAssetImportData");
...
static_assert(offsetof(UInterchangeAssetImportData, TransientTranslatorSettings) == 0x000080, "Member 'UInterchangeAssetImportData::TransientTranslatorSettings' has a wrong offset!");
