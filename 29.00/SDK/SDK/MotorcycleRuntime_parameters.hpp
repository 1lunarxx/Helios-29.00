...
static_assert(offsetof(FortMotorcycleVehicle_MotorcycleInventoryMode__DelegateSignature, IsInInventoryMode) == 0x000000, "Member 'FortMotorcycleVehicle_MotorcycleInventoryMode__DelegateSignature::IsInInventoryMode' has a wrong offset!");
...
static_assert(offsetof(FortMotorcycleVehicle_MotorcycleJump__DelegateSignature, JumpChargeFactor) == 0x000000, "Member 'FortMotorcycleVehicle_MotorcycleJump__DelegateSignature::JumpChargeFactor' has a wrong offset!");
...
static_assert(offsetof(FortMotorcycleVehicle_MotorcycleStartAirTrick__DelegateSignature, TrickType) == 0x000000, "Member 'FortMotorcycleVehicle_MotorcycleStartAirTrick__DelegateSignature::TrickType' has a wrong offset!");
...
static_assert(offsetof(FortMotorcycleVehicle_MotorcycleSuperSlidingChanged__DelegateSignature, bIsSuperSliding) == 0x000000, "Member 'FortMotorcycleVehicle_MotorcycleSuperSlidingChanged__DelegateSignature::bIsSuperSliding' has a wrong offset!");
