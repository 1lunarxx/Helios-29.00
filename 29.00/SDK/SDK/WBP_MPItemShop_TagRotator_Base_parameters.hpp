...
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_IsMobileGame_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, K2Node_Select_Default) == 0x000011, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_SelectFloat_ReturnValue) == 0x000030, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000038, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_MakeVector2D_Y_ImplicitCast) == 0x000040, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_MakeVector2D_Y_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_Divide_DoubleDouble_A_ImplicitCast) == 0x000048, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_Divide_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator, CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast) == 0x000050, "Member 'WBP_MPItemShop_TagRotator_Base_C_InitializeTagRotator::CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_IsUsingTouch_ReturnValue) == 0x000010, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_GetRuntimeOptions_ReturnValue) == 0x000018, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_GetRuntimeOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_BooleanAND_ReturnValue) == 0x000020, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_BooleanOR_ReturnValue) == 0x000021, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State, CallFunc_BooleanAND_ReturnValue_1) == 0x000022, "Member 'WBP_MPItemShop_TagRotator_Base_C_Set_Focused_State::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
