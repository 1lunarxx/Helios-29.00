...
{
public:
	uint8                                         Pad_D0[0x238];                                     // 0x00D0(0x0238)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPCGStaticMeshSpawnerContext) == 0x000008, "Wrong alignment on FPCGStaticMeshSpawnerContext");
static_assert(sizeof(FPCGStaticMeshSpawnerContext) == 0x000308, "Wrong size on FPCGStaticMeshSpawnerContext");
...
static_assert(sizeof(FPCGSelectionKey) == 0x000030, "Wrong size on FPCGSelectionKey");
...
static_assert(offsetof(FPCGSelectionKey, SelectionClass) == 0x000008, "Member 'FPCGSelectionKey::SelectionClass' has a wrong offset!");
static_assert(offsetof(FPCGSelectionKey, ObjectPath) == 0x000010, "Member 'FPCGSelectionKey::ObjectPath' has a wrong offset!");
static_assert(offsetof(FPCGSelectionKey, OptionalExtraDependency) == 0x000028, "Member 'FPCGSelectionKey::OptionalExtraDependency' has a wrong offset!");
...
static_assert(sizeof(FPCGSplineSamplerParams) == 0x000100, "Wrong size on FPCGSplineSamplerParams");
...
static_assert(offsetof(FPCGSplineSamplerParams, bComputeSegmentIndex) == 0x000028, "Member 'FPCGSplineSamplerParams::bComputeSegmentIndex' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, SegmentIndexAttribute) == 0x00002C, "Member 'FPCGSplineSamplerParams::SegmentIndexAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bComputeSubsegmentIndex) == 0x000030, "Member 'FPCGSplineSamplerParams::bComputeSubsegmentIndex' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, SubsegmentIndexAttribute) == 0x000034, "Member 'FPCGSplineSamplerParams::SubsegmentIndexAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bComputeTangents) == 0x000038, "Member 'FPCGSplineSamplerParams::bComputeTangents' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, ArriveTangentAttribute) == 0x00003C, "Member 'FPCGSplineSamplerParams::ArriveTangentAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, LeaveTangentAttribute) == 0x000040, "Member 'FPCGSplineSamplerParams::LeaveTangentAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bComputeAlpha) == 0x000044, "Member 'FPCGSplineSamplerParams::bComputeAlpha' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, AlphaAttribute) == 0x000048, "Member 'FPCGSplineSamplerParams::AlphaAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bComputeDistance) == 0x00004C, "Member 'FPCGSplineSamplerParams::bComputeDistance' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, DistanceAttribute) == 0x000050, "Member 'FPCGSplineSamplerParams::DistanceAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bComputeInputKey) == 0x000054, "Member 'FPCGSplineSamplerParams::bComputeInputKey' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, InputKeyAttribute) == 0x000058, "Member 'FPCGSplineSamplerParams::InputKeyAttribute' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bUnbounded) == 0x00005C, "Member 'FPCGSplineSamplerParams::bUnbounded' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, InteriorSampleSpacing) == 0x000060, "Member 'FPCGSplineSamplerParams::InteriorSampleSpacing' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, InteriorBorderSampleSpacing) == 0x000064, "Member 'FPCGSplineSamplerParams::InteriorBorderSampleSpacing' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bTreatSplineAsPolyline) == 0x000068, "Member 'FPCGSplineSamplerParams::bTreatSplineAsPolyline' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, InteriorOrientation) == 0x000069, "Member 'FPCGSplineSamplerParams::InteriorOrientation' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bProjectOntoSurface) == 0x00006A, "Member 'FPCGSplineSamplerParams::bProjectOntoSurface' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, InteriorDensityFalloffCurve) == 0x000070, "Member 'FPCGSplineSamplerParams::InteriorDensityFalloffCurve' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, PointSteepness) == 0x0000F8, "Member 'FPCGSplineSamplerParams::PointSteepness' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bSeedFromLocalPosition) == 0x0000FC, "Member 'FPCGSplineSamplerParams::bSeedFromLocalPosition' has a wrong offset!");
static_assert(offsetof(FPCGSplineSamplerParams, bSeedFrom2DPosition) == 0x0000FD, "Member 'FPCGSplineSamplerParams::bSeedFrom2DPosition' has a wrong offset!");
...
static_assert(sizeof(FPCGDebugVisualizationSettings) == 0x000048, "Wrong size on FPCGDebugVisualizationSettings");
...
static_assert(offsetof(FPCGPinProperties, Usage) == 0x000004, "Member 'FPCGPinProperties::Usage' has a wrong offset!");
...
static_assert(offsetof(FPCGPinProperties, PinStatus) == 0x00000D, "Member 'FPCGPinProperties::PinStatus' has a wrong offset!");
static_assert(offsetof(FPCGPinProperties, bInvisiblePin) == 0x00000E, "Member 'FPCGPinProperties::bInvisiblePin' has a wrong offset!");
static_assert(offsetof(FPCGPinProperties, bAllowMultipleConnections) == 0x00000F, "Member 'FPCGPinProperties::bAllowMultipleConnections' has a wrong offset!");
