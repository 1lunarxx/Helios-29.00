...
{
public:
	struct FJunoWorldMetadata                     WorldMetadata;                                     // 0x0000(0x0038)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FJunoEvent_WorldLoadedOrCreated) == 0x000008, "Wrong alignment on FJunoEvent_WorldLoadedOrCreated");
static_assert(sizeof(FJunoEvent_WorldLoadedOrCreated) == 0x000038, "Wrong size on FJunoEvent_WorldLoadedOrCreated");
...
static_assert(sizeof(FJunoPlayerAccountSaveData) == 0x000010, "Wrong size on FJunoPlayerAccountSaveData");
...
{
public:
	struct FJunoWorldMetadata                     MetaData;                                          // 0x0000(0x0038)(NativeAccessSpecifierPublic)
	class FString                                 OwnerId;                                           // 0x0038(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OwnerName;                                         // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         Keyholders;                                        // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         Occupants;                                         // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	double                                        WorldOwnerGuestReservationExpiration;              // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              CreatedAt;                                         // 0x0080(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              LastPlayed;                                        // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FJunoReplicatedWorldMetadata) == 0x000008, "Wrong alignment on FJunoReplicatedWorldMetadata");
static_assert(sizeof(FJunoReplicatedWorldMetadata) == 0x000090, "Wrong size on FJunoReplicatedWorldMetadata");
...
static_assert(offsetof(FJunoReplicatedWorldMetadata, OwnerId) == 0x000038, "Member 'FJunoReplicatedWorldMetadata::OwnerId' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, OwnerName) == 0x000048, "Member 'FJunoReplicatedWorldMetadata::OwnerName' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, Keyholders) == 0x000058, "Member 'FJunoReplicatedWorldMetadata::Keyholders' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, Occupants) == 0x000068, "Member 'FJunoReplicatedWorldMetadata::Occupants' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, WorldOwnerGuestReservationExpiration) == 0x000078, "Member 'FJunoReplicatedWorldMetadata::WorldOwnerGuestReservationExpiration' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, CreatedAt) == 0x000080, "Member 'FJunoReplicatedWorldMetadata::CreatedAt' has a wrong offset!");
static_assert(offsetof(FJunoReplicatedWorldMetadata, LastPlayed) == 0x000088, "Member 'FJunoReplicatedWorldMetadata::LastPlayed' has a wrong offset!");
