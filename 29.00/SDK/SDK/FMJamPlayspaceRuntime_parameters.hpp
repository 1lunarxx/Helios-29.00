...
{
public:
	struct FJamLoadResult                         LoadResult;                                        // 0x0000(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(JamMusicSlot_OnJamLoadRequestComplete) == 0x000028, "Wrong size on JamMusicSlot_OnJamLoadRequestComplete");
