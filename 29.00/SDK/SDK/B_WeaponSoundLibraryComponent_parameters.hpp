...
public:
	...
	bool                                          CallFunc_ValidateModMetasounds_bShouldBuild;       // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetOwner_ReturnValue;                     // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AFortWeaponRanged*                      K2Node_DynamicCast_AsFort_Weapon_Ranged;           // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class AActor* DeadActor, float Damage, class AFortPawn* InstigatedBy, const struct FVector& HitLocation, class AActor* DamageCauser)> K2Node_CreateDelegate_OutputDelegate;              // 0x002C(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APawn*                                  CallFunc_GetInstigator_ReturnValue;                // 0x0038(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	const class UFortWeaponModAudioData*          K2Node_Event_InModAudioData_1;                     // 0x0040(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_ValidateModMetasounds_bShouldBuild_1;     // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, CallFunc_ValidateModMetasounds_bShouldBuild) == 0x000010, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::CallFunc_ValidateModMetasounds_bShouldBuild' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, CallFunc_GetOwner_ReturnValue) == 0x000018, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, K2Node_DynamicCast_AsFort_Weapon_Ranged) == 0x000020, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::K2Node_DynamicCast_AsFort_Weapon_Ranged' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, K2Node_CreateDelegate_OutputDelegate) == 0x00002C, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, CallFunc_GetInstigator_ReturnValue) == 0x000038, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::CallFunc_GetInstigator_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, K2Node_Event_InModAudioData_1) == 0x000040, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::K2Node_Event_InModAudioData_1' has a wrong offset!");
...
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, CallFunc_ValidateModMetasounds_bShouldBuild_1) == 0x000051, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::CallFunc_ValidateModMetasounds_bShouldBuild_1' has a wrong offset!");
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent, K2Node_Event_EndPlayReason) == 0x000052, "Member 'B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent::K2Node_Event_EndPlayReason' has a wrong offset!");
...
static_assert(sizeof(B_WeaponSoundLibraryComponent_C_TryHandleFireEvent) == 0x000058, "Wrong size on B_WeaponSoundLibraryComponent_C_TryHandleFireEvent");
...
static_assert(offsetof(B_WeaponSoundLibraryComponent_C_TryHandleFireEvent, CallFunc_SetBoolParameter_self_CastInput) == 0x000048, "Member 'B_WeaponSoundLibraryComponent_C_TryHandleFireEvent::CallFunc_SetBoolParameter_self_CastInput' has a wrong offset!");
