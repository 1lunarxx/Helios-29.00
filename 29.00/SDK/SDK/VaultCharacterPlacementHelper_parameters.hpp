...
{
public:
	double                                        CurrentZoomLevel;                                  // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature) == 0x000008, "Wrong alignment on VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature");
static_assert(sizeof(VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature) == 0x000008, "Wrong size on VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature");
