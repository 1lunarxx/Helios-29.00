...
static_assert(offsetof(WBP_PriceSwitcher_Base_C_ExecuteUbergraph_WBP_PriceSwitcher_Base, CallFunc_IsMobileGame_ReturnValue) == 0x000004, "Member 'WBP_PriceSwitcher_Base_C_ExecuteUbergraph_WBP_PriceSwitcher_Base::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PriceSwitcher_Base_C_ExecuteUbergraph_WBP_PriceSwitcher_Base, Temp_bool_Variable) == 0x000005, "Member 'WBP_PriceSwitcher_Base_C_ExecuteUbergraph_WBP_PriceSwitcher_Base::Temp_bool_Variable' has a wrong offset!");
