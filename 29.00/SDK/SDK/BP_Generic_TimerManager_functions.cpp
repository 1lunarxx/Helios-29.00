...
// Function BP_Generic_TimerManager.BP_Generic_TimerManager_C.FadeOut__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_Generic_TimerManager_C::FadeOut__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Generic_TimerManager_C", "FadeOut__DelegateSignature");
...
void ABP_Generic_TimerManager_C::OnSecondsRemainingUpdated__DelegateSignature(int32 SecondsRemaining_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Generic_TimerManager_C", "OnSecondsRemainingUpdated__DelegateSignature");

	Params::BP_Generic_TimerManager_C_OnSecondsRemainingUpdated__DelegateSignature Parms{};
...
// Function BP_Generic_TimerManager.BP_Generic_TimerManager_C.OnTimerActive__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_Generic_TimerManager_C::OnTimerActive__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Generic_TimerManager_C", "OnTimerActive__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_Generic_TimerManager.BP_Generic_TimerManager_C.OnTimerFinished__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_Generic_TimerManager_C::OnTimerFinished__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Generic_TimerManager_C", "OnTimerFinished__DelegateSignature");
...
void ABP_Generic_TimerManager_C::OnTimerStateChange__DelegateSignature(int32 NewTimerState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Generic_TimerManager_C", "OnTimerStateChange__DelegateSignature");

	Params::BP_Generic_TimerManager_C_OnTimerStateChange__DelegateSignature Parms{};
